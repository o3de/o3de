...
Test Case: Creating tests for basic editor feature like creating a level, adding new entities, modifying the entities etc.
"""


class Tests:
    create_level = ("Level created and loaded successfully", "Failed to create the level")
    open_level = ("Level loaded successfully", "Failed to load the level")
    create_entity = ("Parent entity created successfully", "Failed to create a parent entity")
    set_entity_name = ("Entity name set successfully", "Failed to set entity name")
    delete_entity = ("Parent entity deleted successfully", "Failed to delete parent entity")
    game_mode_enter = ("Game Mode entered successfully", "Failed to enter the game mode")
    game_mode_exit = ("Game mode exited successfully", "Failed to exit game mode")
    create_child_entity = ("Child entity created successfully", "Failed to create a child entity")
    delete_child_entity = ("Child entity deleted successfully", "Failed to delete child entity")
    add_mesh_component = ("Mesh component added successfully", "Failed to add mesh component")
    found_component_typeId = ("Found component typeId", "Unable to find component TypeId")
    remove_mesh_component = ("Mesh component removed successfully", "Failed to remove mesh component")


def sample_editor_tests():
    """
        Performing basic test in editor
            01. create_level if it does not exist else 02. open exiting level

            03. create parent entity and set name
            04. create child entity
            05. delete child entity
            06. add mesh component
            07. remove mesh component
            08. enter game mode
            09. exit game_mode
            10. delete parent entity
            11. save level
    ...
    Report.result(Tests.create_level, general.get_current_level_name() == test_level)

    # 02. load existing level - skipping this since this could alter existing level that other test depends on

    # 03. create_entity and set name
    ...
    # 04. Creating child Entity and setting name to above created parent entity
    ...
    # 05. delete_Child_entity
    editor.ToolsApplicationRequestBus(bus.Broadcast, 'DeleteEntityById', child_1_entity)
    Report.result(Tests.delete_entity, search_entity(child_1_entity, "Child_1") == False)

    # 06. add mesh component to parent entity
...
if __name__ == "__main__":
    ...
    Report.start_test(sample_editor_tests)
