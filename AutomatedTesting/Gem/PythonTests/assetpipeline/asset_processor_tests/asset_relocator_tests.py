...
class TestsAssetRelocator_WindowsAndMac(object):
        ...
        pytest.param(
            {
                ...
                "primary": "move",
                "src_rel_path": os.path.join("testingAssets", "Materials", "test_texture_sequence.mtl"),
        ...
        pytest.param(
            {
                ...
                "primary": "move",
                "src_rel_path": os.path.join("testingAssets", "Textures",  "test_texture_sequence", "*.png"),
                "secondary": "UpdateReferences",
                "confirm": True,
                "expected_messages": [
                    "SUCCESS COUNT: 6",
                ...
                "unexpected_messages": [
                    ...
                    ["Updated", "test_texture_sequence.mtl", "SUCCESS"],
                ],
            },
            id="C21968362_2",
            marks=[pytest.mark.test_case_id("C21968362")],
        ...
        pytest.param(
            {
                ...
                "primary": "move",
                "src_rel_path": os.path.join("testingAssets", "Textures", "milestone2", "AM_MudAndGrass_01*"),
                "secondary": "UpdateReferences",
                "confirm": True,
                "expected_messages": [
                    "SUCCESS COUNT: 3",
        ...
        pytest.param(
            {
                ...
                "primary": "move",
                "src_rel_path": os.path.join("testingAssets", "Textures", "*"),
                "secondary": "UpdateReferences",
                "confirm": True,
                "expected_messages": [
                    "SUCCESS COUNT: 9",
        ...
        pytest.param(
            {
                ...
                "primary": "delete",
                "src_rel_path": os.path.join("testingAssets", "textures", "*.png"),
                "secondary": "UpdateReferences",
                "confirm": True,
                "expected_messages": "Command --updateReferences must be used with command --move",
                "unexpected_messages": [["SourceFileRelocator", "Error"]],
        ...
        pytest.param(
            {
                ...
                "unexpected_messages": [["SourceFileRelocator", "Error"], ["Updated", "am_grass1.mtl", "SUCCESS"]],
            },
            id="C21968370_3",
            marks=[pytest.mark.test_case_id("C21968370")],
        ),
    ...
    def test_WindowsAndMac_UpdateReferencesAllowBrokenDependencies_PathExistenceAndMessage(self, ap_setup_fixture,
        ...
        all_test_asset_rel_paths = [
            ...
            "testFile - Copy.txt",
            "testFile.txt",
            os.path.join("Materials", "am_grass1.mtl"),
            os.path.join("Materials", "test_texture_sequence.mtl"),
            os.path.join("Textures", "milestone2", "AM_MudAndGrass_01_ddna.tif"),
            os.path.join("Textures", "milestone2", "AM_MudAndGrass_01_diff.tif"),
            os.path.join("Textures", "milestone2", "AM_MudAndGrass_01_displ.tif"),
            os.path.join("Textures", "test_texture_sequence", "test_texture_sequence000.png"),
            os.path.join("Textures", "test_texture_sequence", "test_texture_sequence001.png"),
            os.path.join("Textures", "test_texture_sequence", "test_texture_sequence002.png"),
            os.path.join("Textures", "test_texture_sequence", "test_texture_sequence003.png"),
            os.path.join("Textures", "test_texture_sequence", "test_texture_sequence004.png"),
            os.path.join("Textures", "test_texture_sequence", "test_texture_sequence005.png"),
        ]
    ...
    tests = [
                pytest.param(
                    {
                        "primary": "move",
                        "src_rel_path": os.path.join("test_texture_sequence000.png"),
    ...
    def test_WindowsAndMac_MoveMetadataFiles_PathExistenceAndMessage(self, workspace, request, ap_setup_fixture,
        ...
        src_rel_paths_initial = ["test_texture_sequence000.png", "test_texture_sequence001.png", "test_texture_sequence000.png.exportsettings"]
...
move_a_file_tests = [
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="one_txt_file",
            encoded_command="project_test_assets_dir\\testFile.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="wildcard_files",
            encoded_command="project_test_assets_dir\\test*.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="partial file name",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            description="Move a file: source = absolute-file (wildcards); destination = absolute (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="project_test_assets_dir\\*.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="no filename",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            description="Move a file: source = absolute-file (wildcards); destination = absolute (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="project_dir\\wildcard_fi*\\testFile.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="wildcard on folder",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="wildcard_files",
            encoded_command="project_test_assets_dir\\test*.txt,dev_dir\\Move*\\",
            encoded_output_dir="dev_dir\\MoveFile\\",
            move_successful=False,
            step="Move with Wildcard on File to a wildcard before the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
        ),
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="wildcard_files",
            encoded_command="project_dir\\wildcard_fi*\\testFile.txt,dev_dir\\MoveOutput*\\",
            encoded_output_dir="dev_dir\\MoveOutputles\\",
            move_successful=False,
            step="Move with wildcard on folder before filename to a folder with a wildcard before the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
        ),
    ...
    pytest.param(
        MoveTest(
            description="Move a file: source = absolute-file (wildcards); destination = absolute (wildcards) (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="project_test_assets_dir\\*.txt,dev_dir\\MoveOutput\\*.txt",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="Move with Wildcard for the Filename to a folder wildcard after the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="one_txt_file",
            encoded_command="one_txt_file\\testFile.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            output_messages=["Destination must exist within a scanfolder."],
        ),
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="wildcard_files",
            encoded_command="wildcard_files\\test*.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="Move with Wildcard on File to a wildcard before the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            description="Move a file: source = relative-file (wildcards); destination = absolute (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="wildcard_fi*\\testFile.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="Move with wildcard on folder before filename to a folder with a wildcard before the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            description="Move a file: source = relative-file (wildcards); destination = absolute (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="wildcard_files\\*.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="Move with Wildcard for the Filename to a folder wildcard after the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            description="Move a file: source = relative-file (wildcards); destination = absolute (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="wildcard_files*\\testFile.txt,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="Move with wildcard on folder before filename to a folder with a wildcard before the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="wildcard_files",
            encoded_command="wildcard_files\\test*.txt,dev_dir\\Move*\\",
            encoded_output_dir="dev_dir\\MoveFile\\",
            move_successful=False,
            step="Move with Wildcard on File to a wildcard before the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
    ...
    pytest.param(
        MoveTest(
            description="Move a file: source = relative-file (wildcards); destination = absolute (wildcards) (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="wildcard_files\\*.txt,dev_dir\\MoveOutput\\*.txt",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            step="Move with Wildcard for the Filename to a folder wildcard after the folder declaration",
            output_messages=["Destination must exist within a scanfolder."],
...
move_a_folder_tests = [
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="wildcard_files",
            encoded_command="project_test_assets_dir\\*,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            output_messages=["Destination must exist within a scanfolder."],
            step="1",
    ...
    pytest.param(
        MoveTest(
            description="Move a folder: source = absolute-folder (wildcards); destination = absolute (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="project_dir\\wildcard_file*\\,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            output_messages=["Wildcard search did not match any files."],
            step="2",
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="wildcard_files",
            encoded_command="wildcard_files\\,dev_dir\\MoveOutput\\",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            output_messages=[
                "Cannot operate on directories.  Please specify a file or use a wildcard to select all files within a directory."
    ...
    pytest.param(
        MoveTest(
            description="Move a folder: source = relative-folder (wildcards); destination = absolute (path outside scan folder)",
            asset_folder="wildcard_files",
            encoded_command="wildcard_file*\\*,dev_dir\\MoveOutput\\*",
            encoded_output_dir="dev_dir\\MoveOutput\\",
            move_successful=False,
            output_messages=["Destination must exist within a scanfolder."],
            step=2,
    ...
    pytest.param(
        MoveTest(
            ...
            asset_folder="wildcard_files",
            encoded_command="wildcard_file*\\,dev_dir\\MoveOutput*\\*",
            encoded_output_dir="dev_dir\\MoveOutputs\\",
            move_successful=False,
            output_messages=["Wildcard search did not match any files."],
            step=4,
        ),
