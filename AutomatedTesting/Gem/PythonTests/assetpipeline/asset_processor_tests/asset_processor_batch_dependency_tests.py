...
class TestsAssetProcessorBatch_DependenycyTests(object):
    ...
    def test_WindowsMacPlatforms_RunAPBatch_NotMissingDependency(self, ap_setup_fixture, asset_processor,
        ...
        asset_processor.add_relative_source_asset(os.path.join("EngineAssets", "Engine", "engine_dependencies.xml"))
        asset_processor.add_scan_folder(os.path.join("EngineAssets", "Engine"))
        asset_processor.add_relative_source_asset(os.path.join("EngineAssets", "Engine", "Libs", "MaterialEffects", "surfacetypes.xml"))
        ...
        asset_processor.add_relative_source_asset(os.path.join("EngineAssets", "Engine", "Schema", "enginedependency.xmlschema"))
        asset_processor.batch_process()
