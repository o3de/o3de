...
def AtomEditorComponents_DepthOfField_AddedToEntity():
    ...
    Test Steps:
    1) Creation of DepthOfField entity.
    ...
    with Tracer() as error_tracer:
        ...
        # 2. Add a DepthOfField component to DepthOfField entity.
        depth_of_field_component = depth_of_field_entity.add_component(depth_of_field)
        ...
        # 11. Set the DepthOfField components's Camera Entity to the newly created Camera entity.
        camera_property_path = "Controller|Configuration|Camera Entity"
        depth_of_field_component.get_property_tree()
        depth_of_field_component.set_component_property_value(camera_property_path, camera_entity.id)
        camera_entity_set = depth_of_field_component.get_component_property_value(camera_property_path)
        Report.result(Tests.camera_property_set, camera == camera_entity_set)
