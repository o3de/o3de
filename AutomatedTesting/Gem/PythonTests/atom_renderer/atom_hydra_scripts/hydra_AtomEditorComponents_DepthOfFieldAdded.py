...
Hydra script that creates an entity and attaches the DepthOfField component to it for test verification.
"""
...
def AtomEditorComponents_DepthOfField_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        has_component = hydra.has_components(depth_of_field_entity.id, [depth_of_field])
        Report.result(Tests.depth_of_field_creation, depth_of_field_entity.id.IsValid())
        Report.critical_result(Tests.depth_of_field_component, has_component)
        ...
        # 10. UNDO deletion.
        general.undo()
        Report.result(Tests.deletion_undo, depth_of_field_entity.id.isValid())
