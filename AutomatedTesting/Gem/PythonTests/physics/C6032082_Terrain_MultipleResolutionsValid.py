...
def C6032082_Terrain_MultipleResolutionsValid():
    ...
    level_128 = Level(
        "C6032082_Terrain_MultipleResolutionsValid_128x128_1m",
    ...
    level_512 = Level(
        "C6032082_Terrain_MultipleResolutionsValid_512x512_2m",
    ...
    level_1024 = Level(
        "C6032082_Terrain_MultipleResolutionsValid_1024x1024_32m",
