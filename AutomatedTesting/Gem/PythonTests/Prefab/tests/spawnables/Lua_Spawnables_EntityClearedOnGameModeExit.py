...
def Lua_Spawnables_EntityClearedOnGameModeExit():
    ...
    def validate_entities_in_edit_mode(condition):
        ...
        search_filter.names = ["PinkFlower_Lua_EntityClearedOnGameModeExit"]
        ...
        assert len(flower_entity) == 0, f"Unexpectedly found PinkFlower_Lua_EntityClearedOnGameModeExit entity {condition}"
    ...
    helper.wait_for_condition(lambda: EditorEntity(general.find_game_entity(
        "PinkFlower_Lua_EntityClearedOnGameModeExit")) is not None, 3.0)
    flower_entity = EditorEntity(general.find_game_entity("PinkFlower_Lua_EntityClearedOnGameModeExit"))
    assert spawner_entity, "Failed to find Spawner entity at runtime"
    assert flower_entity, "Failed to find PinkFlower_Lua_EntityClearedOnGameModeExit entity at runtime"
    ...
    # Exit Game Mode and verify despawn of PinkFlower_Lua_EntityClearedOnGameModeExit.spawnable
