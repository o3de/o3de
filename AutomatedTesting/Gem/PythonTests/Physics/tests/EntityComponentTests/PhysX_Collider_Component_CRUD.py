...
def PhysX_Collider_Component_CRUD():
    ...
    # 3) Set Box Shape and Child Properties
        ...
        validate_vector3_property("Box Dimensions", physx_collider.get_box_dimensions, physx_collider.set_box_dimensions, physx_collider.component.get_component_name(), VECTOR3_TESTS_NEGATIVE_EXPECT_PASS)

    # 4) Set Capsule Shape and Child Properties
        physx_collider.set_capsule_shape()

        validate_float_property("Capsule Height", physx_collider.get_capsule_height, physx_collider.set_capsule_height, physx_collider.component.get_component_name(), FLOAT_HEIGHT_TESTS)
    ...
    # 5) Set Cylinder Shape and Child Properties
        ...
        validate_float_property("Cylinder Height", physx_collider.get_cylinder_height, physx_collider.set_cylinder_height, physx_collider.component.get_component_name(),  CYLINDER_HEIGHT_TESTS)
        validate_float_property("Cylinder Radius", physx_collider.get_cylinder_radius, physx_collider.set_cylinder_radius, physx_collider.component.get_component_name(), COLLIDER_RADIUS_TESTS)

        validate_integer_property("Cylinder Subdivision", physx_collider.get_cylinder_subdivision, physx_collider.set_cylinder_subdivision, physx_collider.component.get_component_name(), CYLINDER_SUBDIVISION_TESTS)

    # 6) Set Sphere Shape and Child Properties
        physx_collider.set_sphere_shape()

        validate_float_property("Sphere Radius", physx_collider.get_sphere_radius, physx_collider.set_sphere_radius, physx_collider.component.get_component_name(), COLLIDER_RADIUS_TESTS)
    ...
    # 7) Set General Properties
        ...
        validate_vector3_property("Offset", physx_collider.get_offset, physx_collider.set_offset, physx_collider.component.get_component_name(), VECTOR3_TESTS_NEGATIVE_EXPECT_PASS)
        ...
        validate_float_property("Contact Offset", physx_collider.get_contact_offset, physx_collider.set_contact_offset, physx_collider.component.get_component_name(), CONTACT_OFFSET_TESTS)
        validate_float_property("Rest Offset", physx_collider.get_rest_offset, physx_collider.set_rest_offset, physx_collider.component.get_component_name(), REST_OFFSET_TESTS)
    ...
    # 8) Set PhyicsAsset Shape and Child Properties
        ...
        validate_vector3_property("PhysX Mesh Asset Scale", physx_collider.get_physx_mesh_asset_scale, physx_collider.set_physx_mesh_asset_scale, physx_collider.component.get_component_name(), VECTOR3_TESTS_NEGATIVE_EXPECT_PASS)
