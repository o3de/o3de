...
class TestAutomation(TestAutomationBase):
    ...
    def test_LandscapeCanvas_Edit_UndoNodeDelete_PrefabEntity(self, request, workspace, editor, launcher_platform):
        from .EditorScripts import Edit_UndoNodeDelete_PrefabEntity as test_module
        self._run_test(request, workspace, editor, test_module)

    def test_LandscapeCanvas_GradientModifierNodes_EntityCreatedOnNodeAdd(self, request, workspace, editor,
                                                                          launcher_platform):
        from .EditorScripts import GradientModifierNodes_EntityCreatedOnNodeAdd as test_module
        self._run_test(request, workspace, editor, test_module)

    def test_LandscapeCanvas_GradientModifierNodes_EntityRemovedOnNodeDelete(self, request, workspace, editor,
                                                                             launcher_platform):
        from .EditorScripts import GradientModifierNodes_EntityRemovedOnNodeDelete as test_module
        self._run_test(request, workspace, editor, test_module)

    def test_LandscapeCanvas_GradientNodes_DependentComponentsAdded(self, request, workspace, editor,
                                                                    launcher_platform):
    ...
    def test_LandscapeCanvas_GradientNodes_EntityRemovedOnNodeDelete(self, request, workspace, editor,
                                                                     launcher_platform):
    ...
    def test_LandscapeCanvas_GraphClosed_TabbedGraphClosesIndependently(self, request, workspace, editor,
                                                                        launcher_platform):
    ...
    def test_LandscapeCanvas_LayerExtenderNodes_ComponentEntitySync(self, request, workspace, editor,
                                                                    launcher_platform):
    ...
    def test_LandscapeCanvas_Prefab_CreateInstantiate(self, request, workspace, editor, launcher_platform):
