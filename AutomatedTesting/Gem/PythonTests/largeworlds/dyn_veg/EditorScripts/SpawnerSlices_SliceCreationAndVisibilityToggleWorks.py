...
def SpawnerSlices_SliceCreationAndVisibilityToggleWorks():
    ...
    veg_1 = dynveg.create_vegetation_area_by_dynamic_slice_asset_path("vegetation_1", position, 16.0, 16.0, 16.0, asset_path)
    ...
    veg_2 = dynveg.create_vegetation_area_by_dynamic_slice_asset_path("vegetation_2", position, 1.0, 1.0, 1.0, "")
