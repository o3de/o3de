...
class TestAutomation(EditorTestSuite):
    ...
    class AtomEditorComponents_PostFXShapeWeightModifierAdded(EditorBatchedTest):
        from Atom.tests import (
            hydra_AtomEditorComponents_PostFxShapeWeightModifierAdded as test_module,
        )

    @pytest.mark.skipif(
        ly_test_tools.LINUX, reason="https://github.com/o3de/o3de/issues/14008"
    )
    @pytest.mark.test_case_id("C32078128")
    class AtomEditorComponents_ReflectionProbeAdded(EditorBatchedTest):
        from Atom.tests import (
            hydra_AtomEditorComponents_ReflectionProbeAdded as test_module,
        )

    class AtomEditorComponents_SkyAtmosphereAdded(EditorBatchedTest):
        from Atom.tests import (
            hydra_AtomEditorComponents_SkyAtmosphereAdded as test_module,
        )
    ...
    class AtomEditorComponentsLevel_DiffuseGlobalIlluminationAdded(EditorBatchedTest):
        from Atom.tests import (
            hydra_AtomEditorComponentsLevel_DiffuseGlobalIlluminationAdded as test_module,
        )

    @pytest.mark.test_case_id("C36525660")
    class AtomEditorComponentsLevel_DisplayMapperAdded(EditorBatchedTest):
        from Atom.tests import (
            hydra_AtomEditorComponentsLevel_DisplayMapperAdded as test_module,
        )
