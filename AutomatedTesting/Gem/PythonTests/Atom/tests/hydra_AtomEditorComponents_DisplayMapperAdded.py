...
def AtomEditorComponents_DisplayMapper_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Add Display Mapper level component to the level entity.
        display_mapper_component = EditorLevel.add_component(AtomComponentProperties.display_mapper())
        Report.critical_result(
            Tests.display_mapper_component,
            EditorLevel.has_component(AtomComponentProperties.display_mapper()))

        # 2. UNDO the level component addition.
        # -> UNDO component addition.
        general.undo()
        general.idle_wait_frames(1)
        Report.result(Tests.creation_undo, not EditorLevel.has_component(AtomComponentProperties.display_mapper()))

        # 3. REDO the level component addition.
        # -> REDO component addition.
        general.redo()
        general.idle_wait_frames(1)
        Report.result(Tests.creation_redo, EditorLevel.has_component(AtomComponentProperties.display_mapper()))
