...
def AtomEditorComponents_SSAO_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create a SSAO entity with no components.
        ssao_entity = EditorEntity.create_editor_entity(AtomComponentProperties.ao())
        Report.critical_result(Tests.ssao_creation, ssao_entity.exists())

        # 2. Add AO component to SSAO entity.
        ssao_component = ssao_entity.add_component(AtomComponentProperties.ao())
        Report.critical_result(
            Tests.ao_component,
            ssao_entity.has_component(AtomComponentProperties.ao()))

        # 3. Remove AO component.
        ssao_component.remove()
        general.idle_wait_frames(1)
        Report.result(Tests.remove_component,
                      not ssao_entity.has_component(AtomComponentProperties.ao()))
        ...
        Report.result(
            Tests.enable_blur,
            ssao_component.get_component_property_value(AtomComponentProperties.ao('Enable Blur')) is False)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('Enable Blur'), True)
        Report.result(
            Tests.enable_blur,
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(AtomComponentProperties.ao('SSAO Strength')) == 2.0)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('SSAO Strength'), 0.0)
        Report.result(
            Tests.set_ssao_strength,
            ssao_component.get_component_property_value(AtomComponentProperties.ao('SSAO Strength')) == 0.0)
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(AtomComponentProperties.ao('SSAO Sampling Radius')) == 0.25)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('SSAO Sampling Radius'), 0.0)
        Report.result(
            Tests.set_sample_radius,
            ssao_component.get_component_property_value(AtomComponentProperties.ao('SSAO Sampling Radius')) == 0.0)
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(AtomComponentProperties.ao('Blur Strength')) == 1.0)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('Blur Strength'), 0.0)
        Report.result(
            Tests.set_blur_strength,
            ssao_component.get_component_property_value(AtomComponentProperties.ao('Blur Strength')) == 0.0)
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(AtomComponentProperties.ao('Blur Edge Threshold')) == 1.0)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('Blur Edge Threshold'), 0.0)
        Report.result(
            Tests.set_blur_edge_threshold,
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(AtomComponentProperties.ao('Blur Sharpness')) == 400.0)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('Blur Sharpness'), 0.0)
        Report.result(
            Tests.set_blur_sharpness,
            ssao_component.get_component_property_value(AtomComponentProperties.ao('Blur Sharpness')) == 0.0)
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(AtomComponentProperties.ao('Enable Downsample')) is False)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('Enable Downsample'), True)
        Report.result(
            Tests.enable_downsample,
        ...
        Report.result(
            Tests.enable_downsample,
            ssao_component.get_component_property_value(AtomComponentProperties.ao('Enabled Override')) is False)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('Enabled Override'), True)
        Report.result(
            Tests.enable_downsample,
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(AtomComponentProperties.ao('EnableBlur Override')) is False)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('EnableBlur Override'), True)
        Report.result(
            Tests.enable_blur_override,
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(
                AtomComponentProperties.ao('BlurConstFalloff Override')) == 0.0)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('BlurConstFalloff Override'), 1.0)
        Report.result(
            Tests.set_blur_const_falloff,
            ssao_component.get_component_property_value(
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(
                AtomComponentProperties.ao('EnableDownsample Override')) is False)

        ssao_component.set_component_property_value(AtomComponentProperties.ao('EnableDownsample Override'), True)
        Report.result(
            Tests.enable_downsample_override,
            ssao_component.get_component_property_value(
