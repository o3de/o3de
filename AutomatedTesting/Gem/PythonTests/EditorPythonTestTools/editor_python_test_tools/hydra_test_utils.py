...
def launch_and_validate_results(request, test_directory, editor, editor_script, expected_lines, unexpected_lines=[],
                                ...
                                timeout=300, log_file_name="Editor.log", enable_prefab_system=False):
    """
    ...
    :param enable_prefab_system: Specifies whether to use enable prefab system or not. Defaults to False.
    """
