...
function(o3de_version_specifier_contains op specifier_version version result)
    ...
    elseif(op STREQUAL ">" AND version VERSION_GREATER specifier_version)
        set(contains_version TRUE)
    elseif(op STREQUAL "===" AND version VERSION_EQUAL specifier_version)
        set(contains_version TRUE)
    elseif(op STREQUAL "~=")
...
function(o3de_engine_compatible engine_path expected_engine_name version_op version_specifier out_result out_engine_version verbose)
    ...
    elseif(version_op AND version_specifier)
        ...
        if(json_error)
            ...
            if(NOT is_compatible)
                set(warning_msg "The engine ${engine_name} version ${engine_version} at ${engine_path} is not compatible with the project's version specifier '${version_op}${version_specifier}'\n Please use the o3de CLI to register the project to a compatible engine or update the project or engine.")
            endif()
        endif()
    else()
