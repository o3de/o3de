        ...
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto editContext = serializeContext->GetEditContext())
            {
                editContext->Class<GradientTransformConfig>(QT_TRANSLATE_NOOP("GradientSignal", "Gradient Transform"), "")
                    ...
                    ->DataElement(nullptr, &GradientTransformConfig::m_allowReference, QT_TRANSLATE_NOOP("GradientSignal", "Allow Reference"), QT_TRANSLATE_NOOP("GradientSignal", "When enabled, the shape reference can be overridden. When disabled, all operations are relative to this entity."))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsAdvancedModeReadOnly)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ->DataElement(nullptr, &GradientTransformConfig::m_shapeReference, QT_TRANSLATE_NOOP("GradientSignal", "Shape Reference"), QT_TRANSLATE_NOOP("GradientSignal", "An optional shape reference that can be used to drive bounds and transform"))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsReferenceReadOnly)
                    
                    ->DataElement(nullptr, &GradientTransformConfig::m_overrideBounds, QT_TRANSLATE_NOOP("GradientSignal", "Override Bounds"), QT_TRANSLATE_NOOP("GradientSignal", "Allow manual override of the associated parameter"))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsAdvancedModeReadOnly)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ->DataElement(nullptr, &GradientTransformConfig::m_bounds, QT_TRANSLATE_NOOP("GradientSignal", "Bounds"), QT_TRANSLATE_NOOP("GradientSignal", "Local (untransformed) bounds of a box used to remap, clamp, wrap, scale incoming coordinates"))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsBoundsReadOnly)
                    ->DataElement(nullptr, &GradientTransformConfig::m_center, QT_TRANSLATE_NOOP("GradientSignal", "Center"), QT_TRANSLATE_NOOP("GradientSignal", "Local (untransformed) center of a box used to remap, clamp, wrap, scale incoming coordinates"))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsBoundsReadOnly)

                    ->DataElement(nullptr, &GradientTransformConfig::m_overrideTranslate, QT_TRANSLATE_NOOP("GradientSignal", "Override Translate"), QT_TRANSLATE_NOOP("GradientSignal", "Allow manual override of the associated parameter"))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsAdvancedModeReadOnly)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ->DataElement(nullptr, &GradientTransformConfig::m_translate, QT_TRANSLATE_NOOP("GradientSignal", "Translate"), "")
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsTranslateReadOnly)
                    ->DataElement(nullptr, &GradientTransformConfig::m_overrideRotate, QT_TRANSLATE_NOOP("GradientSignal", "Override Rotate"), QT_TRANSLATE_NOOP("GradientSignal", "Allow manual override of the associated parameter"))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsAdvancedModeReadOnly)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ->DataElement(nullptr, &GradientTransformConfig::m_rotate, QT_TRANSLATE_NOOP("GradientSignal", "Rotate"), "")
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsRotateReadOnly)
                    ->DataElement(nullptr, &GradientTransformConfig::m_overrideScale, QT_TRANSLATE_NOOP("GradientSignal", "Override Scale"), QT_TRANSLATE_NOOP("GradientSignal", "Allow manual override of the associated parameter"))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsAdvancedModeReadOnly)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ->DataElement(nullptr, &GradientTransformConfig::m_scale, QT_TRANSLATE_NOOP("GradientSignal", "Scale"), "")
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsScaleReadOnly)
                    
                    ->DataElement(nullptr, &GradientTransformConfig::m_is3d, QT_TRANSLATE_NOOP("GradientSignal", "Sample in 3D"), QT_TRANSLATE_NOOP("GradientSignal", "Check if the UVW should be mapped based on three dimensional world space"))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientTransformConfig::IsAdvancedModeReadOnly)
                    ;
            }
        }
