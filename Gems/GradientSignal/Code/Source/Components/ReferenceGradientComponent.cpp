        ...
        if (serialize)
        {
            ...
            if (edit)
            {
                edit->Class<ReferenceGradientConfig>(
                    ...
                    ->DataElement(nullptr, &ReferenceGradientConfig::m_gradientSampler, QT_TRANSLATE_NOOP("GradientSignal", "Gradient"), QT_TRANSLATE_NOOP("GradientSignal", "Input gradient whose values will be transformed in relation to threshold."))
                    ;
            }
        }
