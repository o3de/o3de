        ...
        if (serialize)
        {
            ...
            if (edit)
            {
                edit->Class<GradientSampler>(QT_TRANSLATE_NOOP("GradientSignal", "Gradient Sampler"), "")
                    ...
                    ->DataElement(nullptr, &GradientSampler::m_gradientId, QT_TRANSLATE_NOOP("GradientSignal", "Gradient Entity Id"), QT_TRANSLATE_NOOP("GradientSignal", "Entity with attached gradient component"))
                    ...
                    ->DataElement(nullptr, &GradientSampler::m_invertInput, QT_TRANSLATE_NOOP("GradientSignal", "Invert Input"), "")
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &GradientSampler::ChangeNotify)

                    ->GroupElementToggle(QT_TRANSLATE_NOOP("GradientSignal", "Enable Transform"), &GradientSampler::m_enableTransform)
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ->DataElement(nullptr, &GradientSampler::m_translate, QT_TRANSLATE_NOOP("GradientSignal", "Translate"), "")
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientSampler::AreTransformSettingsDisabled)
                    ->DataElement(nullptr, &GradientSampler::m_scale, QT_TRANSLATE_NOOP("GradientSignal", "Scale"), "")
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientSampler::AreTransformSettingsDisabled)
                    ->DataElement(nullptr, &GradientSampler::m_rotate, QT_TRANSLATE_NOOP("GradientSignal", "Rotate"), QT_TRANSLATE_NOOP("GradientSignal", "Rotation in degrees."))
                    ->Attribute(AZ::Edit::Attributes::ReadOnly, &GradientSampler::AreTransformSettingsDisabled)
