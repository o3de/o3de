...
namespace CopyDependencyBuilder
{
        ...
        AssetBuilderSDK::ProductPathDependencySet& pathDependencies)
    {
        ...
        startScript="ImportActor -filename \"@projectproductassets@/animationsamples/advanced_rinlocomotion/actor/rinactor.actor\"\nCreateActorInstance
        ...
        0.00000000,0.00000000,0.99997193\n LoadMotionSet -filename \"@projectproductassets@/AnimationSamples/Advanced_RinLocomotion/AnimationEditorFiles/Advanced_RinLocomotion.motionset\"
        \nLoadAnimGraph -filename \"@projectproductassets@/AnimationSamples/Advanced_RinLocomotion/AnimationEditorFiles/Advanced_RinLocomotion.animgraph\"
        \nActivateAnimGraph -actorInstanceID %LASTRESULT3% -animGraphID %LASTRESULT1% -motionSetID %LASTRESULT2% -visualizeScale 1.000000\n"
        */
        AZStd::regex pathRegex(R"(\s+-filename\s+\\\"(?:@projectproductassets@\/)?(\S+)\\\")");
