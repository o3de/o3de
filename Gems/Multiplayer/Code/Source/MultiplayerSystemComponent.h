...
namespace Multiplayer
{
    ...
    public:
        ...
        bool HandleRequest(AzNetworking::IConnection* connection, const AzNetworking::IPacketHeader& packetHeader, MultiplayerPackets::SyncComponentMismatch& packet);
        ...
        void AddComponentVersionMismatchEvent(ComponentVersionMismatchEvent::Handler& handler) override;
    ...
    private:
        ...
        ComponentVersionMismatchEvent m_componentVersionMismatchEvent;
