...
namespace Multiplayer
{
    ...
    )
    {
        ...
        AZStd::string currentLevel;
        AzFramework::LevelSystemLifecycleRequestBus::BroadcastResult(currentLevel, &AzFramework::LevelSystemLifecycleRequests::GetCurrentLevelName);
