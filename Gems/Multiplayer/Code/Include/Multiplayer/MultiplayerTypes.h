...
AZ_DEFINE_TYPE_SAFE_INTEGRAL_TOSTRING(Multiplayer::NetEntityId, uint64_t);
AZ_DEFINE_TYPE_SAFE_INTEGRAL_TOSTRING(Multiplayer::NetComponentId, uint16_t);
AZ_DEFINE_TYPE_SAFE_INTEGRAL_TOSTRING(Multiplayer::PropertyIndex, uint16_t);
AZ_DEFINE_TYPE_SAFE_INTEGRAL_TOSTRING(Multiplayer::RpcIndex, uint16_t);
AZ_DEFINE_TYPE_SAFE_INTEGRAL_TOSTRING(Multiplayer::ClientInputId, uint16_t);
AZ_DEFINE_TYPE_SAFE_INTEGRAL_TOSTRING(Multiplayer::HostFrameId, uint32_t);
