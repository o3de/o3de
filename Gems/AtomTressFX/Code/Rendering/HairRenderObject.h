    ...
    namespace Render
    {
        ...
        namespace Hair
        {
            ...
            private:
                ...
                //!  between passes.
                AZStd::vector<Data::Instance<RHI::DeviceBufferView>> m_dynamicBuffersViews;   // RW used for the Compute
                AZStd::vector<Data::Instance<RHI::DeviceBufferView>> m_readBuffersViews;      // Read only used for the Raster fill
            ...
            public:
                ...
                const RHI::DeviceDispatchItem* GetDispatchItem(RPI::Shader* computeShader);
            ...
            private:
                ...
                Data::Instance<RHI::DeviceBuffer> m_indexBuffer;
