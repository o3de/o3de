...
namespace StartingPointInput
{
    void InputEventGroup::Reflect(AZ::ReflectContext* reflection)
    {
        if (AZ::SerializeContext* serializeContext = azrtti_cast<AZ::SerializeContext*>(reflection))
        {
            ...
            {
                editContext->Class<InputEventGroup>(
                    QT_TRANSLATE_NOOP("StartingPointInput", "InputEventGroup"),
                    QT_TRANSLATE_NOOP("StartingPointInput", "Groups input bindings by the event they generate"))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::NameLabelOverride, &InputEventGroup::GetEditorText)
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &InputEventGroup::m_eventName,
                        QT_TRANSLATE_NOOP("StartingPointInput", "Event Name"),
                        QT_TRANSLATE_NOOP("StartingPointInput", "The event generated by the collection of Input Bindings"))
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ_CRC_CE("RefreshAttributesAndValues"))
                    ->DataElement(AZ::Edit::UIHandlers::Default, &InputEventGroup::m_inputHandlers,
                        QT_TRANSLATE_NOOP("StartingPointInput", "Event Generators"),
                        QT_TRANSLATE_NOOP("StartingPointInput", "Handlers that generate named events"))
                    ->DataElement(AZ::Edit::UIHandlers::CheckBox, &InputEventGroup::m_excludeFromRelease,
                        QT_TRANSLATE_NOOP("StartingPointInput", "Exclude from release"),
                        QT_TRANSLATE_NOOP("StartingPointInput", "This input binding will not activate in release builds"));
            }
        }
    }
}
...
namespace StartingPointInput
{
    ...
    void InputConfigurationComponent::Reflect(AZ::ReflectContext* reflection)
    {
        ...
        if (serializeContext)
        {
            ...
            if (editContext)
            {
                editContext->Class<InputConfigurationComponent>(
                    QT_TRANSLATE_NOOP("StartingPointInput", "Input"),
                    QT_TRANSLATE_NOOP("StartingPointInput", "The Input component allows an entity to bind a set of inputs to an event by referencing a .inputbindings file"))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                        ...
                        ->Attribute(AZ::Edit::Attributes::HelpPageURL, "https://www.o3de.org/docs/user-guide/components/reference/gameplay/input/")
                    ->DataElement(AZ::Edit::UIHandlers::Default, &InputConfigurationComponent::m_inputEventBindingsAsset,
                        QT_TRANSLATE_NOOP("StartingPointInput", "Input to event bindings"),
                        QT_TRANSLATE_NOOP("StartingPointInput", "Asset containing input to event binding information."))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::SpinBox, &InputConfigurationComponent::m_localPlayerIndex,
                        QT_TRANSLATE_NOOP("StartingPointInput", "Local player index"),
                        QT_TRANSLATE_NOOP("StartingPointInput",
