...
#include <AzToolsFramework/SourceControl/EditorPerforceSystemComponent.h>
...
namespace AzToolsFramework
{
    ...
    void EditorPerforceSystemComponent::Activate()
    {
    ...
    void EditorPerforceSystemComponent::Deactivate()
    {
    ...
    void EditorPerforceSystemComponent::SetConnection(PerforceConnection* connection)
    {
    ...
    void EditorPerforceSystemComponent::Reflect(AZ::ReflectContext* context)
    {
        if (AZ::SerializeContext* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            serializeContext->Class<EditorPerforceSystemComponent, AZ::Component>()
                ;

            if (AZ::EditContext* editContext = serializeContext->GetEditContext())
            {
                editContext->Class<EditorPerforceSystemComponent>(
    ...
    void EditorPerforceSystemComponent::GetProvidedServices(AZ::ComponentDescriptor::DependencyArrayType& provided)
    {
        provided.push_back(AZ_CRC("SourceControlService", 0x67f338fd));
        provided.push_back(AZ_CRC("PerforceService", 0x74b25961));
    }

    void EditorPerforceSystemComponent::GetIncompatibleServices(AZ::ComponentDescriptor::DependencyArrayType& incompatible)
    {
        incompatible.push_back(AZ_CRC("PerforceService", 0x74b25961));
    }

    void EditorPerforceSystemComponent::GetFileInfo(const char* fullFilePath, const SourceControlResponseCallback& respCallback)
    {
    ...
    void EditorPerforceSystemComponent::GetBulkFileInfo(const AZStd::unordered_set<AZStd::string>& fullFilePaths, const SourceControlResponseCallbackBulk& respCallback)
    {
    ...
    void EditorPerforceSystemComponent::RequestEdit(const char* fullFilePath, bool allowMultiCheckout, const SourceControlResponseCallback& respCallback)
    {
        AZ_Assert(fullFilePath, "Must specify a file path");
        AZ_Assert(respCallback, "Must specify a callback!");
    ...
    void EditorPerforceSystemComponent::RequestEditBulk(const AZStd::unordered_set<AZStd::string>& fullFilePaths, bool allowMultiCheckout, const SourceControlResponseCallbackBulk& respCallback)
    {
        AZ_Assert(!fullFilePaths.empty(), "Must specify a file path");
        AZ_Assert(respCallback, "Must specify a callback!");
    ...
    void EditorPerforceSystemComponent::RequestDelete(const char* fullFilePath, const SourceControlResponseCallback& respCallback)
    {
        RequestDeleteExtended(fullFilePath, false, respCallback);
    }

    void EditorPerforceSystemComponent::RequestDeleteExtended(const char* fullFilePath, bool skipReadOnly, const SourceControlResponseCallback& respCallback)
    {
        AZ_Assert(fullFilePath, "Must specify a file path");
        AZ_Assert(respCallback, "Must specify a callback!");
    ...
    void EditorPerforceSystemComponent::RequestDeleteBulk(const char* fullFilePath, const SourceControlResponseCallbackBulk& respCallback)
    {
        RequestDeleteBulkExtended(fullFilePath, false, respCallback);
    }

    void EditorPerforceSystemComponent::RequestDeleteBulkExtended(const char* fullFilePath, bool skipReadOnly, const SourceControlResponseCallbackBulk& respCallback)
    {
        AZ_Assert(fullFilePath, "Must specify a file path");
        AZ_Assert(respCallback, "Must specify a callback!");
    ...
    void EditorPerforceSystemComponent::RequestRevert(const char* fullFilePath, const SourceControlResponseCallback& respCallback)
    {
        AZ_Assert(fullFilePath, "Must specify a file path");
        AZ_Assert(respCallback, "Must specify a callback!");
    ...
    void EditorPerforceSystemComponent::RequestLatest(const char* fullFilePath, const SourceControlResponseCallback& respCallback)
    {
        AZ_Assert(fullFilePath, "Must specify a file path");
        AZ_Assert(respCallback, "Must specify a callback!");
    ...
    void EditorPerforceSystemComponent::RequestRename(const char* sourcePathFull, const char* destPathFull, const SourceControlResponseCallback& respCallback)
    {
        RequestRenameExtended(sourcePathFull, destPathFull, false, respCallback);
    }

    void EditorPerforceSystemComponent::RequestRenameExtended(const char* sourcePathFull, const char* destPathFull, bool skipReadOnly, const SourceControlResponseCallback& respCallback)
    {
    ...
    void EditorPerforceSystemComponent::RequestRenameBulk(const char* sourcePathFull, const char* destPathFull, const SourceControlResponseCallbackBulk& respCallback)
    {
        RequestRenameBulkExtended(sourcePathFull, destPathFull, false, respCallback);
    }

    void EditorPerforceSystemComponent::RequestRenameBulkExtended(const char* sourcePathFull, const char* destPathFull, bool skipReadOnly, const SourceControlResponseCallbackBulk& respCallback)
    {
        AZ_Assert(sourcePathFull, "Must specify a source file path");
        AZ_Assert(destPathFull, "Must specify a destination file path");
        AZ_Assert(respCallback, "Must specify a callback!");
    ...
    void EditorPerforceSystemComponent::EnableSourceControl(bool enable)
    {
        m_testTrust = enable;
    ...
    void EditorPerforceSystemComponent::EnableTrust(bool enable, AZStd::string fingerprint)
    {
    ...
    void EditorPerforceSystemComponent::SetConnectionSetting(const char* key, const char* value, const SourceControlSettingCallback& respCallBack)
    {
    ...
    void EditorPerforceSystemComponent::GetConnectionSetting(const char* key, const SourceControlSettingCallback& respCallBack)
    {
        PerforceSettingResult result;
        result.m_callback = respCallBack;
    ...
    SourceControlFileInfo EditorPerforceSystemComponent::GetFileInfo(const char* filePath)
    {
    ...
    bool EditorPerforceSystemComponent::RequestEdit(const char* filePath, bool allowMultiCheckout)
    {
    ...
    bool EditorPerforceSystemComponent::RequestEditBulk(const AZStd::unordered_set<AZStd::string>& fullFilePath, bool allowMultiCheckout)
    {
    ...
    bool EditorPerforceSystemComponent::RequestDelete(const char* filePath)
    {
    ...
    bool EditorPerforceSystemComponent::RequestDeleteBulk(const char* filePath)
    {
        if (!CheckConnectivityForAction("delete", filePath))
        {
            return false;
    ...
    bool EditorPerforceSystemComponent::RequestLatest(const char* filePath)
    {
    ...
    bool EditorPerforceSystemComponent::RequestRevert(const char* filePath)
    {
    ...
    bool EditorPerforceSystemComponent::RequestRename(const char* sourcePath, const char* destPath)
    {
    ...
    bool EditorPerforceSystemComponent::RequestRenameBulk(const char* sourcePathFull, const char* destPathFull)
    {
    ...
    bool EditorPerforceSystemComponent::ClaimChangedFile(const char* path, int changeListNumber)
    {
    ...
    bool EditorPerforceSystemComponent::ExecuteAdd(const char* filePath)
    {
        bool sourceAwareFile = false;
        if (!ExecuteAndParseFstat(filePath, sourceAwareFile))
        {
    ...
    bool EditorPerforceSystemComponent::ExecuteEdit(const char* filePath, bool allowMultiCheckout, bool allowAdd)
    {
        bool sourceAwareFile = false;
        if (!ExecuteAndParseFstat(filePath, sourceAwareFile))
        {
    ...
    bool EditorPerforceSystemComponent::ExecuteEditBulk(const AZStd::unordered_set<AZStd::string>& filePaths, bool allowMultiCheckout, bool allowAdd)
    {
    ...
    bool EditorPerforceSystemComponent::ExecuteDelete(const char* filePath)
    {
        bool sourceAwareFile = false;
    ...
    bool EditorPerforceSystemComponent::ExecuteDeleteBulk(const char* filePath)
    {
        int changeListNumber = GetOrCreateOurChangelist();
        if (changeListNumber <= 0)
        {
    ...
    bool EditorPerforceSystemComponent::ExecuteSync(const char* filePath)
    {
        bool sourceAwareFile = false;
        if (!ExecuteAndParseFstat(filePath, sourceAwareFile))
        {
    ...
    bool EditorPerforceSystemComponent::ExecuteRevert(const char* filePath)
    {
        bool sourceAwareFile = false;
        if (!ExecuteAndParseFstat(filePath, sourceAwareFile) || !sourceAwareFile)
        {
    ...
    bool EditorPerforceSystemComponent::ExecuteMove(const char* sourcePath, const char* destPath)
    {
    ...
    bool EditorPerforceSystemComponent::ExecuteMoveBulk(const char* sourcePath, const char* destPath)
    {
        int changeListNumber = GetOrCreateOurChangelist();
        if (changeListNumber <= 0)
        {
    ...
    void EditorPerforceSystemComponent::QueueJobRequest(PerforceJobRequest&& jobRequest)
    {
    ...
    void EditorPerforceSystemComponent::QueueSettingResponse(const PerforceSettingResult& result)
    {
        AZStd::lock_guard<AZStd::mutex> locker(m_SettingsQueueMutex);
        m_settingsQueue.push(AZStd::move(result));
        AZ::TickBus::QueueFunction(&EditorPerforceSystemComponent::ProcessResultQueue, this);
    }

    bool EditorPerforceSystemComponent::CheckConnectivityForAction(const char* actionDesc, const char* filePath) const
    {
        (void)actionDesc;
    ...
    bool EditorPerforceSystemComponent::ExecuteAndParseFstat(const char* filePath, bool& sourceAwareFile)
    {
    ...
    bool EditorPerforceSystemComponent::ExecuteAndParseFstat(const char* filePath, AZStd::vector<PerforceMap>& commandMap) const
    {
        s_perforceConn->m_command.ExecuteFstat(filePath);
    ...
    bool EditorPerforceSystemComponent::ExecuteAndParseFstat(const AZStd::unordered_set<AZStd::string>& filePaths, AZStd::vector<PerforceMap>& commandMap) const
    {
    ...
    bool EditorPerforceSystemComponent::ExecuteAndParseSet(const char* key, const char* value) const
    {
    ...
    bool EditorPerforceSystemComponent::CommandSucceeded()
    {
    ...
    bool EditorPerforceSystemComponent::UpdateTrust()
    {
        AZ_Assert(m_ProcessThreadID != AZStd::thread::id(), "The perforce worker thread has not started.");
        AZ_Assert(AZStd::this_thread::get_id() == m_ProcessThreadID, "You may only call this function from the perforce worker thread.");
    ...
    bool EditorPerforceSystemComponent::IsTrustKeyValid() const
    {
    ...
    void EditorPerforceSystemComponent::VerifyP4PortIsSet()
    {
        AZ_Assert(m_ProcessThreadID != AZStd::thread::id(), "The perforce worker thread has not started.");
        AZ_Assert(AZStd::this_thread::get_id() == m_ProcessThreadID, "You may only call this function from the perforce worker thread.");
    ...
    void EditorPerforceSystemComponent::TestConnectionTrust(bool attemptResolve)
    {
        AZ_Assert(m_ProcessThreadID != AZStd::thread::id(), "The perforce worker thread has not started.");
        AZ_Assert(AZStd::this_thread::get_id() == m_ProcessThreadID, "You may only call this function from the perforce worker thread.");
    ...
    bool EditorPerforceSystemComponent::IsConnectionValid() const
    {
    ...
    bool EditorPerforceSystemComponent::CacheClientConfig() const
    {
        s_perforceConn->m_command.ExecuteInfo();
    ...
    void EditorPerforceSystemComponent::TestConnectionValid()
    {
        AZ_Assert(m_ProcessThreadID != AZStd::thread::id(), "The perforce worker thread has not started.");
        AZ_Assert(AZStd::this_thread::get_id() == m_ProcessThreadID, "You may only call this function from the perforce worker thread.");
    ...
    bool EditorPerforceSystemComponent::UpdateConnectivity()
    {
        AZ_Assert(m_ProcessThreadID != AZStd::thread::id(), "The perforce worker thread has not started.");
        AZ_Assert(AZStd::this_thread::get_id() == m_ProcessThreadID, "You may only call this function from the perforce worker thread.");
    ...
    void EditorPerforceSystemComponent::DropConnectivity()
    {
        AZ_Assert(m_ProcessThreadID != AZStd::thread::id(), "The perforce worker thread has not started.");
        AZ_Assert(AZStd::this_thread::get_id() == m_ProcessThreadID, "You may only call this function from the perforce worker thread.");
    ...
    int EditorPerforceSystemComponent::GetOrCreateOurChangelist()
    {
    ...
    int EditorPerforceSystemComponent::FindExistingChangelist()
    {
    ...
    void EditorPerforceSystemComponent::ThreadWorker()
    {
    ...
    void EditorPerforceSystemComponent::ProcessJob(const PerforceJobRequest& request)
    {
        AZ_Assert(m_ProcessThreadID != AZStd::thread::id(), "The perforce worker thread has not started.");
        AZ_Assert(AZStd::this_thread::get_id() == m_ProcessThreadID, "You may only call this function from the perforce worker thread.");
        ...
        if (validPerforceRequest)
        {
            ...
            resp.m_bulkCallback = request.m_bulkCallback;
            {
                ...
                AZ::TickBus::QueueFunction(&EditorPerforceSystemComponent::ProcessResultQueue, this); // narrow events to the main thread.
            }
        }
    }

    AZStd::vector<SourceControlFileInfo> EditorPerforceSystemComponent::GetBulkFileInfo(const char* requestPath) const
    {
        return GetBulkFileInfo(AZStd::unordered_set<AZStd::string>{ requestPath });
    }

    AZStd::vector<SourceControlFileInfo> EditorPerforceSystemComponent::GetBulkFileInfo(const AZStd::unordered_set<AZStd::string>& requestPaths) const
    {
    ...
    void EditorPerforceSystemComponent::ProcessJobOffline(const PerforceJobRequest& request)
    {
        AZ_Assert(m_ProcessThreadID != AZStd::thread::id(), "The perforce worker thread has not started.");
        AZ_Assert(AZStd::this_thread::get_id() == m_ProcessThreadID, "You may only call this function from the perforce worker thread.");
    ...
    void EditorPerforceSystemComponent::ProcessResultQueue()
    {
    ...
    bool EditorPerforceSystemComponent::ParseOutput(PerforceMap& perforceMap, AZStd::string& perforceOutput, const char* lineDelim) const
    {
    ...
    bool EditorPerforceSystemComponent::ParseDuplicateOutput(AZStd::vector<PerforceMap>& perforceMapList, AZStd::string& perforceOutput) const
    {
        // replace "..." with empty strings, each line is in the format of "... key value"
        AzFramework::StringFunc::Replace(perforceOutput, "...", "");
