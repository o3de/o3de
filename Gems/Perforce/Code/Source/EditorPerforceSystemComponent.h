...
namespace Perforce
{
    ...
    public:
        ...
        bool m_skipReadonly{};
        AzToolsFramework::SourceControlResponseCallback m_callback{ nullptr };
        AzToolsFramework::SourceControlResponseCallbackBulk m_bulkCallback{ nullptr };
    ...
    public:
        ...
        AzToolsFramework::SourceControlResponseCallbackBulk m_bulkCallback{ nullptr };
        bool m_succeeded{};
        AzToolsFramework::SourceControlFileInfo m_fileInfo;
        AZStd::vector<AzToolsFramework::SourceControlFileInfo> m_bulkFileInfo;
    ...
    public:
        ...
        AzToolsFramework::SourceControlSettingCallback m_callback = nullptr;
        AzToolsFramework::SourceControlSettingInfo m_settingInfo;
    };
    ...
    class EditorPerforceSystemComponent
        : public AZ::Component
        , private SourceControlCommandBus::Handler
        , private SourceControlConnectionRequestBus::Handler
    {
    public:
        AZ_COMPONENT(EditorPerforceSystemComponent, "{680C2C8B-37CA-42EB-9E50-06AB2474201E}")

        AZStd::string m_autoChangelistDescription;

        EditorPerforceSystemComponent() = default;
        ~EditorPerforceSystemComponent() override = default;
    ...
    private:
        ...
        void GetFileInfo(const char* fullFilePath, const AzToolsFramework::SourceControlResponseCallback& respCallback) override;
        void GetBulkFileInfo(const AZStd::unordered_set<AZStd::string>& fullFilePaths, const AzToolsFramework::SourceControlResponseCallbackBulk& respCallback) override;
        void RequestEdit(const char* fullFilePath, bool allowMultiCheckout, const AzToolsFramework::SourceControlResponseCallback& respCallback) override;
        void RequestEditBulk(const AZStd::unordered_set<AZStd::string>& fullFilePaths, bool allowMultiCheckout, const AzToolsFramework::SourceControlResponseCallbackBulk& respCallback) override;
        void RequestDelete(const char* fullFilePath, const AzToolsFramework::SourceControlResponseCallback& respCallback) override;
        void RequestDeleteExtended(const char* fullFilePath, bool skipReadOnly, const AzToolsFramework::SourceControlResponseCallback& respCallback) override;
        void RequestDeleteBulk(const char* fullFilePath, const AzToolsFramework::SourceControlResponseCallbackBulk& respCallback) override;
        void RequestDeleteBulkExtended(const char* fullFilePath, bool skipReadOnly, const AzToolsFramework::SourceControlResponseCallbackBulk& respCallback) override;
        void RequestRevert(const char* fullFilePath, const AzToolsFramework::SourceControlResponseCallback& respCallback) override;
        void RequestLatest(const char* fullFilePath, const AzToolsFramework::SourceControlResponseCallback& respCallback) override;
        void RequestRename(const char* sourcePathFull, const char* destPathFull, const AzToolsFramework::SourceControlResponseCallback& respCallback) override;
        void RequestRenameExtended(const char* sourcePathFull, const char* destPathFull, bool skipReadOnly, const AzToolsFramework::SourceControlResponseCallback& respCallback) override;
        void RequestRenameBulk(const char* sourcePathFull, const char* destPathFull, const AzToolsFramework::SourceControlResponseCallbackBulk& respCallback) override;
        void RequestRenameBulkExtended(const char* sourcePathFull, const char* destPathFull, bool skipReadOnly, const AzToolsFramework::SourceControlResponseCallbackBulk& respCallback) override;
        //////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////
        // SourceControlConnectionRequestBus::Handler overrides
        void EnableSourceControl(bool enable) override;
        bool IsActive() const override { return m_connectionState == AzToolsFramework::SourceControlState::Active; }
        void EnableTrust(bool enable, AZStd::string fingerprint) override;
        void SetConnectionSetting(const char* key, const char* value, const AzToolsFramework::SourceControlSettingCallback& respCallBack) override;
        void GetConnectionSetting(const char* key, const AzToolsFramework::SourceControlSettingCallback& respCallBack) override;
        AzToolsFramework::SourceControlState GetSourceControlState() const override { return m_connectionState; }
        //////////////////////////////////////////////////////////////////////////

        AzToolsFramework::SourceControlFileInfo GetFileInfo(const char*);
        AZStd::vector<AzToolsFramework::SourceControlFileInfo> GetBulkFileInfo(const char* requestPath) const;
        AZStd::vector<AzToolsFramework::SourceControlFileInfo> GetBulkFileInfo(const AZStd::unordered_set<AZStd::string>& requestPaths) const;
        ...
        AzToolsFramework::LocalFileSCComponent m_localFileSCComponent;
        ...
        AzToolsFramework::SourceControlState m_connectionState;
    };
