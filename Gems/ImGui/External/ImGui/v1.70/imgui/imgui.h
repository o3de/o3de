...
{
    // Gamepad Mapping
    ImGuiNavInput_Activate,      // activate / open / toggle / tweak value       // e.g. Bottom Face Button on all consoles,    (Cross(X), A),  Space ( Keyboard )
    ImGuiNavInput_Cancel,        // cancel / close / exit                        // e.g. Right Face Button on all consoles,     (Circle, B),    Escape ( Keyboard )
    ImGuiNavInput_Input,         // text input / on-screen keyboard              // e.g. Top Face Button on all consoles,       (Triangle, B),  Return ( Keyboard )
    ImGuiNavInput_Menu,          // tap: toggle menu / hold: focus, move, resize // e.g. Left Face Button on all consoles,      (Square, B),    Alt ( Keyboard )
    ...
    ImGuiNavInput_FocusPrev,     // next window (w/ PadMenu)                     // e.g. L1 or L2 (Console)
    ImGuiNavInput_FocusNext,     // prev window (w/ PadMenu)                     // e.g. R1 or R2 (Console)
    ImGuiNavInput_TweakSlow,     // slower tweaks                                // e.g. L1 or L2 (Console)
    ImGuiNavInput_TweakFast,     // faster tweaks                                // e.g. R1 or R2 (Console)
