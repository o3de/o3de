...
/*
 ...
 - Gamepad support is particularly useful to use dear imgui on a console system without a mouse!
...
bool ImGui::ItemAdd(const ImRect& bb, ImGuiID id, const ImRect* nav_bb_arg)
{
    ...
    if (id != 0)
    {
        ...
        if ((g.NavId == id || g.NavAnyRequest) && g.NavWindow != nullptr && window != nullptr)
