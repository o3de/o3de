...
{
    // Gamepad Mapping
    ImGuiNavInput_Activate,      // activate / open / toggle / tweak value       // e.g. Cross   (), A (), A (), Space (Keyboard)
    ImGuiNavInput_Cancel,        // cancel / close / exit                        // e.g. Circle  (), B (), B (), Escape (Keyboard)
    ImGuiNavInput_Input,         // text input / on-screen keyboard              // e.g. Triangle(), Y (), X (), Return (Keyboard)
    ImGuiNavInput_Menu,          // tap: toggle menu / hold: focus, move, resize // e.g. Square  (), X (), Y (), Alt (Keyboard)
    ...
    ImGuiNavInput_FocusPrev,     // next window (w/ PadMenu)                     // e.g. L1 or L2 (), LB or LT (), L or ZL ()
    ImGuiNavInput_FocusNext,     // prev window (w/ PadMenu)                     // e.g. R1 or R2 (), RB or RT (), R or ZL ()
    ImGuiNavInput_TweakSlow,     // slower tweaks                                // e.g. L1 or L2 (), LB or LT (), L or ZL ()
    ImGuiNavInput_TweakFast,     // faster tweaks                                // e.g. R1 or R2 (), RB or RT (), R or ZL ()
