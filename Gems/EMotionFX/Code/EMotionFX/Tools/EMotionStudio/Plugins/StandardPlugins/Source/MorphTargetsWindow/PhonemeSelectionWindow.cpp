...
namespace EMStudio
{
    ...
    {
        // set window title
        setWindowTitle(tr("Phoneme Selection Window"));
        ...
        QLabel* labelAdd = new QLabel(tr("- Use drag&drop or double click to add -"));
        ...
        QLabel* labelRemove = new QLabel(tr("- Use drag&drop or double click to remove -"));
