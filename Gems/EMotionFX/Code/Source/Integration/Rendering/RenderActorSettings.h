...
namespace AZ::Render
{
    ...
    public:
        ...
        AZ::Color m_hoveredHitDetectionColliderColor{ 0.0f, 0.0f, 1.0f, 1.0f };
        ...
        AZ::Color m_hoveredRagdollColliderColor{ 0.0f, 0.0f, 1.0f, 1.0f };
        ...
        AZ::Color m_hoveredClothColliderColor{ 0.0f, 0.0f, 1.0f, 1.0f };
        AZ::Color m_simulatedObjectColliderColor{ 0.44f, 0.44f, 0.44f, 1.0f };
        AZ::Color m_selectedSimulatedObjectColliderColor{ 1.0f, 0.34f, 0.87f, 1.0f };
        AZ::Color m_hoveredSimulatedObjectColliderColor{ 0.0f, 0.0f, 1.0f, 1.0f };
