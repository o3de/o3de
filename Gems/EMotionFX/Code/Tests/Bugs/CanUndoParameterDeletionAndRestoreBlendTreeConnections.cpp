...
namespace EMotionFX
{
    std::vector<std::string> prepareLY92860Commands
    {
        ...
        R"str(AnimGraphCreateNode -animGraphID 100 -type {A8B5BB1E-5BA9-4B0A-88E9-21BB7A199ED2} -parentName Root -xPos 411 -yPos 238 -name GENERATE -namePrefix BlendTree)str",
        ...
        R"str(AnimGraphCreateNode -animGraphID 100 -type {4510529A-323F-40F6-B773-9FA8FC4DE53D} -parentName BlendTree0 -xPos -534 -yPos -15 -name GENERATE -namePrefix Parameters)str",
        R"str(AnimGraphCreateNode -animGraphID 100 -type {80D8C793-3CD4-4216-B804-CC00EAD20FAA} -parentName BlendTree0 -xPos -230 -yPos -121 -name GENERATE -namePrefix Smoothing)str",
        R"str(AnimGraphCreateNode -animGraphID 100 -type {80D8C793-3CD4-4216-B804-CC00EAD20FAA} -parentName BlendTree0 -xPos -150 -yPos 12 -name GENERATE -namePrefix Smoothing)str",
        R"str(AnimGraphCreateNode -animGraphID 100 -type {80D8C793-3CD4-4216-B804-CC00EAD20FAA} -parentName BlendTree0 -xPos -171 -yPos 157 -name GENERATE -namePrefix Smoothing)str",
        R"str(AnimGraphAdjustNode -animGraphID 100 -name Smoothing1 -xPos -229 -yPos 10 -updateAttributes false)str",
        R"str(AnimGraphAdjustNode -animGraphID 100 -name Smoothing2 -xPos -229 -yPos 120 -updateAttributes false)str",
        ...
        R"str(AnimGraphCreateParameter -animGraphID 100 -type {2ED6BBAF-5C82-4EAA-8678-B220667254F2} -name Parameter2 -contents <ObjectStream version = "3">
            <Class name = "FloatSliderParameter" version = "1" type = "{2ED6BBAF-5C82-4EAA-8678-B220667254F2}">
            <Class name = "FloatParameter" field = "BaseClass1" version = "1" type = "{0F0B8531-0B07-4D9B-A8AC-3A32D15E8762}">
            <Class name = "(RangedValueParameter&lt;ValueType, Derived&gt;)&lt;float FloatParameter &gt;" field = "BaseClass1" version = "1" type = "{01CABBF8-9500-5ABB-96BD-9989198146C2}">
            <Class name = "(DefaultValueParameter&lt;ValueType, Derived&gt;)&lt;float (RangedValueParameter&lt;ValueType, Derived&gt;)&lt;float FloatParameter &gt; &gt;" field = "BaseClass1" version = "1" type = "{3221F118-9372-5BA3-BD8B-E88267CB356B}">
        ...
        R"str(AnimGraphCreateConnection -animGraphID 100 -sourceNode Parameters0 -targetNode Smoothing0 -sourcePort 0 -targetPort 0 -startOffsetX 119 -startOffsetY 42 -endOffsetX -2 -endOffsetY 38)str",
        R"str(AnimGraphCreateConnection -animGraphID 100 -sourceNode Parameters0 -targetNode Smoothing1 -sourcePort 1 -targetPort 0 -startOffsetX 121 -startOffsetY 55 -endOffsetX -3 -endOffsetY 40)str",
        R"str(AnimGraphCreateConnection -animGraphID 100 -sourceNode Parameters0 -targetNode Smoothing2 -sourcePort 2 -targetPort 0 -startOffsetX 119 -startOffsetY 70 -endOffsetX -2 -endOffsetY 40)str"
    };
