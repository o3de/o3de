...
#include <EMotionStudio/Plugins/StandardPlugins/Source/MotionSetsWindow/MotionSetWindow.h>
...
namespace EMotionFX
{
    ...
    TEST_F(UIFixture, CanAddMotions)
    {
        ...
        */
        ...
        {
            command = AZStd::string::format("ImportMotion -filename %s", filename);
        ...
        EXPECT_STREQ(item->text().toUtf8().data(), assetName) << "Asset name DOES NOT match table entry";
    }
} // namespace EMotionFX
