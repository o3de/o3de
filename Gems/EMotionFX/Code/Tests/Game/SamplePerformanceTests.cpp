...
namespace EMotionFX
{
    ...
    public:
        ...
        void TestMotionSamplingPerformance(const char* motionFilename)
        {
            ...
            const char* actorFilename  = "@projectproductassets@\\animationsamples\\advanced_rinlocomotion\\actor\\rinactor.actor";
    ...
    TEST_P(PerformanceTestFixture, DISABLED_PerformanceTest)
    {
        ...
        const char* actorFilename     = "@projectproductassets@\\AnimationSamples\\Advanced_RinLocomotion\\Actor\\rinActor.actor";
        const char* motionSetFilename = "@projectproductassets@\\AnimationSamples\\Advanced_RinLocomotion\\AnimationEditorFiles\\Advanced_RinLocomotion.motionset";
        const char* animGraphFilename = "@projectproductassets@\\AnimationSamples\\Advanced_RinLocomotion\\AnimationEditorFiles\\Advanced_RinLocomotion.animgraph";
    ...
    TEST_F(PerformanceTestFixture, DISABLED_MotionSamplingPerformanceNonUniform)
    {
        ...
        TestMotionSamplingPerformance("@projectproductassets@\\animationsamples\\advanced_rinlocomotion\\motions\\rin_idle.motion");
    }
    ...
    TEST_F(PerformanceTestFixture, DISABLED_MotionSamplingPerformanceUniform)
    {
        ...
        TestMotionSamplingPerformance("@projectproductassets@\\animationsamples\\advanced_rinlocomotion\\motions\\rin_walk_kick_01.motion");
    }
