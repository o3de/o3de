...
set DCCSI_COMMONFEATURES_SCRIPTS=%O3DE_DEV%\Gems\AtomLyIntegration\CommonFeatures\Editor\Scripts
echo     DCCSI_COMMONFEATURES_SCRIPTS = %DCCSI_COMMONFEATURES_SCRIPTS% 

set DCCSI_COLORGRADING_SCRIPTS=%DCCSI_COMMONFEATURES_SCRIPTS%\ColorGrading
...
set PYTHONPATH=%DCCSIG_PATH%;%DCCSI_PYTHON_LIB_PATH%;%O3DE_BUILD_PATH%;%DCCSI_COLORGRADING_SCRIPTS%;%DCCSI_COMMONFEATURES_SCRIPTS%;%PYTHONPATH%
