...
namespace AZ
{
    namespace Render
    {
        class AoComponentConfig final
            : public ComponentConfig
        {
        public:
            AZ_CLASS_ALLOCATOR(AoComponentConfig, SystemAllocator)
            AZ_RTTI(AZ::Render::AoComponentConfig, "{C1ACBBE7-C3BD-4245-B571-3B5FDCAC0B0B}", AZ::ComponentConfig);
