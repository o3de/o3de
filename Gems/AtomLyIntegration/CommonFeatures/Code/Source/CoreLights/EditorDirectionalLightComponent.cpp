                ...
                if (EditContext* editContext = serializeContext->GetEditContext())
                {
                    ...
                    editContext->Class<DirectionalLightComponentConfig>("DirectionalLightComponentConfig", "")
                        ...
                        ->ClassElement(Edit::ClassElements::Group, "Lighting Channels")
                            ->Attribute(Edit::Attributes::AutoExpand, true)
                            ->DataElement(Edit::UIHandlers::CheckBox, &DirectionalLightComponentConfig::m_lightingChannel0, "Channel 0", "Lighting channel 0.")
                            ->DataElement(Edit::UIHandlers::CheckBox, &DirectionalLightComponentConfig::m_lightingChannel1, "Channel 1", "Lighting channel 1.")
                            ->DataElement(Edit::UIHandlers::CheckBox, &DirectionalLightComponentConfig::m_lightingChannel2, "Channel 2", "Lighting channel 2.")
