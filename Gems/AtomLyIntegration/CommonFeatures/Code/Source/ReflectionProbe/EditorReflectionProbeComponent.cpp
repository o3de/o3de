            ...
            if (AZ::SerializeContext* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
            {
                ...
                if (AZ::EditContext* editContext = serializeContext->GetEditContext())
                {
                    editContext->Class<EditorReflectionProbeComponent>(
                        QT_TRANSLATE_NOOP("AtomLyIntegration", "Reflection Probe"), QT_TRANSLATE_NOOP("AtomLyIntegration", "The ReflectionProbe component captures an IBL specular reflection at a specific position in the level"))
                        ...
                        ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("AtomLyIntegration", "Cubemap Bake"))
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                            ->UIElement(AZ::Edit::UIHandlers::Button, QT_TRANSLATE_NOOP("AtomLyIntegration", "Bake Reflection Probe"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Bake Reflection Probe"))
                                ->Attribute(AZ::Edit::Attributes::NameLabelOverride, "")
                                ->Attribute(AZ::Edit::Attributes::ButtonText, QT_TRANSLATE_NOOP("AtomLyIntegration", "Bake Reflection Probe"))
                            ...
                            ->DataElement(AZ::Edit::UIHandlers::Slider, &EditorReflectionProbeComponent::m_bakeExposure, QT_TRANSLATE_NOOP("AtomLyIntegration", "Bake Exposure"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Exposure to use when baking the cubemap"))
                                ...
                                ->Attribute(AZ::Edit::Attributes::Visibility, &EditorReflectionProbeComponent::GetBakedCubemapVisibilitySetting)
                        ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("AtomLyIntegration", "Cubemap"))
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                            ->DataElement(AZ::Edit::UIHandlers::Default, &EditorReflectionProbeComponent::m_useBakedCubemap, QT_TRANSLATE_NOOP("AtomLyIntegration", "Use Baked Cubemap"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Selects between a cubemap that captures the environment at location in the scene or a preauthored cubemap"))
                            ...
                            ->DataElement(AZ::Edit::UIHandlers::ComboBox, &EditorReflectionProbeComponent::m_bakedCubeMapQualityLevel, QT_TRANSLATE_NOOP("AtomLyIntegration", "Baked Cubemap Quality"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Resolution of the baked cubemap"))
                                ->Attribute(AZ::Edit::Attributes::Visibility, &EditorReflectionProbeComponent::GetBakedCubemapVisibilitySetting)
                            ...
                            ->DataElement(AZ::Edit::UIHandlers::MultiLineEdit, &EditorReflectionProbeComponent::m_bakedCubeMapRelativePath, QT_TRANSLATE_NOOP("AtomLyIntegration", "Baked Cubemap Path"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Baked Cubemap Path"))
                                ->Attribute(AZ::Edit::Attributes::ReadOnly, true)
                                ->Attribute(AZ::Edit::Attributes::Visibility, &EditorReflectionProbeComponent::GetBakedCubemapVisibilitySetting)
                            ->DataElement(AZ::Edit::UIHandlers::Default, &EditorReflectionProbeComponent::m_authoredCubeMapAsset, QT_TRANSLATE_NOOP("AtomLyIntegration", "Cubemap file"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Authored Cubemap file"))
                    ...
                    editContext->Class<ReflectionProbeComponentController>(
                        ...
                        ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                        ->DataElement(AZ::Edit::UIHandlers::Default, &ReflectionProbeComponentController::m_configuration, QT_TRANSLATE_NOOP("AtomLyIntegration", "Configuration"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                        ;
                    ...
                    editContext->Class<ReflectionProbeComponentConfig>(
                        ...
                        ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                        ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("AtomLyIntegration", "Inner Extents"))
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                            ->DataElement(AZ::Edit::UIHandlers::Default, &ReflectionProbeComponentConfig::m_innerHeight, QT_TRANSLATE_NOOP("AtomLyIntegration", "Height"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Height of the reflection probe inner volume"))
                                ->Attribute(AZ::Edit::Attributes::Min, 0.f)
                                ->Attribute(AZ::Edit::Attributes::ChangeNotify, Edit::PropertyRefreshLevels::ValuesOnly)
                            ->DataElement(AZ::Edit::UIHandlers::Default, &ReflectionProbeComponentConfig::m_innerLength, QT_TRANSLATE_NOOP("AtomLyIntegration", "Length"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Length of the reflection probe inner volume"))
                                ->Attribute(AZ::Edit::Attributes::Min, 0.f)
                                ->Attribute(AZ::Edit::Attributes::ChangeNotify, Edit::PropertyRefreshLevels::ValuesOnly)
                            ->DataElement(AZ::Edit::UIHandlers::Default, &ReflectionProbeComponentConfig::m_innerWidth, QT_TRANSLATE_NOOP("AtomLyIntegration", "Width"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Width of the reflection probe inner volume"))
                                ->Attribute(AZ::Edit::Attributes::Min, 0.f)
                                ->Attribute(AZ::Edit::Attributes::ChangeNotify, Edit::PropertyRefreshLevels::ValuesOnly)
                        ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("AtomLyIntegration", "Settings"))
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                            ->DataElement(AZ::Edit::UIHandlers::CheckBox, &ReflectionProbeComponentConfig::m_useParallaxCorrection, QT_TRANSLATE_NOOP("AtomLyIntegration", "Parallax Correction"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Correct the reflection to adjust for the offset from the capture position"))
                                ->Attribute(AZ::Edit::Attributes::ChangeNotify, Edit::PropertyRefreshLevels::ValuesOnly)
                            ->DataElement(AZ::Edit::UIHandlers::CheckBox, &ReflectionProbeComponentConfig::m_showVisualization, QT_TRANSLATE_NOOP("AtomLyIntegration", "Show Visualization"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Show the reflection probe visualization sphere"))
                                ->Attribute(AZ::Edit::Attributes::ChangeNotify, Edit::PropertyRefreshLevels::ValuesOnly)
                            ->DataElement(AZ::Edit::UIHandlers::Slider, &ReflectionProbeComponentConfig::m_renderExposure, QT_TRANSLATE_NOOP("AtomLyIntegration", "Exposure"), QT_TRANSLATE_NOOP("AtomLyIntegration", "Exposure to use when rendering meshes with the cubemap"))
