...
namespace AZ::Render
{
    ...
    void AtomViewportDisplayInfoSystemComponent::DrawMemoryInfo()
    {
        ...
        float imagePoolUsedAllocateddMB = static_cast<float>(imagePoolMemoryUsage.m_usedResidentInBytes) / MB;
        ...
        DrawLine(
            AZStd::string::format("RPI AssetStreamingImagePool (used/total): %.2f / %.2f MiB", imagePoolUsedAllocateddMB, imagePoolTotalAllocatedMB),
