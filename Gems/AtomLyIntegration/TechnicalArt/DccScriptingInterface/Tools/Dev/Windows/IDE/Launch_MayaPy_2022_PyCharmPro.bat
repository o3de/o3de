...
echo.
echo ~    O3DE DCCsi PyCharm Launch Env ...
echo _____________________________________________________________________
echo.
echo ~    default envas for pycharm env
...
echo _____________________________________________________________________
echo.
echo ~ O3DE DCCsi MayaPy PyCharm %PYCHARM_VER_YEAR%.%PYCHARM_VER_MAJOR%.%PYCHARM_VER_MINOR% ...
