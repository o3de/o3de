...
set "PATH_DCCSI_TOOLS_MAYA=%PATH_DCCSI_TOOLS%\DCC\Maya"
echo     PATH_DCCSI_TOOLS_MAYA = %PATH_DCCSI_TOOLS_MAYA%

set MAYA_MODULE_PATH=%PATH_DCCSI_TOOLS_MAYA%;%MAYA_MODULE_PATH%
...
set "DCCSI_MAYA_PLUG_IN_PATH=%PATH_DCCSI_TOOLS_MAYA%\plugins"
...
set "DCCSI_MAYA_SHELF_PATH=%PATH_DCCSI_TOOLS_MAYA%\Prefs\Shelves"
...
set "DCCSI_MAYA_XBMLANGPATH=%PATH_DCCSI_TOOLS_MAYA%\Prefs\icons"
:: also attached to maya's built-it env var
...
set "DCCSI_MAYA_SCRIPT_MEL_PATH=%PATH_DCCSI_TOOLS_MAYA%\Scripts\Mel"
:: also attached to maya's built-it env var
...
set "DCCSI_MAYA_SCRIPT_PY_PATH=%PATH_DCCSI_TOOLS_MAYA%\Scripts\Python"
:: also attached to maya's built-it env var
...
set "DCCSI_MAYA_SCRIPT_PATH=%PATH_DCCSI_TOOLS_MAYA%\Scripts"
:: also attached to maya's built-it env var
