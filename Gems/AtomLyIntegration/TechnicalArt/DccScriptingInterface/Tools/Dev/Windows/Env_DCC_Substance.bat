...
IF "%DCCSI_SUBSTANCE_CFG_NAME%"=="" (set "DCCSI_SUBSTANCE_CFG_NAME=o3de_dccsi.sbscfg")
echo     DCCSI_SUBSTANCE_CFG_NAME = %DCCSI_SUBSTANCE_CFG_NAME%

:: o3de dccsi substance config
:: https://substance3d.adobe.com/documentation/sddoc/project-settings-188974384.html
IF "%DCCSI_SUBSTANCE_CFG%"=="" (set "DCCSI_SUBSTANCE_CFG=%DCCSI_TOOLS_SUBSTANCE%\%DCCSI_SUBSTANCE_CFG_NAME%")
