...
IF "%DCCSI_SUBSTANCE_CFG%"=="" (set "DCCSI_SUBSTANCE_CFG=o3de_dccsi.sbscfg")
...
IF "%DCCSI_SUBSTANCE_CFG_PATH%"=="" (set "DCCSI_SUBSTANCE_CFG_PATH=%DCCSI_TOOLS_SUBSTANCE_PATH%\%DCCSI_SUBSTANCE_CFG%")
echo     DCCSI_SUBSTANCE_CFG_PATH = %DCCSI_SUBSTANCE_CFG_PATH%
