...
IF "%DCCSI_BLENDER_LOCATION%"=="" (set "DCCSI_BLENDER_LOCATION=%ProgramFiles%\Blender Foundation\Blender %BLENDER_VERSION%")
...
IF "%DCCSI_BLENDER_PYTHON%"=="" (set "DCCSI_BLENDER_PYTHON=%DCCSI_BLENDER_LOCATION%\%BLENDER_VERSION%\python")
...
IF "%DCCSI_BLENDER_ADDONS%"=="" (set "DCCSI_BLENDER_ADDONS=%DCCSI_BLENDER_LOCATION%\AddOns")
