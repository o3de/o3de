...
ENVAR_DCCSI_SUBSTANCE_CFG = "DCCSI_SUBSTANCE_CFG_NAME"
...
PATH_DCCSI_SUBSTANCE_CFG = Path(PATH_DCCSI_TOOLS_SUBSTANCE, DCCSI_SUBSTANCE_CFG)
...
if __name__ == '__main__':
    ...
    _stash_dict[ENVAR_DCCSI_PY_SUBSTANCE] = PATH_DCCSI_PY_SUBSTANCE
