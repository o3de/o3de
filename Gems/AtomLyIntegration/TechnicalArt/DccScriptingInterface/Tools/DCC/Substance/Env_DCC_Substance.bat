...
:: maintenance: latest version of Adobe CC Substance Designer, June-23-2022 @HogJonny-AMZN
...
IF "%DCCSI_TOOLS_SUBSTANCE_PATH%"=="" (set "DCCSI_TOOLS_SUBSTANCE_PATH=%PATH_DCCSI_TOOLS%\DCC\Substance")
echo     DCCSI_TOOLS_SUBSTANCE_PATH = %DCCSI_TOOLS_SUBSTANCE_PATH%

IF "%DCCSI_SUBSTANCE_RESOURCES%"=="" (set "DCCSI_SUBSTANCE_RESOURCES=%DCCSI_TOOLS_SUBSTANCE_PATH%\Resources")
...
:: python scripts
IF "%DCCSI_SUBSTANCE_SCRIPTS%"=="" (set "DCCSI_SUBSTANCE_SCRIPTS=%DCCSI_SUBSTANCE_RESOURCES%\Scripts")
...
IF "%DCCSI_SUBSTANCE_CFG%"=="" (set "DCCSI_SUBSTANCE_CFG=%DCCSI_TOOLS_SUBSTANCE_PATH%\o3de_dccsi.sbscfg")
