...
ENVAR_DCCSI_BLENDER_LOCATION = "PATH_DCCSI_BLENDER_LOC"
PATH_DCCSI_BLENDER_ROOT_LOC = f'C:\\Program Files\\Blender Foundation\\Blender'
PATH_DCCSI_BLENDER_LOCATION = f'{PATH_DCCSI_BLENDER_ROOT_LOC} {TAG_DCCSI_BLENDER_VERSION}'
...
PATH_DCCSI_BLENDER_PYTHON_LOC = f"{PATH_DCCSI_BLENDER_LOCATION}\\{TAG_DCCSI_BLENDER_VERSION}/python"
...
PATH_DCCSI_BLENDER_BOOTSTRAP = f'{PATH_DCCSI_TOOLS_DCC_BLENDER}\\{SLUG_DCCSI_BLENDER_BOOTSTRAP}'
