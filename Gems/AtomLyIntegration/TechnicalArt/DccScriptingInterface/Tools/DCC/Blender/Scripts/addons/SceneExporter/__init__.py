...
def register():
    ...
    bpy.utils.register_class(ui.AddStaticColliderMesh)
    bpy.utils.register_class(ui.AddDynamicColliderMesh)
...
def unregister():
    ...
    bpy.utils.unregister_class(ui.AddStaticColliderMesh)
    bpy.utils.unregister_class(ui.AddDynamicColliderMesh)
