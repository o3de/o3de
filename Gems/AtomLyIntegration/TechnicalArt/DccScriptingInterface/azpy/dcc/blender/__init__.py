...
# -------------------------------------------------------------------------
"""! @brief
<DCCsi>/azpy/dcc/blender/__init__.py

dcc/blender is a sub-module of the azpy.dcc pure-python api.
If a sub-module requires an import from a blender api like bpy,
