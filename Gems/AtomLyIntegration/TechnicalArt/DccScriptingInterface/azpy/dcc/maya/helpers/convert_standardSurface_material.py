...
##
# @file convert_standardSource_material.py
#
...
# TODO - Stopped at getting the full audit of currently open Maya file. The thing that was missing was getting texture
# TODO- information. The material handling needs to work for all texture types (which it currently does not)

import logging as _logging
import maya.cmds as mc

_LOGGER = _logging.getLogger('azpy.dcc.maya.helpers.convert_standardSurface_material')
