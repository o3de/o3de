...
# -------------------------------------------------------------------------
"""! @brief
<DCCsi>/azpy/dcc/houdini/__init__.py

dcc/houdini is a sub-module of the azpy.dcc pure-python api.
If a sub-module requires an import from a houdini api like hou,
...
def init(_all=list()):
    """If the Houdini or other apis are required for a package/module to
...
# Make sure we can import the native Houdini apis
try:
    import hou
