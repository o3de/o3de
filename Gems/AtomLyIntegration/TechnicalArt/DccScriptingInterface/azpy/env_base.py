...
#  paths
_BASE_ENVVAR_DICT[ENVAR_O3DE_DEV] = '${0}'.format(ENVAR_O3DE_DEV)
_BASE_ENVVAR_DICT[ENVAR_PATH_O3DE_PROJECT] = '${0}'.format(ENVAR_PATH_O3DE_PROJECT)
_BASE_ENVVAR_DICT[ENVAR_PATH_DCCSIG] = '${0}'.format(ENVAR_PATH_DCCSIG)
_BASE_ENVVAR_DICT[ENVAR_DCCSI_LOG_PATH] = '${0}'.format(ENVAR_DCCSI_LOG_PATH)
_BASE_ENVVAR_DICT[ENVAR_DCCSI_AZPY_PATH] = '${0}'.format(ENVAR_DCCSI_AZPY_PATH)
_BASE_ENVVAR_DICT[ENVAR_PATH_DCCSI_TOOLS] = '${0}'.format(ENVAR_PATH_DCCSI_TOOLS)
...
_BASE_ENVVAR_DICT[ENVAR_PATH_DCCSI_PYTHON] = '${0}'.format(ENVAR_PATH_DCCSI_PYTHON)
_BASE_ENVVAR_DICT[ENVAR_PATH_DCCSI_PYTHON_LIB] = '${0}'.format(ENVAR_PATH_DCCSI_PYTHON_LIB)
