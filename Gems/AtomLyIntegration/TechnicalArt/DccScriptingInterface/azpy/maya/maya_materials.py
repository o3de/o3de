...
def assign_textures(target_mesh, material_name, texture_set):
    pass


def process_single_file(action, target_file, data):
    # **kwargs    ?? For multiple actions?
    pass


def process_multiple_files(action, target_files, data):
    # action - convert materials, assign textures
    pass
...
print('maya_materials:::::::::')
print(json.dumps(get_scene_material_information(), sort_keys=True, indent=4))
# print(get_material_assignments())
...
def set_texture_maps(material_name, texture_list):
    """
