...
namespace Terrain
{
    ...
    void TerrainLayerSpawnerComponent::OnTransformChanged(const AZ::Transform& /*local*/, const AZ::Transform& world)
    {
        RefreshArea();
    }

    void TerrainLayerSpawnerComponent::OnShapeChanged(ShapeChangeReasons changeReason)
    {
        RefreshArea();
    }
