...
protected:
    ...
    Terrain::TerrainSurfaceGradientListComponent* m_colliderComponent;
    ...
    void AddSurfaceGradientListToEntities()
    {
        ...
        Terrain::TerrainSurfaceGradientListComponent* terrainSurfaceGradientListComponent =
            m_entity->CreateComponent<Terrain::TerrainSurfaceGradientListComponent>(Terrain::TerrainSurfaceGradientListComponent(config));
...
TEST_F(TerrainSurfaceGradientListTest, SurfaceGradientReturnsSurfaceWeightsInOrder)
{
    ...
    float expectedWeightList[] = { gradient2Value, gradient1Value };
