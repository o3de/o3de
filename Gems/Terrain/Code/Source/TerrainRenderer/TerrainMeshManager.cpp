        ...
        auto createMesh = [&](RtSector::MeshGroup& meshGroup, uint32_t indexBufferByteOffset, uint32_t indexBufferByteCount)
        {
            ...
            m_meshfeatureProcessor->UpdateMeshInfoEntry(
                ...
                [&](AZ::Render::MeshInfoEntry* entry) -> bool
                {
                    ...
                    entry->m_meshBuffers[position] =
                        AZ::Render::BufferViewIndexAndOffset::Create(positionsVertexBufferView, positionsBufferFormat);

                    AZ::RHI::ShaderSemantic normal{ AZ::Name{ "NORMAL" } };
                    entry->m_meshBuffers[normal] =
                        AZ::Render::BufferViewIndexAndOffset::Create(normalsVertexBufferView, normalsBufferFormat);
