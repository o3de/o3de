...
namespace AZ::Render
{
    class BindlessImageArrayHandler
    {
        public:
            ...
            uint16_t AppendBindlessImage(const RHI::DeviceImageView* imageView);
            void UpdateBindlessImage(uint16_t index, const RHI::DeviceImageView* imageView);
        ...
        private:
            ...
            AZStd::vector<const RHI::DeviceImageView*> m_bindlessImageViews;
