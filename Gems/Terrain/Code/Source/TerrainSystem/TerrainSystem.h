...
public:
    ...
    */
    ...
    //! @terrainExists: Can be nullptr. If != nullptr then, if there's no terrain at location x,y or location x,y is inside a terrain HOLE
    //! then *terrainExistsPtr will be set to false,
