...
namespace
{
    ...
    //
    // Note: This was the first pass attempt to find the nearest intersection between a ray and terrain,
    // before the simpler and more efficient iterative approach that is implemented above was proposed.
    // I am leaving it in for now until we have some benchmarks/tests in place, namely out of curiosity
    // to see how it performs in comparison to the iterative approach, after which it should be removed.
