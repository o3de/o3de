...
namespace
{
    ...
    /*
       ...
       Visualization:
        ...
        |____|____|____|____|____|____|____|____|
    */
    inline void FindNearestIntersectionIterative(
        ...
        AzFramework::RenderGeometry::RayResult& result)
    {
        ...
        tUntilNextBoundary = AZ::Vector2::CreateSelectCmpGreater(
            clippedEnd, clippedStart, tDelta - tUntilNextBoundary, tUntilNextBoundary);
        ...
        const AZ::Vector2 gridIncrement = terrainResolution *
            AZ::Vector2::CreateSelectCmpEqual(
                                        clippedLineSegment,
