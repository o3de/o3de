                ...
                if (!vertices.empty())
                {
                        ...
                        if (cl_navmesh_showInputData)
                        {
                            for (size_t i = 2; i < vertices.size(); i += 3)
                            {
                                DebugDraw::DebugDrawRequestBus::Broadcast(&DebugDraw::DebugDrawRequests::DrawLineLocationToLocation,
                                    transformed[i - 2], transformed[i - 1], AZ::Colors::Red, 30.f);
                                DebugDraw::DebugDrawRequestBus::Broadcast(&DebugDraw::DebugDrawRequests::DrawLineLocationToLocation,
                                    transformed[i - 1], transformed[i - 0], AZ::Colors::Red, 30.f);
                                DebugDraw::DebugDrawRequestBus::Broadcast(&DebugDraw::DebugDrawRequests::DrawLineLocationToLocation,
                                    transformed[i - 0], transformed[i - 2], AZ::Colors::Red, 30.f);
                            }
                        }
                    }
                    else
                    {
                        ...
                        if (cl_navmesh_showInputData)
                        {
                            ...
                            {
                                DebugDraw::DebugDrawRequestBus::Broadcast(&DebugDraw::DebugDrawRequests::DrawLineLocationToLocation,
                                    transformed[indices[i - 2]], transformed[indices[i - 1]], AZ::Colors::Red, 30.f);
                                DebugDraw::DebugDrawRequestBus::Broadcast(&DebugDraw::DebugDrawRequests::DrawLineLocationToLocation,
                                    transformed[indices[i - 1]], transformed[indices[i - 0]], AZ::Colors::Red, 30.f);
                                DebugDraw::DebugDrawRequestBus::Broadcast(&DebugDraw::DebugDrawRequests::DrawLineLocationToLocation,
                                    transformed[indices[i - 0]], transformed[indices[i - 2]], AZ::Colors::Red, 30.f);
                            }
                        }
                    }
