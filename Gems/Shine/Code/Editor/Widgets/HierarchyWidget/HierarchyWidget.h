...
public:
    ...
    void CreateItems(const Shine::EntityArray& elements);
    void RecreateItems(const Shine::EntityArray& elements);
    void ClearItems();
...
private:
    ...
    void ReparentItems(const QTreeWidgetItemRawPtrList& baseParentItems, const HierarchyItemRawPtrList& childItems);
    ...
    void DropMimeDataAssets(
        const QMimeData* data, QTreeWidgetItem* targetWidgetItem, bool onElement, int childIndex, const QPoint* newElementPosition);
