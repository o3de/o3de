...
void ViewportAlign::AlignSelectedElements(EditorWindow* editorWindow, AlignType alignType)
{
    ...
    Shine::EntityArray selectedElements = SelectionHelpers::GetTopLevelSelectedElements(editorWindow->GetHierarchy(), selectedItems);
    ...
    const AZ::Uuid transformComponentType = Shine::UiTransform2dComponentUuid;
