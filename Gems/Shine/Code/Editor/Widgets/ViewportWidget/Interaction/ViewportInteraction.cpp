...
#include "Toolbar/CoordinateSystemToolbarSection.h"
#include "Toolbar/MainToolbar.h"
#include "Toolbar/ModeToolbar.h"
#include "Toolbar/EnterPreviewToolbar.h"
...
#include "Widgets/ViewportWidget/DragInteraction/ViewportMoveGuideInteraction.h"
#include "Widgets/ViewportWidget/DragInteraction/ViewportMoveInteraction.h"
#include "Widgets/ViewportWidget/ViewportElement.h"
    ...
    const QTreeWidgetItemRawPtrQList& selectedItems)
{
    ...
    {
        Shine::EntityArray selectedElements = SelectionHelpers::GetTopLevelSelectedElements(m_editorWindow->GetHierarchy(), selectedItems);
...
void ViewportInteraction::MousePressEvent(QMouseEvent* ev)
{
        ...
        ((m_interactionMode == InteractionMode::MOVE || m_interactionMode == InteractionMode::ANCHOR) && m_interactionType == InteractionType::DIRECT && ctrlKeyPressed))
    {
        ...
        else
        {
            ...
            {
                Shine::EntityArray topLevelSelectedElements = SelectionHelpers::GetTopLevelSelectedElements(m_editorWindow->GetHierarchy(), selectedItems);
...
const AZ::Uuid& ViewportInteraction::InitAndGetTransformComponentType()
{
    ...
    {
        m_transformComponentType = Shine::UiTransform2dComponentUuid;
    }
    ...
    if (m_interactionType == InteractionType::NONE)
    {
        if (m_isAreaSelectionActive)
        {
            ...
            if (mouseDragDistance2 >= g_minAreaSelectionDistance2)
            {
                ...
                Shine::EntityArray elementsToSelect;
