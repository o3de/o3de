...
public: // member functions
    ...
    {
        return m_canvasViewportMatrixProps.scale;
    }
    AZ::Vector3 GetCanvasToViewportTranslation() const
    {
        return m_canvasViewportMatrixProps.translation;
    }
    ...
    {
        return m_shouldScaleToFitOnViewportResize;
    }
...
private: // member functions
    ...
    void UpdateInteractionType(const AZ::Vector2& mousePosition, const QTreeWidgetItemRawPtrQList& selectedItems);
    ...
    void ProcessInteraction(
        const AZ::Vector2& mousePosition, Qt::KeyboardModifiers modifiers, const QTreeWidgetItemRawPtrQList& selectedItems);
    ...
    void DrawAxisGizmo(
        ...
        const ViewportIcon* lineTextureX,
        const ViewportIcon* lineTextureY);
...
private: // data
    ...
    Shine::EntityArray m_selectedElementsAtSelectionStart;
    ...
    SerializeHelpers::SerializedEntryList
        m_selectedEntitiesUndoState; //! This can be eliminated once the dragInteractions all use ViewportDragInteraction
};

ADD_ENUM_CLASS_ITERATION_OPERATORS(
    ViewportInteraction::InteractionMode, ViewportInteraction::InteractionMode::SELECTION, ViewportInteraction::InteractionMode::ANCHOR);

ADD_ENUM_CLASS_ITERATION_OPERATORS(
    ViewportInteraction::CoordinateSystem, ViewportInteraction::CoordinateSystem::LOCAL, ViewportInteraction::CoordinateSystem::VIEW);
