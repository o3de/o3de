...
class ViewportWidget
    ...
    , private ShinePassDataRequestBus::Handler
...
private: // data
    ...
    AZStd::unique_ptr<ViewportAnchor> m_viewportAnchor;
    AZStd::unique_ptr<ViewportHighlight> m_viewportHighlight;
