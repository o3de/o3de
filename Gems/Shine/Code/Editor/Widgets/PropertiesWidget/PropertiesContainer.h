...
class PropertiesContainer : public QScrollArea
{
    Q_OBJECT
...
private:
    ...
    bool m_selectionEventAccepted; // ensure selection logic executes only once per click since eventFilter may execute multiple times for a
                                   // single click
