...
class PropertyAssetDirectorySelectionCtrl : public AzToolsFramework::PropertyAssetCtrl
{
public:
    ...
    const AZStd::string GetFolderSelection() const override
    {
        return m_folderPath;
    }
...
class PropertyHandlerDirectory : public AzToolsFramework::PropertyHandler<AZStd::string, PropertyDirectoryCtrl>
{
public:
    ...
    {
        return AZ_CRC_CE("Directory");
    }

    QWidget* CreateGUI(QWidget* pParent) override;
    void ConsumeAttribute(
        PropertyDirectoryCtrl* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName) override;
    void WriteGUIValuesIntoProperty(
        size_t index, PropertyDirectoryCtrl* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node) override;
    bool ReadValuesIntoGUI(
        size_t index, PropertyDirectoryCtrl* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node) override;
