    ...
    , m_snapCheckbox(new QCheckBox("Snap to grid", parent))
{
    ...
    // Combobox.
    {
        ...
        QObject::connect(m_editorWindow, SIGNAL(SignalCoordinateSystemCycle()), SLOT(HandleCoordinateSystemCycle()));
    }
    ...
    // Snap to grid checkbox.
    {
        ...
        QObject::connect(m_editorWindow, SIGNAL(SignalSnapToGridToggle()), SLOT(HandleSnapToGridToggle()));
    }
