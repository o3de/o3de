...
namespace SelectionHelpers
{
    ...
    AZ::Entity* GetTopLevelParentOfElement(const Shine::EntityArray& elements, AZ::Entity* elementToFind)
    {
        do
        {
            for (auto e : elements)
    ...
    void RemoveEntityFromArray(Shine::EntityArray& listToTrim, const AZ::Entity* entityToRemove)
    {
    ...
    void GetListOfTopLevelSelectedItems(
        [[maybe_unused]] const HierarchyWidget* widget,
    ...
    HierarchyItemRawPtrList GetSelectedHierarchyItems(
        [[maybe_unused]] const HierarchyWidget* widget, const QTreeWidgetItemRawPtrQList& selectedItems)
    {
    ...
    Shine::EntityArray GetSelectedElements(
        [[maybe_unused]] const HierarchyWidget* widget, const QTreeWidgetItemRawPtrQList& selectedItems)
    {
        auto count = selectedItems.count();
        Shine::EntityArray elements(count);
        {
    ...
    EntityHelpers::EntityIdList GetSelectedElementIds(
        [[maybe_unused]] const HierarchyWidget* widget, const QTreeWidgetItemRawPtrQList& selectedItems, bool addInvalidIdIfEmpty)
    {
    ...
    Shine::EntityArray GetTopLevelSelectedElements(const HierarchyWidget* widget, const QTreeWidgetItemRawPtrQList& selectedItems)
    {
        HierarchyItemRawPtrList topLevelSelectedItems;
        GetListOfTopLevelSelectedItems(widget, selectedItems, widget->invisibleRootItem(), topLevelSelectedItems);
    ...
    Shine::EntityArray GetTopLevelSelectedElementsNotControlledByParent(
