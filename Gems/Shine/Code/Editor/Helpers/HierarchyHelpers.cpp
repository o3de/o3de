...
namespace
{
    void CreateItems(HierarchyWidget* widget, Shine::EntityArray& completeListOfNewlyCreatedTopLevelElements)
    {
...
namespace HierarchyHelpers
{
    ...
    void Delete(HierarchyWidget* hierarchy, SerializeHelpers::SerializedEntryList& entries)
    {
    ...
    QAction* CreateAddElementAction(
    ...
    void CreateItemsAndElements(HierarchyWidget* widget, const SerializeHelpers::SerializedEntryList& entryList)
    {
        Shine::EntityArray completeListOfNewlyCreatedTopLevelElements;
        ...
        // Create elements
        {
            ...
            for (auto iter = entryList.rbegin(); iter != entryList.rend(); ++iter)
            {
                ...
                SerializeHelpers::RestoreSerializedElements(
                    widget->GetEditorWindow()->GetCanvas(),
    ...
    Shine::EntityArray CreateItemsAndElements(
        HierarchyWidget* widget, const QTreeWidgetItemRawPtrQList& selectedItems, bool createAsChildOfSelection, Creator creator)
    {
        Shine::EntityArray completeListOfNewlyCreatedTopLevelElements;
        ...
        // Create elements
        {
            HierarchyItem* parent = nullptr;
            {
                HierarchyItem* selectedItem = nullptr;
                {
                    ...
                    SelectionHelpers::GetListOfTopLevelSelectedItems(widget, selectedItems, widget->invisibleRootItem(), items);
    ...
    QTreeWidgetItem* _GetItem([[maybe_unused]] HierarchyWidget* widget, QTreeWidgetItem* i)
    {
        return i;
    }

    QTreeWidgetItem* _GetItem([[maybe_unused]] HierarchyWidget* widget, HierarchyItem* i)
    {
        return i;
    }

    QTreeWidgetItem* _GetItem(HierarchyWidget* widget, SerializeHelpers::SerializedEntry& e)
    {
        return HierarchyHelpers::ElementToItem(widget, e.m_id, false);
    }

    QTreeWidgetItem* _GetItem(HierarchyWidget* widget, AZ::Entity* e)
    {
        return HierarchyHelpers::ElementToItem(widget, e, false);
    }

    QTreeWidgetItem* _GetItem(HierarchyWidget* widget, AZ::EntityId e)
    {
        return HierarchyHelpers::ElementToItem(widget, e, false);
    }
    ...
    void SetSelectedItem(HierarchyWidget* widget, AZ::Entity* element)
    {
        Shine::EntityArray elementUnderCursor;
        if (element)
        {
