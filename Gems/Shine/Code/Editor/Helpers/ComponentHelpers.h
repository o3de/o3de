...
namespace ComponentHelpers
{
    ...
    bool CanAddComponentsToSelectedEntities(
        const AZStd::vector<AZ::TypeId>& componentTypes, EntityComponentPair* firstIncompatibleComponentType = nullptr);
    ...
    bool CanAddComponentsToEntity(
        const AZStd::vector<AZ::TypeId>& componentTypes,
    ...
    void AddComponentsWithAssetToEntity(
        const ComponentAssetHelpers::ComponentAssetPairs& componentAssetPairs, const AZ::EntityId& entityId);

    struct ComponentTypeData
    {
        const AZ::SerializeContext::ClassData* classData;
        bool isShineComponent;
    };
