...
CommandHierarchyItemCreateFromData::CommandHierarchyItemCreateFromData(
    UndoStack* stack,
...
void CommandHierarchyItemCreateFromData::redo()
{
    ...
    if (m_entries.empty())
    {
        ...
        Shine::EntityArray completeListOfNewlyCreatedTopLevelElements =
            HierarchyHelpers::CreateItemsAndElements(m_hierarchy, m_hierarchy->selectedItems(), m_createAsChildOfSelection, m_creator);

        // Shine::EntityArray -> HierarchyItemRawPtrList.
...
void CommandHierarchyItemCreateFromData::Push(
    UndoStack* stack,
    HierarchyWidget* hierarchy,
    ...
    const QString& dataSource)
{
    ...
    stack->push(new CommandHierarchyItemCreateFromData(
        stack,
        hierarchy,
        SelectionHelpers::GetSelectedElementIds(hierarchy, selectedItems, true),
