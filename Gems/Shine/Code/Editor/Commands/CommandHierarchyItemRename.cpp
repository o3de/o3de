...
CommandHierarchyItemRename::CommandHierarchyItemRename(
...
void CommandHierarchyItemRename::Push(
    UndoStack* stack, HierarchyWidget* hierarchy, const AZ::EntityId& entityId, const QString& fromName, const QString& toName)
{
    ...
    stack->push(new CommandHierarchyItemRename(stack, hierarchy, entityId, fromName, toName));
}
