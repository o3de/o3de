...
namespace UnitTest
{
    ...
    protected:
        ...
        void SetupApplication() override
        {
            ...
            {
                modules.emplace_back(new Shine::ShineModule);
            };
    ...
    TEST_F(ShineSerializationTest, Serialization_LayoutErrorsOnNullptr_FT)
    {
