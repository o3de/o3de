...
namespace UnitTest
{
    ...
    class ShineAnimationTestApplication : public AzFramework::Application
    {
    public:
        ShineAnimationTestApplication()
    ...
    protected:
        ...
        void SetupApplication() override
        {
            ...
            m_application = aznew ShineAnimationTestApplication();
        ...
        UnitTest::AnimationTestStubTimer* GetTimer()
        {
            return static_cast<ShineAnimationTestApplication*>(m_application)->GetTimer();
        }
        UiCanvasComponent* m_canvasComponent;
    };

    TEST_F(ShineAnimationTest, Animation_TrackEventTriggered_FT)
    {
