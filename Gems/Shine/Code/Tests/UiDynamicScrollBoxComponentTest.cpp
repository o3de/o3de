...
namespace UnitTest
{
    ...
    protected:
        ...
        {
            Shine::EntityArray children = entity->FindComponent<UiElementComponent>()->GetChildElements();
        ...
        {
            const Shine::EntityArray childEntities = uiCanvasComponent->GetChildElements();
