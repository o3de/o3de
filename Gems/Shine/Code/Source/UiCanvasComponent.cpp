...
public:
    ...
    void OnActionMultitouch(AZ::EntityId entityId, const Shine::ActionName& actionName, const AZ::Vector2& position, int multitouchIndex) override
    {
...
namespace
{
    Shine::CanvasId s_lastCanvasId = 0;
    ...
    UiRenderer* GetUiRendererForEditor()
    {
        ...
        {
            CShine* Shine = static_cast<CShine*>(AZ::Interface<IShine>::Get());
            return Shine->GetUiRendererForEditor();
        }
        return nullptr;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::CanvasId UiCanvasComponent::GetCanvasId()
{
    return m_id;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::EntityArray UiCanvasComponent::GetChildElements()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Entity* UiCanvasComponent::CreateChildElement(const Shine::NameType& name)
{
    AZ::Entity* child = nullptr;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Entity* UiCanvasComponent::FindElementById(Shine::ElementId id)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Entity* UiCanvasComponent::FindElementByName(const Shine::NameType& name)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId UiCanvasComponent::FindElementEntityIdByName(const Shine::NameType& name)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiCanvasComponent::FindElementsByName(const Shine::NameType& name, Shine::EntityArray& result)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Entity* UiCanvasComponent::FindElementByHierarchicalName(const Shine::NameType& name)
{
    // start at the root
    ...
    while (currentEntity)
    {
        ...
        else if (pos == Shine::NameType::npos)
        {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiCanvasComponent::FindElements(AZStd::function<bool(const AZ::Entity*)> predicate, Shine::EntityArray& result)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::EntityArray UiCanvasComponent::PickElements(const AZ::Vector2& bound0, const AZ::Vector2& bound1)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiCanvasComponent::FixupCreatedEntities(Shine::EntityArray topLevelEntities, bool makeUniqueNamesAndIds, AZ::Entity* optionalInsertionPoint)
{
    if (makeUniqueNamesAndIds)
    {
        ...
        Shine::EntityArray namedChildren;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZStd::string UiCanvasComponent::GetUniqueChildName(AZ::EntityId parentEntityId, AZStd::string baseName, const Shine::EntityArray* includeChildren)
{
...
void UiCanvasComponent::RecoverOrphanedElements()
{
    ...
    if (!recoveredOrphansElement)
    {
        ...
        recoveredOrphansElement->CreateComponent(Shine::UiTransform2dComponentUuid);
...
AZ::RHI::AttachmentId UiCanvasComponent::UseRenderTarget(const AZ::Name& renderTargetName, AZ::RHI::Size size)
{
    ...
    // Notify Shine render pass that it needs to rebuild
    QueueRttPassRebuild();
...
void UiCanvasComponent::RenderCanvas(bool isInGame, AZ::Vector2 viewportSize, UiRenderer* uiRenderer)
{
    ...
    // list.
    // We could prevent this at the CShine::Render level. But doing it here with an m_isRendering flag also allows us to
    ...
    if (m_renderGraph.GetDirtyFlag())
    {
        ...
        if (renderToTexture)
        {
            ...
            Shine::RenderToTextureRequestBus::EventResult(attachmentImage, GetEntityId(),
                &Shine::RenderToTextureRequestBus::Events::GetRenderTarget, m_attachmentImageId);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::ElementId UiCanvasComponent::GenerateId()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiCanvasComponent::GetRenderTargets(Shine::AttachmentImagesAndDependencies& attachmentImagesAndDependencies)
{
...
void UiCanvasComponent::QueueRttPassRebuild()
{
    ...
    if (uiRenderer && uiRenderer->GetViewportContext()) // can be null in automated testing
    {
        if (const AZ::RPI::ScenePtr& scene = uiRenderer->GetViewportContext()->GetRenderScene())
        {
            ...
            ShinePassRequestBus::Event(sceneId, &ShinePassRequestBus::Events::RebuildRttChildren);
        }
    }
}
...
void UiCanvasComponent::GetDebugInfoRenderGraph(ShineDebug::DebugInfoRenderGraph& info) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiCanvasComponent::DebugReportDrawCalls(AZ::IO::HandleType fileHandle, ShineDebug::DebugInfoDrawCallReport& reportInfo, void* context) const
{
...
void UiCanvasComponent::Activate()
{
    ...
    Shine::RenderToTextureRequestBus::Handler::BusConnect(GetEntityId());
...
void UiCanvasComponent::Deactivate()
{
    ...
    Shine::RenderToTextureRequestBus::Handler::BusDisconnect();
    ...
    //! Notify Shine pass that it needs to rebuild
    QueueRttPassRebuild();
...
AZStd::vector<AZ::EntityId> UiCanvasComponent::GetEntityIdsOfElementAndDescendants(AZ::Entity* entity)
{
    ...
    Shine::EntityArray descendantEntities;
    UiElementBus::Event(
        entity->GetId(),
        &UiElementBus::Events::FindDescendantElements,
        [](const AZ::Entity*)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool UiCanvasComponent::IsElementNameUnique(const AZStd::string& elementName, const Shine::EntityArray& elements)
{
...
UiCanvasComponent::EntityComboBoxVec UiCanvasComponent::PopulateTooltipDisplayEntityList()
{
    ...
    Shine::EntityArray tooltipDisplayElements;
...
void UiCanvasComponent::DestroyRenderTarget()
{
    if (!m_attachmentImageId.IsEmpty())
    {
        Shine::RenderToTextureRequestBus::Event(GetEntityId(),
            &Shine::RenderToTextureRequestBus::Events::ReleaseRenderTarget, m_attachmentImageId);
    ...
    AZ::SerializeContext::DataElementNode& classElement)
{
    ...
    {
        if (!Shine::ConvertSubElementFromVec2ToVector2(context, classElement, "CanvasSize"))
        {
            return false;
        }
    }
