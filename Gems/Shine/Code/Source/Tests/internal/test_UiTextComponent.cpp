...
namespace
{
    ...
    using StringList = AZStd::list < Shine::StringType >;
        ...
        const StringList& stringList)
    {
        ...
        {
            const UiTextComponent::DrawBatch& drawBatch = *drawBatchIt;
            const Shine::StringType& text = *stringIt;
    ...
    //!
    //! This test depends on the ShineExamples and UiBasics gems being
    ...
    {
        FontFamilyLoad("ui/fonts/ShineExamples/notosans/notosans.fontfamily");
        FontFamilyLoad("ui/fonts/ShineExamples/notoserif/notoserif.fontfamily");
    ...
    void BuildDrawBatchesTests(FontFamily* fontFamily)
    {
        ...
        // Plain string
        {
            const Shine::StringType markupTestString("this is a test!");
        ...
        {
            const Shine::StringType markupTestString("Regular Bold Italic\n");
        ...
        // Single bold
        {
            const Shine::StringType markupTestString("<b>this</b> is a test!");
        ...
        // Single italic
        {
            const Shine::StringType markupTestString("<i>this</i> is a test!");
        ...
        // Bold-italic
        {
            const Shine::StringType markupTestString("<b><i>this</i></b> is a test!");
        ...
        // Anchor tag
        {
            const Shine::StringType markupTestString("<a action=\"action\" data=\"data\">this</a> is a test!");
        ...
        {
            const Shine::StringType markupTestString(
        ...
        {
            const Shine::StringType markupTestString("<font color=\"#ff0000\"><a action=\"action\" data=\"data\">this</a></font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<a action=\"action\" data=\"data\">this <font color=\"#ff0000\">is</font> a test!</a>");
        ...
        {
            const Shine::StringType markupTestString("<a action=\"action1\" data=\"data1\">this <font color=\"#ff0000\">is</font></a> a <a action=\"action2\" data=\"data2\">te<font color=\"#ff0000\">st!</font></a>");
        ...
        // Font tag: font face
        {
            const Shine::StringType markupTestString("<font face=\"notoserif\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font face=\"notosans\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font face=\"default-ui\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font face=\"invalidFontName\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font face=\"\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font color=\"#ff0000\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font color=\"#00FF00\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font color=\"#0000FF\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font color=\"#GGGGGG\">this</font> is a test!");
        ...
        // Font tag: font color (invalid hex value)
        {
            const Shine::StringType markupTestString("<font color=\"#FF\">this</font> is a test!");
        ...
        // Font tag: font color (invalid formatting)
        {
            const Shine::StringType markupTestString("<font color=\"gluten\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font color=\"\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font face=\"notoserif\" color=\"#FF0000\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font color=\"#FF0000\" face=\"notoserif\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("<font cllor=\"#FF0000\">this</font> is a test!");
        ...
        {
            const Shine::StringType markupTestString("Regular <b>Bold</b> <i>Italic\n<b>Bold-Italic</b></i>");
        ...
        {
            const Shine::StringType markupTestString("<font color=\"#00ff00\">Regular <font face=\"notoserif\"><b>Bold</b></font></font>");
        ...
        {
            const Shine::StringType markupTestString("<font color=\"#00ff00\">Regular </font><font face=\"notoserif\"><b>Bold</b></font> <i>Italic<b> Bold-Italic</b></i>\nHere is <font face=\"default-ui\">default-ui</font>");
    ...
    void WrapTextTests(FontFamily* fontFamily)
    {
        ...
        {
            const Shine::StringType testMarkup("Regular Bold Italic\n");
        ...
        {
            const Shine::StringType textNoMarkup("this is a test!");
            const Shine::StringType markupTestString("<a action=\"action\" data=\"data\">this</a> is a test!");
    ...
    void BatchLinesTests(FontFamily* fontFamily)
    {
        ...
        {
            const Shine::StringType markupTestString("Regular Bold     <i>Italic</i>Bold-Italic");
            TextMarkup::Tag markupRoot;
        ...
        {
            const Shine::StringType textNoMarkup("this is a test!");
            const Shine::StringType markupTestString("<a action=\"action\" data=\"data\">this is a test!</a>");
    ...
    void TestCharacterSpacing(CShine* Shine, const AZStd::string& fontPath, float fontSize, const AZStd::string& testString, float characterSpacing, const char* testName)
    {
        ...
        CreateComponent(testElem, Shine::UiTextComponentUuid);
        ...
        UiLayoutCellDefaultBus::EventResult(
            baseWidth, testElemId, &UiLayoutCellDefaultBus::Events::GetTargetWidth, Shine::UiLayoutCellUnspecifiedSize);

        UiTextBus::Event(testElemId, &UiTextBus::Events::SetCharacterSpacing, characterSpacing);
        float newWidth;
        UiLayoutCellDefaultBus::EventResult(newWidth, testElemId, &UiLayoutCellDefaultBus::Events::GetTargetWidth, Shine::UiLayoutCellUnspecifiedSize);
    ...
    void TestLineSpacing(CShine* Shine, const AZStd::string& fontPath, float fontSize, const AZStd::string& testString, int numNewlines, float lineSpacing, const char* testName)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
        ...
        float baseHeight;
        UiLayoutCellDefaultBus::EventResult(
            baseHeight, testElemId, &UiLayoutCellDefaultBus::Events::GetTargetHeight, Shine::UiLayoutCellUnspecifiedSize);

        UiTextBus::Event(testElemId, &UiTextBus::Events::SetLineSpacing, lineSpacing);
        float newHeight;
        UiLayoutCellDefaultBus::EventResult(
            newHeight, testElemId, &UiLayoutCellDefaultBus::Events::GetTargetHeight, Shine::UiLayoutCellUnspecifiedSize);
    ...
    void TrackingLeadingTests(CShine* Shine)
    {
        // Character Spacing

        TestCharacterSpacing(Shine, "default-ui", 32.0f, "Hi", 1000.0f, "one space");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "W", 1000.0f, "no spaces");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "", 1000.0f, "empty string");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "Hi", 4500.0f, "bigger spacing");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "abcde", 1000.0f, "four spaces");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "abcde", 3500.0f, "four spaces, larger spacing");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "12345678", 5432.1f, "seven spaces, non-round spacing");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "12345678", 5432.1f, "seven spaces, non-round spacing, lots of kerning");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "Hi", -1000.0f, "negative spacing");
        TestCharacterSpacing(Shine, "default-ui", 32.0f, "abcde", -1000.0f, "negative spacing, 4 spaces");
        TestCharacterSpacing(Shine, "default-ui", 16.0f, "Hi", 1000.0f, "smaller font size, one space");
        TestCharacterSpacing(Shine, "default-ui", 16.0f, "abcdefghijk", 1000.0f, "smaller font size, ten spaces");
        TestCharacterSpacing(Shine, "default-ui", 16.0f, "abcdefghijk", 3500.0f, "smaller font size, ten spaces, larger spacing");
        TestCharacterSpacing(Shine, "default-ui", 64.0f, "Hi", 1000.0f, "larger font size, one space");
        TestCharacterSpacing(Shine, "default-ui", 64.0f, "abcdefgh", 1000.0f, "larger font size, seven spaces");
        TestCharacterSpacing(Shine, "default-ui", 64.0f, "abcdefgh", 5200.0f, "larger font size, seven spaces, larger spacing");
        TestCharacterSpacing(Shine, "default", 32.0f, "abcdefgh", 1000.0f, "default (monospace) font, seven spaces");
        TestCharacterSpacing(Shine, "notosans-regular", 32.0f, "WAW.AWA|WAW", 2500.0f, "noto sans font, 10 spaces, larger spacing");
        TestCharacterSpacing(Shine, "notosans-regular", 32.0f, "WAW.AWA|WAW", 25.0f, "noto sans font, 10 spaces, smaller spacing");
        TestCharacterSpacing(Shine, "notosans-regular", 32.0f, "WAW.AWA|WAW", -25.0f, "noto sans font, 10 spaces, smaller negative spacing");

        // Line Spacing

        TestLineSpacing(Shine, "default-ui", 32.0f, "Hi\nHello", 1, 5.0f, "one newline");
        TestLineSpacing(Shine, "default-ui", 32.0f, "1\n2\n3\n4\n5", 4, 5.0f, "four newlines");
    ...
    void ComponentGetSetTextTestsLoc(CShine* Shine)
    {
        if (AZStd::string("korean") == GetISystem()->GetLocalizationManager()->GetLanguage())
        {
            static const Shine::StringType koreanHello("\xEC\x95\x88\xEB\x85\x95\xED\x95\x98\xEC\x84\xB8\xEC\x9A\x94");
            ...
            // Tests: Get/SetText with localization and escaping markup
            {
                ...
                {
                    AZStd::string testString = Shine::StringType("&<>% ") + koreanHello;
                    AZStd::string resultString;
                    UiTextBus::EventResult(resultString, testElemId, &UiTextBus::Events::GetTextWithFlags, UiTextInterface::GetLocalized);
                    AZ_Assert(testString == resultString, "Test failed");
                    resultString.clear();
            ...
            // of each other..
            {
                ...
                // of the localization key.
                {
                    ...
                    testString = Shine::StringType("<font color=\"#FF0000\">") + koreanHello + "</font>";
                    AZStd::string resultString;
                    UiTextBus::EventResult(resultString, testElemId, &UiTextBus::Events::GetTextWithFlags, UiTextInterface::GetLocalized);
                    AZ_Assert(testString == resultString, "Test failed");
                }
    ...
    void MarkupFlagTest(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
...
void FontSharedPtrTests()
{
    ...
    // Basic font load and unload
    {
        ...
        const bool loadSuccess = font->Load("ui/fonts/ShineExamples/notosans/notosans-regular.font");
    ...
    // Font and font family case sensitivity checks
    {
        ...
        {
            const char* notoSansFontFamily = "ui/fonts/ShineExamples/notosans/notosans.fontfamily";
            ...
            // GetFontFamily case-sensitivity tests by filepath
            {
                ...
                const char* notoSansFontFamilyUpper = "UI/FONTS/ShineExamples/NOTOSANS/NOTOSANS.FONTFAMILY";
                const char* notoSansFontFamilyMixed1 = "ui/fonts/ShineExamples/notosans/Notosans.fontfamily";
                const char* notoSansFontFamilyMixed2 = "ui/fonts/ShineExamples/notosans/Notosans.Fontfamily";
                const char* notoSansFontFamilyMixed3 = "ui/fonts/ShineExamples/notosans/NotoSans.Fontfamily";
                const char* notoSansFontFamilyMixed4 = "ui/fonts/ShineExamples/notosans/notosans.FONTFAMILY";
                const char* notoSansFontFamilyMixed5 = "ui/fonts/ShineExamples/notosans/NOTOSANS.fontfamily";
                const char* notoSansFontFamilyMixed6 = "Ui/fonts/ShineExamples/notosans/notosans.fontfamily";
                const char* notoSansFontFamilyMixed7 = "ui/fonts/ShineExamples/Notosans/notosans.fontfamily";
    ...
    {
        const char* notoSansFontFamily = "ui/fonts/ShineExamples/notosans/notosans.fontfamily";
        const char* notoSansRegularPath = "ui/fonts/ShineExamples/notosans/notosans-regular.font";
        const char* notoSansItalicPath = "ui/fonts/ShineExamples/notosans/notosans-italic.font";
        const char* notoSansBoldPath = "ui/fonts/ShineExamples/notosans/notosans-bold.font";
        const char* notoSansBoldItalicPath = "ui/fonts/ShineExamples/notosans/notosans-bolditalic.font";
...
void UiTextComponent::UnitTest(CShine* Shine, IConsoleCmdArgs* cmdArgs)
{
    ...
    FontFamilyPtr notoSans = FontFamilyLoad("ui/fonts/ShineExamples/notosans/notosans.fontfamily");
    FontFamilyPtr notoSerif = FontFamilyLoad("ui/fonts/ShineExamples/notoserif/notoserif.fontfamily");

    NewlineSanitizeTests();
    BuildDrawBatchesTests(notoSans.get());
    WrapTextTests(notoSans.get());
    BatchLinesTests(notoSans.get());
    TrackingLeadingTests(Shine);
    ComponentGetSetTextTests(Shine);
    MarkupFlagTest(Shine);
}

void UiTextComponent::UnitTestLocalization(CShine* Shine, IConsoleCmdArgs* /* cmdArgs */)
{
    ...
    ComponentGetSetTextTestsLoc(Shine);
}
