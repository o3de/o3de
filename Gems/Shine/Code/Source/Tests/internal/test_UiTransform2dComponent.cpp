...
namespace
{
    ...
    AZ::EntityId CreateElementWithTransform2dComponent(UiCanvasInterface* canvas, const char* name) 
    {
        ...
        CreateComponent(testElem, Shine::UiTransform2dComponentUuid);
    ...
    void TestRotation(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        ...
        Shine->ReleaseCanvas(canvasEntityId, false);
    }
    
    // Test that the Scale modifying functions operate as intended
    void TestScale(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestScaleToDeviceMode(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestViewportSpaceTransforms(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestCanvasSpaceTransforms(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestCanvasSpaceNoScaleNoRot(CShine* Shine) 
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestLocalTransform(CShine* Shine) 
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    // Test for Local Transform Accessors
    void TestLocalInverseTransform(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestLocalPositioning(CShine* Shine) 
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestViewportPositioning(CShine* Shine) 
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestCanvasPositioning(CShine* Shine) 
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    // Test IsPointInRect
    void TestIsPointInRect(CShine* Shine) 
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestBoundsAreOverlappingRect(CShine* Shine) 
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestAnchorsPush(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    void TestAnchorsAdjustOffset(CShine* Shine) 
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
    ...
    // Test local size
    void TestLocalSizeParameters(CShine* Shine)
    {
        AZ::EntityId canvasEntityId = Shine->CreateCanvas();
        UiCanvasInterface* canvas = UiCanvasBus::FindFirstHandler(canvasEntityId);
        AZ_Assert(canvas, "Test failed");
...
void UiTransform2dComponent::UnitTest(CShine* Shine, IConsoleCmdArgs* /* cmdArgs */)
{
    // Helper function tests
    TestAABBLogic();
    ...
    TestScale(Shine);
    TestPivot(Shine);
    TestScaleToDeviceMode(Shine);
    TestViewportSpaceTransforms(Shine);
    TestCanvasSpaceTransforms(Shine);
    TestCanvasSpaceNoScaleNoRot(Shine);
    TestLocalTransform(Shine);
    TestLocalInverseTransform(Shine);
    TestLocalPositioning(Shine);
    TestViewportPositioning(Shine);
    TestCanvasPositioning(Shine);
    TestIsPointInRect(Shine);
    TestBoundsAreOverlappingRect(Shine);

    // UiTransform2dBus tests
    TestAnchorsPush(Shine);
    TestAnchorsAdjustOffset(Shine);
    TestOffsets(Shine);
    TestLocalSizeParameters(Shine);
}
