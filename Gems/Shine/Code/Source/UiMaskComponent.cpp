...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiMaskComponent::Render(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
...
bool UiMaskComponent::IsPointMasked(AZ::Vector2 point)
{
    ...
    if (m_maskInteraction)
    {
        ...
        if (m_childMaskElement.IsValid())
        {
            ...
            Shine::EntityArray childMaskElements;
            UiElementBus::Event(
                m_childMaskElement,
...
void UiMaskComponent::DestroyRenderTarget()
{
    if (!m_contentAttachmentImageId.IsEmpty())
    {
        ...
        Shine::RenderToTextureRequestBus::Event(
            canvasEntityId, &Shine::RenderToTextureRequestBus::Events::ReleaseRenderTarget, m_contentAttachmentImageId);
    ...
    if (!m_maskAttachmentImageId.IsEmpty())
    {
        ...
        UiElementBus::EventResult(canvasEntityId, GetEntityId(), &UiElementBus::Events::GetCanvasEntityId);
        Shine::RenderToTextureRequestBus::Event(
            canvasEntityId, &Shine::RenderToTextureRequestBus::Events::ReleaseRenderTarget, m_maskAttachmentImageId);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiMaskComponent::RenderUsingStencilMask(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiMaskComponent::RenderUsingGradientMask(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
    UiRenderInterface* renderInterface, UiElementInterface* childMaskElementInterface, int numChildren, bool isInGame)
{
    ...
    UiElementBus::EventResult(canvasEntityId, GetEntityId(), &UiElementBus::Events::GetCanvasEntityId);
    Shine::RenderToTextureRequestBus::EventResult(
        contentAttachmentImage, canvasEntityId, &Shine::RenderToTextureRequestBus::Events::GetRenderTarget, m_contentAttachmentImageId);
    Shine::RenderToTextureRequestBus::EventResult(
        maskAttachmentImage, canvasEntityId, &Shine::RenderToTextureRequestBus::Events::GetRenderTarget, m_maskAttachmentImageId);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiMaskComponent::RenderDisabledMask(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
    UiRenderInterface* renderInterface, UiElementInterface* childMaskElementInterface, int numChildren, bool isInGame)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiMaskComponent::RenderDisabledMaskWithDoubleRender(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiMaskComponent::RenderMaskPrimitives(Shine::IRenderGraph* renderGraph,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiMaskComponent::RenderContentPrimitives(Shine::IRenderGraph* renderGraph,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool UiMaskComponent::ValidateMaskConfiguration(const Shine::IRenderGraph* renderGraph)
{
