...
public: // member functions
    ...
    AZ_COMPONENT(UiImageComponent, Shine::UiImageComponentUuid, AZ::Component);
    ...
    // UiRenderInterface
    void Render(Shine::IRenderGraph* renderGraph) override;
    // ~UiRenderInterface
...
private: // member functions
    ...
    void ClipAndRenderForSlicedRadialFill(uint32 numVertsPerside, uint32 numVerts, const Shine::UiPrimitiveVertex* verts, uint32 totalIndices, const uint16* indices);
    void ClipAndRenderForSlicedRadialCornerOrEdgeFill(uint32 numVertsPerside, uint32 numVerts, const Shine::UiPrimitiveVertex* verts, uint32 totalIndices, const uint16* indices);

    int ClipToLine(const Shine::UiPrimitiveVertex* vertices, const uint16* indices, Shine::UiPrimitiveVertex* newVertex, uint16* renderIndices, int& vertexOffset, int idxOffset, const Vec2& lineOrigin, const Vec2& lineEnd);

    void RenderTriangleList(const Shine::UiPrimitiveVertex* vertices, const uint16* indices, int numVertices, int numIndices);
    ...
    Shine::AZu32ComboBoxVec PopulateIndexStringList() const;
...
private: // data
    ...
    Shine::BlendMode m_blendMode      = Shine::BlendMode::Normal;
    ...
    Shine::UiPrimitive m_cachedPrimitive;
