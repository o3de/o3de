...
public: // member functions
    ...
    const Shine::ActionName& GetHoverStartActionName() override;
    void SetHoverStartActionName(const Shine::ActionName& actionName) override;
    const Shine::ActionName& GetHoverEndActionName() override;
    void SetHoverEndActionName(const Shine::ActionName& actionName) override;
    const Shine::ActionName& GetPressedActionName() override;
    void SetPressedActionName(const Shine::ActionName& actionName) override;
    const Shine::ActionName& GetReleasedActionName() override;
    void SetReleasedActionName(const Shine::ActionName& actionName) override;
    const Shine::ActionName& GetOutsideReleasedActionName() const override;
    void SetOutsideReleasedActionName(const Shine::ActionName& actionName) override;
...
protected: // data members
    ...
    Shine::ActionName m_hoverStartActionName;

    //! Action triggered on hover end
    Shine::ActionName m_hoverEndActionName;

    //! Action triggered on pressed
    Shine::ActionName m_pressedActionName;

    //! Action triggered on release
    Shine::ActionName m_releasedActionName;

    //! Action triggered on release outside
    Shine::ActionName m_outsideReleasedActionName;
...
private: // static member functions
    ...
    static Shine::EntityArray GetNavigableInteractables(AZ::EntityId sourceEntity);
