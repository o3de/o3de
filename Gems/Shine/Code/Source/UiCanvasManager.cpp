...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiCanvasManager::GetRenderTargets(Shine::AttachmentImagesAndDependencies& attachmentImagesAndDependencies)
{
    for (auto canvas : m_loadedCanvases)
    {
...
void UiCanvasManager::OnCatalogAssetChanged(const AZ::Data::AssetId& assetId)
{
    ...
    if (assetInfo.m_assetType != Shine::CanvasAsset::TYPEINFO_Uuid())
    {
...
AZ::EntityId UiCanvasManager::ReloadCanvasFromXml(const AZStd::string& xmlString, UiEntityContext* entityContext)
{
    ...
    if (newCanvasEntity)
    {
        ...
        {
            Shine::CanvasId oldCanvasId = oldCanvasComponent->GetCanvasId();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId UiCanvasManager::FindCanvasById(Shine::CanvasId id)
{
    // this is only used for finding canvases loaded in game
    for (auto canvas : m_loadedCanvases)
    {
...
bool UiCanvasManager::HandleInputEventForInWorldCanvases(const AzFramework::InputChannel::Snapshot& inputSnapshot, const AZ::Vector2& viewportPos)
{
    ...
    auto viewportContext = Shine->GetUiRenderer()->GetViewportContext();
    ...
    // Shine system to say how ray input should be handled.
...
void UiCanvasManager::DebugDisplayDrawCallData() const
{
    ...
    for (auto canvas : m_loadedCanvases)
    {
        ...
        // Num elements
        ShineDebug::DebugInfoRenderGraph info;
...
{
    AZStd::string logFolder = AZStd::string::format("@log@/Shine");
    ...
    ShineDebug::DebugInfoDrawCallReport reportInfo;
    ...
    for (auto canvas : m_loadedCanvases)
    {
        ...
        ShineDebug::DebugInfoRenderGraph renderGraphInfo;
    ...
    for (ShineDebug::DebugInfoTextureUsage& reportTextureUsage : reportInfo.m_textures)
    {
