...
//! \brief Simple utility class for Shine functionality in Lua.
//!
...
namespace AZ
{
    AZ_TYPE_INFO_SPECIALIZE(ShineLua, "{2570D3B3-2D18-4DB1-A0DE-E017A2F491D1}");
}

// This is the memory allocation for the static data member used for the debug console variables
#ifndef _RELEASE
AllocateConstIntCVar(CShine, CV_ui_DisplayTextureData);
AllocateConstIntCVar(CShine, CV_ui_DisplayCanvasData);
AllocateConstIntCVar(CShine, CV_ui_DisplayDrawCallData);
AllocateConstIntCVar(CShine, CV_ui_DisplayElemBounds);
AllocateConstIntCVar(CShine, CV_ui_DisplayElemBoundsCanvasIndex);
#endif

#if defined(SHINE_INTERNAL_UNIT_TEST)
AllocateConstIntCVar(CShine, CV_ui_RunUnitTestsOnStartup);
#endif
    ...
    , m_uiCursorVisibleCounter(0)
{
    ...
    // This support will be removed at some point
    {
        ...
        if (behaviorContext)
        {
            behaviorContext->Class<ShineLua>("ShineLua")
                ->Attribute(AZ::Script::Attributes::ExcludeFrom, AZ::Script::Attributes::ExcludeFlags::All)
                ->Attribute(AZ::Script::Attributes::Storage, AZ::Script::Attributes::StorageType::Value)
                ->Method("ShowMouseCursor", &ShineLua::ShowMouseCursor)
            ;
    ...
    DefineConstIntCVar3("ui_RunUnitTestsOnStartup", CV_ui_RunUnitTestsOnStartup, 0, VF_CHEAT,
        "0=off, 1=run Shine unit tests on startup");
...
////////////////////////////////////////////////////////////////////////////////////////////////////
IDraw2d* CShine::GetDraw2d()
{
    return m_draw2d.get();
}

////////////////////////////////////////////////////////////////////////////////////////////////////
UiRenderer* CShine::GetUiRenderer()
{
    return m_uiRenderer.get();
}

////////////////////////////////////////////////////////////////////////////////////////////////////
UiRenderer* CShine::GetUiRendererForEditor()
{
    return m_uiRendererForEditor.get();
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::SetUiRendererForEditor(AZStd::shared_ptr<UiRenderer> uiRenderer)
{
    m_uiRendererForEditor = uiRenderer;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId CShine::CreateCanvas()
{
    return m_uiCanvasManager->CreateCanvas();
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId CShine::LoadCanvas(const AZStd::string& assetIdPathname)
{
    return m_uiCanvasManager->LoadCanvas(assetIdPathname.c_str());
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId CShine::CreateCanvasInEditor(UiEntityContext* entityContext)
{
    return m_uiCanvasManager->CreateCanvasInEditor(entityContext);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId CShine::LoadCanvasInEditor(const AZStd::string& assetIdPathname, const AZStd::string& sourceAssetPathname, UiEntityContext* entityContext)
{
    return m_uiCanvasManager->LoadCanvasInEditor(assetIdPathname, sourceAssetPathname, entityContext);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId CShine::ReloadCanvasFromXml(const AZStd::string& xmlString, UiEntityContext* entityContext)
{
    return m_uiCanvasManager->ReloadCanvasFromXml(xmlString, entityContext);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId CShine::FindCanvasById(Shine::CanvasId id)
{
    return m_uiCanvasManager->FindCanvasById(id);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId CShine::FindLoadedCanvasByPathName(const AZStd::string& assetIdPathname)
{
    return m_uiCanvasManager->FindLoadedCanvasByPathName(assetIdPathname.c_str());
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::ReleaseCanvas(AZ::EntityId canvas, bool forEditor)
{
    m_uiCanvasManager->ReleaseCanvas(canvas, forEditor);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::ReleaseCanvasDeferred(AZ::EntityId canvas)
{
    m_uiCanvasManager->ReleaseCanvasDeferred(canvas);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
ISprite* CShine::LoadSprite(const AZStd::string& pathname)
{
    return CSprite::LoadSprite(pathname);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
ISprite* CShine::CreateSprite(const AZ::Data::Asset<AZ::RPI::AttachmentImageAsset>& attachmentImageAsset)
{
    return CSprite::CreateSprite(attachmentImageAsset);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
bool CShine::DoesSpriteTextureAssetExist(const AZStd::string& pathname)
{
    return CSprite::DoesSpriteTextureAssetExist(pathname);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Data::Instance<AZ::RPI::Image> CShine::LoadTexture(const AZStd::string& pathname)
{
    return CDraw2d::LoadTexture(pathname);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::PostInit()
{
#if defined(SHINE_INTERNAL_UNIT_TEST)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::SetViewportSize(AZ::Vector2 viewportSize)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::Update(float deltaTimeInSeconds)
{
    ...
    // canvas size for full screen UI canvases. It needs to be set before either Shine->Update or
    // Shine->Render are called. It must match the viewport size that the input system is using.
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::ExecuteQueuedEvents()
{
    // Execute events that have been queued during the canvas update
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::OnLoadScreenUnloaded()
{
    m_uiCanvasManager->OnLoadScreenUnloaded();
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::IncrementVisibleCounter()
{
    ++m_uiCursorVisibleCounter;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::DecrementVisibleCounter()
{
    --m_uiCursorVisibleCounter;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
bool CShine::IsUiCursorVisible()
{
    return m_uiCursorVisibleCounter > 0;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::SetUiCursor(const char* cursorImagePath)
{
    ...
    if (cursorImagePath && *cursorImagePath)
    {
        ...
        // Note: this check could be avoided if ShineSystemComponent included the RPISystem
        // as a required service. However, ShineSystempComponent is currently activated for
        // tools as well as game and RPIService is not available with all tools such as AP. An
        // enhancement would be to break ShineSystemComponent into a  game only component
        if (m_uiRenderer->IsReady())
        {
            LoadUiCursor();
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Vector2 CShine::GetUiCursorPosition()
{
...
void CShine::SetUiCursorPosition(const AZ::Vector2& positionNormalized)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool CShine::OnInputChannelEventFiltered(const AzFramework::InputChannel& inputChannel)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool CShine::OnInputTextEventFiltered(const AZStd::string& textUTF8)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::OnTick(float deltaTime, [[maybe_unused]] AZ::ScriptTimePoint time)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
int CShine::GetTickOrder()
{
    return AZ::TICK_PRE_RENDER;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::OnRenderTick()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::OnBootstrapSceneReady(AZ::RPI::Scene* bootstrapScene)
{
    // Load cursor if its path was set before RPI was initialized
    LoadUiCursor();

    ShinePassDataRequestBus::Handler::BusConnect(bootstrapScene->GetId());
}

////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::AttachmentImagesAndDependencies CShine::GetRenderTargets()
{
...
#ifndef _RELEASE
////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::DebugReportDrawCalls(IConsoleCmdArgs* cmdArgs)
{
    if (AZ::Interface<IShine>::Get())
    {
        // We want to use an internal-only non-static function so downcast to CShine
        ...
        Shine->m_uiCanvasManager->DebugReportDrawCalls(name);
    }
}
#endif
...
#if defined(SHINE_INTERNAL_UNIT_TEST)
////////////////////////////////////////////////////////////////////////////////////////////////////
void CShine::RunUnitTests(IConsoleCmdArgs* cmdArgs)
{
    ...
    CShine* Shine = static_cast<CShine*>(AZ::Interface<IShine>::Get());
    AZ_Assert(Shine, "Attempting to run unit-tests prior to Shine initialization!");

    TextMarkup::UnitTest(cmdArgs);
    UiTextComponent::UnitTest(Shine, cmdArgs);
    UiTextComponent::UnitTestLocalization(Shine, cmdArgs);
    UiTransform2dComponent::UnitTest(Shine, cmdArgs);
    UiMarkupButtonComponent::UnitTest(Shine, cmdArgs);
}
#endif
