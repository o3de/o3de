...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::AZu32ComboBoxVec UiFlipbookAnimationComponent::PopulateIndexStringList() const
{
    AZ::u32 numFrames = GetMaxFrame();
    if (numFrames > 0)
    {
        return Shine::GetEnumSpriteIndexList(GetEntityId(), 0, numFrames - 1);
    }
    
    // Add an empty element to prevent an AzToolsFramework warning that fires
    // when an empty container is encountered.
    Shine::AZu32ComboBoxVec comboBoxVec;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::AZu32ComboBoxVec UiFlipbookAnimationComponent::PopulateConstrainedIndexStringList() const
{
    ...
    return Shine::GetEnumSpriteIndexList(GetEntityId(), m_startFrame, m_endFrame, errorMessage);
}
