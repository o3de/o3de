...
void CDraw2d::OnBootstrapSceneReady(AZ::RPI::Scene* bootstrapScene)
{
    ...
    ShinePassRequestBus::EventResult(uiCanvasPass, sceneId, &ShinePassRequestBus::Events::GetUiCanvasPass);
    ...
    // Use scene as output scope (will render to the UiCanvas child pass of the Shine pass)
