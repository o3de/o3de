...
public: // member functions
    ...
    AZ_COMPONENT(UiDropTargetComponent, Shine::UiDropTargetComponentUuid, AZ::Component);

    UiDropTargetComponent();
    ~UiDropTargetComponent() override;

    // UiDropTargetInterface
    const Shine::ActionName& GetOnDropActionName() override;
    void SetOnDropActionName(const Shine::ActionName& actionName) override;
...
private: // static member functions
    ...
    static Shine::EntityArray GetNavigableDropTargets(AZ::EntityId sourceEntity);
...
private: // data
    ...
    Shine::ActionName m_onDropActionName;
