...
public: // member functions
    ...
    //! Constructor, constructed by the Shine class
    UiCanvasManager();
...
public: // member functions
    ...
    AZ::EntityId FindCanvasById(Shine::CanvasId id);
    ...
    void GetRenderTargets(Shine::AttachmentImagesAndDependencies& attachmentImagesAndDependencies);
