...
public: // member functions
    ...
    AZ_COMPONENT(UiMaskComponent, Shine::UiMaskComponentUuid, AZ::Component);

    UiMaskComponent();
    ~UiMaskComponent() override;

    // UiRenderControlInterface
    void Render(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
...
private: // member functions
    ...
    void RenderUsingStencilMask(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
    ...
    void RenderUsingGradientMask(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
        UiRenderInterface* renderInterface, UiElementInterface* childMaskElementInterface, int numChildren, bool isInGame);

    // render a disabled mask (in case where we don't have both draw behind and draw in front enabled)
    void RenderDisabledMask(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
        UiRenderInterface* renderInterface, UiElementInterface* childMaskElementInterface, int numChildren, bool isInGame);

    // render a disabled mask (in case where we do have both draw behind and draw in front enabled
    void RenderDisabledMaskWithDoubleRender(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
        UiRenderInterface* renderInterface, UiElementInterface* childMaskElementInterface, int numChildren, bool isInGame);

    // render this element's component and the child mask element
    void RenderMaskPrimitives(Shine::IRenderGraph* renderGraph,
    ...
    void RenderContentPrimitives(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
    ...
    bool ValidateMaskConfiguration(const Shine::IRenderGraph* renderGraph);
