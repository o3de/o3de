...
namespace Shine
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void PrimitiveListRenderNode::AddPrimitive(Shine::UiPrimitive* primitive)
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    Shine::UiPrimitiveList& PrimitiveListRenderNode::GetPrimitives() const
    {
        return const_cast<Shine::UiPrimitiveList&>(m_primitives);
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    bool PrimitiveListRenderNode::HasSpaceToAddPrimitive(Shine::UiPrimitive* primitive) const
    {
    ...
    void PrimitiveListRenderNode::ValidateNode()
    {
        ...
        size_t primCount = 0;
        const Shine::UiPrimitive* lastPrim = nullptr;
        int highestTexUnit = 0;
        for (const Shine::UiPrimitive& primitive : m_primitives)
        {
        ...
        if (system && !gEnv->IsDedicated())
        {
            ...
            else
            {
                AZ_WarningOnce("UI", false, "Failed to create a Dynamic Draw Context for UI Element's render target. "\
                    "Please ensure that the custom ShinePass has been added to the project's main render pipeline.");
            }
        }
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void RenderGraph::AddPrimitive(Shine::UiPrimitive* primitive, const AZ::Data::Instance<AZ::RPI::Image>& texture,
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void RenderGraph::AddAlphaMaskPrimitive(Shine::UiPrimitive* primitive,
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    Shine::UiPrimitive* RenderGraph::GetDynamicQuadPrimitive(const AZ::Vector2* positions, uint32 packedColor)
    {
    ...
    void RenderGraph::Render(UiRenderer* uiRenderer, [[maybe_unused]] const AZ::Vector2& viewportSize)
    {
        ...
        dynamicDraw->SetStencilState(uiRenderer->GetBaseState().m_stencilState);
        AZ::RHI::TargetBlendState defaultBlendModeState = GetBlendModeState(Shine::BlendMode::Normal, false);
        ...
        // SHINE_ATOM_TODO - It is currently necessary to render to the targets twice. Needs investigation
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void RenderGraph::GetRenderTargetsAndDependencies(Shine::AttachmentImagesAndDependencies& attachmentImagesAndDependencies)
    {
        for (RenderNode* renderNode : m_renderTargetRenderNodes)
        {
            ...
            {
                Shine::AttachmentImages attachmentImages;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void RenderGraph::GetDebugInfoRenderGraph(ShineDebug::DebugInfoRenderGraph& info) const
    {
        ...
        AZStd::set<AZ::Data::Instance<AZ::RPI::Image>>& uniqueTextures) const
    {
        ...
        for (const RenderNode* renderNode : renderNodeList)
        {
            ...
            else if (renderNode->GetType() == RenderNodeType::PrimitiveList)
            {
                ...
                Shine::UiPrimitiveList& primitives = primListRenderNode->GetPrimitives();
                info.m_numPrimitives += static_cast<int>(primitives.size());
                {
                    for (const Shine::UiPrimitive& primitive : primitives)
                    {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void RenderGraph::DebugReportDrawCalls(AZ::IO::HandleType fileHandle, ShineDebug::DebugInfoDrawCallReport& reportInfo, void* context) const
    {
            ...
            else if (renderNode->GetType() == RenderNodeType::PrimitiveList)
            {
                ...
                if (nodeExistsBecauseOfExceedingMaxTextures)
                {
                    if (!previousNodeAlreadyCounted)
                    {
                        for (int i = 0; i < prevPrimListNode->GetNumTextures(); ++i)
                        {
                            ...
                            ShineDebug::DebugInfoTextureUsage* matchingTextureUsage = nullptr;
                ...
                for (int i = 0; i < primListRenderNode->GetNumTextures(); ++i)
                {
                    ...
                    if (!matchingTextureUsage)
                    {
                        ...
                        ShineDebug::DebugInfoTextureUsage newTextureUsage;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    AZ::RHI::TargetBlendState RenderGraph::GetBlendModeState(Shine::BlendMode blendMode, [[maybe_unused]] bool isShaderOutputPremultAlpha) const
    {
        // SHINE_ATOM_TODO - remove "premultiplyAlpha" parameter and clean up related comments as I think it's no longer needed
        ...
        // fully opaque.
        // If the blend mode is Shine::BlendMode::Normal and we just use GS_BLSRC_SRCALPHA | GS_BLDST_ONEMINUSSRCALPHA
        ...
        //
        // For blend modes other than Shine::BlendMode::Normal we make similar adjustments. This works well for
        // Shine::BlendMode::Add. For the other three blend modes we cannot get the same results - but the results
    ...
    void RenderGraph::SetRttPassesEnabled(UiRenderer* uiRenderer, bool enabled)
    {
        ...
        for (RenderTargetRenderNode* renderTargetRenderNode : m_renderTargetRenderNodes)
        {
            ...
            ShinePassRequestBus::EventResult(rttPass, sceneId, &ShinePassRequestBus::Events::GetRttPass, renderTargetRenderNode->GetRenderTargetName());
            if (rttPass)
            {
