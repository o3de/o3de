    ...
    AZ::SerializeContext::DataElementNode& canvasEntityNode)
{
    ...
    AZ::SerializeContext::DataElementNode* canvasComponentNode =
        Shine::FindComponentNode(canvasEntityNode, UiCanvasComponent::TYPEINFO_Uuid());
    ...
    AZStd::vector<AZ::SerializeContext::DataElementNode>& copiedEntities)
{
    ...
    if (!Shine::CreateEntityIdNode(context, entityNode))
    {
        return false;
    }
    ...
    if (!Shine::CreateComponentBaseClassNode(context, sliceComponentNode))
    {
        return false;
    }
