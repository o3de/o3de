...
public: // types
    ...
    typedef Shine::EntityIdMap EntityIdMap;
...
public: // member functions
    ...
    void RenderElement(Shine::IRenderGraph* renderGraph, bool isInGame) override;

    Shine::ElementId GetElementId() override;
    Shine::NameType GetName() override;
    ...
    Shine::EntityArray FindAllChildrenIntersectingRect(const AZ::Vector2& bound0, const AZ::Vector2& bound1, bool isInGame) override;
    ...
    AZ::Entity* FindChildByName(const Shine::NameType& name) override;
    AZ::Entity* FindDescendantByName(const Shine::NameType& name) override;
    AZ::EntityId FindChildEntityIdByName(const Shine::NameType& name) override;
    AZ::EntityId FindDescendantEntityIdByName(const Shine::NameType& name) override;
    AZ::Entity* FindChildByEntityId(AZ::EntityId id) override;
    AZ::Entity* FindDescendantById(Shine::ElementId id) override;
    void FindDescendantElements(AZStd::function<bool(const AZ::Entity*)> predicate, Shine::EntityArray& result) override;
    ...
    void SetCanvas(UiCanvasComponent* canvas, Shine::ElementId elementId);
