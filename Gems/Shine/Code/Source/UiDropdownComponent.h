...
public: // member functions
    ...
    AZ_COMPONENT(UiDropdownComponent, Shine::UiDropdownComponentUuid, AZ::Component);
    ...
    const Shine::ActionName& GetExpandedActionName() override;
    void SetExpandedActionName(const Shine::ActionName& actionName) override;
    const Shine::ActionName& GetCollapsedActionName() override;
    void SetCollapsedActionName(const Shine::ActionName& actionName) override;
    const Shine::ActionName& GetOptionSelectedActionName() override;
    void SetOptionSelectedActionName(const Shine::ActionName& actionName) override;
    // ~UiDropdownInterface
...
private: // data
    ...
    Shine::ActionName m_expandedActionName;
    Shine::ActionName m_collapsedActionName;
    Shine::ActionName m_optionSelectedActionName;

    bool m_expanded;
    AZ::EntityId m_canvasEntityId;
    float m_delayTimer;
    AZ::EntityId m_baseParent;
    Shine::EntityArray m_submenus;
