...
////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiDropdownComponent::GetExpandedActionName()
{
    return m_expandedActionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiDropdownComponent::SetExpandedActionName(const Shine::ActionName& actionName)
{
    m_expandedActionName = actionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiDropdownComponent::GetCollapsedActionName()
{
    return m_collapsedActionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiDropdownComponent::SetCollapsedActionName(const Shine::ActionName& actionName)
{
    m_collapsedActionName = actionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiDropdownComponent::GetOptionSelectedActionName()
{
    return m_optionSelectedActionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiDropdownComponent::SetOptionSelectedActionName(const Shine::ActionName& actionName)
{
...
AZ::EntityId UiDropdownComponent::CreateContentParentInteractable()
{
    ...
    if (button)
    {
        ...
        button->Deactivate();
        button->CreateComponent(Shine::UiTransform2dComponentUuid);
        button->CreateComponent(Shine::UiButtonComponentUuid);
        button->Activate();
