...
public: // member functions
    ...
    AZ_COMPONENT(UiTextComponent, Shine::UiTextComponentUuid, AZ::Component);
    ...
    Shine::PathnameType GetFont() override;
    void SetFont(const Shine::PathnameType& fontPath) override;
...
#if defined(SHINE_INTERNAL_UNIT_TEST)
    static void UnitTest(CShine* Shine, IConsoleCmdArgs* cmdArgs);
    static void UnitTestLocalization(CShine* Shine, IConsoleCmdArgs* cmdArgs);
#endif
...
private: // data
    ...
    AzFramework::SimpleAssetReference<Shine::FontAsset> m_fontFilename;
    IFFont* m_font;
