...
public: // member functions
    ...
    AZ_COMPONENT(UiTransform2dComponent, Shine::UiTransform2dComponentUuid, AZ::Component);
...
protected: // member functions
    ...
    //! element's scale to device mode
    Shine::EntityArray GetDescendantsWithSameDimensionScaleToDevice(ScaleToDeviceMode scaleToDeviceMode) const;
