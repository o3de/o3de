    ...
    int GetCharArrayIndexFromUtf8CharIndex(const AZStd::string& utf8String, const uint utf8Index)
    {
        ...
        if (stringLength > 0 && stringLength >= utf8Index)
        {
            ...
            while (uint32_t ch = *pChar)
            {
                ...
                rawIndex += Shine::GetMultiByteCharSize(ch);
...
bool UiTextInputComponent::HandleEnterPressed(bool& shouldStayActive)
{
    ...
    if (handled)
    {
        ...
        // select all the text
        m_textCursorPos = 0;
        m_textSelectionStartPos = Shine::GetUtf8StringLength(textString);
    }
...
bool UiTextInputComponent::HandleAutoActivation()
{
    ...
    AZStd::string textString;
    UiTextBus::EventResult(textString, m_textEntity, &UiTextBus::Events::GetText);
    m_textCursorPos = Shine::GetUtf8StringLength(textString);
    m_textSelectionStartPos = m_textCursorPos;
...
bool UiTextInputComponent::HandleKeyInputBegan(const AzFramework::InputChannel::Snapshot& inputSnapshot, AzFramework::ModifierKeyMask activeModifierKeys)
{
    ...
    else if (inputSnapshot.m_channelId == AzFramework::InputDeviceKeyboard::Key::NavigationDelete)
    {
        ...
        if (m_textCursorPos < Shine::GetUtf8StringLength(textString) || m_textCursorPos != m_textSelectionStartPos)
        {
            if (m_textCursorPos != m_textSelectionStartPos)
            {
                // range is selected
    ...
    else if (command == UiNavigationHelpers::Command::Left || command == UiNavigationHelpers::Command::Right)
    {
        if (m_textCursorPos != m_textSelectionStartPos)
        {
            ...
            if (isShiftModifierActive)
            {
                ...
                {
                    if (m_textCursorPos < Shine::GetUtf8StringLength(textString))
                    {
                        ++m_textCursorPos;
                    }
                }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiTextInputComponent::GetChangeAction()
{
    return m_changeAction;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiTextInputComponent::SetChangeAction(const Shine::ActionName& actionName)
{
    m_changeAction = actionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiTextInputComponent::GetEndEditAction()
{
    return m_endEditAction;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiTextInputComponent::SetEndEditAction(const Shine::ActionName& actionName)
{
    m_endEditAction = actionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiTextInputComponent::GetEnterAction()
{
    return m_enterAction;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiTextInputComponent::SetEnterAction(const Shine::ActionName& actionName)
{
...
void UiTextInputComponent::SetText(const AZStd::string& text)
{
    ...
    if (m_textCursorPos >= 0)
    {
        int maxPos = Shine::GetUtf8StringLength(text);
    ...
    if (m_isPasswordField)
    {
        ...
        UiTextBus::Event(
            ...
            [this](const AZStd::string& originalText)
            {
                ...
                int numReplacementChars = Shine::GetUtf8StringLength(originalText);
    ...
    AZ::SerializeContext::DataElementNode& classElement)
{
    ...
    {
        if (!Shine::ConvertSubElementFromColorFToAzColor(context, classElement, "TextSelectionColor"))
        {
            return false;
        }

        if (!Shine::ConvertSubElementFromColorFToAzColor(context, classElement, "TextCursorColor"))
        {
            return false;
        }
    }
    ...
    {
        if (!Shine::ConvertSubElementFromCharToUInt32(context, classElement, "ReplacementCharacter"))
        {
            return false;
        }
    }
