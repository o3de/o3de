...
public: // member functions
    ...
    AZ_COMPONENT(UiDraggableComponent, Shine::UiDraggableComponentUuid, UiInteractableComponent);
...
private: // member functions
    ...
    void FindNavigableDropTargetElements(AZ::EntityId ignoreElement, Shine::EntityArray& result);
