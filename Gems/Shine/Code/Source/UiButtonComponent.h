...
public: // member functions
    ...
    AZ_COMPONENT(UiButtonComponent, Shine::UiButtonComponentUuid, UiInteractableComponent);
    ...
    const Shine::ActionName& GetOnClickActionName() override;
    void SetOnClickActionName(const Shine::ActionName& actionName) override;
    // ~UiButtonInterface
