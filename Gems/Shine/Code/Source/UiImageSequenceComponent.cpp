...
namespace
{
    ...
    void PopulateSpriteListFromImageList(UiImageSequenceComponent::SpriteList& spriteList, UiImageSequenceComponent::ImageList& imageList)
    {
        ...
        {
            ISprite* sprite = AZ::Interface<IShine>::Get()->LoadSprite(textureAssetRef.GetAssetPath().c_str());
            if (sprite)
            {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiImageSequenceComponent::Render(Shine::IRenderGraph* renderGraph)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::AZu32ComboBoxVec UiImageSequenceComponent::PopulateIndexStringList()
{
    const AZ::u32 indexCount = GetImageIndexCount();
    return Shine::GetEnumSpriteIndexList(GetEntityId(), 0, indexCount - 1);
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiImageSequenceComponent::RenderTriangleList(const Shine::UiPrimitiveVertex* vertices, const uint16* indices, int numVertices, int numIndices)
{
