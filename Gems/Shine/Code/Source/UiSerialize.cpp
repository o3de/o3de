...
namespace UiSerialize
{
    ...
    void ReflectUiTypes(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
                ...
                [](AZ::SerializeContext& context, AZ::SerializeContext::DataElementNode& rootElement)
            {
                ...
                rootElement.Convert<AzFramework::SimpleAssetReference<Shine::FontAsset>>(context);
            ...
            AzFramework::SimpleAssetReference<Shine::FontAsset>::Register(*serializeContext);
            AzFramework::SimpleAssetReference<Shine::CanvasAsset>::Register(*serializeContext);
        ...
        const char* spriteElementName)
    {
...

        {
            ...
            if (!Shine::MoveElement(context, srcClassElement, colorNode, colorElementName, "Color"))
            {
                return false;
            }

            {
                ...
                if (!Shine::ConvertSubElementFromVector3ToAzColor(context, dstColorNode, "Color"))
                {
                    return false;
                }
            }
...

        {
            ...
            if (!Shine::MoveElement(context, srcClassElement, alphaNode, alphaElementName, "Alpha"))
            {
                return false;
            }
        }

        {
            ...
            if (!Shine::MoveElement(context, srcClassElement, spriteNode, spriteElementName, "Sprite"))
            {
                return false;
            }
        }
