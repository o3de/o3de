...
////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiScrollBoxComponent::GetScrollOffsetChangingActionName()
{
    return m_scrollOffsetChangingActionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiScrollBoxComponent::SetScrollOffsetChangingActionName(const Shine::ActionName& actionName)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiScrollBoxComponent::GetScrollOffsetChangedActionName()
{
    return m_scrollOffsetChangedActionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiScrollBoxComponent::SetScrollOffsetChangedActionName(const Shine::ActionName& actionName)
{
...
UiScrollBoxComponent::EntityComboBoxVec UiScrollBoxComponent::PopulateChildEntityList()
{
    ...
    Shine::EntityArray matchingElements;
    UiElementBus::Event(
        GetEntityId(),
...
UiScrollBoxComponent::EntityComboBoxVec UiScrollBoxComponent::PopulateScrollBarEntityList(UiScrollerInterface::Orientation orientation)
{
    ...
    Shine::EntityArray scrollBarElements;
    UiCanvasBus::Event(
        canvasEntityId,
    ...
    AZ::SerializeContext::DataElementNode& classElement)
{
    ...
    {
        if (!Shine::ConvertSubElementFromAzStringToAssetRef<LmbrCentral::TextureAsset>(context, classElement, "SelectedSprite"))
        {
            return false;
        }

        if (!Shine::ConvertSubElementFromAzStringToAssetRef<LmbrCentral::TextureAsset>(context, classElement, "DisabledSprite"))
        {
            return false;
        }
    }
    ...
    {
        if (!Shine::ConvertSubElementFromVec2ToVector2(context, classElement, "ScrollOffset"))
        {
            return false;
        }

        if (!Shine::ConvertSubElementFromVec2ToVector2(context, classElement, "SnapGrid"))
        {
            return false;
        }
    }
