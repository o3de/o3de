...
////////////////////////////////////////////////////////////////////////////////////////////////////
const Shine::ActionName& UiButtonComponent::GetOnClickActionName()
{
    return m_actionName;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiButtonComponent::SetOnClickActionName(const Shine::ActionName& actionName)
{
    ...
    AZ::SerializeContext::DataElementNode& classElement)
{
    ...
    if (classElement.GetVersion() < 4)
    {
        ...
        if (!Shine::ConvertSubElementFromAzStringToAssetRef<LmbrCentral::TextureAsset>(context, classElement, "PressedSprite"))
        {
            return false;
        }
