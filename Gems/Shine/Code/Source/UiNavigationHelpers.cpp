...
namespace UiNavigationHelpers
{
    ...
    AZ::EntityId GetNextElement(AZ::EntityId curEntityId, Command command,
        const Shine::EntityArray& navigableElements, AZ::EntityId defaultEntityId,
    ...
    AZ::EntityId SearchForNextElement(AZ::EntityId curElement, Command command,
        const Shine::EntityArray& navigableElements, AZ::EntityId parentElement)
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void FindNavigableInteractables(AZ::EntityId parentElement, AZ::EntityId ignoreElement, Shine::EntityArray& result)
    {
