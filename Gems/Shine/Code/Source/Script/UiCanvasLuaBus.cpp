...
AZ::EntityId UiCanvasLuaProxy::FindElementById(Shine::ElementId id)
{
...
AZ::EntityId UiCanvasLuaProxy::FindElementByName(const Shine::NameType& name)
{
    CryWarning(VALIDATOR_MODULE_SYSTEM, VALIDATOR_WARNING,
...
AZ::EntityId UiCanvasLuaProxy::LoadCanvas(const char* canvasFilename)
{
    ...
    return AZ::Interface<IShine>::Get()->LoadCanvas(canvasFilename);
}
