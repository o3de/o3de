...
public: // member functions
    ...
    AZ_COMPONENT(UiScrollBarComponent, Shine::UiScrollBarComponentUuid, AZ::Component);
    ...
    const Shine::ActionName& GetValueChangingActionName() override;
    void SetValueChangingActionName(const Shine::ActionName& actionName) override;
    ValueChangeCallback GetValueChangedCallback() override;
    void SetValueChangedCallback(ValueChangeCallback onChange) override;
    const Shine::ActionName& GetValueChangedActionName() override;
    void SetValueChangedActionName(const Shine::ActionName& actionName) override;
    // ~UiScrollerInterface
...
private: // data
    ...
    Shine::ActionName m_valueChangedActionName;
    Shine::ActionName m_valueChangingActionName;
