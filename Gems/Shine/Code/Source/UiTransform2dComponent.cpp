...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::EntityArray UiTransform2dComponent::GetDescendantsWithSameDimensionScaleToDevice(ScaleToDeviceMode scaleToDeviceMode) const
{
...
AZStd::string UiTransform2dComponent::GetScaleToDeviceModeWarningText() const
{
    ...
    if (m_scaleToDeviceMode != ScaleToDeviceMode::None)
    {
        ...
        {
            // Check if any descendants have their scale to device mode set in the same dimension
            Shine::EntityArray descendants = GetDescendantsWithSameDimensionScaleToDevice(m_scaleToDeviceMode);
    ...
    AZ::SerializeContext::DataElementNode& classElement)
{
    ...
    {
        if (!Shine::ConvertSubElementFromVec2ToVector2(context, classElement, "Pivot"))
        {
            return false;
        }

        if (!Shine::ConvertSubElementFromVec2ToVector2(context, classElement, "Scale"))
        {
            return false;
        }
    }
