...
namespace Shine
{
    ...
    class ShinePoolAllocator final
        : public AZ::PoolAllocator
    {
    public:
        AZ_RTTI(ShinePoolAllocator, "{0FFA2FE4-498A-4FF6-A58A-F49F0E8575EE}", AZ::PoolAllocator);
    };
    ...
    public: // functions
        ...
        AZ_CLASS_ALLOCATOR(PrimitiveListRenderNode, ShinePoolAllocator);
        ...
        void AddPrimitive(Shine::UiPrimitive* primitive);
        Shine::UiPrimitiveList& GetPrimitives() const;
        ...
        bool HasSpaceToAddPrimitive(Shine::UiPrimitive* primitive) const;
    ...
    private: // data
        ...
        Shine::UiPrimitiveList   m_primitives;
    ...
    public: // functions
        // We use a pool allocator to keep these allocations fast.
        AZ_CLASS_ALLOCATOR(MaskRenderNode, ShinePoolAllocator);
    ...
    public: // functions
        // We use a pool allocator to keep these allocations fast.
        AZ_CLASS_ALLOCATOR(RenderTargetRenderNode, ShinePoolAllocator);
    ...
    public:
        ...
        Shine::UiPrimitive* GetDynamicQuadPrimitive(const AZ::Vector2* positions, uint32 packedColor) override;
        ...
        void AddPrimitive(Shine::UiPrimitive* primitive, const AZ::Data::Instance<AZ::RPI::Image>& texture,
        ...
        void AddAlphaMaskPrimitive(Shine::UiPrimitive* primitive,
        ...
        void GetRenderTargetsAndDependencies(Shine::AttachmentImagesAndDependencies& attachmentImagesAndDependencies);
        ...
        void DebugReportDrawCallsRenderNodeList(const AZStd::vector<RenderNode*>& renderNodeList, AZ::IO::HandleType fileHandle,
            ShineDebug::DebugInfoDrawCallReport& reportInfo, void* context, const AZStd::string& indent) const;
#endif
    ...
    protected: // types
        ...
        struct DynamicQuad
        {
            Shine::UiPrimitiveVertex         m_quadVerts[4];
            Shine::UiPrimitive   m_primitive;
        };

    protected: // member functions

        //! Given a blend mode and whether the shader will be outputing premultiplied alpha, return state flags
        AZ::RHI::TargetBlendState GetBlendModeState(Shine::BlendMode blendMode, bool isShaderOutputPremultAlpha) const;
