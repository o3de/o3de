...
public: // member functions
    ...
    AZ_COMPONENT(UiFaderComponent, Shine::UiFaderComponentUuid, AZ::Component);
...
protected: // member functions
    ...
    void RenderStandardFader(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
    ...
    void RenderRttFader(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
        UiRenderInterface* renderInterface, int numChildren, bool isInGame);

    // render this element's visual component (if any) and child elements
    void RenderElementAndChildren(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
         UiRenderInterface* renderInterface, int numChildren, bool isInGame);
