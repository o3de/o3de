...
class UiCanvasComponent
    ...
    , public Shine::RenderToTextureRequestBus::Handler
{
public: // constants
...
public: // member functions
    ...
    AZ_COMPONENT(UiCanvasComponent, Shine::UiCanvasComponentUuid, AZ::Component);
    ...
    Shine::CanvasId GetCanvasId() override;
    ...
    Shine::EntityArray GetChildElements() override;
    AZStd::vector<AZ::EntityId> GetChildElementEntityIds() override;

    AZ::Entity* CreateChildElement(const Shine::NameType& name) override;

    AZ::Entity* FindElementById(Shine::ElementId id) override;
    AZ::Entity* FindElementByName(const Shine::NameType& name) override;
    void FindElementsByName(const Shine::NameType& name, Shine::EntityArray& result) override;
    AZ::EntityId FindElementEntityIdByName(const Shine::NameType& name) override;
    AZ::Entity* FindElementByHierarchicalName(const Shine::NameType& name) override;
    void FindElements(AZStd::function<bool(const AZ::Entity*)> predicate, Shine::EntityArray& result) override;

    AZ::Entity* PickElement(AZ::Vector2 point) override;
    Shine::EntityArray PickElements(const AZ::Vector2& bound0, const AZ::Vector2& bound1) override;
    ...
    void FixupCreatedEntities(Shine::EntityArray topLevelEntities, bool makeUniqueNamesAndIds, AZ::Entity* optionalInsertionPoint) override;
    ...
    AZStd::string GetUniqueChildName(AZ::EntityId parentEntityId, AZStd::string baseName, const Shine::EntityArray* includeChildren) override;
    ...
    // Shine::RenderToTextureRequestBus overrides ...
    ...
    void GetDebugInfoRenderGraph(ShineDebug::DebugInfoRenderGraph& info) const;
    void DebugInfoCountChildren(const AZ::EntityId entity, bool parentEnabled, DebugInfoNumElements& info) const;

    void DebugReportDrawCalls(AZ::IO::HandleType fileHandle, ShineDebug::DebugInfoDrawCallReport& reportInfo, void* context) const;
...
private: // member functions
    ...
    bool IsElementNameUnique(const AZStd::string& elementName, const Shine::EntityArray& elements);
    ...
    //! Notify Shine pass that it needs to rebuild its Rtt child passes
...
private: // data
    ...
    Shine::ElementId m_lastElementId;
...
private: // static data
    ...
    Shine::RenderGraph m_renderGraph; //!< the render graph for rendering the canvas, can be cached between frames
