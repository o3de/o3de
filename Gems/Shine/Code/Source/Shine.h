...
#if !defined(_RELEASE)
#define SHINE_INTERNAL_UNIT_TEST
#endif

#if defined(_RELEASE) && defined(SHINE_INTERNAL_UNIT_TEST)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//! CShine is the full implementation of the IShine interface
class CShine
    : public IShine
    ...
    , protected ShinePassDataRequestBus::Handler
{
public:

    //! Create the Shine object, the given system pointer is stored internally
    CShine();
    ...
    AZ::EntityId FindCanvasById(Shine::CanvasId id) override;
    ...
    // ShinePassDataRequestBus
    Shine::AttachmentImagesAndDependencies GetRenderTargets() override;
    // ~ShinePassDataRequestBus

    // Get the UIRenderer for the game (which is owned by CShine). This is not exposed outside the gem.
    UiRenderer* GetUiRenderer();

    // Get/set the UIRenderer for the Editor (which is owned by CShine). This is not exposed outside the gem.
