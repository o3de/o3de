...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiElementComponent::RenderElement(Shine::IRenderGraph* renderGraph, bool isInGame)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::ElementId UiElementComponent::GetElementId()
{
    return m_elementId;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::NameType UiElementComponent::GetName()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::EntityArray UiElementComponent::GetChildElements()
{
    int numChildren = static_cast<int>(m_childEntityIdOrder.size());
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Entity* UiElementComponent::CreateChildElement(const Shine::NameType& name)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Shine::EntityArray UiElementComponent::FindAllChildrenIntersectingRect(const AZ::Vector2& bound0, const AZ::Vector2& bound1, bool isInGame)
{
    Shine::EntityArray result;
    ...
    for (int i = 0; i < m_childEntityIdOrder.size(); ++i)
    {
        ...
        // Check children of this child first
        // child elements do not have to be contained in the parent element's bounds
        Shine::EntityArray childMatches = childElementComponent->FindAllChildrenIntersectingRect(bound0, bound1, isInGame);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Entity* UiElementComponent::FindChildByName(const Shine::NameType& name)
{
    AZ::Entity* matchElem = nullptr;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Entity* UiElementComponent::FindDescendantByName(const Shine::NameType& name)
{
    AZ::Entity* matchElem = nullptr;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId UiElementComponent::FindChildEntityIdByName(const Shine::NameType& name)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::EntityId UiElementComponent::FindDescendantEntityIdByName(const Shine::NameType& name)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::Entity* UiElementComponent::FindDescendantById(Shine::ElementId id)
{
    if (id == m_elementId)
    {
        return GetEntity();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiElementComponent::FindDescendantElements(AZStd::function<bool(const AZ::Entity*)> predicate, Shine::EntityArray& result)
{
    if (AreChildPointersValid())
    {
        int numChildren = static_cast<int>(m_childElementComponents.size());
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiElementComponent::SetCanvas(UiCanvasComponent* canvas, Shine::ElementId elementId)
{
    m_canvas = canvas;
    ...
    AZStd::vector<AZ::SerializeContext::DataElementNode>& entities)
{
    ...
    AZ::SerializeContext::DataElementNode* elementComponentNode =
        Shine::FindComponentNode(elementNode, UiElementComponent::TYPEINFO_Uuid());
