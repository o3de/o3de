...
public: // member functions
    ...
    AZ_COMPONENT(UiTextInputComponent, Shine::UiTextInputComponentUuid, AZ::Component);
    ...
    const Shine::ActionName& GetChangeAction() override;
    void SetChangeAction(const Shine::ActionName& actionName) override;
    const Shine::ActionName& GetEndEditAction() override;
    void SetEndEditAction(const Shine::ActionName& actionName) override;
    const Shine::ActionName& GetEnterAction() override;
    void SetEnterAction(const Shine::ActionName& actionName) override;
...
private: // data
    ...
    Shine::ActionName m_changeAction;
    Shine::ActionName m_endEditAction;
    Shine::ActionName m_enterAction;
