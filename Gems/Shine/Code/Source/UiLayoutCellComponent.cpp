...
{
    return m_minWidthOverridden ? m_minWidth : Shine::UiLayoutCellUnspecifiedSize;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiLayoutCellComponent::SetMinWidth(float width)
{
    if (Shine::IsUiLayoutCellSizeSpecified(width))
    {
        m_minWidth = width;
    ...
    {
        m_minWidth = Shine::UiLayoutCellUnspecifiedSize;
        m_minWidthOverridden = false;
    }
    InvalidateLayout();
}
...
{
    return m_minHeightOverridden ? m_minHeight : Shine::UiLayoutCellUnspecifiedSize;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiLayoutCellComponent::SetMinHeight(float height)
{
    if (Shine::IsUiLayoutCellSizeSpecified(height))
    {
        m_minHeight = height;
    ...
    {
        m_minHeight = Shine::UiLayoutCellUnspecifiedSize;
        m_minHeightOverridden = false;
    }
    InvalidateLayout();
}
...
{
    return m_targetWidthOverridden ? m_targetWidth : Shine::UiLayoutCellUnspecifiedSize;
}
...
void UiLayoutCellComponent::SetTargetWidth(float width)
{
    ...
    {
        m_targetWidth = Shine::UiLayoutCellUnspecifiedSize;
        m_targetWidthOverridden = false;
    }
...
{
    return m_targetHeightOverridden ? m_targetHeight : Shine::UiLayoutCellUnspecifiedSize;
}
...
void UiLayoutCellComponent::SetTargetHeight(float height)
{
    ...
    {
        m_targetHeight = Shine::UiLayoutCellUnspecifiedSize;
        m_targetHeightOverridden = false;
    }
...
{
    return m_maxWidthOverridden ? m_maxWidth : Shine::UiLayoutCellUnspecifiedSize;
}
...
void UiLayoutCellComponent::SetMaxWidth(float width)
{
    ...
    {
        m_maxWidth = Shine::UiLayoutCellUnspecifiedSize;
        m_maxWidthOverridden = false;
    }
...
{
    return m_maxHeightOverridden ? m_maxHeight : Shine::UiLayoutCellUnspecifiedSize;
}
...
void UiLayoutCellComponent::SetMaxHeight(float height)
{
    ...
    {
        m_maxHeight = Shine::UiLayoutCellUnspecifiedSize;
        m_maxHeightOverridden = false;
    }
...
{
    return m_extraWidthRatioOverridden ? m_extraWidthRatio : Shine::UiLayoutCellUnspecifiedSize;
}
...
void UiLayoutCellComponent::SetExtraWidthRatio(float width)
{
    ...
    {
        m_extraWidthRatio = Shine::UiLayoutCellUnspecifiedSize;
        m_extraWidthRatioOverridden = false;
    }
...
{
    return m_extraHeightRatioOverridden ? m_extraHeightRatio : Shine::UiLayoutCellUnspecifiedSize;
}
...
void UiLayoutCellComponent::SetExtraHeightRatio(float height)
{
    ...
    {
        m_extraHeightRatio = Shine::UiLayoutCellUnspecifiedSize;
        m_extraHeightRatioOverridden = false;
    }
...
void UiLayoutCellComponent::Reflect(AZ::ReflectContext* context)
{
    ...
    if (behaviorContext)
    {
        ...
        behaviorContext->Constant("UiLayoutCellUnspecifiedSize", BehaviorConstant(Shine::UiLayoutCellUnspecifiedSize));
