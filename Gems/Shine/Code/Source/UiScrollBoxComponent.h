...
public: // member functions
    ...
    AZ_COMPONENT(UiScrollBoxComponent, Shine::UiScrollBoxComponentUuid, AZ::Component);
    ...
    const Shine::ActionName& GetScrollOffsetChangingActionName() override;
    void SetScrollOffsetChangingActionName(const Shine::ActionName& actionName) override;
    ...
    const Shine::ActionName& GetScrollOffsetChangedActionName() override;
    void SetScrollOffsetChangedActionName(const Shine::ActionName& actionName) override;
...
private: // data
    ...
    Shine::ActionName m_scrollOffsetChangedActionName;
    Shine::ActionName m_scrollOffsetChangingActionName;
