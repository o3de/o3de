...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiFaderComponent::Render(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
...
void UiFaderComponent::CreateOrResizeRenderTarget(const AZ::Vector2& pixelAlignedTopLeft, const AZ::Vector2& pixelAlignedBottomRight)
{
    ...
    // [SHINE_ATOM_TODO][GHI #6271] Optimize by reusing existing render targets
    DestroyRenderTarget();
    ...
    Shine::RenderToTextureRequestBus::EventResult(
        m_attachmentImageId,
        canvasEntityId,
        &Shine::RenderToTextureRequestBus::Events::UseRenderTarget,
...
void UiFaderComponent::DestroyRenderTarget()
{
    if (!m_attachmentImageId.IsEmpty())
    {
        AZ::EntityId canvasEntityId;
        UiElementBus::EventResult(canvasEntityId, GetEntityId(), &UiElementBus::Events::GetCanvasEntityId);
        Shine::RenderToTextureRequestBus::Event(
            canvasEntityId, &Shine::RenderToTextureRequestBus::Events::ReleaseRenderTarget, m_attachmentImageId);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiFaderComponent::RenderStandardFader(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
    UiRenderInterface* renderInterface, int numChildren, bool isInGame)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiFaderComponent::RenderRttFader(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
    UiRenderInterface* renderInterface, int numChildren, bool isInGame)
{
    ...
    UiElementBus::EventResult(canvasEntityId, GetEntityId(), &UiElementBus::Events::GetCanvasEntityId);
    Shine::RenderToTextureRequestBus::EventResult(
        attachmentImage, canvasEntityId, &Shine::RenderToTextureRequestBus::Events::GetRenderTarget, m_attachmentImageId);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UiFaderComponent::RenderElementAndChildren(Shine::IRenderGraph* renderGraph, UiElementInterface* elementInterface,
     UiRenderInterface* renderInterface, int numChildren, bool isInGame)
{
