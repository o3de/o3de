...
AllocateConstIntCVar(ShineDebug, CV_r_DebugUIDraw2dFont);
AllocateConstIntCVar(ShineDebug, CV_r_DebugUIDraw2dImage);
AllocateConstIntCVar(ShineDebug, CV_r_DebugUIDraw2dLine);
AllocateConstIntCVar(ShineDebug, CV_r_DebugUIDraw2dDefer);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
#if !defined(_RELEASE)
#ifdef SHINE_ATOM_TODO // [GHI #6270] Support RTT using Atom
    ...
    const char* text, AZ::Color baseColor, AZ::Color selectedColor, AZ::Color pressedColor, AZ::Color textColor)
{
...

    {
        ...
        CreateComponent(buttonElem, Shine::UiTransform2dComponentUuid);
        CreateComponent(buttonElem, Shine::UiImageComponentUuid);
        CreateComponent(buttonElem, Shine::UiButtonComponentUuid);
        ...
        ISprite* sprite = AZ::Interface<IShine>::Get()->LoadSprite(pathname);
...
namespace
{
    ...
    {
    public:
        ActionListener(AZ::EntityId canvasId, Shine::ActionName actionName, AZStd::function<void(void)> fn)
            : m_canvasId(canvasId)
        ...
        void OnAction([[maybe_unused]] AZ::EntityId canvasId, const Shine::ActionName& actionName) override
        {
...
static void DestroyTestCanvas()
{
    if (g_testCanvasId.IsValid())
    {
        ...
        AZ::Interface<IShine>::Get()->ReleaseCanvas(g_testCanvasId, false);
...
static void TestCanvasCreate ([[maybe_unused]] IConsoleCmdArgs* Cmd)
{
    ...
    CreateComponent(pauseMenuElem, Shine::UiTransform2dComponentUuid);
    CreateComponent(pauseMenuElem, Shine::UiImageComponentUuid);
    ...
    CreateComponent(testImageElem, Shine::UiTransform2dComponentUuid);
    CreateComponent(testImageElem, Shine::UiImageComponentUuid);
    UiTransform2dBus::Event(
        testImageElem->GetId(),
    ...
    Shine::ActionName actionName1("ShowImage");
    ...
    auto setChangedTextFn = [changedTextElem]([[maybe_unused]] AZ::EntityId textInputEntityId, Shine::StringType textString)
        {
            UiTextBus::Event(changedTextElem->GetId(), &UiTextBus::Events::SetText, textString);
        };
    auto setEditedTextFn = [editedTextElem]([[maybe_unused]] AZ::EntityId textInputEntityId, Shine::StringType textString)
        {
            UiTextBus::Event(editedTextElem->GetId(), &UiTextBus::Events::SetText, textString);
        };
    auto setEnteredTextFn = [enteredTextElem]([[maybe_unused]] AZ::EntityId textInputEntityId, Shine::StringType textString)
        {
    ...
    Shine::EntityArray foundElements;
