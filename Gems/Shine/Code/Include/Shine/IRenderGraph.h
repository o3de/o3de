...
namespace Shine
{
    ...
    public:
        ...
        virtual void AddPrimitive(Shine::UiPrimitive* primitive, const AZ::Data::Instance<AZ::RPI::Image>& texture,
        ...
        virtual void AddAlphaMaskPrimitive(Shine::UiPrimitive* primitive,
        ...
        virtual Shine::UiPrimitive* GetDynamicQuadPrimitive(const AZ::Vector2* positions, uint32 packedColor) = 0;
