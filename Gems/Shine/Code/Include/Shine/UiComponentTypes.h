...
namespace Shine
{
    // Uuid strings for all component types define by Shine.
    // This can be used to create components at runtime. E.g.:
    //     entity->CreateComponent(Shine::UiTransform2dComponentUuid);
    ...
    // The Uuid of the Shine system component. Can be used from tools to activate this component.
    inline constexpr AZ::TypeId ShineSystemComponentUuid{ "{B0C78B8D-1E5B-47D7-95D0-EC69C0513804}" };
};
