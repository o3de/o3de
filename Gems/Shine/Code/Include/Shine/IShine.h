...
// from a DLL simpler. All files within this DLL are compiled with the SHINE_EXPORTS
// symbol defined in the StdAfx.h. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see
// SHINE_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
#ifdef SHINE_EXPORTS
    #define SHINE_API AZ_DLL_EXPORT
#else
    #define SHINE_API AZ_DLL_IMPORT
#endif

////////////////////////////////////////////////////////////////////////////////////////////////////
//! The IShine interface provides access to the other interfaces provided by the UI module
class IShine
{
public:
    AZ_RTTI(IShine, "{652ED9D7-0782-44E8-BCE7-65DD38C90907}");

    IShine() = default;
    virtual ~IShine() = default;
    ...
    virtual AZ::EntityId FindCanvasById(Shine::CanvasId id) = 0;
...
SHINE_API IShine* CreateShineInterface(ISystem* system);
