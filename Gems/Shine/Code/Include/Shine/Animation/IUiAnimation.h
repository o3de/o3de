...
public:
    ...
    virtual void InitPostLoad(IUiAnimSequence* pSequence, bool remapIds, Shine::EntityIdMap* entityIdMap) = 0;
...
struct IUiAnimSequence
{
    ...
    */
    ...
    virtual void InitPostLoad(IUiAnimationSystem* pUiAnimationSystem, bool remapIds, Shine::EntityIdMap* entityIdMap) = 0;
...
struct IUiAnimationSystem
{
    ...
    */
    ...
    virtual void InitPostLoad(bool remapIds, Shine::EntityIdMap* entityIdMap) = 0;
