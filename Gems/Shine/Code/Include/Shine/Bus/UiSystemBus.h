...
public:
    ...
    //! We use this for metrics to find out which components are part of the Shine Gem
    virtual const AZStd::list<AZ::ComponentDescriptor*>* GetShineComponentDescriptors() = 0;
};
