...
public: // member functions
    ...
    virtual const Shine::ActionName& GetChangeAction() = 0;

    //! Set the "change" action name
    virtual void SetChangeAction(const Shine::ActionName& actionName) = 0;
    ...
    virtual const Shine::ActionName& GetEndEditAction() = 0;

    //! Set the "end edit" action name
    virtual void SetEndEditAction(const Shine::ActionName& actionName) = 0;

    //! Get the "enter" action name, the action is sent to canvas listeners when enter is pressed
    virtual const Shine::ActionName& GetEnterAction() = 0;

    //! Set the "enter" action name
    virtual void SetEnterAction(const Shine::ActionName& actionName) = 0;
