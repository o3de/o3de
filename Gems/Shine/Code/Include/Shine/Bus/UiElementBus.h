...
public: // member functions
    ...
    virtual void RenderElement(Shine::IRenderGraph* renderGraph, bool isInGame) = 0;

    //! Retrieves the identifier of this element.
    virtual Shine::ElementId GetElementId() = 0;

    //! Get the name of this element
    virtual Shine::NameType GetName() = 0;
    ...
    virtual Shine::EntityArray FindAllChildrenIntersectingRect(const AZ::Vector2& bound0, const AZ::Vector2& bound1, bool isInGame) = 0;
    ...
    virtual AZ::Entity* FindChildByName(const Shine::NameType& name) = 0;

    //! Return the first descendant element with the given name or nullptr if no match
    virtual AZ::Entity* FindDescendantByName(const Shine::NameType& name) = 0;

    //! Return the first immediate child entity Id with the given name or invalid Id if no match
    virtual AZ::EntityId FindChildEntityIdByName(const Shine::NameType& name) = 0;

    //! Return the first descendant entity Id with the given name or invalid Id if no match
    virtual AZ::EntityId FindDescendantEntityIdByName(const Shine::NameType& name) = 0;
    ...
    virtual AZ::Entity* FindDescendantById(Shine::ElementId id) = 0;

    //! recursively find descendant elements matching a predicate
    //! \param result, any matching elements will be added to this array
    virtual void FindDescendantElements(AZStd::function<bool(const AZ::Entity*)> predicate, Shine::EntityArray& result) = 0;
