...
public: // member functions
    ...
    virtual Shine::CanvasId GetCanvasId() = 0;
    ...
    virtual Shine::EntityArray GetChildElements() = 0;
    ...
    virtual AZ::Entity* CreateChildElement(const Shine::NameType& name) = 0;

    //! Return the element on this canvas with the given id or nullptr if no match
    virtual AZ::Entity* FindElementById(Shine::ElementId id) = 0;

    //! Return the first element on this canvas with the given name or nullptr if no match
    virtual AZ::Entity* FindElementByName(const Shine::NameType& name) = 0;

    //! Return the first element on this canvas with the given name or nullptr if no match
    virtual AZ::EntityId FindElementEntityIdByName(const Shine::NameType& name) = 0;

    //! Find all elements on this canvas with the given name
    virtual void FindElementsByName(const Shine::NameType& name, Shine::EntityArray& result) = 0;
    ...
    virtual AZ::Entity* FindElementByHierarchicalName(const Shine::NameType& name) = 0;

    //! Find all elements on this canvas matching the predicate
    virtual void FindElements(AZStd::function<bool(const AZ::Entity*)> predicate, Shine::EntityArray& result) = 0;
    ...
    virtual Shine::EntityArray PickElements(const AZ::Vector2& bound0, const AZ::Vector2& bound1) = 0;
    ...
    virtual void FixupCreatedEntities(Shine::EntityArray topLevelEntities, bool makeUniqueNamesAndIds, AZ::Entity* optionalInsertionPoint) = 0;
    ...
    virtual AZStd::string GetUniqueChildName(AZ::EntityId parentEntityId, AZStd::string baseName, const Shine::EntityArray* includeChildren) = 0;
...
public: // member functions
    ...
    virtual void OnAction(AZ::EntityId entityId, const Shine::ActionName& actionName) = 0;
    ...
    virtual void OnActionMultitouch(
        ...
        [[maybe_unused]] const Shine::ActionName& actionName,
