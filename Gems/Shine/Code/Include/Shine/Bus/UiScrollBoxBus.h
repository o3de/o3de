...
public: // member functions
    ...
    virtual const Shine::ActionName& GetScrollOffsetChangingActionName() = 0;

    //! Set the action triggered while the scroll offset is changing
    virtual void SetScrollOffsetChangingActionName(const Shine::ActionName& actionName) = 0;
    ...
    virtual const Shine::ActionName& GetScrollOffsetChangedActionName() = 0;

    //! Set the action triggered when the scroll offset is done changing
    virtual void SetScrollOffsetChangedActionName(const Shine::ActionName& actionName) = 0;
