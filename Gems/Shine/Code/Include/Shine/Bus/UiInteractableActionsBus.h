...
public: // member functions
    ...
    virtual const Shine::ActionName& GetHoverStartActionName() = 0;

    //! Set the hover start action name
    virtual void SetHoverStartActionName(const Shine::ActionName& actionName) = 0;

    //! Get the hover end action name
    virtual const Shine::ActionName& GetHoverEndActionName() = 0;

    //! Set the hover end action name
    virtual void SetHoverEndActionName(const Shine::ActionName& actionName) = 0;

    //! Get the pressed action name
    virtual const Shine::ActionName& GetPressedActionName() = 0;

    //! Set the pressed action name
    virtual void SetPressedActionName(const Shine::ActionName& actionName) = 0;

    //! Get the released action name
    virtual const Shine::ActionName& GetReleasedActionName() = 0;

    //! Set the released action name
    virtual void SetReleasedActionName(const Shine::ActionName& actionName) = 0;

    //! Get the release outside of the UI element action name
    virtual const Shine::ActionName& GetOutsideReleasedActionName() const = 0;

    //! Set the release outside of the UI element action name
    virtual void SetOutsideReleasedActionName(const Shine::ActionName& actionName) = 0;
