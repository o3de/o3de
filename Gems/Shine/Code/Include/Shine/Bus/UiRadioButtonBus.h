...
public: // member functions
    ...
    virtual const Shine::ActionName& GetTurnOnActionName() = 0;

    //! Set the action triggered when turned on
    virtual void SetTurnOnActionName(const Shine::ActionName& actionName) = 0;

    //! Get the action triggered when turned off
    virtual const Shine::ActionName& GetTurnOffActionName() = 0;

    //! Set the action triggered when turned off
    virtual void SetTurnOffActionName(const Shine::ActionName& actionName) = 0;

    //! Get the action triggered when changed
    virtual const Shine::ActionName& GetChangedActionName() = 0;

    //! Set the action triggered when changed
    virtual void SetChangedActionName(const Shine::ActionName& actionName) = 0;
