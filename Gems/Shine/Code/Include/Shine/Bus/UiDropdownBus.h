...
public: // member functions
    ...
    virtual const Shine::ActionName& GetExpandedActionName() = 0;

    //! Set the name of the action that is sent when the dropdown is expanded
    virtual void SetExpandedActionName(const Shine::ActionName& actionName) = 0;

    //! Get the name of the action that is sent when the dropdown is collapsed
    virtual const Shine::ActionName& GetCollapsedActionName() = 0;

    //! Set the name of the action that is sent when the dropdown is collapsed
    virtual void SetCollapsedActionName(const Shine::ActionName& actionName) = 0;

    //! Get the name of the action that is sent when the dropdown value is changed
    virtual const Shine::ActionName& GetOptionSelectedActionName() = 0;

    //! Set the name of the action that is sent when the dropdown value is changed
    virtual void SetOptionSelectedActionName(const Shine::ActionName& actionName) = 0;
