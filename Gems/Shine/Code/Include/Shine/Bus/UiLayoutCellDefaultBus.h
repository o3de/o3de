...
public: // member functions
    ...
    //! \param maxWidth A width that the element will not surpass. Shine::UiLayoutCellUnspecifiedSize means no max 
    virtual float GetTargetWidth(float maxWidth) = 0;

    //! Get the target height
    //! \param maxHeight A height that the element will not surpass. Shine::UiLayoutCellUnspecifiedSize means no max
