...
public: // member functions
    ...
    virtual const Shine::ActionName& GetValueChangingActionName() = 0;

    //! Set the action triggered while the value is changing
    virtual void SetValueChangingActionName(const Shine::ActionName& actionName) = 0;
    ...
    virtual const Shine::ActionName& GetValueChangedActionName() = 0;

    //! Set the action triggered when the value is done changing
    virtual void SetValueChangedActionName(const Shine::ActionName& actionName) = 0;
