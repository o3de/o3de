...
AZ::RPI::ScenePtr UiRenderer::CreateScene(AZStd::shared_ptr<AZ::RPI::ViewportContext> viewportContext)
{
    ...
    atomScene->EnableAllFeatureProcessors(); // [LYSHINE_ATOM_TODO][LYN-8717] Enable minimal feature processors
    ...
    AZStd::string pipelineAssetPath = "passes/MainRenderPipeline.azasset"; // [LYSHINE_ATOM_TODO][LYN-8717] Use a custom UI pipeline
...
void UiRenderer::DebugDisplayTextureData(int recordingOption)
{
    ...
    {
#ifdef LYSHINE_ATOM_TODO // [LYN-7857] Support canvas debug display with Atom
