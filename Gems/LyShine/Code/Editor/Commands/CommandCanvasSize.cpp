...
CommandCanvasSize::CommandCanvasSize(
    UndoStack* stack, CanvasSizeToolbarSection* canvasSizeToolbar, AZ::Vector2 from, AZ::Vector2 to, bool fromPreset)
    : QUndoCommand()
    , m_stack(stack)
...
{
    QString description(QString("%1 x %2 (%3)").arg(QString::number(m_to.GetX())).arg(QString::number(m_to.GetY())).arg("custom"));
