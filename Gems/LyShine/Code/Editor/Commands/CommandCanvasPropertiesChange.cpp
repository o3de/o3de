...
CommandCanvasPropertiesChange::CommandCanvasPropertiesChange(
    UndoStack* stack, AZStd::string& undoXml, AZStd::string& redoXml, EditorWindow* editorWindow, const char* commandName)
    : QUndoCommand()
    , m_stack(stack)
...
void CommandCanvasPropertiesChange::Push(
    UndoStack* stack, AZStd::string& undoXml, AZStd::string& redoXml, EditorWindow* editorWindow, const char* commandName)
{
