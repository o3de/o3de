...
class CommandHierarchyItemToggleIsVisible : public QUndoCommand
{
public:
    void undo() override;
    void redo() override;
...
private:
    CommandHierarchyItemToggleIsVisible(UndoStack* stack, HierarchyWidget* hierarchy, const HierarchyItemRawPtrList& items);
