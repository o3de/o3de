...
CommandHierarchyItemDelete::CommandHierarchyItemDelete(UndoStack* stack, HierarchyWidget* hierarchy)
    : QUndoCommand()
    , m_stack(stack)
...
void CommandHierarchyItemDelete::Push(UndoStack* stack, HierarchyWidget* hierarchy, const QTreeWidgetItemRawPtrQList& selectedItems)
{
