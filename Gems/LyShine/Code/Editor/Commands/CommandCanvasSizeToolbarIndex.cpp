...
#include "Toolbar/CanvasSizeToolbarSection.h"
...
CommandCanvasSizeToolbarIndex::CommandCanvasSizeToolbarIndex(
    UndoStack* stack, CanvasSizeToolbarSection* canvasSizeToolbar, int from, int to)
    : QUndoCommand()
    , m_stack(stack)
...
bool CommandCanvasSizeToolbarIndex::mergeWith(const QUndoCommand* other)
{
    ...
    if (!((subsequent->m_stack == m_stack) && (subsequent->m_canvasSizeToolbar == m_canvasSizeToolbar)))
    {
...
void CommandCanvasSizeToolbarIndex::Push(UndoStack* stack, CanvasSizeToolbarSection* canvasSizeToolbar, int from, int to)
{
