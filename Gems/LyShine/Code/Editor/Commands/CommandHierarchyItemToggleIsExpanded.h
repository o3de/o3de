...
class CommandHierarchyItemToggleIsExpanded : public QUndoCommand
{
public:
    void undo() override;
    void redo() override;
    ...
    static void Push(UndoStack* stack, HierarchyWidget* hierarchy, HierarchyItem* item);

private:
    CommandHierarchyItemToggleIsExpanded(UndoStack* stack, HierarchyWidget* hierarchy, HierarchyItem* item);
