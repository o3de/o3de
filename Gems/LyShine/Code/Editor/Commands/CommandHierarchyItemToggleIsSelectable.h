...
class CommandHierarchyItemToggleIsSelectable : public QUndoCommand
{
public:
    void undo() override;
    void redo() override;
    ...
    static void Push(UndoStack* stack, HierarchyWidget* hierarchy, const HierarchyItemRawPtrList& items);

private:
    CommandHierarchyItemToggleIsSelectable(UndoStack* stack, HierarchyWidget* hierarchy, const HierarchyItemRawPtrList& items);
