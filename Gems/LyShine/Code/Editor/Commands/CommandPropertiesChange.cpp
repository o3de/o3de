...
CommandPropertiesChange::CommandPropertiesChange(
    UndoStack* stack, HierarchyWidget* hierarchy, SerializeHelpers::SerializedEntryList& preValueChanges, const char* commandName)
    : QUndoCommand()
    , m_stack(stack)
...
void CommandPropertiesChange::Push(
    UndoStack* stack, HierarchyWidget* hierarchy, SerializeHelpers::SerializedEntryList& preValueChanges, const char* commandName)
{
    ...
    stack->push(new CommandPropertiesChange(stack, hierarchy, preValueChanges, commandName));
}
