...
CommandHierarchyItemToggleIsExpanded::CommandHierarchyItemToggleIsExpanded(
    UndoStack* stack, HierarchyWidget* hierarchy, HierarchyItem* item)
    : QUndoCommand()
    , m_stack(stack)
...
void CommandHierarchyItemToggleIsExpanded::Push(UndoStack* stack, HierarchyWidget* hierarchy, HierarchyItem* item)
{
    ...
    stack->push(new CommandHierarchyItemToggleIsExpanded(stack, hierarchy, item));
}
