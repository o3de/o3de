...
namespace EntityHelpers
{
    ...
    {
        return AZ::Vector2(v.GetX() - std::remainder(v.GetX(), snapDistance), v.GetY() - std::remainder(v.GetY(), snapDistance));
    }
    ...
    {
        return UiTransform2dInterface::Offsets(
            offs.m_left - std::remainder((grabbedEdges.m_left ? offs.m_left : 0.0f), snapDistance),
