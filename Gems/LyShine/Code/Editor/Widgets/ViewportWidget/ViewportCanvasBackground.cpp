...
void ViewportCanvasBackground::Draw(
    Draw2dHelper& draw2d, const AZ::Vector2& canvasSize, float canvasToViewportScale, const AZ::Vector3& canvasToViewportTranslation)
{
    ...
    AZ::Vector2 positions[quadVertCount] = { topLeft, topRight, bottomRight, bottomLeft };
    ...
    const AZ::Vector2 uvs[4] = {
        AZ::Vector2(0, 0), AZ::Vector2(uvScale.GetX(), 0), AZ::Vector2(uvScale.GetX(), uvScale.GetY()), AZ::Vector2(0, uvScale.GetY())
    };
