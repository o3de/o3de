...
#include "Widgets/PresetButton.h"
...
PivotPresetsWidget::PivotPresetsWidget(int defaultPresetIndex, PresetChanger presetChanger, QWidget* parent)
    : QWidget(parent)
    ...
    // Preset buttons.
    {
        for (int presetIndex = 0; presetIndex < PivotPresets::PresetIndexCount; ++presetIndex)
        {
            PresetButton* button = new PresetButton(
                UICANVASEDITOR_PIVOT_ICON_NAME_DEFAULT,
