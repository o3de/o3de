...
public:
    ...
    {
        return AZ_CRC_CE("UiParticleColorKeyframeCtrl");
    }
    ...
    void ConsumeAttribute(
        PropertyUiParticleColorKeyframeCtrl* GUI,
        AZ::u32 attrib,
        AzToolsFramework::PropertyAttributeReader* attrValue,
        const char* debugName) override;
    void WriteGUIValuesIntoProperty(
        size_t index, PropertyUiParticleColorKeyframeCtrl* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node) override;
