...
class PropertyHandlerPivot : public AzToolsFramework::PropertyHandler<AZ::Vector2, PropertyPivotCtrl>
{
public:
    ...
    {
        return AZ_CRC_CE("Pivot");
    }

    QWidget* CreateGUI(QWidget* pParent) override;
    void ConsumeAttribute(
        PropertyPivotCtrl* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName) override;
    void WriteGUIValuesIntoProperty(
        size_t index, PropertyPivotCtrl* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node) override;
    bool ReadValuesIntoGUI(
        size_t index, PropertyPivotCtrl* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node) override;
