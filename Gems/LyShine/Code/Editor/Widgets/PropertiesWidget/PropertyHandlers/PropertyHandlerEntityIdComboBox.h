...
class PropertyEntityIdComboBoxCtrl : public QWidget
{
    Q_OBJECT
public:
...
public:
    ...
    virtual void WriteGUIValuesIntoProperty(
        size_t index, PropertyEntityIdComboBoxCtrl* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node) override;
    virtual bool ReadValuesIntoGUI(
        size_t index, PropertyEntityIdComboBoxCtrl* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node) override;
    ...
    {
        return AZ::Edit::UIHandlers::ComboBox;
    }
    ...
    virtual void UpdateWidgetInternalTabbing(PropertyEntityIdComboBoxCtrl* widget) override
    {
        widget->UpdateTabOrder();
    }
    virtual void ConsumeAttribute(
        PropertyEntityIdComboBoxCtrl* GUI,
        AZ::u32 attrib,
