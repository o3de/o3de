...
namespace LyShineEditor
{
    class CanvasAssetPropertyHandler
        : QObject
        , public AzToolsFramework::
              PropertyHandler<AzFramework::SimpleAssetReference<LyShine::CanvasAsset>, AzToolsFramework::PropertyAssetCtrl>
    {
        Q_OBJECT
    ...
    public:
        ...
        void ConsumeAttribute(
            AzToolsFramework::PropertyAssetCtrl* GUI,
            AZ::u32 attrib,
