...
class PropertyHandlerOffset : public UIVectorPropertyHandlerBase<UiTransform2dInterface::Offsets>
{
public:
    ...
    UiTransform2dInterface::Offsets InternalOffsetToDisplayedOffset(
        UiTransform2dInterface::Offsets internalOffset, const UiTransform2dInterface::Anchors& anchors, const AZ::Vector2& pivot);
    UiTransform2dInterface::Offsets DisplayedOffsetToInternalOffset(
        UiTransform2dInterface::Offsets displayedOffset, const UiTransform2dInterface::Anchors& anchors, const AZ::Vector2& pivot);
