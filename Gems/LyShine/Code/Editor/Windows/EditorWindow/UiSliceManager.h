...
class UiSliceManager : public UiEditorEntityContextNotificationBus::Handler
{
public: // member functions
    ...
    AZ::Outcome<void, AZStd::string> PushEntitiesBackToSlice(
        const AzToolsFramework::EntityIdList& entityIdList, const AZ::Data::Asset<AZ::SliceAsset>& sliceAsset);

    //! Push the given set of entities to the given slice instance (handles adds and removes).
    AZ::Outcome<void, AZStd::string> QuickPushSliceInstance(
        const AZ::SliceComponent::SliceInstanceAddress& sliceAddress, const AzToolsFramework::EntityIdList& entityIdList);
...
private: // member functions
    ...
    AZ::Entity* ValidateSingleRootAndGenerateOrderedEntityList(
        const AzToolsFramework::EntityIdSet& liveEntities, AzToolsFramework::EntityIdList& outOrderedEntityList, AZ::Entity*& insertBefore);
