        ...
        if (serializeContext)
        {
            ...
            if (editContext)
            {
                editContext->Class<FollowTargetFromDistance>(
                    ...
                    ->DataElement(nullptr, &FollowTargetFromDistance::m_followDistance,
                    ...
                    ->DataElement(nullptr, &FollowTargetFromDistance::m_minFollowDistance,
                        ...
                        ->Attribute(AZ::Edit::Attributes::Max, &FollowTargetFromDistance::GetMaximumFollowDistance)
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ_CRC_CE("RefreshAttributesAndValues"))
                    ->DataElement(nullptr, &FollowTargetFromDistance::m_maxFollowDistance,
