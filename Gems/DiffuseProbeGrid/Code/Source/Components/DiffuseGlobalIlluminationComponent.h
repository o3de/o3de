...
#include <Components/DiffuseGlobalIlluminationComponentConfig.h>
#include <Components/DiffuseGlobalIlluminationComponentConstants.h>
#include <Components/DiffuseGlobalIlluminationComponentController.h>
