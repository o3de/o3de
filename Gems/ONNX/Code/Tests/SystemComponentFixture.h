...
namespace ONNX
{
    ...
    class ONNXTestModule : public AZ::Module
    {
    public:
        AZ_RTTI(ONNXTestModule, "{6243E208-4147-46D5-8EA1-BB8037963775}", AZ::Module);
        AZ_CLASS_ALLOCATOR(ONNXTestModule, AZ::OSAllocator, 0);
    ...
    template<class... Components>
    class ComponentFixtureApp : public AzFramework::Application
    {
    public:
        ComponentFixtureApp()
        {
        ...
        void CreateStaticModules(AZStd::vector<AZ::Module*>& outModules) override
        {
            ...
            outModules.emplace_back(aznew ONNXTestModule<Components...>());
        }
    ...
    //! A fixture that constructs an ONNXSystemComponent
    /*!
     * This fixture can be used by any test that needs the ONNX runtime to
     * be working. It will construct all necessary allocators for ONNX
     * objects to be successfully instantiated.
     */
    template<class... Components>
    class ComponentFixture : public UnitTest::ScopedAllocatorSetupFixture
    {
    public:
        void SetUp() override
        {
            ...
            // Add ONNX as an active gem within the Settings Registry for unit test
            if (auto settingsRegistry = AZ::SettingsRegistry::Get(); settingsRegistry != nullptr)
            {
                AZ::Test::AddActiveGem("ONNX", *settingsRegistry);
            }
