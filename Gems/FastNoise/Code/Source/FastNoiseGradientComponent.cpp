        ...
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto editContext = serializeContext->GetEditContext())
            {
                editContext->Class<FastNoiseGradientConfig>(
                    QT_TRANSLATE_NOOP("FastNoiseGem", "FastNoise Gradient"), "")
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(AZ::Edit::UIHandlers::Slider, &FastNoiseGradientConfig::m_seed, QT_TRANSLATE_NOOP("FastNoiseGem", "Random Seed"), QT_TRANSLATE_NOOP("FastNoiseGem", "Using different seeds will cause the noise output to change"))
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FastNoiseGradientConfig::m_noiseType, QT_TRANSLATE_NOOP("FastNoiseGem", "Noise Type"), QT_TRANSLATE_NOOP("FastNoiseGem", "Sets the type of noise generator used"))
                    ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<int>::min())
                    ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<int>::max())
                    ->EnumAttribute(FastNoise::NoiseType::Value, QT_TRANSLATE_NOOP("FastNoiseGem", "Value"))
                    ->EnumAttribute(FastNoise::NoiseType::ValueFractal, QT_TRANSLATE_NOOP("FastNoiseGem", "Value Fractal"))
                    ->EnumAttribute(FastNoise::NoiseType::Perlin, QT_TRANSLATE_NOOP("FastNoiseGem", "Perlin"))
                    ->EnumAttribute(FastNoise::NoiseType::PerlinFractal, QT_TRANSLATE_NOOP("FastNoiseGem", "Perlin Fractal"))
                    ->EnumAttribute(FastNoise::NoiseType::Simplex, QT_TRANSLATE_NOOP("FastNoiseGem", "Simplex"))
                    ->EnumAttribute(FastNoise::NoiseType::SimplexFractal, QT_TRANSLATE_NOOP("FastNoiseGem", "Simplex Fractal"))
                    ->EnumAttribute(FastNoise::NoiseType::Cellular, QT_TRANSLATE_NOOP("FastNoiseGem", "Cellular"))
                    ->EnumAttribute(FastNoise::NoiseType::WhiteNoise, QT_TRANSLATE_NOOP("FastNoiseGem", "White Noise"))
                    ->EnumAttribute(FastNoise::NoiseType::Cubic, QT_TRANSLATE_NOOP("FastNoiseGem", "Cubic"))
                    ->EnumAttribute(FastNoise::NoiseType::CubicFractal, QT_TRANSLATE_NOOP("FastNoiseGem", "Cubic Fractal"))
                    ->DataElement(AZ::Edit::UIHandlers::Slider, &FastNoiseGradientConfig::m_frequency, QT_TRANSLATE_NOOP("FastNoiseGem", "Frequency"), QT_TRANSLATE_NOOP("FastNoiseGem", "Higher frequencies are more coarse"))
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Slider, &FastNoiseGradientConfig::m_octaves, QT_TRANSLATE_NOOP("FastNoiseGem", "Octaves"), QT_TRANSLATE_NOOP("FastNoiseGem", "Number of recursions in the pattern generation, higher octaves refine the pattern"))
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Slider, &FastNoiseGradientConfig::m_lacunarity, QT_TRANSLATE_NOOP("FastNoiseGem", "Lacunarity"), QT_TRANSLATE_NOOP("FastNoiseGem", "The frequency multiplier between each octave"))
                    ->Attribute(AZ::Edit::Attributes::Min, 0.f)
                    ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                    ->Attribute(AZ::Edit::Attributes::SoftMax, 5.f)
                    ->Attribute(AZ::Edit::Attributes::Visibility, &FastNoiseGradientConfig::GetFractalParameterVisbility)
                    ->DataElement(AZ::Edit::UIHandlers::Slider, &FastNoiseGradientConfig::m_gain, QT_TRANSLATE_NOOP("FastNoiseGem", "Gain"), QT_TRANSLATE_NOOP("FastNoiseGem", "The relative strength of noise from each layer when compared to the last"))
                    ->Attribute(AZ::Edit::Attributes::Min, 0.f)
                    ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                    ->Attribute(AZ::Edit::Attributes::SoftMax, 5.f)
                    ->Attribute(AZ::Edit::Attributes::Visibility, &FastNoiseGradientConfig::GetFractalParameterVisbility)
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FastNoiseGradientConfig::m_cellularDistanceFunction, QT_TRANSLATE_NOOP("FastNoiseGem", "Distance Function"), QT_TRANSLATE_NOOP("FastNoiseGem", "Sets the distance function used to calculate the cell for a given point"))
                    ->Attribute(AZ::Edit::Attributes::Visibility, &FastNoiseGradientConfig::GetCellularParameterVisibility)
                    ->EnumAttribute(FastNoise::CellularDistanceFunction::Euclidean, QT_TRANSLATE_NOOP("FastNoiseGem", "Euclidean"))
                    ->EnumAttribute(FastNoise::CellularDistanceFunction::Manhattan, QT_TRANSLATE_NOOP("FastNoiseGem", "Manhattan"))
                    ->EnumAttribute(FastNoise::CellularDistanceFunction::Natural, QT_TRANSLATE_NOOP("FastNoiseGem", "Natural"))
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FastNoiseGradientConfig::m_cellularReturnType, QT_TRANSLATE_NOOP("FastNoiseGem", "Return Type"), QT_TRANSLATE_NOOP("FastNoiseGem", "Alters the value type the cellular function returns from its calculation"))
                    ->Attribute(AZ::Edit::Attributes::Visibility, &FastNoiseGradientConfig::GetCellularParameterVisibility)
                    ->EnumAttribute(FastNoise::CellularReturnType::CellValue, QT_TRANSLATE_NOOP("FastNoiseGem", "CellValue"))
                    ->EnumAttribute(FastNoise::CellularReturnType::Distance, QT_TRANSLATE_NOOP("FastNoiseGem", "Distance"))
                    ->EnumAttribute(FastNoise::CellularReturnType::Distance2, QT_TRANSLATE_NOOP("FastNoiseGem", "Distance2"))
                    ->EnumAttribute(FastNoise::CellularReturnType::Distance2Add, QT_TRANSLATE_NOOP("FastNoiseGem", "Distance2Add"))
                    ->EnumAttribute(FastNoise::CellularReturnType::Distance2Sub, QT_TRANSLATE_NOOP("FastNoiseGem", "Distance2Sub"))
                    ->EnumAttribute(FastNoise::CellularReturnType::Distance2Mul, QT_TRANSLATE_NOOP("FastNoiseGem", "Distance2Mul"))
                    ->EnumAttribute(FastNoise::CellularReturnType::Distance2Div, QT_TRANSLATE_NOOP("FastNoiseGem", "Distance2Div"))
                    ->DataElement(AZ::Edit::UIHandlers::Slider, &FastNoiseGradientConfig::m_cellularJitter, QT_TRANSLATE_NOOP("FastNoiseGem", "Jitter"), QT_TRANSLATE_NOOP("FastNoiseGem", "Sets the maximum distance a cellular point can move from its grid position"))
                    ->Attribute(AZ::Edit::Attributes::Min, 0.f)
                    ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                    ->Attribute(AZ::Edit::Attributes::SoftMax, 10.f)
                    ->Attribute(AZ::Edit::Attributes::Visibility, &FastNoiseGradientConfig::GetCellularParameterVisibility)
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("FastNoiseGem", "FastNoise Advanced Settings"))
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FastNoiseGradientConfig::m_interp, QT_TRANSLATE_NOOP("FastNoiseGem", "Interpolation"), QT_TRANSLATE_NOOP("FastNoiseGem", "Changes the interpolation method used to smooth between noise values"))
                    ->Attribute(AZ::Edit::Attributes::Visibility, &FastNoiseGradientConfig::GetInterpParameterVisibility)
                    ->EnumAttribute(FastNoise::Interp::Linear, QT_TRANSLATE_NOOP("FastNoiseGem", "Linear"))
                    ->EnumAttribute(FastNoise::Interp::Hermite, QT_TRANSLATE_NOOP("FastNoiseGem", "Hermite"))
                    ->EnumAttribute(FastNoise::Interp::Quintic, QT_TRANSLATE_NOOP("FastNoiseGem", "Quintic"))
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FastNoiseGradientConfig::m_fractalType, QT_TRANSLATE_NOOP("FastNoiseGem", "Fractal Type"), QT_TRANSLATE_NOOP("FastNoiseGem", "Sets how the fractal is combined"))
                    ->Attribute(AZ::Edit::Attributes::Visibility, &FastNoiseGradientConfig::GetFractalParameterVisbility)
                    ->EnumAttribute(FastNoise::FractalType::FBM, QT_TRANSLATE_NOOP("FastNoiseGem", "FBM"))
                    ->EnumAttribute(FastNoise::FractalType::Billow, QT_TRANSLATE_NOOP("FastNoiseGem", "Billow"))
                    ->EnumAttribute(FastNoise::FractalType::RigidMulti, QT_TRANSLATE_NOOP("FastNoiseGem", "Rigid Multi"))
                    ;
            }
        }
