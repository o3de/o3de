...
namespace ScriptCanvas
{
    ...
    {        
        ...
        {
            SC_RUNTIME_ASSERT(resultBVP && resultBVP->m_value, "This function is only expected for BehaviorConext bound event handling, and must always have a location for a return value");
