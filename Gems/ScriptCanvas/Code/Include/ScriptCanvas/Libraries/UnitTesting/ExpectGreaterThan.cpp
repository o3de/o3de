...
namespace ScriptCanvas
{
    namespace Nodes
    {
        namespace UnitTesting
        {
            ...
            void ExpectGreaterThan::OnInputSignal([[maybe_unused]] const SlotId& slotId)
            {
                ...
                {
                    SCRIPT_CANVAS_UNIT_TEST_LEGACY_NODE_COMPARE_IMPLEMENTATIONS(ExpectGreaterThan);
                }
