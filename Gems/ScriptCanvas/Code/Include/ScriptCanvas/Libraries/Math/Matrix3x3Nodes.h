...
namespace ScriptCanvas
{
    namespace Matrix3x3Nodes
    {
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromColumns, "Math/Matrix3x3", "{B6DCF2BC-DA3C-4BBD-ACF1-1AEF69AC2345}", "returns a rotation matrix based on angle around Z axis", "Column1", "Column2", "Column3");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromCrossProduct, "Math/Matrix3x3", "{C44601FB-8AE2-4B68-9EEA-732F00906695}", "returns a skew-symmetric cross product matrix based on supplied vector", "Source");

        AZ_INLINE Data::Matrix3x3Type FromDiagonal(const Data::Vector3Type& source)
        {
            return Data::Matrix3x3Type::CreateDiagonal(source);
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromDiagonal, "Math/Matrix3x3", "{B32389F0-AE61-4CEA-838B-C61363358C76}", "returns a diagonal matrix using the supplied vector", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromQuaternion, "Math/Matrix3x3", "{08EACF1F-E32F-4099-8F87-DFC9BF485FBA}", "returns a rotation matrix using the supplied quaternion", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromRotationXDegrees, "Math/Matrix3x3", "{D4808156-62E8-44B4-A39F-A5D2568C23FB}", "returns a rotation matrix representing a rotation in degrees around X-axis", "Degrees");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromRotationYDegrees, "Math/Matrix3x3", "{F0AD7957-987F-4DE3-92B3-9C56D8B2855A}", "returns a rotation matrix representing a rotation in degrees around Y-axis", "Degrees");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromRows, "Math/Matrix3x3", "{8C303C56-000A-4C2E-8A50-9DEF58007C1E}", "returns a matrix from three row", "Row1", "Row2", "Row3");

        AZ_INLINE Data::Matrix3x3Type FromScale(const Data::Vector3Type& source)
        {
            return Data::Matrix3x3Type::CreateScale(source);
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromScale, "Math/Matrix3x3", "{C6833356-DBDE-477D-8E4E-CAB6FE918D01}", "returns a scale matrix using the supplied vector", "Scale");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromTransform, "Math/Matrix3x3", "{F570C56A-2E7B-4FB7-8E86-FC2C52C0F5E8}", "returns a matrix using the supplied transform", "Transform");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetColumn, "Math/Matrix3x3", "{43051443-0691-461D-9615-EE9FDA54C826}", "returns vector from matrix corresponding to the Column index", "Source", "Column");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_MULTI_RESULTS_NODE(GetColumns, "Math/Matrix3x3", "{3F00356D-4435-4554-9363-7F9CA599D287}", "returns all columns from matrix", "Source", "Column1", "Column2", "Column3");

        AZ_INLINE Data::Vector3Type GetDiagonal(const Data::Matrix3x3Type& source)
        {
            return source.GetDiagonal();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetDiagonal, "Math/Matrix3x3", "{BC0FBCF4-E063-4705-A46F-0C9F9B39DFC5}", "returns vector of matrix diagonal values", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetElement, "Math/Matrix3x3", "{FA9C7B9F-ECEF-48FB-9AB0-8CAF07B2EF82}", "returns scalar from matrix corresponding to the (Row,Column) pair", "Source", "Row", "Column");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetRow, "Math/Matrix3x3", "{C4E00343-3642-4B09-8CFA-2D2F1CA6D595}", "returns vector from matrix corresponding to the Row index", "Source", "Row");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_MULTI_RESULTS_NODE(GetRows, "Math/Matrix3x3", "{DDF76F4C-0C79-4856-B577-7DBA092CE59B}", "returns all rows from matrix", "Source", "Row1", "Row2", "Row3");

        AZ_INLINE Data::Matrix3x3Type Invert(const Data::Matrix3x3Type& source)
        {
            return source.GetInverseFull();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(Invert, "Math/Matrix3x3", "{E2771F5F-C674-4E7C-82F1-CD19C2798CA0}", "returns inverse of Matrix", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(IsFinite, "Math/Matrix3x3", "{63CF6F9A-3DC4-4393-B63C-91FF1FDE540F}", "returns true if all numbers in matrix is finite", "Source");

        AZ_INLINE Data::BooleanType IsOrthogonal(const Data::Matrix3x3Type& source)
        {
            return source.IsOrthogonal();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(IsOrthogonal, "Math/Matrix3x3", "{1277CE0F-2F2F-4DF8-9505-90A721DED72F}", "returns true if the matrix is orthogonal", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(MultiplyByNumber, "Math/Matrix3x3", "{E74EFEA0-68B1-4490-BF65-2A2A33BDA666}", "returns matrix created from multiply the source matrix by Multiplier", "Source", "Multiplier");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(MultiplyByVector, "Math/Matrix3x3", "{EBED6839-291D-4474-95E6-B810B3564774}", "returns vector created by right left multiplying matrix by supplied vector", "Source", "Vector");

        AZ_INLINE Data::Matrix3x3Type Orthogonalize(const Data::Matrix3x3Type& source)
        {
            return source.GetOrthogonalized();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(Orthogonalize, "Math/Matrix3x3", "{593599AB-BAE4-4DA3-B03F-238210204D26}", "returns an orthogonal matrix from the Source matrix", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(ToAdjugate, "Math/Matrix3x3", "{4ECACBEB-714D-4DF6-823F-CE3329B4C705}", "returns the transpose of Matrix of cofactors", "Source");

        AZ_INLINE Data::NumberType ToDeterminant(const Data::Matrix3x3Type& source)
        {
            return source.GetDeterminant();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(ToDeterminant, "Math/Matrix3x3", "{3D7F3B86-63ED-4FC3-8862-2D2721D1D61B}", "returns determinant of Matrix", "Source", "Determinant");

        AZ_INLINE Data::Vector3Type ToScale(const Data::Matrix3x3Type& source)
        {
            return source.RetrieveScale();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(ToScale, "Math/Matrix3x3", "{B5099DB1-9072-4781-AC20-839367AB97D1}", "returns scale part of the transformation matrix", "Source");

        AZ_INLINE Data::Matrix3x3Type Transpose(const Data::Matrix3x3Type& source)
        {
            return source.GetTranspose();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(Transpose, "Math/Matrix3x3", "{99EDAA4D-A427-4404-925D-7F8FF41646FB}", "returns transpose of Matrix", "Source");

        AZ_INLINE Data::Matrix3x3Type Zero()
        {
            return Data::Matrix3x3Type::CreateZero();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(Zero, "Math/Matrix3x3", "{E5E7A9DA-0B7B-49BA-9350-D5876CF870E6}", "returns the zero matrix");
