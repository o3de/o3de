...
namespace ScriptCanvas
{
    namespace Matrix4x4Nodes
    {
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromColumns, "Math/Matrix4x4", "{7A5CDFCC-9BD1-493F-8959-B1868302CD1D}", "returns a rotation matrix based on angle around Z axis", "Column1", "Column2", "Column3", "Column4");

        AZ_INLINE Data::Matrix4x4Type FromDiagonal(const Data::Vector4Type& source)
        {
            return Data::Matrix4x4Type::CreateDiagonal(source);
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromDiagonal, "Math/Matrix4x4", "{24F755B3-230C-45FE-86FC-C6A0ED219C9D}", "returns a diagonal matrix using the supplied vector", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromQuaternionAndTranslation, "Math/Matrix4x4", "{2B16CA4D-8F05-4917-B708-BEF24CBFB1EB}", "returns a skew-symmetric cross product matrix based on supplied vector", "Rotation", "Translation");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromProjection, "Math/Matrix4x4", "{8684FF66-D8EE-4AB7-B9A2-3EE833ADFF87}", "returns a projection matrix using the supplied vertical FOV and aspect ratio", "Vertical FOV", "Aspect Ratio", "Near", "Far");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromProjectionFov, "Math/Matrix4x4", "{3525FAB0-F490-4081-BC63-F5713A637383}", "returns a projection matrix using the supplied vertical FOV and horizontal FOV", "Vertical FOV", "Horizontal FOV", "Near", "Far");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromProjectionVolume, "Math/Matrix4x4", "{39F295E7-E835-4491-A5F0-5B44C3E47BDF}", "returns a projection matrix center around the (left, right, bottom, top) values", "Left", "Right", "Bottom", "Top", "Near", "Far");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromRotationXDegrees, "Math/Matrix4x4", "{07107536-86B0-4927-A304-DF580419F839}", "returns a rotation matrix representing a rotation in degrees around X-axis", "Degrees");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromRotationYDegrees, "Math/Matrix4x4", "{11323B35-6BB0-4402-BDD6-98BE75E6CF99}", "returns a rotation matrix representing a rotation in degrees around Y-axis", "Degrees");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromRotationZDegrees, "Math/Matrix4x4", "{1D520FBD-EB39-4EA0-BFA0-CE5834C076F2}", "returns a rotation matrix representing a rotation in degrees around Z-axis", "Degrees");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromRows, "Math/Matrix4x4", "{F62339F3-0F88-4C23-86DA-920540488A46}", "returns a matrix from three row", "Row1", "Row2", "Row3", "Row4");

        AZ_INLINE Data::Matrix4x4Type FromScale(const Data::Vector3Type& source)
        {
            return Data::Matrix4x4Type::CreateScale(source);
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromScale, "Math/Matrix4x4", "{017C6716-DCEE-4D49-A593-4F6B9B18954F}", "returns a scale matrix using the supplied vector", "Scale");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromTranslation, "Math/Matrix4x4", "{70E5B6E4-D071-4CD5-BDA0-90C8885B38A4}", "returns a skew-symmetric cross product matrix based on supplied vector", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromTransform, "Math/Matrix4x4", "{34E3A8AF-D6B4-4841-A63B-A28B0DF07C1E}", "returns a matrix using the supplied transform", "Transform");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetColumn, "Math/Matrix4x4", "{0FB960BE-8BDE-487F-A153-EDC5E22B1C02}", "returns vector from matrix corresponding to the Column index", "Source", "Column");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_MULTI_RESULTS_NODE(GetColumns, "Math/Matrix4x4", "{7F1BDAEE-2BEE-4029-AC97-B5922A3CD3D4}", "returns all columns from matrix", "Source", "Column1", "Column2", "Column3", "Column4");

        AZ_INLINE Data::Vector4Type GetDiagonal(const Data::Matrix4x4Type& source)
        {
            return source.GetDiagonal();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetDiagonal, "Math/Matrix4x4", "{DA8E7E0C-7702-4E34-81EA-1F40B03356A3}", "returns vector of matrix diagonal values", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetElement, "Math/Matrix4x4", "{66428D28-2FE8-473E-B5B8-A2B4451CA4F3}", "returns scalar from matrix corresponding to the (Row,Column) pair", "Source", "Row", "Column");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetRow, "Math/Matrix4x4", "{D96FCA17-206B-4A19-A08B-28BB4FDBF75C}", "returns vector from matrix corresponding to the Row index", "Source", "Row");

        AZ_INLINE Data::Vector3Type GetTranslation(const Data::Matrix4x4Type& source)
        {
            return source.GetTranslation();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(GetTranslation, "Math/Matrix4x4", "{D69E296E-FC38-4273-8619-FC7D2F29BC19}", "returns translation vector from the matrix", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(Invert, "Math/Matrix4x4", "{3C691878-0E1C-4D6A-8226-070A31F6FFD8}", "returns inverse of Matrix", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE_WITH_DEFAULTS(IsClose, MathNodeUtilities::DefaultToleranceSIMD<2>, "Math/Matrix4x4", "{D14CE5BA-67A8-44C8-8E5B-F19F270ACB0E}",
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(IsFinite, "Math/Matrix4x4", "{5B9B6735-3593-41CE-9329-36F8B96893A2}", "returns true if all numbers in matrix is finite", "Source");
        ...
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(MultiplyByVector, "Math/Matrix4x4", "{5D5CEC9B-DBBD-4C43-BC01-8C637A4B1F14}", "returns vector created by right left multiplying matrix by supplied vector", "Source", "Vector");

        AZ_INLINE Data::Vector3Type ToScale(const Data::Matrix4x4Type& source)
        {
            return source.RetrieveScale();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(ToScale, "Math/Matrix4x4", "{A6B79A2C-4B73-4F62-81E4-28F5A013FCEE}", "returns scale part of the transformation matrix", "Source");

        AZ_INLINE Data::Matrix4x4Type Transpose(const Data::Matrix4x4Type& source)
        {
            return source.GetTranspose();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(Transpose, "Math/Matrix4x4", "{B93735CF-F56B-4BB4-B10B-1CEEB0EB2C4A}", "returns transpose of Matrix", "Source");

        AZ_INLINE Data::Matrix4x4Type Zero()
        {
            return Data::Matrix4x4Type::CreateZero();
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(Zero, "Math/Matrix4x4", "{E9EE8687-3A98-415C-A8D5-CACF34C056EA}", "returns the zero matrix");
