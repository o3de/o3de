...
namespace ScriptCanvasEditor
{
    namespace EditorSettings
    {
        ...
        void EditorWorkspace::Init(const QByteArray& windowState)
        {
        ...
        void EditorWorkspace::Restore(MainWindow* window)
        {
        ...
        void ScriptCanvasEditorSettings::OnConstructPresetsChanged([[maybe_unused]] GraphCanvas::ConstructType constructType)
        {
