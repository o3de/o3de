...
namespace ScriptCanvasEditor
{
    ...
    public:
        AZ_CLASS_ALLOCATOR(VersionExplorerLog, AZ::SystemAllocator, 0);

        explicit VersionExplorerLog(QWidget* parent = nullptr);
        ~VersionExplorerLog();
    ...
    private:
        ...
        AZStd::unique_ptr<Ui::VersionExplorerLog> m_ui;
