...
// Function Nodes
    ...
    AZ::EntityId DisplayFunctionNode(AZ::EntityId, ScriptCanvas::Nodes::Core::FunctionNode* functionNode)
    {
        AZ::EntityId graphCanvasNodeId;
...
///////////////////
    ...
    AZ::EntityId DisplayScriptCanvasSlot(AZ::EntityId graphCanvasNodeId, const ScriptCanvas::Slot& slot, GraphCanvas::SlotGroup slotGroup)
    {
        ...
        if (slot.IsExecution())
        {
            ...
            if (slot.IsLatent())
            {
                executionConfiguration.m_textDecoration = "🕒";
        ...
        else if (slot.IsData())
        {
            ...
            if (slot.IsLatent())
            {
                dataSlotConfiguration.m_textDecoration = "🕒";
