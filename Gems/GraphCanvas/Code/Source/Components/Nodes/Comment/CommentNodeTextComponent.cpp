...
namespace GraphCanvas
{
    ...
    void CommentNodeTextComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            ...
            if (editContext)
            {
                editContext->Class < CommentNodeTextSaveData >(QT_TRANSLATE_NOOP("GraphCanvas", "SaveData"), QT_TRANSLATE_NOOP("GraphCanvas", "The save information regarding a comment node"))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "Properties")
                        ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &CommentNodeTextSaveData::m_comment, QT_TRANSLATE_NOOP("GraphCanvas", "Title"), QT_TRANSLATE_NOOP("GraphCanvas", "The comment to display on this node"))
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &CommentNodeTextSaveData::m_backgroundColor, QT_TRANSLATE_NOOP("GraphCanvas", "Background Color"), QT_TRANSLATE_NOOP("GraphCanvas", "The background color to display the node comment on"))
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &CommentNodeTextSaveData::m_fontConfiguration, QT_TRANSLATE_NOOP("GraphCanvas", "Font Settings"), QT_TRANSLATE_NOOP("GraphCanvas", "The font settings used to render the font in the comment."))
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &CommentNodeTextSaveData::UpdateStyleOverrides)
                ;

                editContext->Class<CommentNodeTextComponent>(QT_TRANSLATE_NOOP("GraphCanvas", "Comment"), QT_TRANSLATE_NOOP("GraphCanvas", "The node's customizable properties"))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "Properties")
                        ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &CommentNodeTextComponent::m_saveData, QT_TRANSLATE_NOOP("GraphCanvas", "SaveData"), QT_TRANSLATE_NOOP("GraphCanvas", "The modifiable information about this comment."))
                ;

                editContext->Class<FontConfiguration>(QT_TRANSLATE_NOOP("GraphCanvas", "Font Settings"), QT_TRANSLATE_NOOP("GraphCanvas", "Various settings used to control a font."))
                    ->DataElement(AZ::Edit::UIHandlers::Default, &FontConfiguration::m_fontColor, QT_TRANSLATE_NOOP("GraphCanvas", "Font Color"), QT_TRANSLATE_NOOP("GraphCanvas", "The color that the font of this comment should render with"))
                    ->DataElement(AZ::Edit::UIHandlers::Default, &FontConfiguration::m_fontFamily, QT_TRANSLATE_NOOP("GraphCanvas", "Font Family"), QT_TRANSLATE_NOOP("GraphCanvas", "The font family to use when rendering this comment."))
                    ->DataElement(AZ::Edit::UIHandlers::Default, &FontConfiguration::m_pixelSize, QT_TRANSLATE_NOOP("GraphCanvas", "Pixel Size"), QT_TRANSLATE_NOOP("GraphCanvas", "The size of the font(in pixels)"))
                        ->Attribute(AZ::Edit::Attributes::Min, 1)
                        ->Attribute(AZ::Edit::Attributes::Max, 200)
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FontConfiguration::m_weight, QT_TRANSLATE_NOOP("GraphCanvas", "Weight"), QT_TRANSLATE_NOOP("GraphCanvas", "The weight of the font"))
                        ->EnumAttribute(QFont::Thin, QT_TRANSLATE_NOOP("GraphCanvas", "Thin"))
                        ->EnumAttribute(QFont::ExtraLight, QT_TRANSLATE_NOOP("GraphCanvas", "Extra Light"))
                        ->EnumAttribute(QFont::Light, QT_TRANSLATE_NOOP("GraphCanvas", "Light"))
                        ->EnumAttribute(QFont::Normal, QT_TRANSLATE_NOOP("GraphCanvas", "Normal"))
                        ->EnumAttribute(QFont::Medium, QT_TRANSLATE_NOOP("GraphCanvas", "Medium"))
                        ->EnumAttribute(QFont::DemiBold, QT_TRANSLATE_NOOP("GraphCanvas", "Demi-Bold"))
                        ->EnumAttribute(QFont::Bold, QT_TRANSLATE_NOOP("GraphCanvas", "Bold"))
                        ->EnumAttribute(QFont::ExtraBold, QT_TRANSLATE_NOOP("GraphCanvas", "Extra Bold"))
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FontConfiguration::m_style, QT_TRANSLATE_NOOP("GraphCanvas", "Style"), QT_TRANSLATE_NOOP("GraphCanvas", "The style of the font"))
                        ->EnumAttribute(QFont::Style::StyleNormal, QT_TRANSLATE_NOOP("GraphCanvas", "Normal"))
                        ->EnumAttribute(QFont::Style::StyleItalic, QT_TRANSLATE_NOOP("GraphCanvas", "Italic"))
                        ->EnumAttribute(QFont::Style::StyleOblique, QT_TRANSLATE_NOOP("GraphCanvas", "Oblique"))
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FontConfiguration::m_verticalAlignment, QT_TRANSLATE_NOOP("GraphCanvas", "Vertical Alignment"), QT_TRANSLATE_NOOP("GraphCanvas", "The Vertical Alignment of the font"))
                        ->EnumAttribute(Qt::AlignmentFlag::AlignTop, QT_TRANSLATE_NOOP("GraphCanvas", "Top"))
                        ->EnumAttribute(Qt::AlignmentFlag::AlignVCenter, QT_TRANSLATE_NOOP("GraphCanvas", "Middle"))
                        ->EnumAttribute(Qt::AlignmentFlag::AlignBottom, QT_TRANSLATE_NOOP("GraphCanvas", "Bottom"))
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &FontConfiguration::m_horizontalAlignment, QT_TRANSLATE_NOOP("GraphCanvas", "Horizontal Alignment"), QT_TRANSLATE_NOOP("GraphCanvas", "The Horizontal Alignment of the font"))
                        ->EnumAttribute(Qt::AlignmentFlag::AlignLeft, QT_TRANSLATE_NOOP("GraphCanvas", "Left"))
                        ->EnumAttribute(Qt::AlignmentFlag::AlignHCenter, QT_TRANSLATE_NOOP("GraphCanvas", "Center"))
                        ->EnumAttribute(Qt::AlignmentFlag::AlignRight, QT_TRANSLATE_NOOP("GraphCanvas", "Right"))
                    ;
            }
        }
    }
