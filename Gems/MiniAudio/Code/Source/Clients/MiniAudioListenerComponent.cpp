    ...
    void MiniAudioListenerComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (auto behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context))
        {
            ...
            behaviorContext->EBus<MiniAudioListenerRequestBus>("MiniAudioListenerRequestBus")
                ...
                ->Event("SetInnerConeAngleInRadians", &MiniAudioListenerRequests::SetInnerAngleInRadians)
                ->Event("GetInnerConeAngleInDegrees", &MiniAudioListenerRequests::GetInnerAngleInDegrees)
                ->Event("SetInnerConeAngleInDegrees", &MiniAudioListenerRequests::SetInnerAngleInDegrees)
                ->Event("GetOuterConeAngleInRadians", &MiniAudioListenerRequests::GetOuterAngleInRadians)
                ->Event("SetOuterConeAngleInRadians", &MiniAudioListenerRequests::SetOuterAngleInRadians)
                ->Event("GetOuterConeAngleInDegrees", &MiniAudioListenerRequests::GetOuterAngleInDegrees)
                ->Event("SetOuterConeAngleInDegrees", &MiniAudioListenerRequests::SetOuterAngleInDegrees)
                ->Event("GetOuterVolume", &MiniAudioListenerRequests::GetOuterVolume)
                ->Event("SetOuterVolume", &MiniAudioListenerRequests::SetOuterVolume)
                ;
