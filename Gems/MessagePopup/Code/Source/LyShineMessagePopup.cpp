    ...
    void LyShineMessagePopup::OnShowPopup(AZ::u32 _popupID, const AZStd::string& _message, EPopupButtons _buttons, EPopupKind _kind, AZStd::function<void(int _button)> _callback, void** _popupClientID)
    {
        ...
        if (_kind == EPopupKind_Generic)
        {
            ...
            case EPopupButtons::EPopupButtons_NoButtons:
                canvasEntityId = gEnv->pLyShine->LoadCanvas("@projectproductassets@/ui/canvases/defaultmessagepopup.uicanvas");
                break;
            case EPopupButtons::EPopupButtons_Confirm:
                canvasEntityId = gEnv->pLyShine->LoadCanvas("@projectproductassets@/ui/canvases/defaultmessagepopup_confirm.uicanvas");
                isNavigationSupported = true;
                break;
            case EPopupButtons::EPopupButtons_YesNo:
                canvasEntityId = gEnv->pLyShine->LoadCanvas("@projectproductassets@/ui/canvases/defaultmessagepopup_yesno.uicanvas");
                isNavigationSupported = true;
                break;
            }
        }
        ...
        {
            canvasEntityId = gEnv->pLyShine->LoadCanvas("@projectproductassets@/ui/canvases/toaster.uicanvas");
        }
