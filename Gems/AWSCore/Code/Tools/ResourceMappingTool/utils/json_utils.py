...
def load_resource_mapping_json_schema(schema_path: str) -> None:
    ...
    if not _RESOURCE_MAPPING_SCHEMA:
        ...
        schema_pattern_properties: Dict[str, any] = \
            _RESOURCE_MAPPING_SCHEMA[_RESOURCE_MAPPING_SCHEMA_PROPERTIES_KEY_NAME][_RESOURCE_MAPPING_JSON_KEY_NAME][_RESOURCE_MAPPING_SCHEMA_PATTERN_PROPERTIES_KEY_NAME]
        ...
        _RESOURCE_MAPPING_SCHEMA_VERSION_PATTERN = \
            _RESOURCE_MAPPING_SCHEMA[_RESOURCE_MAPPING_SCHEMA_PROPERTIES_KEY_NAME][_RESOURCE_MAPPING_VERSION_JSON_KEY_NAME][_RESOURCE_MAPPING_SCHEMA_PROPERTY_PATTERN_KEY_NAME]
