        ...
        if (serialize)
        {
            ...
            if (edit)
            {
                edit->Class<Descriptor>(
                    ...
                    ->DataElement(0, &Descriptor::m_weight, QT_TRANSLATE_NOOP("Vegetation", "Weight"), QT_TRANSLATE_NOOP("Vegetation", "Weight counted against the total density of the placed vegetation sector"))
                    ->DataElement(0, &Descriptor::m_advanced, QT_TRANSLATE_NOOP("Vegetation", "Display Per-Item Overrides"), QT_TRANSLATE_NOOP("Vegetation", "Display the per-item override settings that can be used with filter and modifier components when those components have 'Allow Per-Item Overrides' enabled."))
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Position Modifier"))
                        ...
                        ->DataElement(0, &Descriptor::m_positionOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Position Modifier has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Rotation Modifier"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(0, &Descriptor::m_rotationOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Rotation Modifier has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Scale Modifier"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(0, &Descriptor::m_scaleOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Scale Modifier has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Altitude Filter"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(0, &Descriptor::m_altitudeFilterOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Altitude Filter has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(0, &Descriptor::m_altitudeFilterMin, QT_TRANSLATE_NOOP("Vegetation", "Min"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsAltitudeFilterReadOnly)
                        ->DataElement(0, &Descriptor::m_altitudeFilterMax, QT_TRANSLATE_NOOP("Vegetation", "Max"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsAltitudeFilterReadOnly)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Distance Between Filter (Radius)"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(0, &Descriptor::m_radiusOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Distance Between Filter has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Surface Slope Alignment"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(0, &Descriptor::m_surfaceAlignmentOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Surface Slope Alignment Modifier has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Slope Filter"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(0, &Descriptor::m_slopeFilterOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Slope Filter has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Surface Mask Filter"))
                        ...
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(0, &Descriptor::m_inclusiveSurfaceFilterTags, QT_TRANSLATE_NOOP("Vegetation", "Inclusion Tags"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsSurfaceTagFilterReadOnly)
                        ->DataElement(0, &Descriptor::m_exclusiveSurfaceFilterTags, QT_TRANSLATE_NOOP("Vegetation", "Exclusion Tags"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsSurfaceTagFilterReadOnly)
                    ->EndGroup()

                    ->DataElement(0, &Descriptor::m_surfaceTagDistance, QT_TRANSLATE_NOOP("Vegetation", "Surface Mask Depth Filter"), "")
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
        ...
        if (serialize)
        {
            ...
            if (edit)
            {
                edit->Class<SurfaceTagDistance>(
                    ...
                    ->DataElement(0, &SurfaceTagDistance::m_tags, QT_TRANSLATE_NOOP("Vegetation", "Surface Tags"), QT_TRANSLATE_NOOP("Vegetation", "The surface tags to compare the distance from the planting tag to."))
                    ->DataElement(0, &SurfaceTagDistance::m_upperDistanceInMeters, QT_TRANSLATE_NOOP("Vegetation", "Upper Distance Range (m)"), QT_TRANSLATE_NOOP("Vegetation", "Upper Distance in meters from comparison surface, negative for below"))
                    ->DataElement(0, &SurfaceTagDistance::m_lowerDistanceInMeters, QT_TRANSLATE_NOOP("Vegetation", "Lower Distance Range (m)"), QT_TRANSLATE_NOOP("Vegetation", "Lower Distance in meters from comparison surface, negative for below"))
                    ;
            }
        }
