        ...
        if (serialize)
        {
            ...
            if (edit)
            {
                edit->Class<Descriptor>(
                    QT_TRANSLATE_NOOP("Vegetation", "Vegetation Descriptor"), QT_TRANSLATE_NOOP("Vegetation", "Details used to create vegetation instances"))
                    // For this ComboBox to actually work, there is a PropertyHandler registration in EditorVegetationSystemComponent.cpp
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &Descriptor::m_spawnerType, QT_TRANSLATE_NOOP("Vegetation", "Instance Spawner"), QT_TRANSLATE_NOOP("Vegetation", "The type of instances to spawn"))
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &Descriptor::m_instanceSpawner, QT_TRANSLATE_NOOP("Vegetation", "Instance"), QT_TRANSLATE_NOOP("Vegetation", "Instance data"))
                        ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->DataElement(nullptr, &Descriptor::m_weight, QT_TRANSLATE_NOOP("Vegetation", "Weight"), QT_TRANSLATE_NOOP("Vegetation", "Weight counted against the total density of the placed vegetation sector"))
                    ->DataElement(nullptr, &Descriptor::m_advanced, QT_TRANSLATE_NOOP("Vegetation", "Display Per-Item Overrides"), QT_TRANSLATE_NOOP("Vegetation", "Display the per-item override settings that can be used with filter and modifier components when those components have 'Allow Per-Item Overrides' enabled."))
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)

                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Position Modifier"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(nullptr, &Descriptor::m_positionOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Position Modifier has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_positionMinX, QT_TRANSLATE_NOOP("Vegetation", "Min X"), QT_TRANSLATE_NOOP("Vegetation", "Minimum position offset on X axis."))
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_positionMaxX, QT_TRANSLATE_NOOP("Vegetation", "Max X"), QT_TRANSLATE_NOOP("Vegetation", "Maximum position offset on X axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -2.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 2.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsPositionFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_positionMinY, QT_TRANSLATE_NOOP("Vegetation", "Min Y"), QT_TRANSLATE_NOOP("Vegetation", "Minimum position offset on Y axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -2.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 2.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsPositionFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_positionMaxY, QT_TRANSLATE_NOOP("Vegetation", "Max Y"), QT_TRANSLATE_NOOP("Vegetation", "Maximum position offset on Y axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -2.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 2.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsPositionFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_positionMinZ, QT_TRANSLATE_NOOP("Vegetation", "Min Z"), QT_TRANSLATE_NOOP("Vegetation", "Minimum position offset on Z axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -2.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 2.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsPositionFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_positionMaxZ, QT_TRANSLATE_NOOP("Vegetation", "Max Z"), QT_TRANSLATE_NOOP("Vegetation", "Maximum position offset on Z axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -2.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 2.0f)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Rotation Modifier"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(nullptr, &Descriptor::m_rotationOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Rotation Modifier has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_rotationMinX, QT_TRANSLATE_NOOP("Vegetation", "Min X"), QT_TRANSLATE_NOOP("Vegetation", "Minimum rotation offset on X axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_rotationMaxX, QT_TRANSLATE_NOOP("Vegetation", "Max X"), QT_TRANSLATE_NOOP("Vegetation", "Maximum rotation offset on X axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -180.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 180.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsRotationFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_rotationMinY, QT_TRANSLATE_NOOP("Vegetation", "Min Y"), QT_TRANSLATE_NOOP("Vegetation", "Minimum rotation offset on Y axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -180.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 180.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsRotationFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_rotationMaxY, QT_TRANSLATE_NOOP("Vegetation", "Max Y"), QT_TRANSLATE_NOOP("Vegetation", "Maximum rotation offset on Y axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -180.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 180.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsRotationFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_rotationMinZ, QT_TRANSLATE_NOOP("Vegetation", "Min Z"), QT_TRANSLATE_NOOP("Vegetation", "Minimum rotation offset on Z axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -180.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 180.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsRotationFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_rotationMaxZ, QT_TRANSLATE_NOOP("Vegetation", "Max Z"), QT_TRANSLATE_NOOP("Vegetation", "Maximum rotation offset on Z axis."))
                            ->Attribute(AZ::Edit::Attributes::Min, std::numeric_limits<float>::lowest())
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                            ->Attribute(AZ::Edit::Attributes::SoftMin, -180.0f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 180.0f)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Scale Modifier"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(nullptr, &Descriptor::m_scaleOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Scale Modifier has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_scaleMin, QT_TRANSLATE_NOOP("Vegetation", "Min"), "")
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_scaleMax, QT_TRANSLATE_NOOP("Vegetation", "Max"), "")
                            ->Attribute(AZ::Edit::Attributes::Min, 0.01f)
                            ->Attribute(AZ::Edit::Attributes::SoftMax, 10.0f)
                            ->Attribute(AZ::Edit::Attributes::Step, 0.125f)
                            ->Attribute(AZ::Edit::Attributes::Max, std::numeric_limits<float>::max())
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Altitude Filter"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(nullptr, &Descriptor::m_altitudeFilterOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Altitude Filter has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(nullptr, &Descriptor::m_altitudeFilterMin, QT_TRANSLATE_NOOP("Vegetation", "Min"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsAltitudeFilterReadOnly)
                        ->DataElement(nullptr, &Descriptor::m_altitudeFilterMax, QT_TRANSLATE_NOOP("Vegetation", "Max"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsAltitudeFilterReadOnly)

                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Distance Between Filter (Radius)"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(nullptr, &Descriptor::m_radiusOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Distance Between Filter has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &Descriptor::m_boundMode, QT_TRANSLATE_NOOP("Vegetation", "Bound Mode"), "")
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_radiusMin, QT_TRANSLATE_NOOP("Vegetation", "Radius Min"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Surface Slope Alignment"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(nullptr, &Descriptor::m_surfaceAlignmentOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Surface Slope Alignment Modifier has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_surfaceAlignmentMin, QT_TRANSLATE_NOOP("Vegetation", "Min"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                            ->Attribute(AZ::Edit::Attributes::Max, 1.0f)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsSurfaceAlignmentFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_surfaceAlignmentMax, QT_TRANSLATE_NOOP("Vegetation", "Max"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                            ->Attribute(AZ::Edit::Attributes::Max, 1.0f)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsSurfaceAlignmentFilterReadOnly)

                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Slope Filter"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(nullptr, &Descriptor::m_slopeFilterOverrideEnabled, QT_TRANSLATE_NOOP("Vegetation", "Override Enabled"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Slope Filter has 'Allow Per-Item Overrides' enabled."))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_slopeFilterMin, QT_TRANSLATE_NOOP("Vegetation", "Min"), "")
                            ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                            ->Attribute(AZ::Edit::Attributes::Max, 180.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsSlopeFilterReadOnly)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &Descriptor::m_slopeFilterMax, QT_TRANSLATE_NOOP("Vegetation", "Max"), "")
                            ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                            ->Attribute(AZ::Edit::Attributes::Max, 180.0f)
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsSlopeFilterReadOnly)

                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Surface Mask Filter"))
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, false)
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &Descriptor::m_surfaceFilterOverrideMode, QT_TRANSLATE_NOOP("Vegetation", "Override Mode"), QT_TRANSLATE_NOOP("Vegetation", "Enable per-item override settings for this item when the Surface Mask Filter has 'Allow Per-Item Overrides' enabled."))
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->EnumAttribute(OverrideMode::Disable, QT_TRANSLATE_NOOP("Vegetation", "Disable"))
                            ->EnumAttribute(OverrideMode::Replace, QT_TRANSLATE_NOOP("Vegetation", "Replace"))
                            ->EnumAttribute(OverrideMode::Extend, QT_TRANSLATE_NOOP("Vegetation", "Extend"))
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->DataElement(nullptr, &Descriptor::m_inclusiveSurfaceFilterTags, QT_TRANSLATE_NOOP("Vegetation", "Inclusion Tags"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsSurfaceTagFilterReadOnly)
                        ->DataElement(nullptr, &Descriptor::m_exclusiveSurfaceFilterTags, QT_TRANSLATE_NOOP("Vegetation", "Exclusion Tags"), "")
                            ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
                            ->Attribute(AZ::Edit::Attributes::ReadOnly, &Descriptor::IsSurfaceTagFilterReadOnly)
                    ->EndGroup()

                    ->DataElement(nullptr, &Descriptor::m_surfaceTagDistance, QT_TRANSLATE_NOOP("Vegetation", "Surface Mask Depth Filter"), "")
                        ->Attribute(AZ::Edit::Attributes::Visibility, &Descriptor::GetAdvancedGroupVisibility)
        ...
        if (serialize)
        {
            ...
            if (edit)
            {
                edit->Class<SurfaceTagDistance>(
                    QT_TRANSLATE_NOOP("Vegetation", "VegetationSurfaceTagDepth"), QT_TRANSLATE_NOOP("Vegetation", "Describes depth information for a vegetation object based on a tag to match with a surface mask"))
                    ->DataElement(nullptr, &SurfaceTagDistance::m_tags, QT_TRANSLATE_NOOP("Vegetation", "Surface Tags"), QT_TRANSLATE_NOOP("Vegetation", "The surface tags to compare the distance from the planting tag to."))
                    ->DataElement(nullptr, &SurfaceTagDistance::m_upperDistanceInMeters, QT_TRANSLATE_NOOP("Vegetation", "Upper Distance Range (m)"), QT_TRANSLATE_NOOP("Vegetation", "Upper Distance in meters from comparison surface, negative for below"))
                    ->DataElement(nullptr, &SurfaceTagDistance::m_lowerDistanceInMeters, QT_TRANSLATE_NOOP("Vegetation", "Lower Distance Range (m)"), QT_TRANSLATE_NOOP("Vegetation", "Lower Distance in meters from comparison surface, negative for below"))
                    ;
            }
        }
