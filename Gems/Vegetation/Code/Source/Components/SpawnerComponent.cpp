        ...
        if (serialize)
        {
            ...
            if (edit)
            {
                edit->Class<SpawnerConfig>(
                    ...
                    ->DataElement(nullptr, &SpawnerConfig::m_inheritBehavior, QT_TRANSLATE_NOOP("Vegetation", "Inherit Behavior"), QT_TRANSLATE_NOOP("Vegetation", "Allow shapes, modifiers, filters of a parent to affect this area."))
                    ->DataElement(nullptr, &SpawnerConfig::m_allowEmptyMeshes, QT_TRANSLATE_NOOP("Vegetation", "Allow Empty Assets"), QT_TRANSLATE_NOOP("Vegetation", "Allow unspecified asset references in the Descriptors to claim space and block other vegetation."))
