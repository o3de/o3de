        ...
        if (serialize)
        {
            ...
            if (edit)
            {
                edit->Class<SurfaceMaskFilterConfig>(
                    ...
                    ->DataElement(nullptr, &SurfaceMaskFilterConfig::m_allowOverrides, QT_TRANSLATE_NOOP("Vegetation", "Allow Per-Item Overrides"), QT_TRANSLATE_NOOP("Vegetation", "Allow per-descriptor parameters to override component parameters."))
                    ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("Vegetation", "Inclusion"))
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(nullptr, &SurfaceMaskFilterConfig::m_inclusiveSurfaceMasks, QT_TRANSLATE_NOOP("Vegetation", "Surface Tags"), "")
                    ...
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(nullptr, &SurfaceMaskFilterConfig::m_exclusiveSurfaceMasks, QT_TRANSLATE_NOOP("Vegetation", "Surface Tags"), "")
