...
namespace Vegetation
{
    ...
    public:
        ...
        static constexpr const char* const s_helpUrl = "https://www.o3de.org/docs/user-guide/components/reference/vegetation-filters/vegetation-surface-mask-depth-filter/";
    };
}
