    ...
    if (serialize)
    {
        ...
        if (edit)
        {
            edit->Class<DebugConfig>(
                ...
                ->DataElement(nullptr, &DebugConfig::m_collectionFrequencyUs, QT_TRANSLATE_NOOP("Vegetation", "Collection Frequency"), QT_TRANSLATE_NOOP("Vegetation", "How often to collect the data points in microseconds"))
                ->DataElement(nullptr, &DebugConfig::m_minThresholdUs, QT_TRANSLATE_NOOP("Vegetation", "Medium Threshold"), QT_TRANSLATE_NOOP("Vegetation", "Minimum number of microseconds the sector should reach"))
                ->DataElement(nullptr, &DebugConfig::m_maxThresholdUs, QT_TRANSLATE_NOOP("Vegetation", "High Threshold"), QT_TRANSLATE_NOOP("Vegetation", "Maximum number of microseconds the sector should reach"))
                ->DataElement(nullptr, &DebugConfig::m_maxDatapointDisplayCount, QT_TRANSLATE_NOOP("Vegetation", "Max Data Point Display Count"), QT_TRANSLATE_NOOP("Vegetation", "Only display the X newest data points"))
                ->DataElement(nullptr, &DebugConfig::m_maxLabelDisplayDistance, QT_TRANSLATE_NOOP("Vegetation", "Max Label Display Distance"), QT_TRANSLATE_NOOP("Vegetation", "Only display labels within X meters"))
                ->DataElement(nullptr, &DebugConfig::m_showVisualization, QT_TRANSLATE_NOOP("Vegetation", "Show Sector Info"), QT_TRANSLATE_NOOP("Vegetation", "Show the sector info in the 3D viewport"))
                ->DataElement(nullptr, &DebugConfig::m_showDebugStats, QT_TRANSLATE_NOOP("Vegetation", "Show Debug Stats"), QT_TRANSLATE_NOOP("Vegetation", "Show debug stats from the vegetation system on screen"))
                ->DataElement(nullptr, &DebugConfig::m_showInstanceVisualization, QT_TRANSLATE_NOOP("Vegetation", "Show Per Instance Visualization"), QT_TRANSLATE_NOOP("Vegetation", "Show a colored cube per instance, color is specified by the creating area"))
