        ...
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto editContext = serializeContext->GetEditContext())
            {
                editContext->Class<EditorAreaComponentBase>("EditorAreaComponentBase", "")
                    ...
                    ->DataElement(nullptr, &EditorAreaComponentBase::m_overridePreviewSettings, "Override Preview Settings", "")
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &EditorAreaComponentBase::PreviewSettingsAndSettingsVisibilityChanged)
                    ->DataElement(nullptr, &EditorAreaComponentBase::m_previewEntityId, "Pin Preview to Shape", "The entity whose shape represents the bounds to render the gradient preview")
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &EditorAreaComponentBase::PreviewSettingsAndSettingsVisibilityChanged)
                    ->Attribute(AZ::Edit::Attributes::Visibility, &EditorAreaComponentBase::GetPreviewGroupVisibility)
                    ->DataElement(nullptr, &EditorAreaComponentBase::m_previewPosition, "Preview Position", "Center of the preview bounds")
                    ...
                    ->DataElement(nullptr, &EditorAreaComponentBase::m_previewSize, "Preview Size", "Size of the preview bounds")
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &EditorAreaComponentBase::UpdatePreviewSettings)
                    ->Attribute(AZ::Edit::Attributes::Visibility, &EditorAreaComponentBase::GetPreviewSizeVisibility)
                    ->DataElement(nullptr, &EditorAreaComponentBase::m_constrainToShape, "Constrain to Shape", "If checked, only renders the parts of the gradient inside the component's shape and not its entire bounding box")
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &EditorAreaComponentBase::UpdatePreviewSettings)
