...
namespace PhysX
{
    ...
    void ColliderComponentMode::BindActionsToMenus()
    {
        ...
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.colliderComponentMode.setOffsetSubMode", 6000);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.colliderComponentMode.setRotationSubMode", 6001);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.colliderComponentMode.setResizeSubMode", 6002);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.colliderComponentMode.resetCurrentMode", 6003);
    }
