...
namespace PhysX
{
    ...
    void JointsComponentMode::BindActionsToMenus()
    {
        ...
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToTranslationSubMode", 6000);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToRotationSubMode", 6001);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToMaxForceSubMode", 6002);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToMaxTorqueSubMode", 6003);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToDampingSubMode", 6004);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToStiffnessSubMode", 6005);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToSnapPositionSubMode", 6006);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToSnapRotationSubMode", 6007);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToSwingLimitsSubMode", 6008);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.switchToTwistLimitsSubMode", 6009);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.jointsComponentMode.resetCurrentMode", 6010);
    }
