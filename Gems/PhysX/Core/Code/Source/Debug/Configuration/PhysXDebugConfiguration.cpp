    ...
    namespace Debug
    {
        ...
        /*static*/ void DebugDisplayData::Reflect(AZ::ReflectContext* context)
        {
            ...
            if (auto* serialize = azrtti_cast<AZ::SerializeContext*>(context))
            {
                ...
                if (AZ::EditContext* editContext = serialize->GetEditContext())
                {
                    editContext->Class<DebugDisplayData>(QT_TRANSLATE_NOOP("PhysX", "Editor Configuration"), QT_TRANSLATE_NOOP("PhysX", "Editor settings for PhysX."))
                        ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &DebugDisplayData::m_centerOfMassDebugSize,
                            QT_TRANSLATE_NOOP("PhysX", "Debug Draw Center of Mass Size"), QT_TRANSLATE_NOOP("PhysX", "The size of the debug draw circle representing the center of mass."))
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::Default, &DebugDisplayData::m_centerOfMassDebugColor,
                            QT_TRANSLATE_NOOP("PhysX", "Debug Draw Center of Mass Color"), QT_TRANSLATE_NOOP("PhysX", "The color of the debug draw circle representing the center of mass."))
                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &DebugDisplayData::m_globalCollisionDebugDraw, QT_TRANSLATE_NOOP("PhysX", "Global Collision Debug"),
                            QT_TRANSLATE_NOOP("PhysX", "Set up global collision debug draw."
                            ...
                            "</ul>"))
                        ->EnumAttribute(DebugDisplayData::GlobalCollisionDebugState::AlwaysOn, QT_TRANSLATE_NOOP("PhysX", "Enable all colliders"))
                        ->EnumAttribute(DebugDisplayData::GlobalCollisionDebugState::AlwaysOff, QT_TRANSLATE_NOOP("PhysX", "Disable all colliders"))
                        ->EnumAttribute(DebugDisplayData::GlobalCollisionDebugState::Manual, QT_TRANSLATE_NOOP("PhysX", "Set manually"))
                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &DebugDisplayData::m_globalCollisionDebugDrawColorMode, QT_TRANSLATE_NOOP("PhysX", "Global Collision Debug Color Mode"),
                            QT_TRANSLATE_NOOP("PhysX", "Set up debug color mode."
                            "<ul style=\"margin-left:15px; margin-top:-10px; -qt-list-indent:0;\">"
                            ...
                            "</ul>"))
                        ->EnumAttribute(DebugDisplayData::GlobalCollisionDebugColorMode::MaterialColor, QT_TRANSLATE_NOOP("PhysX", "Material Color Mode"))
                        ->EnumAttribute(DebugDisplayData::GlobalCollisionDebugColorMode::ErrorColor, QT_TRANSLATE_NOOP("PhysX", "Error Mode"))

                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)

                        ->DataElement(AZ::Edit::UIHandlers::Default, &DebugDisplayData::m_showJointHierarchy,
                            QT_TRANSLATE_NOOP("PhysX", "Display Joints Hierarchy"),
                            QT_TRANSLATE_NOOP("PhysX", "Flag to switch on / off the display of joint lead-follower connections in the viewport."))
                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &DebugDisplayData::m_jointHierarchyLeadColor,
                            QT_TRANSLATE_NOOP("PhysX", "Joints Hierarchy Lead Color"),
                            QT_TRANSLATE_NOOP("PhysX", "Color of the lead half of a lead-follower joint connection line."))
                        ->EnumAttribute(DebugDisplayData::JointLeadColor::Aquamarine, QT_TRANSLATE_NOOP("PhysX", "Aquamarine"))
                        ->EnumAttribute(DebugDisplayData::JointLeadColor::AliceBlue, QT_TRANSLATE_NOOP("PhysX", "AliceBlue"))
                        ->EnumAttribute(DebugDisplayData::JointLeadColor::CadetBlue, QT_TRANSLATE_NOOP("PhysX", "CadetBlue"))
                        ->EnumAttribute(DebugDisplayData::JointLeadColor::Coral, QT_TRANSLATE_NOOP("PhysX", "Coral"))
                        ->EnumAttribute(DebugDisplayData::JointLeadColor::Green, QT_TRANSLATE_NOOP("PhysX", "Green"))
                        ->EnumAttribute(DebugDisplayData::JointLeadColor::DarkGreen, QT_TRANSLATE_NOOP("PhysX", "DarkGreen"))
                        ->EnumAttribute(DebugDisplayData::JointLeadColor::ForestGreen, QT_TRANSLATE_NOOP("PhysX", "ForestGreen"))
                        ->EnumAttribute(DebugDisplayData::JointLeadColor::Honeydew, QT_TRANSLATE_NOOP("PhysX", "Honeydew"))
                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &DebugDisplayData::m_jointHierarchyFollowerColor,
                            QT_TRANSLATE_NOOP("PhysX", "Joints Hierarchy Follower Color"),
                            QT_TRANSLATE_NOOP("PhysX", "Color of the follower half of a lead-follower joint connection line."))
                        ->EnumAttribute(DebugDisplayData::JointFollowerColor::Chocolate, QT_TRANSLATE_NOOP("PhysX", "Chocolate"))
                        ->EnumAttribute(DebugDisplayData::JointFollowerColor::HotPink, QT_TRANSLATE_NOOP("PhysX", "HotPink"))
                        ->EnumAttribute(DebugDisplayData::JointFollowerColor::Lavender, QT_TRANSLATE_NOOP("PhysX", "Lavender"))
                        ->EnumAttribute(DebugDisplayData::JointFollowerColor::Magenta, QT_TRANSLATE_NOOP("PhysX", "Magenta"))
                        ->EnumAttribute(DebugDisplayData::JointFollowerColor::LightYellow, QT_TRANSLATE_NOOP("PhysX", "LightYellow"))
                        ->EnumAttribute(DebugDisplayData::JointFollowerColor::Maroon, QT_TRANSLATE_NOOP("PhysX", "Maroon"))
                        ->EnumAttribute(DebugDisplayData::JointFollowerColor::Red, QT_TRANSLATE_NOOP("PhysX", "Red"))
                        ->EnumAttribute(DebugDisplayData::JointFollowerColor::Yellow, QT_TRANSLATE_NOOP("PhysX", "Yellow"))
                        ->DataElement(AZ::Edit::UIHandlers::Default, &DebugDisplayData::m_jointHierarchyDistanceThreshold,
                            QT_TRANSLATE_NOOP("PhysX", "Joints Hierarchy Distance Threshold"),
                            QT_TRANSLATE_NOOP("PhysX", "Minimum distance required to draw from follower to joint. Distances shorter than this threshold will result in the line drawn from the joint to the lead."))
