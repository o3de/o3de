...
# After it runs, restore any setting here that might actually affect other targets in this same scope.
...
ly_create_alias(NAME OpenMesh NAMESPACE 3rdParty TARGETS ${OpenMesh_Primary_Target})
# note that ly_create_alias would add OpenMeshTools and 3rdParty::OpenMeshTools as an alias
# and the former already exists, so we don't need to do it here and can directly call add_library
