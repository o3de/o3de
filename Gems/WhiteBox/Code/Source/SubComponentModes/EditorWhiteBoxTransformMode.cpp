...
namespace WhiteBox
{
    ...
    void TransformMode::BindActionsToMenus()
    {
        ...
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.whiteBoxComponentMode.transform.translation", 6000);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.whiteBoxComponentMode.transform.rotation", 6001);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.whiteBoxComponentMode.transform.scale", 6002);
    }
