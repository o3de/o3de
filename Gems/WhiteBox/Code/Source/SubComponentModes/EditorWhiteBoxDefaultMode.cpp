...
namespace WhiteBox
{
    ...
    static const AZ::Crc32 HideEdge = AZ_CRC("org.o3de.action.whitebox.hide_edge", 0x84f6a9b9);
    static const AZ::Crc32 HideVertex = AZ_CRC("org.o3de.action.whitebox.hide_vertex", 0x5f81c937);
