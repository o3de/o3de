...
namespace WhiteBox
{
    ...
    void DefaultMode::BindActionsToMenus()
    {
        ...
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.whiteBoxComponentMode.Default.hideEdge", 6000);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.whiteBoxComponentMode.Default.hideVertex", 6001);
    }
