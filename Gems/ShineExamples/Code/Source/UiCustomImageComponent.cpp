...
namespace ShineExamples
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void UiCustomImageComponent::Render(Shine::IRenderGraph* renderGraph)
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void UiCustomImageComponent::RenderToCache(Shine::IRenderGraph* renderGraph)
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    void UiCustomImageComponent::RenderSingleQuad(Shine::IRenderGraph* renderGraph, const AZ::Vector2* positions, const AZ::Vector2* uvs)
    {
        float fade = renderGraph->GetAlphaFade();
        float desiredAlpha = m_overrideAlpha * fade;
