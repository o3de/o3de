...
#include <ShineExamples/UiCustomImageBus.h>
...
namespace ShineExamples
{
    ...
    private: // member functions
        ...
        void RenderToCache(Shine::IRenderGraph* renderGraph);
        void RenderSingleQuad(Shine::IRenderGraph* renderGraph, const AZ::Vector2* positions, const AZ::Vector2* uvs);
        bool IsPixelAligned();
