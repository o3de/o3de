...
function ImageMarkup:UpdateMarkupText()
    local image1TagText = self:GetImageTagText("UI/Textures/ShineExamples/scroll_box_icon_4")
    local image2TagText = self:GetImageTagText("UI/Textures/ShineExamples/scroll_box_icon_3")
