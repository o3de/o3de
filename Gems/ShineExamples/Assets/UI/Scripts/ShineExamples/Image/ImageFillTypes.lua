...
function ImageFillTypes:OnRadioButtonGroupStateChange(entityId)
    ...
    elseif selectedIndex == 1 then
        ...
        for i = 0, #self.Properties.FilledImages do        
            ...
            UiImageBus.Event.SetSpritePathname(self.Properties.FilledImages[i], "ui/textures/ShineExamples/scroll_box_icon_5.tif")
        end        
    elseif selectedIndex == 2 then
        -- Sliced sprite
        for i = 0, #self.Properties.FilledImages do        
            UiImageBus.Event.SetImageType(self.Properties.FilledImages[i], eUiImageType_Sliced)
            UiImageBus.Event.SetSpritePathname(self.Properties.FilledImages[i], "ui/textures/ShineExamples/button.tif")
