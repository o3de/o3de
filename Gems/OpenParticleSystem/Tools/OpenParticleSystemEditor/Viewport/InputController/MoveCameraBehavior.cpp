...
namespace OpenParticleSystemEditor
{
    void MoveCameraBehavior::End()
    {
        ...
        OpenParticleEditorViewportInputControllerRequestBus::BroadcastResult(
            distanceToTarget, &OpenParticleEditorViewportInputControllerRequestBus::Handler::GetDistanceToTarget);
        ...
        OpenParticleEditorViewportInputControllerRequestBus::Broadcast(
            &OpenParticleEditorViewportInputControllerRequestBus::Handler::SetTargetPosition, targetPosition);
    }
