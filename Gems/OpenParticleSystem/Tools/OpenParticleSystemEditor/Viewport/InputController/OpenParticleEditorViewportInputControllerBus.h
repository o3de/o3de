...
{
    class OpenParticleEditorViewportInputControllerRequests
    ...
    using OpenParticleEditorViewportInputControllerRequestBus = AZ::EBus<OpenParticleEditorViewportInputControllerRequests>;
} // namespace OpenParticleSystemEditor
