...
namespace OpenParticleSystemEditor
{
    ...
    private:
        ...
        AZStd::string m_defaultPipelineAssetPath = "passes/ParticleEditorPipeline.azasset";
        AZStd::string m_lowEndPipelineAssetPath = "passes/ParticleEditorLowEndPipeline.azasset";
