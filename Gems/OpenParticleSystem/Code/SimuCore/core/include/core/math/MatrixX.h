...
namespace SimuCore {
    ...
    struct Matrix4 {
        ...
        inline Matrix4(const AZ::Matrix4x4& mat);
    ...
    {
        return Vector4(v.Dot(matrix.value.GetRow(0)), v.Dot(matrix.value.GetRow(1)), v.Dot(matrix.value.GetRow(2)), v.Dot(matrix.value.GetRow(3)));
    }
    ...
    struct Matrix3 {
        ...
        inline Matrix3(const AZ::Matrix3x3& mat);
