        ...
        MaterialShaderParameterLayout MaterialTypeSourceData::CreateMaterialShaderParameterLayout() const
        {
            ...
            EnumeratePropertyGroups(
                [&shaderParamsLayout](const PropertyGroupStack& propertyGroupStack)
                {
                    ...
                    {
                        for (auto& shaderParam : functorSourceData->GetActualSourceData()->GetMaterialShaderParameters())
                        {
                            auto name{ shaderParam.m_name };
                            groupNameContext.ContextualizeSrgInput(name);
                            shaderParamsLayout.AddParameterFromFunctor(name, shaderParam.m_typeName, shaderParam.m_typeSize);
                        }
                    }
                    return true;
                });
