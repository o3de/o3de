...
namespace AZ
{
    namespace RPI
    {
            ...
            [[maybe_unused]] const void* defaultValue, const Uuid& valueTypeId, JsonSerializerContext& context)
        {
            ...
            result.Combine(ContinueStoringToJsonObjectField(outputValue, Field::optional, &property->m_optional, &defaultOptional, azrtti_typeid(property->m_optional), context));
