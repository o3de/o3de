...
namespace UnitTest
{
    ...
    protected:
        ...
        void ValidateInitialValuesFromMaterialType(Data::Instance<Material> material)
        {
            ...
            const RHI::DeviceShaderResourceGroup* srg = material->GetRHIShaderResourceGroup();
            const RHI::DeviceShaderResourceGroupData& srgData = srg->GetData();
    ...
    TEST_F(MaterialTests, TestSetPropertyValueWhenValueIsUnchanged)
    {
        ...
        const RHI::DeviceShaderResourceGroup* srg = material->GetRHIShaderResourceGroup();
        const RHI::DeviceShaderResourceGroupData& srgData = srg->GetData();
        const_cast<RHI::DeviceShaderResourceGroupData*>(&srgData)->SetConstant(m_testMaterialSrgLayout->FindShaderInputConstantIndex(Name{"m_float"}), 0.0f);
    ...
    TEST_F(MaterialTests, TestImageNotProvided)
    {
        ...
        const RHI::DeviceShaderResourceGroupData& srgData = material->GetRHIShaderResourceGroup()->GetData();
