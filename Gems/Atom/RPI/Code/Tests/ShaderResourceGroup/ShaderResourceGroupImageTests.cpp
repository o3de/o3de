...
namespace UnitTest
{
    ...
    protected:
        ...
        Ptr<RHI::DeviceImageView> m_imageViewA;
        Ptr<RHI::DeviceImageView> m_imageViewB;
        Ptr<RHI::DeviceImageView> m_imageViewC;
        AZStd::vector<Data::Instance<Image>> m_threeImages;
        AZStd::vector<const RHI::DeviceImageView*> m_threeImageViews;
        ...
        void TearDown() override
        {
            ...
            m_threeImageViews = AZStd::vector<const RHI::DeviceImageView*>();
    ...
    TEST_F(ShaderResourceGroupImageTests, TestSetGetImageViewArray)
    {
        ...
        AZStd::vector<const RHI::DeviceImageView*> alternateImageViews = { m_imageViewB.get(), nullptr };
    ...
    TEST_F(ShaderResourceGroupImageTests, TestSetGetImageViewArray_ValidationFailure)
    {
        ...
        AZStd::vector<const RHI::DeviceImageView*> tooManyImageViews{ 4, m_imageViewA.get() };
    ...
    {
        AZStd::vector<const RHI::DeviceImageView*> twoImageViews = { m_imageViewA.get(), m_imageViewB.get() };
    ...
    TEST_F(ShaderResourceGroupImageTests, TestSetImageViewArrayAtOffset_ValidationFailure)
    {
        ...
        AZStd::vector<const RHI::DeviceImageView*> tooManyImageViews{ 3, m_imageViewA.get() };
