...
namespace UnitTest
{
    namespace StubRHI
    {
       class PhysicalDevice
        ...
        private:
            AZ::RHI::ResultCode InitInternal(AZ::RHI::Device&, const AZ::RHI::BufferPoolDescriptor&) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            ...
            AZ::RHI::ResultCode OrphanBufferInternal(AZ::RHI::DeviceBuffer&) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            AZ::RHI::ResultCode StreamBufferInternal([[maybe_unused]] const AZ::RHI::DeviceBufferStreamRequest& request) override
            {
                return AZ::RHI::ResultCode::Success;
            }
        ...
        private:
            ...
            AZ::RHI::ResultCode UpdateImageContentsInternal(const AZ::RHI::DeviceImageUpdateRequest&) override
            {
                return AZ::RHI::ResultCode::Success;
            }
        ...
        class StreamingImagePool : public AZ::RHI::DeviceStreamingImagePool
        {
        public:
        ...
        private:
            AZ::RHI::ResultCode InitImageInternal([[maybe_unused]] const AZ::RHI::DeviceStreamingImageInitRequest& request) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            void ShutdownInternal() override
            ...
            AZ::RHI::ResultCode ExpandImageInternal(const AZ::RHI::DeviceStreamingImageExpandRequest&) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            AZ::RHI::ResultCode TrimImageInternal(AZ::RHI::DeviceImage&, uint32_t) override
            {
                return AZ::RHI::ResultCode::Success;
            }
        };

        class SwapChain : public AZ::RHI::DeviceSwapChain
        {
        public:
        ...
        private:
            AZ::RHI::ResultCode InitInternal(
                AZ::RHI::Device&,
                const AZ::RHI::SwapChainDescriptor&,
                [[maybe_unused]] AZ::RHI::SwapChainDimensions* outNativeDimensions) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            AZ::RHI::ResultCode InitImageInternal(const InitImageRequest&) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            AZ::RHI::ResultCode ResizeInternal(
                [[maybe_unused]] const AZ::RHI::SwapChainDimensions& dimensions,
                [[maybe_unused]] AZ::RHI::SwapChainDimensions* nativeDimensions) override
            {
                return AZ::RHI::ResultCode::Success;
            };
        ...
        class Fence : public AZ::RHI::DeviceFence
        {
        public:
            AZ_CLASS_ALLOCATOR(Fence, AZ::SystemAllocator, 0);

        private:
            AZ::RHI::ResultCode InitInternal(AZ::RHI::Device&, AZ::RHI::FenceState) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            void ShutdownInternal() override
            ...
            AZ::RHI::FenceState GetFenceStateInternal() const override
            {
                return AZ::RHI::FenceState::Reset;
            }
        };
        ...
        private:
            ...
            AZ::RHI::ResultCode InitGroupInternal(AZ::RHI::DeviceShaderResourceGroup&) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            AZ::RHI::ResultCode CompileGroupInternal(
                AZ::RHI::DeviceShaderResourceGroup&, const AZ::RHI::DeviceShaderResourceGroupData&) override
            {
                return AZ::RHI::ResultCode::Success;
            }
        };
        ...
        private:
            AZ::RHI::ResultCode InitInternal(
                AZ::RHI::Device&, [[maybe_unused]] const AZ::RHI::DevicePipelineLibraryDescriptor& descriptor) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            void ShutdownInternal() override
            ...
            AZ::RHI::ConstPtr<AZ::RHI::PipelineLibraryData> GetSerializedDataInternal() const override
            {
                return nullptr;
            }
            bool SaveSerializedDataInternal([[maybe_unused]] const AZStd::string& filePath) const
            {
                return true;
            }
        };

        class ShaderStageFunction : public AZ::RHI::ShaderStageFunction
        {
        public:
        ...
        class DeviceTransientAttachmentPool : public AZ::RHI::DeviceTransientAttachmentPool
        {
        public:
            AZ_CLASS_ALLOCATOR(DeviceTransientAttachmentPool, AZ::SystemAllocator, 0);

        private:
            AZ::RHI::ResultCode InitInternal(AZ::RHI::Device&, const AZ::RHI::DeviceTransientAttachmentPoolDescriptor&) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            void BeginInternal(
                [[maybe_unused]] const AZ::RHI::TransientAttachmentPoolCompileFlags flags,
                [[maybe_unused]] const AZ::RHI::TransientAttachmentStatistics::MemoryUsage* memoryHint) override
            {
            }
        ...
        private:
            AZ::RHI::ResultCode BeginInternal(
                [[maybe_unused]] AZ::RHI::CommandList& commandList, [[maybe_unused]] AZ::RHI::QueryControlFlags flags) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            AZ::RHI::ResultCode EndInternal([[maybe_unused]] AZ::RHI::CommandList& commandList) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            AZ::RHI::ResultCode WriteTimestampInternal([[maybe_unused]] AZ::RHI::CommandList& commandList) override
            {
                return AZ::RHI::ResultCode::Success;
            };
        };
        ...
        private:
            AZ::RHI::ResultCode InitInternal(
                [[maybe_unused]] AZ::RHI::Device& device, [[maybe_unused]] const AZ::RHI::QueryPoolDescriptor& descriptor) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            AZ::RHI::ResultCode InitQueryInternal([[maybe_unused]] AZ::RHI::DeviceQuery& query) override
            {
                return AZ::RHI::ResultCode::Success;
            }
        ...
        private:
            void SetVertexViewInternal(
                [[maybe_unused]] AZ::RHI::IndirectCommandIndex index, [[maybe_unused]] const AZ::RHI::DeviceStreamBufferView& view) override
            {
            }
            void SetIndexViewInternal(
                [[maybe_unused]] AZ::RHI::IndirectCommandIndex index, [[maybe_unused]] const AZ::RHI::DeviceIndexBufferView& view) override
            {
            }
            void DrawInternal(
                [[maybe_unused]] AZ::RHI::IndirectCommandIndex index, [[maybe_unused]] const AZ::RHI::DrawLinear& arguments) override
            {
            }
            void DrawIndexedInternal(
                [[maybe_unused]] AZ::RHI::IndirectCommandIndex index, [[maybe_unused]] const AZ::RHI::DrawIndexed& arguments) override
            {
            }
            void DispatchInternal(
                [[maybe_unused]] AZ::RHI::IndirectCommandIndex index, [[maybe_unused]] const AZ::RHI::DispatchDirect& arguments) override
            {
            }
            void SetRootConstantsInternal(
                [[maybe_unused]] AZ::RHI::IndirectCommandIndex index,
                [[maybe_unused]] const uint8_t* data,
                [[maybe_unused]] uint32_t byteSize) override
            {
            }
        };
        ...
        private:
            AZ::RHI::ResultCode InitInternal(
                ...
                [[maybe_unused]] const AZ::RHI::DeviceIndirectBufferSignatureDescriptor& descriptor) override
            {
                return AZ::RHI::ResultCode::Success;
            }
            ...
            uint32_t GetOffsetInternal([[maybe_unused]] AZ::RHI::IndirectCommandIndex index) const override
            {
                return 0;
            }
            void ShutdownInternal() override
