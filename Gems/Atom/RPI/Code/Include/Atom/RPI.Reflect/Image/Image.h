...
namespace AZ
{
    namespace RPI
    {
        ...
        public:
            ...
            virtual RHI::ResultCode UpdateImageContents(const RHI::DeviceImageUpdateRequest& request);
