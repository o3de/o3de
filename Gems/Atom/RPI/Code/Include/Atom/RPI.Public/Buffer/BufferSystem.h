...
namespace AZ
{
    ...
    namespace RPI
    {
        ...
        public:
            ...
            RHI::Ptr<RHI::DeviceBufferPool> GetCommonBufferPool(CommonBufferPoolType poolType) override;
        ...
        private:
            RHI::Ptr<RHI::DeviceBufferPool> m_commonPools[static_cast<uint8_t>(CommonBufferPoolType::Count)];
