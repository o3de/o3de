...
namespace AZ
{
    namespace RPI
    {
        ...
        protected:
            ...
            RHI::ResultCode BeginQueryInternal(int deviceIndex, RHI::Interval rhiQueryIndices, RHI::CommandList& commandList);
            RHI::ResultCode EndQueryInternal(int deviceIndex, RHI::Interval rhiQueryIndices, RHI::CommandList& commandList);
