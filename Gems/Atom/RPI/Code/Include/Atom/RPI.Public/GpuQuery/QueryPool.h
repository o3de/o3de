...
namespace AZ
{
    ...
    namespace RPI
    {
        ...
        protected:
            ...
            AZStd::span<const RHI::Ptr<RHI::DeviceQuery>> GetRhiQueryArray() const;
        ...
        private:
            ...
            AZStd::span<const RHI::Ptr<RHI::DeviceQuery>> GetRhiQueriesFromInterval(const RHI::Interval& rhiQueryIndices) const;
            // Returns an array of raw RHI Query pointers depending on the indices that are provided.
            AZStd::vector<RHI::DeviceQuery*> GetRawRhiQueriesFromInterval(const RHI::Interval& rhiQueryIndices) const;
            ...
            AZStd::vector<RHI::Ptr<RHI::DeviceQuery>> m_rhiQueryArray;
            RHI::Ptr<RHI::DeviceQueryPool> m_rhiQueryPool;
        };
