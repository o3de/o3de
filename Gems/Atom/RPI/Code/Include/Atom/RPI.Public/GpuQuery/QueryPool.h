...
namespace AZ
{
    ...
    namespace RPI
    {
        ...
        private:
            ...
            virtual RHI::ResultCode BeginQueryInternal(int deviceIndex, RHI::Interval rhiQueryIndices, RHI::CommandList& commandList);
            virtual RHI::ResultCode EndQueryInternal(int deviceIndex, RHI::Interval rhiQueryIndices, RHI::CommandList& commandList);
