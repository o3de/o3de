...
namespace UnitTest
{
    ...
    public:
        ...
        MOCK_METHOD5(AcquireMesh, MeshHandle (const MeshHandleDescriptor&, const AZ::Render::MaterialAssignmentMap&));
        MOCK_METHOD5(AcquireMesh, MeshHandle (const MeshHandleDescriptor&, const AZ::Data::Instance<AZ::RPI::Material>&);
