    ...
    namespace Render
    {
            ...
            const AZ::SceneAPI::DataTypes::IMaterialData& materialData, RPI::MaterialSourceData& sourceData)
        {
            ...
            auto handleTexture = [&materialData, &sourceData](
                                     const char* propertyTextureGroup, const char* propertyTextureName, SceneAPI::DataTypes::IMaterialData::TextureMapType textureType) {
                ...
                if (assetFound)
                {
                    properties[propertyTextureName].m_value = texturePath;
                }
