...
namespace AZ
{
    namespace Render
    {
        ...
        public:
            ...
            //! Sets the half width of kernal to apply box blur effect.
            void SetKernalHalfWidth(float width);
        ...
        private:
            ...
            RHI::ShaderInputNameIndex m_kernalHalfWidthIndex = "m_kernalHalfWidth";
            float m_kernalHalfWidth = 5.0f; //!< Default kernal half width for the blur effect.
        };
    }   // namespace Render
}   // namespace AZ
