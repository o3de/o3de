...
namespace AZ
{
    namespace Render
    {
        ...
        {
            AZ_ATOM_PROFILE_TIME_GROUP_REGION(RPI, "SimplePointLightFeatureProcessor: Simulate");
            AZ_UNUSED(packet);
        ...
        {
            AZ_ATOM_PROFILE_TIME_GROUP_REGION(RPI, "SimplePointLightFeatureProcessor: Render");
