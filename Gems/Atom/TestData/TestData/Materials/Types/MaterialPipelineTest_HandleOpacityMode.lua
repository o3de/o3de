...
-- TODO(MaterialPipeline): This MaterialPipelineTest_HandleOpacityMode.lua file is here temporarily until we 
-- migrate the core material types to the material pipeline system, and remove the Process() function from
-- that file. All we need is the ProcessEditor function to hide and/or disable properties based on the opacity mode.
