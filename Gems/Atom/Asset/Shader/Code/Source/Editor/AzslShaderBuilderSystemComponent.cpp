...
namespace AZ
{
    namespace ShaderBuilder
    {
        ...
        void AzslShaderBuilderSystemComponent::Activate()
        {
            ...
            shaderAssetBuilderDescriptor.m_version = 123; // Fix the handling of typed buffers for metal shader related dummy entries
            ...
            if (m_enableShaderVariantAssetBuilder)
            {
                ...
                shaderVariantAssetBuilderDescriptor.m_version = 40; // // Fix the handling of typed buffers for metal shader related dummy entries
