...
namespace AZ
{
    namespace ShaderBuilder
    {
        ...
        void AzslShaderBuilderSystemComponent::Activate()
        {
            ...
            shaderAssetBuilderDescriptor.m_version = 124; // Metal shader debug symbols controlled via settings registry or shader build arguments
            ...
            if (m_enableShaderVariantAssetBuilder)
            {
                ...
                shaderVariantAssetBuilderDescriptor.m_version = 41; // Metal shader debug symbols controlled via settings registry or shader build arguments
                ...
                shaderVariantListBuilderDescriptor.m_version = 2; // First version of ShaderVariantListBuilder
