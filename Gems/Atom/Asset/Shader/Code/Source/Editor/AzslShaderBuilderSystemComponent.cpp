...
namespace AZ
{
    namespace ShaderBuilder
    {
        ...
        void AzslShaderBuilderSystemComponent::Activate()
        {
            ...
            shaderAssetBuilderDescriptor.m_version = 125; // Add specialization constants for shader options
            ...
            if (m_enableShaderVariantAssetBuilder)
            {
                ...
                shaderVariantAssetBuilderDescriptor.m_version = 43; // Add batching to shader variant assets
                ...
                shaderVariantListBuilderDescriptor.m_version = 4; // Add batching to shader variant assets
