...
#define AZ_TRAIT_ATOM_AZSL_SHADER_HEADER "Builders/ShaderHeaders/Platform/Mac/Metal/AzslcHeader.azsli"
#define AZ_TRAIT_ATOM_AZSL_PLATFORM_HEADER "Builders/ShaderHeaders/Platform/Mac/Metal/PlatformHeader.hlsli"
