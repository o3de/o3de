...
namespace AZ
{
    namespace Vulkan
    {
        ...
        RHI::ResultCode DescriptorSetLayout::BuildDescriptorSetLayoutBindings()
        {
            ...
            // In order to address the above issues, we would need to update AZSLc to support some kind of attribute by which the shader-author can manually
