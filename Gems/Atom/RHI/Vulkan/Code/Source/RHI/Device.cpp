    ...
    namespace Vulkan
    {
        ...
        AsyncUploadQueue& Device::GetAsyncUploadQueue()
        {
            if (!m_asyncUploadQueue)
            {
                ...
                AsyncUploadQueue::Descriptor asyncUploadQueueDescriptor(
                    m_descriptor.m_platformLimitsDescriptor->m_platformDefaultValues.m_asyncQueueStagingBufferSizeInBytes);
