...
namespace AZ
{
    namespace Vulkan
    {
        ...
        RHI::ResultCode RayTracingTlas::CreateBuffersInternal(RHI::Device& deviceBase, const RHI::RayTracingTlasDescriptor* descriptor, const RHI::SingleDeviceRayTracingBufferPools& bufferPools)
        {
