...
namespace AZ::RHI
{
    ...
    //! A structure used as an argument to SingleDeviceStreamingImagePool::InitImage.
    ...
    //! A structure used as an argument to SingleDeviceStreamingImagePool::ExpandImage.
    template <typename ImageClass>
    ...
    using SingleDeviceStreamingImageExpandRequest = StreamingImageExpandRequestTemplate<SingleDeviceImage>;
    ...
    public:
        ...
        //! asynchronously or synchronously depends on @m_waitForUpload in @SingleDeviceStreamingImageExpandRequest. 
        //! Upon completion, the views will be invalidated and map to the newly
        //! streamed mip levels.
        ResultCode ExpandImage(const SingleDeviceStreamingImageExpandRequest& request);
    ...
    protected:
        SingleDeviceStreamingImagePool() = default;
    ...
    private:
        ...
        bool ValidateExpandRequest(const SingleDeviceStreamingImageExpandRequest& expandRequest) const;
        ...
        virtual ResultCode ExpandImageInternal(const SingleDeviceStreamingImageExpandRequest& request);
