...
namespace AZ
{
    namespace RHI
    {
        ...
        template<typename TShaderInput, typename TShaderInputDescriptor>
        bool DeviceShaderResourceGroupData::ValidateImageViewAccess(
            TShaderInput inputIndex, const DeviceImageView* imageView, [[maybe_unused]] uint32_t arrayIndex) const
        {
        ...
        template<typename TShaderInput, typename TShaderInputDescriptor>
        bool DeviceShaderResourceGroupData::ValidateBufferViewAccess(
            TShaderInput inputIndex, const DeviceBufferView* bufferView, [[maybe_unused]] uint32_t arrayIndex) const
        {
            if (!Validation::IsEnabled())
            {
                return true;
