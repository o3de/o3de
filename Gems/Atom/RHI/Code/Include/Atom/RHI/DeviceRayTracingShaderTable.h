...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            // accessors
            const RHI::Ptr<DeviceRayTracingPipelineState>& GetPipelineState() const
            {
                return m_rayTracingPipelineState;
            }

            const DeviceRayTracingShaderTableRecordList& GetRayGenerationRecord() const
            {
                return m_rayGenerationRecord;
            }
            DeviceRayTracingShaderTableRecordList& GetRayGenerationRecord()
            {
                return m_rayGenerationRecord;
            }

            const DeviceRayTracingShaderTableRecordList& GetMissRecords() const
            {
                return m_missRecords;
            }
            DeviceRayTracingShaderTableRecordList& GetMissRecords()
            {
                return m_missRecords;
            }

            const DeviceRayTracingShaderTableRecordList& GetHitGroupRecords() const
            {
                return m_hitGroupRecords;
            }
            DeviceRayTracingShaderTableRecordList& GetHitGroupRecords()
            {
                return m_hitGroupRecords;
            }
            ...
            // build operations
            DeviceRayTracingShaderTableDescriptor* Build(
                const AZ::Name& name, const RHI::Ptr<DeviceRayTracingPipelineState>& rayTracingPipelineState);
            ...
            DeviceRayTracingShaderTableDescriptor* HitGroupRecord(
                const AZ::Name& name, uint32_t key = DeviceRayTracingShaderTableRecord::InvalidKey);
        ...
        private:
            ...
            DeviceRayTracingShaderTableRecordList
        ...
        class DeviceRayTracingShaderTable : public DeviceObject
        {
        public:
