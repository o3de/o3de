...
namespace AZ::RHI
{
    ...
    template<typename TShaderInput, typename TShaderInputDescriptor>
    bool SingleDeviceShaderResourceGroupData::ValidateImageViewAccess(TShaderInput inputIndex, const ImageView* imageView, [[maybe_unused]] uint32_t arrayIndex) const
    {
    ...
    template<typename TShaderInput, typename TShaderInputDescriptor>
    bool SingleDeviceShaderResourceGroupData::ValidateBufferViewAccess(TShaderInput inputIndex, const BufferView* bufferView, [[maybe_unused]] uint32_t arrayIndex) const
    {
        if (!Validation::IsEnabled())
        {
            return true;
