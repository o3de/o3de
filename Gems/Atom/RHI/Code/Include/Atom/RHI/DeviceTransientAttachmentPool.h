...
namespace AZ
{
    namespace RHI
    {
        ...
        //! which they attached.
        class DeviceTransientAttachmentPool : public DeviceObject
        {
        public:
            ...
            static bool NeedsTransientAttachmentPool(const DeviceTransientAttachmentPoolDescriptor& descriptor);

            //! Called to initialize the pool.
            ResultCode Init(Device& device, const DeviceTransientAttachmentPoolDescriptor& descriptor);
            ...
            //! Get pool descriptor
            const DeviceTransientAttachmentPoolDescriptor& GetDescriptor() const;
        ...
        private:
            ...
            virtual ResultCode InitInternal(Device& device, const DeviceTransientAttachmentPoolDescriptor& descriptor) = 0;
            ...
            bool ValidateInitParameters(const DeviceTransientAttachmentPoolDescriptor& descriptor) const;

            DeviceTransientAttachmentPoolDescriptor m_descriptor;
