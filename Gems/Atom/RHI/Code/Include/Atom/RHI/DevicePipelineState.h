...
namespace AZ
{
    namespace RHI
    {
         ...
         */
        class DevicePipelineState : public DeviceObject
        {
        public:
             ...
             */
            ResultCode Init(
                Device& device, const PipelineStateDescriptorForDraw& descriptor, DevicePipelineLibrary* pipelineLibrary = nullptr);
             ...
             */
            ResultCode Init(
                Device& device, const PipelineStateDescriptorForDispatch& descriptor, DevicePipelineLibrary* pipelineLibrary = nullptr);
             ...
             */
            ResultCode Init(
                Device& device, const PipelineStateDescriptorForRayTracing& descriptor, DevicePipelineLibrary* pipelineLibrary = nullptr);
        ...
        private:
            ...
            virtual ResultCode InitInternal(
                Device& device, const PipelineStateDescriptorForDraw& descriptor, DevicePipelineLibrary* pipelineLibrary) = 0;

            /// Called when a compute PSO is being initialized.
            virtual ResultCode InitInternal(
                Device& device, const PipelineStateDescriptorForDispatch& descriptor, DevicePipelineLibrary* pipelineLibrary) = 0;

            /// Called when a ray tracing PSO is being initialized.
            virtual ResultCode InitInternal(
                Device& device, const PipelineStateDescriptorForRayTracing& descriptor, DevicePipelineLibrary* pipelineLibrary) = 0;
