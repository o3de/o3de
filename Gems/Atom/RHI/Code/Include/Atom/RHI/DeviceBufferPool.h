...
namespace AZ
{
    namespace RHI
    {
         ...
         */
        struct DeviceBufferMapRequest
        {
            DeviceBufferMapRequest() = default;

            DeviceBufferMapRequest(DeviceBuffer& buffer, size_t byteOffset, size_t byteCount);
        ...
        struct DeviceBufferStreamRequest
        {
            ...
            DeviceFence* m_fenceToSignal = nullptr;
         ...
         */
        class DeviceBufferPool : public DeviceBufferPoolBase
        {
        public:
