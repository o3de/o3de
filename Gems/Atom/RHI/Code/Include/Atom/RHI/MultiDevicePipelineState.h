...
namespace AZ::RHI
{
    ...
    //! A device-specific PipelineState can be accessed by calling GetDeviceObject with the corresponding device
    //! index
    class MultiDevicePipelineState : public MultiDeviceObject<PipelineState>
    {
    public:
        using BaseClassType = MultiDeviceObject<PipelineState>;
        AZ_CLASS_ALLOCATOR(MultiDevicePipelineState, AZ::SystemAllocator, 0);
        AZ_RTTI(MultiDevicePipelineState, "{77B85640-C2E2-4312-AD67-68FED421F84E}", BaseClassType);
