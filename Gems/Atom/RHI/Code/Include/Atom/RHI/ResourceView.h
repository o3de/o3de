...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            virtual Ptr<DeviceResourceView> GetDeviceResourceView(int deviceIndex) const = 0;
            ...
            AZ_RTTI(ResourceView, "{861D8C2E-FC39-476B-8F25-1849201B9053}", Object);
        ...
        private:
            ...
            virtual ResultCode InitInternal(const Resource& resource) = 0;
