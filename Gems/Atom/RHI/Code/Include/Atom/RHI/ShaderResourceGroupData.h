...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            explicit ShaderResourceGroupData(DeviceMask deviceMask, const ShaderResourceGroupLayout* shaderResourceGroupLayout);
            ...
            bool SetImageViewArray(
                ShaderInputImageIndex inputIndex, AZStd::span<const ImageView* const> imageViews, uint32_t arrayIndex = 0);
            ...
            bool SetBufferViewArray(
                ShaderInputBufferIndex inputIndex, AZStd::span<const BufferView* const> bufferViews, uint32_t arrayIndex = 0);
        ...
        bool ShaderResourceGroupData::SetConstant(ShaderInputConstantIndex inputIndex, const T& value)
        {
            ...
            return isValidAll & m_constantsData.SetConstant(inputIndex, value);
        }
        ...
        bool ShaderResourceGroupData::SetConstant(ShaderInputConstantIndex inputIndex, const T& value, uint32_t arrayIndex)
        {
            ...
            return isValidAll & m_constantsData.SetConstant(inputIndex, value, arrayIndex);
        }
        ...
        bool ShaderResourceGroupData::SetConstantMatrixRows(ShaderInputConstantIndex inputIndex, const T& value, uint32_t rowCount)
        {
            ...
            return isValidAll & m_constantsData.SetConstantMatrixRows(inputIndex, value, rowCount);
        }
        ...
        bool ShaderResourceGroupData::SetConstantArray(ShaderInputConstantIndex inputIndex, AZStd::span<const T> values)
        {
            ...
            return isValidAll & m_constantsData.SetConstantArray(inputIndex, values);
        }
        ...
        template<typename TShaderInput, typename TShaderInputDescriptor>
        bool ShaderResourceGroupData::ValidateImageViewAccess(
            TShaderInput inputIndex, const ImageView* imageView, [[maybe_unused]] uint32_t arrayIndex) const
        {
            ...
            const auto frameAttachment = image.GetFrameAttachment();
            ...
            if (!isValidType)
            {
                AZ_Error(
                    ...
                    shaderInputImage.m_name.GetCStr(),
                    arrayIndex,
                    GetShaderInputTypeName(shaderInputImage.m_type));
                return false;
            }
        ...
        template<typename TShaderInput, typename TShaderInputDescriptor>
        bool ShaderResourceGroupData::ValidateBufferViewAccess(
            TShaderInput inputIndex, const BufferView* bufferView, [[maybe_unused]] uint32_t arrayIndex) const
        {
            if (!Validation::IsEnabled())
            {
                return true;
            ...
            const auto frameAttachment = buffer.GetFrameAttachment();
