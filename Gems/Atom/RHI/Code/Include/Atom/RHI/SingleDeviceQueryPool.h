...
namespace AZ::RHI
{
    ...
    template<class T>
    void SingleDeviceQueryPool::SortQueries(AZStd::vector<T*>& queries)
    {
    ...
    template<class T>
    AZStd::vector<Interval> SingleDeviceQueryPool::GetQueryIntervals(const AZStd::vector<T*>& queries)
    {
    ...
    template<class T>
    AZStd::vector<Interval> SingleDeviceQueryPool::GetQueryIntervalsSorted(const AZStd::vector<T*>& sortedQueries)
    {
