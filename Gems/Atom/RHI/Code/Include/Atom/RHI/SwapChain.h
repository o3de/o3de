...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            ResultCode Init(DeviceMask deviceMask, const SwapChainDescriptor& descriptor);
            ...
            inline Ptr<DeviceSwapChain> GetDeviceSwapChain(int deviceIndex) const
            {
                AZ_Assert(
        ...
        private:
            ...
            AZStd::unordered_map<int, Ptr<DeviceSwapChain>> m_deviceSwapChains;
        };
    }
}
