...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            DeviceStreamBufferView(const DeviceBuffer& buffer, uint32_t byteOffset, uint32_t byteCount, uint32_t byteStride);
        ...
        bool ValidateStreamBufferViews(
            const InputStreamLayout& inputStreamLayout, AZStd::span<const DeviceStreamBufferView> streamBufferViews);
    }
}
