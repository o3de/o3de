...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            AZ_RTTI(BufferPool, "{5221436D-6B13-41BC-8DB4-AF7D784D4D72}", ResourcePool)
            BufferPool() = default;
             ...
             */
            ResultCode Init(DeviceMask deviceMask, const BufferPoolDescriptor& descriptor);
        ...
        private:
            ...
            AZStd::unordered_map<int, Ptr<DeviceBufferPool>> m_deviceBufferPools;
        };
    }
}
