...
namespace AZ::RHI
{
    ...
    protected:
        ...
        virtual RHI::BufferBindFlags GetBlasBufferBindFlags() const { return RHI::BufferBindFlags::ShaderReadWrite | RHI::BufferBindFlags::SingleDeviceRayTracingAccelerationStructure; }
        virtual RHI::BufferBindFlags GetTlasInstancesBufferBindFlags() const { return RHI::BufferBindFlags::ShaderReadWrite; }
        virtual RHI::BufferBindFlags GetTlasBufferBindFlags() const { return RHI::BufferBindFlags::SingleDeviceRayTracingAccelerationStructure; }
