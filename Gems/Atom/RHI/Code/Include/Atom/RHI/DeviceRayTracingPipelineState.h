...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            const RHI::DevicePipelineState* GetPipelineState() const
            {
            ...
            DeviceRayTracingPipelineStateDescriptor* ShaderLibrary(const RHI::PipelineStateDescriptorForRayTracing& descriptor);
        ...
        class DeviceRayTracingPipelineState : public DeviceObject
        {
        public:
            ...
            const DeviceRayTracingPipelineStateDescriptor& GetDescriptor() const
            {
                return m_descriptor;
            }
        ...
        private:
            ...
            //////////////////////////////////////////////////////////////////////////
            // Platform API
            virtual RHI::ResultCode InitInternal(
                RHI::Device& deviceBase, const RHI::DeviceRayTracingPipelineStateDescriptor* descriptor) = 0;
