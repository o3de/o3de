...
namespace AZ::RHI
{
    ...
    struct RayTracingShaderLibrary
    {
        ...
        // we use the ShaderName as lookup for the shader module, but the entry function name might be different,
        // especially for hit shaders generated by the material-pipeline
        ...
        AZ::Name m_rayGenerationEntryFunctionName;
        AZ::Name m_missEntryFunctionName;
        AZ::Name m_callableEntryFunctionName;
        AZ::Name m_closestHitEntryFunctionName;
        AZ::Name m_anyHitEntryFunctionName;
        AZ::Name m_intersectionEntryFunctionName;
    };
