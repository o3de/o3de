...
namespace AZ
{
    namespace RHI
    {
         ...
         */
        class DeviceResourceEventInterface : public AZ::EBusTraits
        {
        public:
            ...
            inline bool Compare(const DeviceResourceEventInterface* other) const
            {
        ...
        using DeviceResourceInvalidateBus = AZ::EBus<DeviceResourceEventInterface>;
    }
}
