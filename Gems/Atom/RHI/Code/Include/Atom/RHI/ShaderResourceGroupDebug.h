...
namespace AZ
{
    namespace RHI
    {
        ...
        void PrintConstantDataDiff(
            const ShaderResourceGroup& shaderResourceGroup, ConstantsData& referenceData, bool updateReferenceData = false);
        ...
        /// useful for keeping track of differences in between calls to the function, such as between frames.
        void PrintConstantDataDiff(
            const DrawItem& drawItem, ConstantsData& referenceData, uint32_t srgBindingSlot, bool updateReferenceData = false);
    }
}
