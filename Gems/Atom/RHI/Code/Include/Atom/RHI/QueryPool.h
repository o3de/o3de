...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            AZ_RTTI(QueryPool, "{D6744249-953F-45B6-AD90-B98B35E74521}", ResourcePool)
        ...
        template<class T>
        void QueryPool::SortQueries(AZStd::vector<T*>& queries)
        {
        ...
        template<class T>
        AZStd::vector<Interval> QueryPool::GetQueryIntervals(const AZStd::vector<T*>& queries)
        {
        ...
        template<class T>
        AZStd::vector<Interval> QueryPool::GetQueryIntervalsSorted(const AZStd::vector<T*>& sortedQueries)
        {
