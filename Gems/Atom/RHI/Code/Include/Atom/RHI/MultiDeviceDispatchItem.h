    ...
    struct MultiDeviceDispatchArguments
    {
        ...
        DispatchArguments GetDeviceDispatchArguments(int deviceIndex) const
        {
            ...
            case DispatchType::Indirect:
                return DispatchArguments(SingleDeviceDispatchIndirect{m_mdIndirect.m_maxSequenceCount, m_mdIndirect.m_indirectBufferView->GetDeviceIndirectBufferView(deviceIndex), m_mdIndirect.m_indirectBufferByteOffset, m_mdIndirect.m_countBuffer->GetDeviceBuffer(deviceIndex).get(), m_mdIndirect.m_countBufferByteOffset});
            default:
