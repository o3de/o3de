...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
             ...
             */
            ResultCode Init(
                DeviceMask deviceMask, const PipelineStateDescriptorForDraw& descriptor, PipelineLibrary* pipelineLibrary = nullptr);
             ...
             */
            ResultCode Init(
                DeviceMask deviceMask, const PipelineStateDescriptorForDispatch& descriptor, PipelineLibrary* pipelineLibrary = nullptr);
             ...
             */
            ResultCode Init(
                DeviceMask deviceMask, const PipelineStateDescriptorForRayTracing& descriptor, PipelineLibrary* pipelineLibrary = nullptr);

            inline Ptr<DevicePipelineState> GetDevicePipelineState(int deviceIndex) const
            {
                AZ_Assert(
        ...
        private:
            ...
            AZStd::unordered_map<int, Ptr<DevicePipelineState>> m_devicePipelineStates;
        };
    }
}
