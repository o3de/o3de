...
namespace AZ
{
    namespace RHI
    {
        ...
        struct DeviceDrawArguments
        {
            ...
            DeviceDrawArguments()
                : DeviceDrawArguments(DrawIndexed{})
            {
            }
        ...
        {
            DeviceDrawItemProperties() = default;

            DeviceDrawItemProperties(
                const DeviceDrawItem* item, DrawItemSortKey sortKey = 0, DrawFilterMask filterMask = DrawFilterMaskDefaultValue)
                : m_item{ item }
                , m_sortKey{ sortKey }
