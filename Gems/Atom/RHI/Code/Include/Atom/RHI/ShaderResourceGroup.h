...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            inline Ptr<DeviceShaderResourceGroup> GetDeviceShaderResourceGroup(int deviceIndex) const
            {
                AZ_Assert(
                    m_deviceShaderResourceGroups.find(deviceIndex) != m_deviceShaderResourceGroups.end(),
                    "No DeviceShaderResourceGroup found for device index %d\n",
                    deviceIndex);
        ...
        private:
            ...
            AZStd::unordered_map<int, Ptr<DeviceShaderResourceGroup>> m_deviceShaderResourceGroups;
        };
    }
}
