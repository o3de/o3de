...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            AZ_RTTI(RayTracingBlas, "{705C3E37-D790-4B9E-9476-013EED2F85B8}", MultiDeviceObject)
            RayTracingBlas() = default;
            virtual ~RayTracingBlas() = default;

            static RHI::Ptr<RHI::RayTracingBlas> Create()
            {
                return aznew RayTracingBlas;
            }

            const RHI::Ptr<DeviceRayTracingBlas>& GetDeviceRayTracingBlas(int deviceIndex)
            {
        ...
        private:
            AZStd::unordered_map<int, Ptr<DeviceRayTracingBlas>> m_deviceRayTracingBlas;
        ...
        public:
            ...
            AZ_RTTI(RayTracingTlas, "{5F4A7054-3E36-4F03-A279-8DACFF891995}", MultiDeviceObject)
            RayTracingTlas() = default;
            virtual ~RayTracingTlas() = default;

            static RHI::Ptr<RHI::RayTracingTlas> Create()
            {
                return aznew RayTracingTlas;
            }

            const RHI::Ptr<DeviceRayTracingTlas>& GetDeviceRayTracingTlas(int deviceIndex)
            {
        ...
        private:
            AZStd::unordered_map<int, Ptr<DeviceRayTracingTlas>> m_deviceRayTracingTlas;
