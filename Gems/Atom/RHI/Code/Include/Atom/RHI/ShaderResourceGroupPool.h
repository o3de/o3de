...
namespace AZ
{
    namespace RHI
    {
        ...
        public:
            ...
            ResultCode Init(DeviceMask deviceMask, const ShaderResourceGroupPoolDescriptor& descriptor);
        ...
        private:
            ...
            AZStd::unordered_map<int, Ptr<DeviceShaderResourceGroupPool>> m_deviceShaderResourceGroupPools;
        };
    }
}
