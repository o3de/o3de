...
namespace AZ
{
    namespace RHI
    {
        ...
        struct ImageUpdateRequest
        {
            ...
            ImageSubresourceLayoutPlaced m_sourceSubresourceLayout;
        };
        ...
        public:
            ...
            ResultCode Init(DeviceMask deviceMask, const ImagePoolDescriptor& descriptor);
        ...
        private:
            ...
            AZStd::unordered_map<int, Ptr<DeviceImagePool>> m_deviceImagePools;
        };
    }
}
