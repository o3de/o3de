...
namespace AZ
{
    namespace RHI
    {
        ...
        ResultCode ImagePool::Init(DeviceMask deviceMask, const ImagePoolDescriptor& descriptor)
        {
        ...
        ResultCode ImagePool::UpdateImageContents(const ImageUpdateRequest& request)
        {
            ...
            for (auto& [deviceIndex, deviceImagePool] : m_deviceImagePools)
            {
                ...
                imageUpdateRequest.m_sourceSubresourceLayout =
                    request.m_sourceSubresourceLayout.GetDeviceImageSubresourcePlaced(deviceIndex);
