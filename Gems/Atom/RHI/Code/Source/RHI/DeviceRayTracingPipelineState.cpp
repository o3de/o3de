...
namespace AZ
{
    namespace RHI
    {
        ...
        DeviceRayTracingPipelineStateDescriptor* DeviceRayTracingPipelineStateDescriptor::PipelineState(
        ...
        DeviceRayTracingPipelineStateDescriptor* DeviceRayTracingPipelineStateDescriptor::ShaderLibrary(
        ...
        DeviceRayTracingPipelineStateDescriptor* DeviceRayTracingPipelineStateDescriptor::ClosestHitShaderName(
