...
namespace AZ
{
    namespace RHI
    {
        ...
        ResultCode BufferPool::Init(DeviceMask deviceMask, const BufferPoolDescriptor& descriptor)
        {
                ...
                [this, &descriptor]()
                {
                    ...
                    IterateDevices(
                        [this, &descriptor](int deviceIndex)
                        {
                            ...
                            m_deviceBufferPools[deviceIndex]->Init(*device, descriptor);
        ...
        ResultCode BufferPool::StreamBuffer(const BufferStreamRequest& request)
        {
            ...
            for (auto& [deviceIndex, deviceBufferPool] : m_deviceBufferPools)
            {
                ...
                DeviceBufferStreamRequest bufferStreamRequest{ request.m_fenceToSignal
        ...
        ResultCode BufferPool::InitBuffer(Buffer* buffer, const BufferDescriptor& descriptor, PlatformMethod platformInitResourceMethod)
        {
        ...
        bool BufferPool::ValidateBufferUnmap([[maybe_unused]] Buffer& buffer)
        {
            return true;
        }
