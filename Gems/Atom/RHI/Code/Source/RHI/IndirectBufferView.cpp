...
namespace AZ
{
    namespace RHI
    {
        IndirectBufferView::IndirectBufferView(
            const Buffer& buffer, const IndirectBufferSignature& signature, uint32_t byteOffset, uint32_t byteCount, uint32_t byteStride)
            : m_buffer(&buffer)
        ...
        DeviceIndirectBufferView IndirectBufferView::GetDeviceIndirectBufferView(int deviceIndex) const
        {
            return DeviceIndirectBufferView(
