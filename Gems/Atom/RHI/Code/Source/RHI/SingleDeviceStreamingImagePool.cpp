...
namespace AZ::RHI
{
    ...
    bool SingleDeviceStreamingImagePool::ValidateExpandRequest(const StreamingImageExpandRequest& expandRequest) const
    {
        if (Validation::IsEnabled())
        {
    ...
    ResultCode SingleDeviceStreamingImagePool::ExpandImage(const StreamingImageExpandRequest& request)
    {
        if (!ValidateIsInitialized())
        {
            return ResultCode::InvalidOperation;
    ...
    ResultCode SingleDeviceStreamingImagePool::ExpandImageInternal(const StreamingImageExpandRequest&)
    {
        return ResultCode::Unimplemented;
    }
