...
namespace AZ::RHI
{
    ...
    void ShaderResourceGroupInvalidateRegistry::OnAttach(const Resource* resource, SingleDeviceShaderResourceGroup* shaderResourceGroup)
    {
    ...
    void ShaderResourceGroupInvalidateRegistry::OnDetach(const Resource* resource, SingleDeviceShaderResourceGroup* shaderResourceGroup)
    {
