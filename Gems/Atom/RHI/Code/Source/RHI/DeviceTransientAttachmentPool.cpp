...
namespace AZ
{
    namespace RHI
    {
        bool DeviceTransientAttachmentPool::NeedsTransientAttachmentPool(const DeviceTransientAttachmentPoolDescriptor& descriptor)
        {
        ...
        ResultCode DeviceTransientAttachmentPool::Init(Device& device, const DeviceTransientAttachmentPoolDescriptor& descriptor)
        {
        ...
        const DeviceTransientAttachmentPoolDescriptor& DeviceTransientAttachmentPool::GetDescriptor() const
        {
            return m_descriptor;
        }
        ...
        bool DeviceTransientAttachmentPool::ValidateInitParameters([[maybe_unused]] const DeviceTransientAttachmentPoolDescriptor& descriptor) const
        {
