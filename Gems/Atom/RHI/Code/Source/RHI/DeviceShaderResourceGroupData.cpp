...
namespace AZ
{
    namespace RHI
    {
        ...
        bool DeviceShaderResourceGroupData::ValidateSetImageView(
            ShaderInputImageIndex inputIndex, const DeviceImageView* imageView, uint32_t arrayIndex) const
        {
        ...
        bool DeviceShaderResourceGroupData::ValidateSetBufferView(
            ShaderInputBufferIndex inputIndex, const DeviceBufferView* bufferView, uint32_t arrayIndex) const
        {
            if (!Validation::IsEnabled())
            {
                return true;
        ...
        bool DeviceShaderResourceGroupData::SetImageView(
            ShaderInputImageIndex inputIndex, const DeviceImageView* imageView, uint32_t arrayIndex = 0)
        {
            AZStd::array<const DeviceImageView*, 1> imageViews = {{imageView}};
            return SetImageViewArray(inputIndex, imageViews, arrayIndex);
        }

        bool DeviceShaderResourceGroupData::SetImageViewArray(
            ShaderInputImageIndex inputIndex, AZStd::span<const DeviceImageView* const> imageViews, uint32_t arrayIndex)
        {
        ...
        bool DeviceShaderResourceGroupData::SetImageViewUnboundedArray(
            ShaderInputImageUnboundedArrayIndex inputIndex, AZStd::span<const DeviceImageView* const> imageViews)
        {
        ...
        bool DeviceShaderResourceGroupData::SetBufferView(
            ShaderInputBufferIndex inputIndex, const DeviceBufferView* bufferView, uint32_t arrayIndex)
        {
            AZStd::array<const DeviceBufferView*, 1> bufferViews = {{bufferView}};
            return SetBufferViewArray(inputIndex, bufferViews, arrayIndex);
        }

        bool DeviceShaderResourceGroupData::SetBufferViewArray(
            ShaderInputBufferIndex inputIndex, AZStd::span<const DeviceBufferView* const> bufferViews, uint32_t arrayIndex)
        {
        ...
        bool DeviceShaderResourceGroupData::SetBufferViewUnboundedArray(
            ShaderInputBufferUnboundedArrayIndex inputIndex, AZStd::span<const DeviceBufferView* const> bufferViews)
        {
            if (GetLayout()->ValidateAccess(inputIndex))
            {
        ...
        bool DeviceShaderResourceGroupData::SetSamplerArray(
        ...
        bool DeviceShaderResourceGroupData::SetConstantRaw(
        ...
        const RHI::ConstPtr<RHI::DeviceImageView>& DeviceShaderResourceGroupData::GetImageView(
        ...
        AZStd::span<const RHI::ConstPtr<RHI::DeviceImageView>> DeviceShaderResourceGroupData::GetImageViewArray(
        ...
        AZStd::span<const RHI::ConstPtr<RHI::DeviceImageView>> DeviceShaderResourceGroupData::GetImageViewUnboundedArray(
        ...
        const RHI::ConstPtr<RHI::DeviceBufferView>& DeviceShaderResourceGroupData::GetBufferView(
        ...
        AZStd::span<const RHI::ConstPtr<RHI::DeviceBufferView>> DeviceShaderResourceGroupData::GetBufferViewArray(
        ...
        AZStd::span<const RHI::ConstPtr<RHI::DeviceBufferView>> DeviceShaderResourceGroupData::GetBufferViewUnboundedArray(
        ...
        const RHI::SamplerState& DeviceShaderResourceGroupData::GetSampler(
