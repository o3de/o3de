...
namespace AZ::RHI
{
    ...
    const RHI::Ptr<RHI::SingleDeviceBufferPool>& SingleDeviceRayTracingBufferPools::GetShaderTableBufferPool() const
    {
        AZ_Assert(m_initialized, "SingleDeviceRayTracingBufferPools was not initialized");
        return m_shaderTableBufferPool;
    }

    const RHI::Ptr<RHI::SingleDeviceBufferPool>& SingleDeviceRayTracingBufferPools::GetScratchBufferPool() const
    {
        AZ_Assert(m_initialized, "SingleDeviceRayTracingBufferPools was not initialized");
        return m_scratchBufferPool;
    }

    const RHI::Ptr<RHI::SingleDeviceBufferPool>& SingleDeviceRayTracingBufferPools::GetBlasBufferPool() const
    {
        AZ_Assert(m_initialized, "SingleDeviceRayTracingBufferPools was not initialized");
        return m_blasBufferPool;
    }

    const RHI::Ptr<RHI::SingleDeviceBufferPool>& SingleDeviceRayTracingBufferPools::GetTlasInstancesBufferPool() const
    {
        AZ_Assert(m_initialized, "SingleDeviceRayTracingBufferPools was not initialized");
        return m_tlasInstancesBufferPool;
    }

    const RHI::Ptr<RHI::SingleDeviceBufferPool>& SingleDeviceRayTracingBufferPools::GetTlasBufferPool() const
    {
        AZ_Assert(m_initialized, "SingleDeviceRayTracingBufferPools was not initialized");
