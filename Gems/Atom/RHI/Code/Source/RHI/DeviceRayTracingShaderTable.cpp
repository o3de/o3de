...
namespace AZ
{
    namespace RHI
    {
        ...
        {
            for (DeviceRayTracingShaderTableRecordList::iterator itHitGroup = m_hitGroupRecords.begin();
        ...
        DeviceRayTracingShaderTableDescriptor* DeviceRayTracingShaderTableDescriptor::Build(
        ...
        DeviceRayTracingShaderTableDescriptor* DeviceRayTracingShaderTableDescriptor::HitGroupRecord(
        ...
        DeviceRayTracingShaderTableDescriptor* DeviceRayTracingShaderTableDescriptor::ShaderResourceGroup(
            const RHI::DeviceShaderResourceGroup* shaderResourceGroup)
        {
        ...
        void DeviceRayTracingShaderTable::Build(const AZStd::shared_ptr<DeviceRayTracingShaderTableDescriptor> descriptor)
        {
            AZ_Assert(
                !m_isQueuedForBuild,
                "Attempting to build a DeviceRayTracingShaderTable that's already been queued. Only build once per frame.") m_descriptor =
                descriptor;
