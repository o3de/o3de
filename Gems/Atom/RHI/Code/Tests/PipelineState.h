...
namespace UnitTest
{
    class PipelineLibrary : public AZ::RHI::DevicePipelineLibrary
    {
    public:
    ...
    private:
        AZ::RHI::ResultCode InitInternal(AZ::RHI::Device&, const AZ::RHI::DevicePipelineLibraryDescriptor&) override
        {
    ...
    class PipelineState : public AZ::RHI::DevicePipelineState
    {
    public:
    ...
    private:
        AZ::RHI::ResultCode InitInternal(
            AZ::RHI::Device&, const AZ::RHI::PipelineStateDescriptorForDraw&, AZ::RHI::DevicePipelineLibrary*) override;
        AZ::RHI::ResultCode InitInternal(
            AZ::RHI::Device&, const AZ::RHI::PipelineStateDescriptorForDispatch&, AZ::RHI::DevicePipelineLibrary*) override;
        AZ::RHI::ResultCode InitInternal(
            AZ::RHI::Device&, const AZ::RHI::PipelineStateDescriptorForRayTracing&, AZ::RHI::DevicePipelineLibrary*) override;
        void ShutdownInternal() override {}
    };
}
