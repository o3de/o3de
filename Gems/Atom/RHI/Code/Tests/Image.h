...
namespace UnitTest
{
    class ImageView : public AZ::RHI::DeviceImageView
    {
    public:
    ...
    class Image : public AZ::RHI::DeviceImage
    {
    public:
    ...
    private:
        void GetSubresourceLayoutsInternal(
            const AZ::RHI::ImageSubresourceRange&, AZ::RHI::DeviceImageSubresourceLayoutPlaced*, size_t*) const override
        {
        }
    };

    class ImagePool : public AZ::RHI::DeviceImagePool
    {
    public:
