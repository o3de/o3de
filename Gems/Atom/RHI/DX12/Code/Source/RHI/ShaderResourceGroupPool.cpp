...
namespace AZ
{
    namespace DX12
    {
                                                                 ...
                                                                 bool forceUpdate /*= false*/ )
        {
            ...
            if(forceUpdate || groupData.IsResourceTypeEnabledForCompilation(static_cast<uint32_t>(ResourceMask::BufferViewMask)))
            {
            ...
            if(forceUpdate || groupData.IsResourceTypeEnabledForCompilation(static_cast<uint32_t>(ResourceMask::ImageViewMask)))
            {
                shaderInputIndex = 0;
