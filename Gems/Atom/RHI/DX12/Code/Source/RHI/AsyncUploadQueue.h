...
namespace AZ
{
    namespace DX12
    {
        ...
        private:
            ...
            // Note: the DeviceBufferStreamRequest doesn't need to be cached since the queued command doesn't use the its reference
            AZStd::queue<CommandList::TileMapRequest> m_tileMapRequests;
            AZStd::queue<RHI::DeviceStreamingImageExpandRequest> m_imageExpandRequests;
