...
namespace AZ
{
    namespace DX12
    {
        ...
        void Device::InitFeatures()
        {
            ...
            m_limits.m_maxConstantBufferSize = D3D12_REQ_CONSTANT_BUFFER_ELEMENT_COUNT * 4 * 4; // 4096 vectors * 4 values per vector * 4 bytes per value
            m_limits.m_maxBufferSize = D3D12_REQ_RESOURCE_SIZE_IN_MEGABYTES_EXPRESSION_C_TERM * (1024 * 1024); // 2048 MB
        }
