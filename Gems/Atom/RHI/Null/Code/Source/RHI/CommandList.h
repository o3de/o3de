...
namespace AZ
{
    namespace Null
    {
        ...
        public:
            ...
            void BuildClusterAccelerationStructures([[maybe_unused]] RHI::DeviceRayTracingClusterBlas& rayTracingClusterBlas) override {};
            void BuildClusterBottomLevelAccelerationStructure([[maybe_unused]] RHI::DeviceRayTracingClusterBlas& rayTracingClusterBlas) override {};
