...
namespace AZ
{
    namespace Null
    {
        class TransientAttachmentPool final : public RHI::DeviceTransientAttachmentPool
        {
        ...
        private:
            ...
            RHI::ResultCode InitInternal([[maybe_unused]] RHI::Device& device, [[maybe_unused]] const RHI::DeviceTransientAttachmentPoolDescriptor& descriptor) override { return RHI::ResultCode::Success;}
