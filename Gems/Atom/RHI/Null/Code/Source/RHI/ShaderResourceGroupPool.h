...
namespace AZ
{
    namespace Null
    {
        ...
        private:
            ...
            RHI::ResultCode CompileGroupInternal([[maybe_unused]] RHI::SingleDeviceShaderResourceGroup& groupBase, [[maybe_unused]] const RHI::ShaderResourceGroupData& groupData) override { return RHI::ResultCode::Success;}
