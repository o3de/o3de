...
namespace AZ
{
    namespace Null
    {
        class RayTracingPipelineState final : public RHI::DeviceRayTracingPipelineState
        {
        public:
        ...
        private:
            ...
            RHI::ResultCode InitInternal(
                ...
                [[maybe_unused]] const RHI::DeviceRayTracingPipelineStateDescriptor* descriptor) override
            {
