...
namespace AtomToolsFramework
{
    void DynamicNodeConfig::Reflect(AZ::ReflectContext* context)
    {
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            {
                editContext->Class<DynamicNodeConfig>(QT_TRANSLATE_NOOP("AtomToolsFramework", "DynamicNodeConfig"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Configuration settings defining the slots and UI of a dynamic node."))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->SetDynamicEditDataProvider(&DynamicNodeConfig::GetDynamicEditData)
                    ->UIElement(AZ::Edit::UIHandlers::Button, "", QT_TRANSLATE_NOOP("AtomToolsFramework", "Generate a new random UUID to uniquely identify this node."))
                    ...
                    ->DataElement(AZ_CRC_CE("MultilineStringDialog"), &DynamicNodeConfig::m_category, QT_TRANSLATE_NOOP("AtomToolsFramework", "Category"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Name of the category where this node will appear in the node palette."))
                    ->DataElement(AZ_CRC_CE("MultilineStringDialog"), &DynamicNodeConfig::m_title, QT_TRANSLATE_NOOP("AtomToolsFramework", "Title"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Title that will appear at the top of the node UI in a graph."))
                    ->DataElement(AZ_CRC_CE("MultilineStringDialog"), &DynamicNodeConfig::m_subTitle, QT_TRANSLATE_NOOP("AtomToolsFramework", "Sub Title"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Secondary title that will appear below the main title on the node UI in a graph."))
                    ->DataElement(AZ_CRC_CE("MultilineStringDialog"), &DynamicNodeConfig::m_titlePaletteName, QT_TRANSLATE_NOOP("AtomToolsFramework", "Title Palette Name"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Name of the node title bar UI palette style sheet entry."))
                    ->DataElement(AZ_CRC_CE("MultilineStringDialog"), &DynamicNodeConfig::m_description, QT_TRANSLATE_NOOP("AtomToolsFramework", "Description"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Description about this node's behavior."))
                    ->DataElement(AZ::Edit::UIHandlers::Default, &DynamicNodeConfig::m_slotDataTypeGroups, QT_TRANSLATE_NOOP("AtomToolsFramework", "Slot Data Type Groups"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Groups of slots that should have the same types."))
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &DynamicNodeConfig::m_settings, QT_TRANSLATE_NOOP("AtomToolsFramework", "Settings"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Table of strings that can be used for any context specific or user defined data for each node."))
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->Attribute(AZ::Edit::Attributes::ClearNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                        ->Attribute(AZ::Edit::Attributes::AddNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                        ->Attribute(AZ::Edit::Attributes::RemoveNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &DynamicNodeConfig::m_inputSlots, QT_TRANSLATE_NOOP("AtomToolsFramework", "Input Slots"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Container of dynamic node input slot configurations."))
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->Attribute(AZ::Edit::Attributes::ClearNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                        ->Attribute(AZ::Edit::Attributes::AddNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                        ->Attribute(AZ::Edit::Attributes::RemoveNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &DynamicNodeConfig::m_outputSlots, QT_TRANSLATE_NOOP("AtomToolsFramework", "Output Slots"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Container of dynamic node output slot configurations."))
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->Attribute(AZ::Edit::Attributes::ClearNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                        ->Attribute(AZ::Edit::Attributes::AddNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                        ->Attribute(AZ::Edit::Attributes::RemoveNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &DynamicNodeConfig::m_propertySlots, QT_TRANSLATE_NOOP("AtomToolsFramework", "Property Slots"), QT_TRANSLATE_NOOP("AtomToolsFramework", "Container hub dynamic node property slot configurations."))
                         ->Attribute(AZ::Edit::Attributes::ChangeNotify, AZ::Edit::PropertyRefreshLevels::AttributesAndValues)
                        ->Attribute(AZ::Edit::Attributes::ClearNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                        ->Attribute(AZ::Edit::Attributes::AddNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
                        ->Attribute(AZ::Edit::Attributes::RemoveNotify, AZ::Edit::PropertyRefreshLevels::EntireTree)
