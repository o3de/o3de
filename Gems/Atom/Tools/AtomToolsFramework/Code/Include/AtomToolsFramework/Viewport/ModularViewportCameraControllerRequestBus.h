...
namespace AtomToolsFramework
{
    ...
    public:
        ...
        //! Same as SetCameraPivotAttached only the pivot is set on the current and target camera so no interpolation occurs.
        ...
        //! Same as SetCameraPivotDetached only the pivot is set on the current and target camera so no interpolation occurs.
        ...
        //! Same as SetCameraOffset only the offset is set on the current and target camera so no interpolation occurs.
