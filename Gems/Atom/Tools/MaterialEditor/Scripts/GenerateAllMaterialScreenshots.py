...
def GenerateAllMaterialScreenshots():
    ...
    GenerateMaterialScreenshot('013_SpecularAA_Off', lighting="testdata/testdata/test.lightingpreset.azasset")
    GenerateMaterialScreenshot('013_SpecularAA_On', lighting="testdata/testdata/test.lightingpreset.azasset")
    ...
    GenerateMaterialScreenshot('100_UvTiling_Normal_Dome_Rotate20',      model="materialeditor/viewportmodels/cube.modelpreset.azasset", lighting="testdata/testdata/test.lightingpreset.azasset", cameraHeading=225.0)
    GenerateMaterialScreenshot('100_UvTiling_Normal_Dome_Rotate90',      model="materialeditor/viewportmodels/cube.modelpreset.azasset", lighting="testdata/testdata/test.lightingpreset.azasset", cameraHeading=225.0)
    GenerateMaterialScreenshot('100_UvTiling_Normal_Dome_ScaleOnlyU',    model="materialeditor/viewportmodels/cube.modelpreset.azasset", lighting="testdata/testdata/test.lightingpreset.azasset", cameraHeading=225.0)
    GenerateMaterialScreenshot('100_UvTiling_Normal_Dome_ScaleOnlyV',    model="materialeditor/viewportmodels/cube.modelpreset.azasset", lighting="testdata/testdata/test.lightingpreset.azasset", cameraHeading=225.0)
    GenerateMaterialScreenshot('100_UvTiling_Normal_Dome_ScaleUniform',  model="materialeditor/viewportmodels/cube.modelpreset.azasset", lighting="testdata/testdata/test.lightingpreset.azasset", cameraHeading=225.0)
    GenerateMaterialScreenshot('100_UvTiling_Normal_Dome_TransformAll',  model="materialeditor/viewportmodels/cube.modelpreset.azasset", lighting="testdata/testdata/test.lightingpreset.azasset", cameraHeading=225.0)
