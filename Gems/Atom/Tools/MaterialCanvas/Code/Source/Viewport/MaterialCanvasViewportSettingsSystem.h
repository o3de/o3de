...
{
    //! MaterialCanvasViewportSettingsSystem manages storing and retrieving different viewport settings, loading and saving lighting and model
    //! presets
    class MaterialCanvasViewportSettingsSystem final
        : public MaterialCanvasViewportSettingsRequestBus::Handler
        , public AZ::TickBus::Handler
        , public AzFramework::AssetCatalogEventBus::Handler
    {
    public:
        AZ_RTTI(MaterialCanvasViewportSettingsSystem, "{3CA1A2F4-AD6E-478A-B1E8-565E66BD5B69}");
        AZ_CLASS_ALLOCATOR(MaterialCanvasViewportSettingsSystem, AZ::SystemAllocator, 0);
        AZ_DISABLE_COPY_MOVE(MaterialCanvasViewportSettingsSystem);

        static void Reflect(AZ::ReflectContext* context);

        MaterialCanvasViewportSettingsSystem() = default;
        MaterialCanvasViewportSettingsSystem(const AZ::Crc32& toolId);
        ~MaterialCanvasViewportSettingsSystem();
    ...
    private:
        ...
        // MaterialCanvasViewportSettingsRequestBus::Handler overrides ...
