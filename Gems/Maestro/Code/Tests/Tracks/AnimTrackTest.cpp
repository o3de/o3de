...
namespace Maestro
{
    ...
    namespace AnimTrackTest
    {
        ...
        TEST_F(TAnimTrackTest, SelectKey_InvalidKey)
        {
            ...
            // We are expecting only 1 assert as the function does early-out.
            AZ_TEST_STOP_TRACE_SUPPRESSION(1);
        }
        ...
        TEST_F(TAnimTrackTest, SetKey_InvalidIndex_ExpectAssert)
        {
            ...
            // We are expecting only 1 asserts as the function does early-out.
            AZ_TEST_STOP_TRACE_SUPPRESSION(1);
        }
        ...
        TEST_F(TAnimTrackTest, SetKeyTime_InvalidIndex_ExpectAssert)
        {
            ...
            // We are expecting only 11 assert as the function does early-out.
            AZ_TEST_STOP_TRACE_SUPPRESSION(1);
        }
