...
class TestViewportEntityCreation(object):
    ...
    @pytest.mark.test_case_id("C6317058")
    def test_viewport_entity_creation(self, request, editor, level):
        expected_lines = [
            "New Entity created in the correct position"
        ]
