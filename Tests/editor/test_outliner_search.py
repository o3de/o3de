...
class TestEntityOutlinerSearching(object):
    ...
    @pytest.mark.test_case_id("C17218816")
    def test_outliner_search(self, request, editor, level):
        expected_lines = [
            "Test Entities were set up correctly",
            "Searching Test_0 returns 3 entities",
            "Searching Test returns 4 entities",
            "Searching asdfgh returns 0 entities",
            "Emptying the search returns all entities",
        ]
        unexpected_lines = []
