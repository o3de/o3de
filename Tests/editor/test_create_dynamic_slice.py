...
class TestCreateDynamicSlice(object):
    ...
    @pytest.mark.test_case_id("C1519572")
    def test_create_dynamic_slice(self, request, editor, level):
        expected_lines = [
            "Slice Status (Before setting to dynamic): Not Dynamic",
            "Slice Status (After setting to dynamic): Dynamic",
            "Slice Status (Before unsetting to dynamic): Dynamic",
            "Slice Status (After unsetting to dynamic): Not Dynamic",
        ]
