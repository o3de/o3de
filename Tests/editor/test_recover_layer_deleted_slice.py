...
class TestRecoverLayerDeletedSlice(object):
    ...
    @pytest.mark.test_case_id("C6130896")
    def test_recover_layer_deleted_slice(self, request, editor, level):
        expected_lines = [
            "Layer1 is created",
            "Entity1 is created",
            "Slice Created: True",
            "Parent of Entity1 is : Layer1",
            "This layer can't be recovered.",
        ]
        ...
        hydra_utils.launch_and_validate_results(
            ...
            test_directory,
            editor,
            "recover_layer_deleted_slice.py",
            expected_lines,
            cfg_args=[level],
