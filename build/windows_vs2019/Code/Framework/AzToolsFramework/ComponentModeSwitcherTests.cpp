...
namespace UnitTest
{
    ...
    // Shoes require socks
    class LeatherBootsComponent : public AZ::Component
    {
    public:
    ...
    class WoolSocksComponent : public AzToolsFramework::Components::EditorComponentBase
    {
    public:
    ...
    class HatesSocksComponent : public AZ::Component
    {
    public:
    ...
    class BlueJeansComponent : public AZ::Component
    {
    public:
    ...
    class WhiteBriefsComponent : public AZ::Component
    {
    public:
    ...
    class HeartBoxersComponent : public AZ::Component
    {
    public:
    ...
    class KnifeSheathComponent : public AZ::Component
    {
    public:
    ...
    size_t CountPendingComponentsOnEntity(AZ::Entity* entity)
    {
        ...
        AzToolsFramework::EditorPendingCompositionRequestBus::Event(
            entity->GetId(), &AzToolsFramework::EditorPendingCompositionRequestBus::Events::GetPendingComponents, pendingComponents);
    ...
    size_t CountDisabledComponentsOnEntity(AZ::Entity* entity)
    {
        ...
        AzToolsFramework::EditorDisabledCompositionRequestBus::Event(
            entity->GetId(), &AzToolsFramework::EditorDisabledCompositionRequestBus::Events::GetDisabledComponents, disabledComponents);
    ...
    AZStd::vector<AZ::Component*> GetComponentsForEntity(AZ::Entity* entity)
    {
        ...
        auto itr = AZStd::remove_if(
            components.begin(),
            components.end(),
            [](AZ::Component* component)
            {
                return AzToolsFramework::GetUnderlyingComponentType(*component) != azrtti_typeid<ComponentType>();
            });
    ...
    {
        static bool OnOutcomeForEntity(
            const AzToolsFramework::EntityCompositionRequestBus::Events::AddComponentsOutcome& outcome, AZ::Entity* entity)
        {
            auto iterEntityOutcome = outcome.GetValue().find(entity->GetId());
            EXPECT_NE(iterEntityOutcome, outcome.GetValue().end());
            return CheckAllAreTrue(DoesComponentListHaveComponent(
                iterEntityOutcome->second.m_additionalValidatedComponents, azrtti_typeid<AdditionalValidatedComponentTypes>())...);
        }
    };
    ...
    struct VerifyAddedPendingComponents
    {
            ...
            const AzToolsFramework::EntityCompositionRequestBus::Events::AddComponentsOutcome& outcome, AZ::Entity* entity)
        {
            ...
            EXPECT_NE(iterEntityOutcome, outcome.GetValue().end());
            return CheckAllAreTrue(DoesComponentListHaveComponent(
                iterEntityOutcome->second.m_addedPendingComponents, azrtti_typeid<AddedPendingComponentTypes>())...);
        }
    };
    ...
    struct VerifyAddedValidComponents
    {
            ...
            const AzToolsFramework::EntityCompositionRequestBus::Events::AddComponentsOutcome& outcome, AZ::Entity* entity)
        {
            ...
            EXPECT_NE(iterEntityOutcome, outcome.GetValue().end());
            return CheckAllAreTrue(DoesComponentListHaveComponent(
                iterEntityOutcome->second.m_addedValidComponents, azrtti_typeid<AddedValidComponentTypes>())...);
        }
    ...
    {
        static bool OnOutcomeForEntity(
            const AzToolsFramework::EntityCompositionRequestBus::Events::RemoveComponentsOutcome& outcome, AZ::Entity* entity)
        {
            auto iterEntityOutcome = outcome.GetValue().find(entity->GetId());
            EXPECT_NE(iterEntityOutcome, outcome.GetValue().end());
            return CheckAllAreTrue(DoesComponentListHaveComponent(
                iterEntityOutcome->second.m_invalidatedComponents, azrtti_typeid<InvalidatedComponentTypes>())...);
        }
    };
    ...
    struct VerifyRemovalValidatedComponents
    {
            ...
            const AzToolsFramework::EntityCompositionRequestBus::Events::RemoveComponentsOutcome& outcome, AZ::Entity* entity)
        {
            ...
            EXPECT_NE(iterEntityOutcome, outcome.GetValue().end());
            return CheckAllAreTrue(DoesComponentListHaveComponent(
                iterEntityOutcome->second.m_validatedComponents, azrtti_typeid<ValidatedComponentTypes>())...);
        }
    ...
    private:
        ...
        size_t GetPendingComponentCount() const
        {
            AZ::Entity::ComponentArrayType pendingComponents;
            AzToolsFramework::EditorPendingCompositionRequestBus::Event(
                m_entity->GetId(), &AzToolsFramework::EditorPendingCompositionRequestBus::Events::GetPendingComponents, pendingComponents);
        ...
        size_t GetDisabledComponentCount() const
        {
            ...
            AzToolsFramework::EditorDisabledCompositionRequestBus::Event(
                m_entity->GetId(),
                &AzToolsFramework::EditorDisabledCompositionRequestBus::Events::GetDisabledComponents,
                disabledComponents);
    ...
    class AddComponentsTest : public AllocatorsTestFixture
    {
    public:
        void SetUp() override
        {
            ...
            AzToolsFramework::EditorEntityContextRequestBus::Broadcast(
                &AzToolsFramework::EditorEntityContextRequestBus::Events::AddRequiredComponents, *m_entity1);
            m_entity1->Init();
            ...
            AzToolsFramework::EditorEntityContextRequestBus::Broadcast(
                &AzToolsFramework::EditorEntityContextRequestBus::Events::AddRequiredComponents, *m_entity2);
            m_entity2->Init();
    ...
    TEST_F(AddComponentsTest, ComponentRequiresService)
    {
        ...
        ASSERT_TRUE(outcome.IsSuccess());
        ASSERT_TRUE(
            VerifyAddedValidComponents<WoolSocksComponent>::AndAdditionalValidatedComponents<LeatherBootsComponent>::OnOutcomeForEntity(
                outcome, m_entity1));
        ...
        AzToolsFramework::EntityCompositionRequestBus::BroadcastResult(
            pendingComponentInfo, &AzToolsFramework::EntityCompositionRequestBus::Events::GetPendingComponentInfo, component);
    ...
    TEST_F(AddComponentsTest, ComponentRequiresServiceWithTwoViableOptions)
    {
        ...
        ASSERT_TRUE(outcome.IsSuccess());
        ASSERT_TRUE(
            VerifyAddedValidComponents<WhiteBriefsComponent>::AndAdditionalValidatedComponents<BlueJeansComponent>::OnOutcomeForEntity(
                outcome, m_entity1));
    ...
    TEST_F(AddComponentsTest, RequiredServiceConflictsWithExistingComponents)
    {
        ...
        AzToolsFramework::EntityCompositionRequestBus::BroadcastResult(
            pendingComponentInfo, &AzToolsFramework::EntityCompositionRequestBus::Events::GetPendingComponentInfo, leatherBootsComponent);
        ...
        AzToolsFramework::EntityCompositionRequestBus::BroadcastResult(
            pendingComponentInfo, &AzToolsFramework::EntityCompositionRequestBus::Events::GetPendingComponentInfo, woolSocksComponent);
        // Should have one incompatible component
        ASSERT_EQ(pendingComponentInfo.m_missingRequiredServices.size(), 0);
        ASSERT_EQ(pendingComponentInfo.m_validComponentsThatAreIncompatible.size(), 1);
        ASSERT_EQ(pendingComponentInfo.m_pendingComponentsWithRequiredServices.size(), 0);
        ...
        ASSERT_TRUE(removalOutcome.IsSuccess());
        ASSERT_TRUE(
            (VerifyRemovalValidatedComponents<WoolSocksComponent, LeatherBootsComponent>::OnOutcomeForEntity(removalOutcome, m_entity1)));
    }
    ...
    public:
        ...
        bool DeleteEntity(const EntityId&) override
        {
            return true;
        }
        Entity* FindEntity(const EntityId&) override
        {
            return nullptr;
        }
    ...
    public:
        class VisibleComponent : public AzToolsFramework::Components::EditorComponentBase
        {
        public:
        ...
        class HiddenComponent : public AzToolsFramework::Components::EditorComponentBase
        {
        public:
            ...
            static void Reflect(ReflectContext* reflection)
            {
                ...
                if (serializeContext)
                {
                    ...
                    ec->Class<HiddenComponent>("Hidden Component", "A class that should not show up in the property editor")
                        ...
                        ->Attribute(
                            AZ::Edit::Attributes::SliceFlags, AZ::Edit::SliceFlags::HideOnAdd | AZ::Edit::SliceFlags::PushWhenHidden);
                }
            }
        };
    ...
    TEST_F(EntityTest_Scrubbing, ConflictingVisibleComponents_AreInvalidated)
    {
        ...
        EXPECT_TRUE(
            AZStd::find(
                resultForThisEntity.m_invalidatedComponents.begin(),
                resultForThisEntity.m_invalidatedComponents.end(),
                conflictingVisibleComponent) != resultForThisEntity.m_invalidatedComponents.end());

        // The "Validated components" array should be empty becuase it should only list previously invalid components that were somehow
        // validated by the scrubbing.
    ...
    TEST_F(EntityTest_Scrubbing, InactiveEntityWithInvalidComponents_AreValidatedByPendingComponents)
    {
        ...
        AZ::Entity::ComponentArrayType pendingComponents;
        AzToolsFramework::EditorPendingCompositionRequestBus::Event(
            testEntity->GetId(), &AzToolsFramework::EditorPendingCompositionRequests::GetPendingComponents, pendingComponents);
        ...
        // Don't actually want to keep the component in the pending set, so that we can validate the initial problem, so add it back onto
        // the entity
        pendingComponents.clear();
        AZ::Component* invalidComponent = resultForTestEntity.m_invalidatedComponents[0];
        AzToolsFramework::EditorPendingCompositionRequestBus::Event(
            testEntity->GetId(), &AzToolsFramework::EditorPendingCompositionRequests::RemovePendingComponent, invalidComponent);
        AzToolsFramework::EditorPendingCompositionRequestBus::Event(
            testEntity->GetId(), &AzToolsFramework::EditorPendingCompositionRequests::GetPendingComponents, pendingComponents);
        ...
        testEntity->CreateComponent<AzToolsFramework::Components::GenericComponentWrapper>(aznew LeatherBootsComponent());
        AzToolsFramework::EditorPendingCompositionRequestBus::Event(
            testEntity->GetId(), &AzToolsFramework::EditorPendingCompositionRequests::AddPendingComponent, aznew WoolSocksComponent());
