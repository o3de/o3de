...
#bundle content (WIP)
# process_command([asset_bundler_exe, f'--project-path="{str(o3de_context.project_path)}"'])
...
process_command(['copy', str(args.mono_build_path / 'bin' / 'profile' / '*.*'), str(args.output_path)])
