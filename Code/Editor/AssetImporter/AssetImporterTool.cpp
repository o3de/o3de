...
#include <AssetImporter/AssetImporterWindow.h>
#include <AzCore/Component/ComponentApplication.h>
#include <AssetImporter/ImporterRootDisplay.h>
...
AssetImporterTool* AssetImporterTool::s_instance;

AssetImporterTool::AssetImporterTool(IEditor* editor)
    : m_editor(editor)
...
AssetImporterTool::~AssetImporterTool()
{
...
AZStd::unique_ptr<AZ::DynamicModuleHandle> AssetImporterTool::LoadSceneLibrary(const char* name, bool explicitInit)
{
...
QMainWindow* AssetImporterTool::EditImportSettings(const AZStd::string& sourceFilePath)
{
    if (!m_assetImporterWindow)
    {
        return nullptr;
...
QMainWindow* AssetImporterTool::OpenImportSettings()
{
...
bool AssetImporterTool::SaveBeforeClosing()
{
    if (!m_assetImporterWindow)
    {
        return false;
...
{
    QMainWindow* importSettingsWindow = AssetImporterTool::GetInstance()->EditImportSettings(sourceFilePath);
