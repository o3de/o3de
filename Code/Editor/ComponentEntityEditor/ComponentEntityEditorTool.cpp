...
#include "ComponentEntityEditorTool.h"
...
namespace ComponentEntityEditorToolInternal
{
...
} // end namespace ComponentEntityEditorToolInternal
...
ComponentEntityEditorTool::ComponentEntityEditorTool([[maybe_unused]] IEditor* editor)
    : m_registered(false)
{
    ...
    ComponentEntityEditorToolInternal::RegisterSandboxObjects();

    // Check for common mistakes in component declarations
    ComponentEntityEditorToolInternal::CheckComponentDeclarations();

    m_registered = true;
}

ComponentEntityEditorTool::~ComponentEntityEditorTool()
{
    if (m_registered)
    {
        using namespace AzToolsFramework;
        ...
        ComponentEntityEditorToolInternal::UnregisterSandboxObjects();
    }
