...
{
    {
        ...
        m_menuManagerInterface->RegisterMenu(Editor::ViewportCameraMenuIdentifier, menuProperties);
    }
    {
        AzToolsFramework::MenuProperties menuProperties;
        menuProperties.m_name = "Viewport Debug Info";
        m_menuManagerInterface->RegisterMenu(Editor::ViewportDebugInfoMenuIdentifier, menuProperties);
    }
    {
        AzToolsFramework::MenuProperties menuProperties;
        menuProperties.m_name = "Viewport Helpers";
        m_menuManagerInterface->RegisterMenu(Editor::ViewportHelpersMenuIdentifier, menuProperties);
    }
    {
        AzToolsFramework::MenuProperties menuProperties;
        menuProperties.m_name = "Viewport Size";
        m_menuManagerInterface->RegisterMenu(Editor::ViewportSizeMenuIdentifier, menuProperties);
    }
        {
            AzToolsFramework::MenuProperties menuProperties;
            menuProperties.m_name = "Ratio";
            m_menuManagerInterface->RegisterMenu(Editor::ViewportSizeRatioMenuIdentifier, menuProperties);
        }
        {
            AzToolsFramework::MenuProperties menuProperties;
            menuProperties.m_name = "Resolution";
            m_menuManagerInterface->RegisterMenu(Editor::ViewportSizeResolutionMenuIdentifier, menuProperties);
        }
    {
        AzToolsFramework::MenuProperties menuProperties;
        menuProperties.m_name = "Viewport Options";
        m_menuManagerInterface->RegisterMenu(Editor::ViewportOptionsMenuIdentifier, menuProperties);
    }
}
...
void CLayoutViewPane::OnToolBarRegistrationHook()
{
    ...
    m_toolBarManagerInterface->RegisterToolBar(Editor::ViewportTopToolBarIdentifier, toolBarProperties);

    // Add toolbar to top of viewport.
    QToolBar* toolBar = m_toolBarManagerInterface->GetToolBar(Editor::ViewportTopToolBarIdentifier);
...
void CLayoutViewPane::OnMenuBindingHook()
{
    // Camera
    {
        m_menuManagerInterface->AddWidgetToMenu(Editor::ViewportCameraMenuIdentifier, "o3de.widgetAction.viewport.fieldOfView", 100);
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportCameraMenuIdentifier, "o3de.action.view.goToPosition", 200);
        m_menuManagerInterface->AddSeparatorToMenu(Editor::ViewportCameraMenuIdentifier, 300);
        m_menuManagerInterface->AddWidgetToMenu(
            Editor::ViewportCameraMenuIdentifier, "o3de.widgetAction.viewport.cameraSpeedScale", 400);
    }

    // Debug Info
    {
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportDebugInfoMenuIdentifier, "o3de.action.viewport.info.normal", 100);
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportDebugInfoMenuIdentifier, "o3de.action.viewport.info.full", 200);
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportDebugInfoMenuIdentifier, "o3de.action.viewport.info.compact", 300);
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportDebugInfoMenuIdentifier, "o3de.action.viewport.info.none", 400);
    }

    // Helpers
    {
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportHelpersMenuIdentifier, "o3de.action.view.toggleHelpers", 100);
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportHelpersMenuIdentifier, "o3de.action.view.toggleIcons", 200);
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportHelpersMenuIdentifier, "o3de.action.view.toggleSelectedEntityHelpers", 300);
    }

    // Size
    {
        m_menuManagerInterface->AddSubMenuToMenu(Editor::ViewportSizeMenuIdentifier, Editor::ViewportSizeRatioMenuIdentifier, 100);
        {
            for (size_t i = 0; i < ViewportRatiosCount; ++i)
            {
                int width = ViewportRatios[i].first;
                ...
                m_menuManagerInterface->AddActionToMenu(
                    Editor::ViewportSizeRatioMenuIdentifier, actionIdentifier, SortKeySpacing * (aznumeric_cast<int>(i) + 1));
            }
            
            m_menuManagerInterface->AddSeparatorToMenu(
                Editor::ViewportSizeRatioMenuIdentifier, SortKeySpacing * (aznumeric_cast<int>(ViewportRatiosCount) + 1));
            m_menuManagerInterface->AddActionToMenu(
                Editor::ViewportSizeRatioMenuIdentifier,
                "o3de.action.viewport.size.ratio.custom",
                SortKeySpacing * (aznumeric_cast<int>(ViewportRatiosCount) + 2));
        }
        m_menuManagerInterface->AddSubMenuToMenu(Editor::ViewportSizeMenuIdentifier, Editor::ViewportSizeResolutionMenuIdentifier, 200);
        {
            for (size_t i = 0; i < ViewportResolutionsCount; ++i)
            {
                int width = ViewportResolutions[i].first;
                ...
                m_menuManagerInterface->AddActionToMenu(
                    Editor::ViewportSizeResolutionMenuIdentifier, actionIdentifier, SortKeySpacing * (aznumeric_cast<int>(i) + 1));
            }

            m_menuManagerInterface->AddSeparatorToMenu(
                Editor::ViewportSizeResolutionMenuIdentifier, SortKeySpacing * (aznumeric_cast<int>(ViewportResolutionsCount) + 1));
            m_menuManagerInterface->AddActionToMenu(
                Editor::ViewportSizeResolutionMenuIdentifier,
    ...
    // Options
    {
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportOptionsMenuIdentifier, "o3de.action.edit.snap.toggleGridSnapping", 300);
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportOptionsMenuIdentifier, "o3de.action.edit.snap.toggleShowingGrid", 400);
        m_menuManagerInterface->AddWidgetToMenu(Editor::ViewportOptionsMenuIdentifier, "o3de.widgetAction.viewport.gridSnappingSize", 500);
        m_menuManagerInterface->AddSeparatorToMenu(Editor::ViewportOptionsMenuIdentifier, 600);
        m_menuManagerInterface->AddActionToMenu(Editor::ViewportOptionsMenuIdentifier, "o3de.action.edit.snap.toggleAngleSnapping", 700);
        m_menuManagerInterface->AddWidgetToMenu(Editor::ViewportOptionsMenuIdentifier, "o3de.widgetAction.viewport.angleSnappingSize", 800);
    }
}

void CLayoutViewPane::OnToolBarBindingHook()
{
    m_toolBarManagerInterface->AddWidgetToToolBar(Editor::ViewportTopToolBarIdentifier, "o3de.widgetAction.expander", 300);
    m_toolBarManagerInterface->AddWidgetToToolBar(
        Editor::ViewportTopToolBarIdentifier, "o3de.widgetAction.prefab.editVisualMode", 400);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        Editor::ViewportTopToolBarIdentifier, "o3de.action.view.goToPosition", Editor::ViewportCameraMenuIdentifier, 500);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        Editor::ViewportTopToolBarIdentifier, "o3de.action.viewport.info.toggle", Editor::ViewportDebugInfoMenuIdentifier, 600);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        Editor::ViewportTopToolBarIdentifier, "o3de.action.view.toggleHelpers", Editor::ViewportHelpersMenuIdentifier, 700);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        Editor::ViewportTopToolBarIdentifier, "o3de.action.viewport.resizeIcon", Editor::ViewportSizeMenuIdentifier, 800);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        Editor::ViewportTopToolBarIdentifier, "o3de.action.viewport.menuIcon", Editor::ViewportOptionsMenuIdentifier, 900);
}
