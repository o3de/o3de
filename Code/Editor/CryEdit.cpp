...
void CCryEditApp::RegisterActionHandlers()
{
    ...
    ON_COMMAND(ID_VIEW_SWITCHTOGAME_VIEWPORT, OnViewSwitchToGameViewport)
...
void CCryEditApp::OnViewSwitchToGameViewport()
{
    gSettings.gameModeEnterFullScreen = false;
    OnViewSwitchToGame();
}

void CCryEditApp::OnViewSwitchToGameFullScreen()
{
    gSettings.gameModeEnterFullScreen = true;
    OnViewSwitchToGame();
}
