...
void CViewportTitleDlg::OnToggleDisplayInfo()
{
    ...
    state = static_cast<AZ::AtomBridge::ViewportInfoDisplayState>(static_cast<int>(state)+1);
    if (state == AZ::AtomBridge::ViewportInfoDisplayState::Invalid)
    {
        state = AZ::AtomBridge::ViewportInfoDisplayState::NoInfo;
    }
