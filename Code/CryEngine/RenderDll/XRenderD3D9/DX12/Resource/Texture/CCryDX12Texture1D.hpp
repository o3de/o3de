...
#pragma once
#ifndef __CCRYDX12TEXTURE1D__
#define __CCRYDX12TEXTURE1D__

#include "DX12/Resource/CCryDX12Resource.hpp"

class CCryDX12Texture1D
    : public CCryDX12Resource<ID3D11Texture1D>
{
public:
    DX12_OBJECT(CCryDX12Texture1D, CCryDX12Resource<ID3D11Texture1D>);
    ...
    virtual void STDMETHODCALLTYPE GetDesc(
        _Out_  D3D11_TEXTURE1D_DESC* pDesc) final
    {
        if (pDesc)
        {
            *pDesc = m_Desc11;
