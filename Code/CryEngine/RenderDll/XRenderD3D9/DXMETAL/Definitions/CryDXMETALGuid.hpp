...
DXGL_DEFINE_TYPE_GUID(struct, IDXGIDevice1,             F4E40FAC, 37F4, 43DA, 93, 0F, 13, 14, 51, D4, 3A, D2)
DXGL_DEFINE_TYPE_GUID(struct, IDXGISwapChain,           D8919204, 2ECB, 4685, A2, B4, 23, E0, 68, 0D, EC, 5E)
DXGL_DEFINE_TYPE_GUID(struct, IDXGIFactory1,            00059F2F, 1E3F, 46A7, A4, 95, 67, 75, 8A, 6F, 55, A7)
