...
protected: // -------------------------------------------------------------
    ...
    string  m_systemConfigName; // computed from system_(hardwareplatform)_(assetsPlatform) - eg, system_android_android.cfg or system_android_opengl.cfg or system_windows_pc.cfg
