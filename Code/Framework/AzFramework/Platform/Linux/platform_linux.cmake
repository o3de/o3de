...
if (${PAL_TRAIT_LINUX_WINDOW_MANAGER} STREQUAL "xcb")
    ...
    set(LY_COMPILE_DEFINITIONS PUBLIC AZ_LINUX_WINDOW_MANAGER_XCB)

elseif(PAL_TRAIT_LINUX_WINDOW_MANAGER STREQUAL "wayland")

    set(LY_COMPILE_DEFINITIONS PUBLIC AZ_LINUX_WINDOW_MANAGER_WAYLAND)

elseif(PAL_TRAIT_LINUX_WINDOW_MANAGER STREQUAL "xlib")

    set(LY_COMPILE_DEFINITIONS PUBLIC AZ_LINUX_WINDOW_MANAGER_XLIB)
