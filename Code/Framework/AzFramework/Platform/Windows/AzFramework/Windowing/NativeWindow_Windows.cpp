...
namespace AzFramework
{
    ...
    void NativeWindowImpl_Win32::ResizeClientArea(WindowSize clientAreaSize, bool ignoreScreenSizeLimit)
    {
        RECT rect = {};
        ...
        UINT flag = SWP_NOMOVE | (ignoreScreenSizeLimit ? SWP_NOSENDCHANGING : 0);
