...
AZF_DECLARE_EBUS_SINGLE_ADDRESS(AzFramework::SliceGameEntityOwnershipServiceRequests);
AZF_DECLARE_EBUS_SINGLE_ADDRESS(AzFramework::SliceGameEntityOwnershipServiceNotifications);
