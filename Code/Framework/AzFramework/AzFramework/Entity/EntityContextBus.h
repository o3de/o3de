...
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::EntityContextRequests);
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::EntityContextEvents);
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::EntityIdContextQueries);
