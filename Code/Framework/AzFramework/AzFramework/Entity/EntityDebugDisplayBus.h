...
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::DebugDisplayRequests)
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::EntityDebugDisplayEvents)
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::ViewportDebugDisplayEvents)
AZF_DECLARE_EBUS_SINGLE_ADDRESS(AzFramework::DebugDisplayEvents)
