...
AZF_DECLARE_EBUS_INSTANTIATION_SINGLE_ADDRESS(AzFramework::Terrain::TerrainDataRequests);
AZF_DECLARE_EBUS_INSTANTIATION_SINGLE_ADDRESS(AzFramework::Terrain::TerrainDataNotifications);
