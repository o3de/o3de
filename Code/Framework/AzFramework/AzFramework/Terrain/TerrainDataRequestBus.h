...
AZF_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AzFramework::Terrain::TerrainDataRequests);
AZF_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AzFramework::Terrain::TerrainDataNotifications);
