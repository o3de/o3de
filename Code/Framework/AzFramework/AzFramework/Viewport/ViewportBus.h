...
AZ_DECLARE_EBUS_MULTI_ADDRESS(AZF_API, AzFramework::ViewportRequests);
AZ_DECLARE_EBUS_MULTI_ADDRESS(AZF_API, AzFramework::ViewportBorderRequests);
AZ_DECLARE_EBUS_SINGLE_ADDRESS(AZF_API, AzFramework::ViewportImGuiNotifications);
