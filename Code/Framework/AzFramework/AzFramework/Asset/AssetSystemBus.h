...
AZF_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AzFramework::AssetSystem::AssetSystemInfoNotifications)
AZF_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AzFramework::AssetSystem::AssetSystemRequests)
AZF_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AzFramework::AssetSystem::AssetSystemConnectionNotifications)
AZF_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AzFramework::AssetSystem::AssetSystemStatus)
