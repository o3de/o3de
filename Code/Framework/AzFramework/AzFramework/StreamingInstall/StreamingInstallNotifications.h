...
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::StreamingInstall::StreamingInstallChunkNotifications);
AZF_DECLARE_EBUS_SINGLE_ADDRESS(AzFramework::StreamingInstall::StreamingInstallPackageNotifications);
