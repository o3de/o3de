        ...
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto* editContext = serializeContext->GetEditContext())
            {
                editContext->Class<SceneConfiguration>(
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &SceneConfiguration::m_enablePcm,
                        QT_TRANSLATE_NOOP("PhysX", "Persistent Contact Manifold"), QT_TRANSLATE_NOOP("PhysX", "Enabled the persistent contact manifold narrow-phase algorithm"))
