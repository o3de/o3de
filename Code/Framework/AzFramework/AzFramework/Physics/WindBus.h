...
AZ_DECLARE_EBUS_SINGLE_ADDRESS_WITH_TRAITS(AZF_API, Physics::WindRequests, Physics::WindRequestsTraits)
AZ_DECLARE_EBUS_SINGLE_ADDRESS(AZF_API, Physics::WindNotifications)
