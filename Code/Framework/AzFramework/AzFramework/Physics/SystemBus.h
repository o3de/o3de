...
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZF_API,Physics::DefaultWorldRequests)
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZF_API,Physics::EditorWorldRequests)
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS_WITH_TRAITS(AZF_API,Physics::SystemRequests, Physics::SystemRequestsTraits);
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZF_API,Physics::SystemDebugRequests);
