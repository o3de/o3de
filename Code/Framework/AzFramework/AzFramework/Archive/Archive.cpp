...
namespace AZ::IO
{
    ...
    // TODO - Verify addLevels, or if this function is still needed at all.
    bool Archive::OpenPackCommon(AZStd::string_view szBindRoot, AZStd::string_view szFullPath, AZStd::intrusive_ptr<AZ::IO::MemoryBlock> pData, bool /* addLevels */)
    {
