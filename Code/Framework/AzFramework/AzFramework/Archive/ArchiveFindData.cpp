...
namespace AZ::IO
{
    ...
    void FindData::ScanZips(IArchive* archive, AZStd::string_view szDir)
    {
        ...
        for (auto it = archiveInst->m_arrZips.begin(); it != archiveInst->m_arrZips.end(); ++it)
        {
            ...
            // the problem here is that szDir might be something like "@projectproductassets@/levels/*"
            // but our archive might be mounted at the root, or at some other folder at like "@projectproductassets@" or "@projectproductassets@/levels/mylevel"
            ...
            // Example:
            // "@projectproductassets@\\levels\\*" <--- szDir
            // "@projectproductassets@\\" <--- mount point
            // ~~~~~~~~~~~ Common part
            ...
            // Example:
            // "@projectproductassets@\\levels\\*" <--- szDir
            // "@projectproductassets@\\levels\\mylevel\\" <--- mount point (its level.pak)
            //  ~~~~~~~~~~~~~~~~~~ common part
            // "*" <----  remainder that is not in common
            // "mylevel\\" <--- mount point remainder.

            // example:
            // "@projectproductassets@\\levels\\otherlevel\\*" <--- szDir
            // "@projectproductassets@\\levels\\mylevel\\" <--- mount point (its level.pak)
