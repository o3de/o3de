...
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::WindowRequests)
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::WindowNotifications)
AZF_DECLARE_EBUS_MULTI_ADDRESS(AzFramework::ExclusiveFullScreenRequests)
AZF_DECLARE_EBUS_SINGLE_ADDRESS(AzFramework::WindowSystemRequests)
AZF_DECLARE_EBUS_SINGLE_ADDRESS(AzFramework::WindowSystemNotifications)