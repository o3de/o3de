...
namespace AzToolsFramework
{
    ...
    void ComponentModeActionHandler::OnActionContextModeRegistrationHook()
    {
        ...
        EnumerateComponentModes(
            [&](const AZ::SerializeContext::ClassData* classData, const AZ::Uuid&) -> bool
            {
                ...
                m_actionManagerInterface->RegisterActionContextMode(Editor::MainWindowActionContextIdentifier, modeIdentifier);
    ...
    {
        m_actionManagerInterface->RegisterActionUpdater(Editor::ComponentModeChangedUpdaterIdentifier);
    }
    ...
    void ComponentModeActionHandler::OnMenuBindingHook()
    {
        ...
        m_menuManagerInterface->AddSeparatorToMenu(Editor::EditMenuIdentifier, 3000);
        // Component Mode Actions should be located between these two separators.
        m_menuManagerInterface->AddSeparatorToMenu(Editor::EditMenuIdentifier, 10000);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.componentMode.end", 10001);
    }
    ...
    {
        m_actionManagerInterface->SetActiveActionContextMode(Editor::MainWindowActionContextIdentifier, modeIdentifier);
        m_actionManagerInterface->TriggerActionUpdater(Editor::ComponentModeChangedUpdaterIdentifier);
    }
