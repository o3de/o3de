...
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::Thumbnailer::ThumbnailerRequests);
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::Thumbnailer::ThumbnailerRendererRequests);
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::Thumbnailer::ThumbnailerRendererNotifications);
