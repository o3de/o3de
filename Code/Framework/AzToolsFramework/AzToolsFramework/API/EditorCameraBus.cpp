...
AZ_DECLARE_EBUS_INSTANTIATION_SINGLE_ADDRESS(AZTF_API, Camera::EditorCameraRequests);
AZ_DECLARE_EBUS_INSTANTIATION_SINGLE_ADDRESS(AZTF_API, Camera::EditorCameraSystemRequests);
AZ_DECLARE_EBUS_INSTANTIATION_SINGLE_ADDRESS(AZTF_API, Camera::EditorCameraNotifications);
AZ_DECLARE_EBUS_INSTANTIATION_SINGLE_ADDRESS(AZTF_API, Camera::EditorCameraViewRequests);
