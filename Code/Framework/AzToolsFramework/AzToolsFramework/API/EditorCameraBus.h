...
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZTF_API, Camera::EditorCameraRequests);
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZTF_API, Camera::EditorCameraSystemRequests);
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZTF_API, Camera::EditorCameraNotifications);
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZTF_API, Camera::EditorCameraViewRequests);
