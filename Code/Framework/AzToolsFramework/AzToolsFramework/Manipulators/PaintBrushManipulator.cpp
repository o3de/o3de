...
namespace AzToolsFramework
{
    ...
    void PaintBrushManipulator::BindActionsToMenus()
    {
        ...
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.paintBrushManipulator.increaseSize", baseSortKey);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.paintBrushManipulator.decreaseSize", baseSortKey + 10);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.paintBrushManipulator.increaseHardness", baseSortKey + 20);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.paintBrushManipulator.decreaseHardness", baseSortKey + 30);
    }
