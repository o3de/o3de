...
namespace AzToolsFramework
{
    ...
    void EditorVertexSelectionActionManagement::BindEditorVertexSelectionActionsToMenus()
    {
        ...
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.vertexSelection.duplicate", 6000);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.vertexSelection.delete", 6001);
        menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.vertexSelection.clearSelection", 6002);
    }
