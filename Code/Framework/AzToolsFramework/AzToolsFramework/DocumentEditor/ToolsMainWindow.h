...
namespace AzToolsFramework
{
    ...
    class ToolsMainWindow
        ...
        , protected ToolsMainMenuRequestBus::Handler
    {
    public:
        using Base = AzQtComponents::DockMainWindow;

        ToolsMainWindow(const AZ::Crc32& toolId, const QString& objectName, QWidget* parent = 0);
        ~ToolsMainWindow() override;
    ...
    protected:
        ...
        static constexpr const char* ToolLayoutSettingsKey = "/O3DE/AzToolsFramework/MainWindow/Layouts/Tool";
        static constexpr const char* UserLayoutSettingsKey = "/O3DE/AzToolsFramework/MainWindow/Layouts/User";
        ...
        AzToolsFramework::ToolsAssetBrowser* m_assetBrowser = {};
