...
{
    ToolsAssetBrowserInteractions::ToolsAssetBrowserInteractions()
    {
    ...
    void ToolsAssetBrowserInteractions::RegisterContextMenuActions(
    ...
    void ToolsAssetBrowserInteractions::AddContextMenuActions(
    ...
    void ToolsAssetBrowserInteractions::AddContextMenuActionsForSourceEntries(
        [[maybe_unused]] QWidget* caller, QMenu* menu, const AzToolsFramework::AssetBrowser::AssetBrowserEntry* entry)
    {
        ...
        AddRegisteredScriptToMenu(scriptsMenu, "/O3DE/AzToolsFramework/AssetBrowser/ContextMenuScripts", arguments);
    }

    void ToolsAssetBrowserInteractions::AddContextMenuActionsForFolderEntries(
    ...
    void ToolsAssetBrowserInteractions::AddContextMenuActionsForAllEntries(
        [[maybe_unused]] QWidget* caller, QMenu* menu, const AzToolsFramework::AssetBrowser::AssetBrowserEntry* entry)
    {
    ...
    void ToolsAssetBrowserInteractions::AddContextMenuActionsForSourceControl(
        [[maybe_unused]] QWidget* caller, QMenu* menu, const AzToolsFramework::AssetBrowser::AssetBrowserEntry* entry)
    {
    ...
    void ToolsAssetBrowserInteractions::UpdateContextMenuActionsForSourceControl(bool success, AzToolsFramework::SourceControlFileInfo info)
    {
        if (!success && m_caller)
        {
