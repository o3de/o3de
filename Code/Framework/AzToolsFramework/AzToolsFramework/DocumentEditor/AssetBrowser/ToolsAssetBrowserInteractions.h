...
namespace AzToolsFramework
{
    ...
    class ToolsAssetBrowserInteractions : public AzToolsFramework::AssetBrowser::AssetBrowserInteractionNotificationBus::Handler
    {
    public:
        AZ_CLASS_ALLOCATOR(ToolsAssetBrowserInteractions, AZ::SystemAllocator, 0);

        ToolsAssetBrowserInteractions();
        ~ToolsAssetBrowserInteractions();
