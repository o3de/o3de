...
#include <AzToolsFramework/DocumentEditor/DynamicProperty/DynamicProperty.h>
...
namespace AzToolsFramework
{
    ...
    {
    public:
        AZ_RTTI((AzToolsFramework::AttributeFixedMemberFunction<R(C::*)(Args...) const>, "{78511F1E-58AD-4670-8440-1FE4C9BD1C21}", R, C, Args...), AZ::AttributeFunction<R(Args...)>);
