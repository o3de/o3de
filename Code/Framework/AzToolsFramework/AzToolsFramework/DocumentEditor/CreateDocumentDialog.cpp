...
#include <AzToolsFramework/DocumentEditor/CreateDocumentDialog.h>
...
namespace AzToolsFramework
{
        ...
        , m_initialPath(initialPath)
    {
        ...
        if (filterFn)
        {
            ...
            m_sourceSelectionComboBox = new AzToolsFramework::AssetSelectionComboBox(filterFn, this);
            ...
            QObject::connect(m_sourceSelectionComboBox, &AzToolsFramework::AssetSelectionComboBox::PathSelected, this, [this](const AZStd::string& path) {
...
#include <AzToolsFramework/DocumentEditor/moc_CreateDocumentDialog.cpp>
