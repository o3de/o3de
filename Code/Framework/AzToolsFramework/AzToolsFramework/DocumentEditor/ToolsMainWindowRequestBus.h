...
{
    //! ToolsMainWindowRequestBus provides an interface to common main application window functions like adding docked windows,
    //! resizing the viewport, and other operations 
    class ToolsMainWindowRequests : public AZ::EBusTraits
    {
    public:
    ...
    using ToolsMainWindowRequestBus = AZ::EBus<ToolsMainWindowRequests>;

    class ToolsMainMenuRequests : public AZ::EBusTraits
    {
    public:
        ...
        {
            bool operator()(ToolsMainMenuRequests* left, ToolsMainMenuRequests* right) const
            {
    ...
    using ToolsMainMenuRequestBus = AZ::EBus<ToolsMainMenuRequests>;
} // namespace AzToolsFramework
