...
namespace AzToolsFramework
{
    ...
    //! Each element of an ToolsDocument object info vector will be displayed in a collapsible RPE group in the inspector.
    //! Property changes emitted from each RPE will be tracked and used to signal undo/redo events in the document.
    class ToolsDocumentInspector
        ...
        , public AzToolsFramework::IPropertyEditorNotify
    {
        Q_OBJECT
    public:
        AZ_CLASS_ALLOCATOR(ToolsDocumentInspector, AZ::SystemAllocator, 0);

        ToolsDocumentInspector(const AZ::Crc32& toolId, QWidget* parent = nullptr);
        ~ToolsDocumentInspector() override;
    ...
    private:
        // ToolsDocumentNotificationBus::Handler implementation
        ...
        AZStd::string m_documentSettingsPrefix = "/O3DE/AzToolsFramework/ToolsDocumentInspector";
    };
} // namespace AzToolsFramework
