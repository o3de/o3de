...
#include <AzToolsFramework/DocumentEditor/ToolsDocumentTypeInfo.h>
#include <AzCore/EBus/EBus.h>

namespace AzToolsFramework
{
    //! ToolsDocumentSystemRequestBus is an interface that provides requests for high level user interactions with a system of documents
    class ToolsDocumentSystemRequests : public AZ::EBusTraits
    {
    public:
    ...
    using ToolsDocumentSystemRequestBus = AZ::EBus<ToolsDocumentSystemRequests>;
