...
namespace AzToolsFramework
{
    ...
    //! ToolsDocumentMainWindow is a bridge between the base main window class and the document system. It has actions and menus for
    ...
    //! open document.
    class ToolsDocumentMainWindow
        : public ToolsMainWindow
        , private ToolsDocumentNotificationBus::Handler
    {
        Q_OBJECT
    public:
        AZ_CLASS_ALLOCATOR(ToolsDocumentMainWindow, AZ::SystemAllocator, 0);

        using Base = ToolsMainWindow;

        ToolsDocumentMainWindow(const AZ::Crc32& toolId, const QString& objectName, QWidget* parent = 0);
        ~ToolsDocumentMainWindow();
        ...
        // ToolsMainWindowRequestBus::Handler overrides...
