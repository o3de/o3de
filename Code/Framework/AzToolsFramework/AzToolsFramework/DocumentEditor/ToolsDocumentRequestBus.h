...
#include <AzToolsFramework/DocumentEditor/ToolsDocumentObjectInfo.h>
...
namespace AzToolsFramework
{
    ...
    class ToolsDocumentRequests : public AZ::EBusTraits
    {
    public:
        ...
        virtual ~ToolsDocumentRequests() = default;
    ...
    using ToolsDocumentRequestBus = AZ::EBus<ToolsDocumentRequests>;
} // namespace AzToolsFramework
