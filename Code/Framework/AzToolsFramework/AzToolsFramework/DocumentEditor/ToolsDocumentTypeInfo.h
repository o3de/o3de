...
namespace AzToolsFramework
{
    ...
    struct DocumentTypeInfo final
    {
        ...
        using DocumentFactoryCallback = AZStd::function<ToolsDocumentRequests*(const AZ::Crc32&, const DocumentTypeInfo&)>;
        ...
        ToolsDocumentRequests* CreateDocument(const AZ::Crc32& toolId) const;
