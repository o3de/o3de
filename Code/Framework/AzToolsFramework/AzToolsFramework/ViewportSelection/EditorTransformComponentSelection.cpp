...
namespace AzToolsFramework
{
    ...
    {
        // Edit Menu
        m_menuManagerInterface->AddSeparatorToMenu(Editor::EditMenuIdentifier, 300);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.duplicate", 400);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.delete", 500);
        m_menuManagerInterface->AddSeparatorToMenu(Editor::EditMenuIdentifier, 600);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.selectAll", 700);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.invertSelection", 800);
        m_menuManagerInterface->AddSeparatorToMenu(Editor::EditMenuIdentifier, 900);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.togglePivot", 1000);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.resetEntityTransform", 1100);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.resetManipulator", 1200);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.hideSelection", 1300);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.showAll", 1400);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.lockSelection", 1500);
        m_menuManagerInterface->AddActionToMenu(Editor::EditMenuIdentifier, "o3de.action.edit.unlockAllEntities", 1600);
        m_menuManagerInterface->AddSeparatorToMenu(Editor::EditMenuIdentifier, 1700);

        // Transform Modes
        m_menuManagerInterface->AddActionToMenu(Editor::EditModifyModesMenuIdentifier, "o3de.action.edit.transform.move", 100);
        m_menuManagerInterface->AddActionToMenu(Editor::EditModifyModesMenuIdentifier, "o3de.action.edit.transform.rotate", 200);
        m_menuManagerInterface->AddActionToMenu(Editor::EditModifyModesMenuIdentifier, "o3de.action.edit.transform.scale", 300);
    }
