/*
 * All or portions of this file Copyright (c) o3de.com, Inc. or its affiliates or
 * its licensors.
 *
...
namespace AzToolsFramework
{
    ...
    void EditorTransformComponentSelection::RegisterActions()
    {
        ...
        AddAction(
            ...
            SLockSelection, s_lockSelectionTitle, s_lockSelectionDesc,
            [lockUnlock]()
            {
                lockUnlock(true);
            });
        ...
        AddAction(
            ...
            SUnlockSelection, s_lockSelectionTitle, s_lockSelectionDesc,
            [lockUnlock]()
            {
                lockUnlock(false);
            });
        ...
        AddAction(
            ...
            ShideSelection, s_hideSelectionTitle, s_hideSelectionDesc,
            [showHide]()
            {
                showHide(false);
            });
        ...
        AddAction(
            ...
            SShowSelection, s_hideSelectionTitle, s_hideSelectionDesc,
            [showHide]()
            {
                showHide(true);
            });
        ...
        AddAction(
            ...
            SUnfreezeAll, s_unlockAllTitle, s_unlockAllDesc,
            []()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            SUnhideAll, s_showAllTitle, s_showAllDesc,
            []()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            SSelectAll, s_selectAllTitle, s_selectAllDesc,
            [this]()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            SInvertSelect, s_invertSelectionTitle, s_invertSelectionDesc,
            [this]()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            SDuplicateSelect, s_duplicateTitle, s_duplicateDesc,
            []()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            SDeleteSelect, s_deleteTitle, s_deleteDesc,
            [this]()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            SEditPivot, s_togglePivotTitleEditMenu, s_togglePivotDesc,
            [this]()
            {
        ...
        AddAction(
            ...
            SEditReset, s_resetEntityTransformTitle, s_resetEntityTransformDesc,
            [this]()
            {
                switch (m_mode)
                {
        ...
        AddAction(
            ...
            SEditResetManipulator, s_resetManipulatorTitle, s_resetManipulatorDesc,
        ...
        AddAction(
            ...
            SEditResetLocal, s_resetTransformLocalTitle, s_resetTransformLocalDesc,
            [this]()
            {
                switch (m_mode)
                {
        ...
        AddAction(
            ...
            SEditResetWorld, s_resetTransformWorldTitle, s_resetTransformWorldDesc,
            [this]()
            {
                switch (m_mode)
                {
        ...
        AddAction(
            ...
            SViewportUiVisible, "Toggle Viewport UI", "Hide/Show Viewport UI",
            [this]()
            {
