...
namespace AzToolsFramework
{
    ...
    void EditorTransformComponentSelection::RegisterActions()
    {
        ...
        AddAction(
            ...
            LockSelection, s_lockSelectionTitle, s_lockSelectionDesc,
            [lockUnlock]()
            {
                lockUnlock(true);
            });
        ...
        AddAction(
            ...
            UnlockSelection, s_lockSelectionTitle, s_lockSelectionDesc,
            [lockUnlock]()
            {
                lockUnlock(false);
            });
        ...
        AddAction(
            ...
            ShowSelection, s_hideSelectionTitle, s_hideSelectionDesc,
            [showHide]()
            {
                showHide(true);
            });
        ...
        AddAction(
            ...
            UnhideAll, s_showAllTitle, s_showAllDesc,
            []()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            SelectAll, s_selectAllTitle, s_selectAllDesc,
            [this]()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            InvertSelect, s_invertSelectionTitle, s_invertSelectionDesc,
            [this]()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            DuplicateSelect, s_duplicateTitle, s_duplicateDesc,
            []()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            DeleteSelect, s_deleteTitle, s_deleteDesc,
            [this]()
            {
                AZ_PROFILE_FUNCTION(AZ::Debug::ProfileCategory::AzToolsFramework);
        ...
        AddAction(
            ...
            EditPivot, s_togglePivotTitleEditMenu, s_togglePivotDesc,
            [this]()
            {
        ...
        AddAction(
            ...
            EditReset, s_resetEntityTransformTitle, s_resetEntityTransformDesc,
            [this]()
            {
                switch (m_mode)
                {
        ...
        AddAction(
            ...
            EditResetManipulator, s_resetManipulatorTitle, s_resetManipulatorDesc,
        ...
        AddAction(
            ...
            EditResetLocal, s_resetTransformLocalTitle, s_resetTransformLocalDesc,
            [this]()
            {
                switch (m_mode)
                {
        ...
        AddAction(
            ...
            EditResetWorld, s_resetTransformWorldTitle, s_resetTransformWorldDesc,
            [this]()
            {
                switch (m_mode)
                {
        ...
        AddAction(
            ...
            ViewportUiVisible, "Toggle Viewport UI", "Hide/Show Viewport UI",
            [this]()
            {
