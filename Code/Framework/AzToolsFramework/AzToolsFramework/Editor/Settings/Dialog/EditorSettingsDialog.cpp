...
#include <AzToolsFramework/Editor/Settings/Dialog/ui_EditorSettingsDialog.h>
...
{
    EditorSettingsDialog::EditorSettingsDialog(QWidget* pParent)
        : QDialog(new WindowDecorationWrapper(
              WindowDecorationWrapper::OptionAutoAttach | WindowDecorationWrapper::OptionAutoTitleBarButtons, pParent))
        , ui(new Ui::EditorSettingsDialog)
        , m_currentPageItem(nullptr)
    {
        ...
        connect(ui->pageTree, &QTreeWidget::currentItemChanged, this, &EditorSettingsDialog::OnTreeCurrentItemChanged);

        connect(ui->buttonBox, &QDialogButtonBox::accepted, this, &EditorSettingsDialog::OnAccept);
        connect(ui->buttonBox, &QDialogButtonBox::rejected, this, &EditorSettingsDialog::OnReject);
    ...
    void EditorSettingsDialog::OnAccept()
    {
        /*
    ...
    void EditorSettingsDialog::OnReject()
    {
        /*
    ...
    /*
    void EditorSettingsDialog::SetActivePage(EditorPreferencesTreeWidgetItem* pageItem)
    {
    ...
    */
    void EditorSettingsDialog::SetFilter(const QString& /*filter*/)
    {
        /*
        m_filter = filter;
    ...
    void EditorSettingsDialog::AfterPropertyModified([[maybe_unused]] AzToolsFramework::InstanceDataNode* node)
    {
