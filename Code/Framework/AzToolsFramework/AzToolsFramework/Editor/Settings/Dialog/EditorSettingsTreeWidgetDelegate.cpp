...
// TODO - Move constants as appropriate

static const int IconX = 26;
static const int TextX = 27;

EditorSettingsTreeWidgetItemDelegate::EditorSettingsTreeWidgetItemDelegate(QWidget* parent)
...
void EditorSettingsTreeWidgetItemDelegate::paint(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    painter->save();
...
#include <moc_EditorSettingsTreeWidgetDelegate.cpp>
