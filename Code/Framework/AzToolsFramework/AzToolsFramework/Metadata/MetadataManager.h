...
namespace AzToolsFramework
{
    struct IMetadataRequests
    {
        ...
        //! @param key JSONPath formatted key for the metadata value to read.  Ex: /Settings/Platform/pc.
        //! @return True if metadata file and key exists and was successfully read, false otherwise.
        virtual bool GetJsonValue(AZ::IO::PathView file, AZStd::string_view key, rapidjson_ly::Document& outValue) = 0;
    ...
    public:
        ...
        bool GetJsonValue(AZ::IO::PathView file, AZStd::string_view key, rapidjson_ly::Document& outValue) override;
