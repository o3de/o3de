...
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::AssetEditor::AssetEditorRequests);
AZTF_DECLARE_EBUS_MULTI_ADDRESS(AzToolsFramework::AssetEditor::AssetEditorValidationRequests);
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::AssetEditor::AssetEditorWidgetRequests);
AZTF_DECLARE_EBUS_MULTI_ADDRESS(AzToolsFramework::AssetEditor::AssetEditorNotifications);
