 ...
 namespace AzToolsFramework
 {
     namespace AssetEditor
     {
             ...
             , m_dirty(true)
         {
             ...
             m_propertyEditor->setObjectName("AssetEditorTabPropertyEditor");
         ...
         bool AssetEditorTab::TrySaveAsset(const AZStd::function<void()>& savedCallback)
         {
             ...
             QSpacerItem* horizontalSpacer = new QSpacerItem(txtWidth + SaveConfirmDialogPadding, 0, QSizePolicy::Minimum, QSizePolicy::Expanding);
         ...
         void AssetEditorTab::CreateAsset(AZ::Data::AssetType assetType, const QString& assetName)
         {
             ...
             {
                 AZ_Assert(false, "The AssetEditorTab only supports Generic Asset Types, make sure your type has a handler that implements GenericAssetHandler");
             }
         }
         ...
         bool AssetEditorTab::SaveAsDialog()
         {
             ...
             const QString saveAs = QFileDialog::getSaveFileName(nullptr, tr("Save As..."), m_parentEditorWidget->GetLastSavePath(), filter);
