...
namespace AzToolsFramework::Prefab::PrefabConversionUtils
{
    ...
    void AssetPlatformComponentRemover::GetEntitiesFromInstance(AzToolsFramework::Prefab::Instance& instance, EntityList& hierarchyEntities)
    {
    ...
    void AssetPlatformComponentRemover::SetEditorOnlyEntityHandlerFromCandidates(const EntityList& entities)
    {
    ...
    bool AssetPlatformComponentRemover::HasValidEditorOnlyHandler() const
    {
        return m_editorOnlyEntityHandler != nullptr;
    }

    void AssetPlatformComponentRemover::ClearEditorOnlyEntityIds()
    {
        m_editorOnlyEntityIds.clear();
    }

    void AssetPlatformComponentRemover::AddEntityIdIfEditorOnly(AZ::Entity* entity)
    {
    ...
    */
    AssetPlatformComponentRemover::RemoveEditorOnlyEntitiesResult AssetPlatformComponentRemover::RemoveEditorOnlyEntities(EntityList& entities)
    {
        if (HasValidEditorOnlyHandler())
        {
    ...
    AssetPlatformComponentRemover::ExportEntityResult AssetPlatformComponentRemover::ExportEntity(AZ::Entity* sourceEntity, PrefabProcessorContext& context)
    {
    ...
    bool AssetPlatformComponentRemover::ReadComponentAttribute(
    ...
    AssetPlatformComponentRemover::ShouldExportResult AssetPlatformComponentRemover::ShouldExportComponent(
        AZ::Component* component,
    ...
    AssetPlatformComponentRemover::ResolveExportedComponentResult AssetPlatformComponentRemover::ResolveExportedComponent(
    ...
    AssetPlatformComponentRemover::BuildGameEntityResult AssetPlatformComponentRemover::BuildGameEntity(
    ...
    AssetPlatformComponentRemover::ExportComponentResult AssetPlatformComponentRemover::ExportComponent(
        AZ::Component* component,
        PrefabProcessorContext& prefabProcessorContext,
        AZ::Entity* sourceEntity,
        AZ::Entity* exportEntity)
