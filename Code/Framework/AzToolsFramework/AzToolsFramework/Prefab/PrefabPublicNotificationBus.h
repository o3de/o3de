...
AZTF_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AzToolsFramework::Prefab::PrefabPublicNotifications);
AZTF_DECLARE_EBUS_EXTERN_MULTI_ADDRESS(AzToolsFramework::Prefab::PrefabTemplateNotifications);
