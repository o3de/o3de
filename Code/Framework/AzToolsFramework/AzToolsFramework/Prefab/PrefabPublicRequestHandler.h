...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        public:
            ...
            bool CreatePrefabInMemory(const EntityIdList& entityIds, AZStd::string_view filePath) override;
            AZ::EntityId InstantiatePrefab(AZStd::string_view filePath, AZ::EntityId parent, const AZ::Vector3& position) override;
            bool DeleteEntitiesAndAllDescendantsInInstance(const EntityIdList& entityIds) override;
