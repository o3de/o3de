...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        private:
            ...
            bool AreOverridesPresent(AZ::EntityId entityId, const AZ::Dom::Path& relativePathFromEntity = {}) override;
            ...
            AZStd::optional<OverrideType> GetOverrideType(AZ::EntityId entityId) override;
