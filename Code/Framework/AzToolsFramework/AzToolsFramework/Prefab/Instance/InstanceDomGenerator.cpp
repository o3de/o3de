...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        bool InstanceDomGenerator::GenerateInstanceDom(PrefabDom& instanceDom, const Instance& instance) const
        {
            ...
            const Instance* focusedOrRootInstance =
                PrefabInstanceUtils::ClimbUpToTargetOrRootInstance(relativePath, instance, focusedInstance);
            ...
            PrefabDomPath relativeDomPath(relativePath.c_str());
            PrefabDom focusedOrRootTemplateDom;
            focusedOrRootTemplateDom.CopyFrom(
                m_prefabSystemComponentInterface->FindTemplateDom(focusedOrRootInstance->GetTemplateId()), instanceDom.GetAllocator());
        ...
        void InstanceDomGenerator::UpdateContainerEntityInDomFromRoot(PrefabDom& instanceDom, const Instance& instance) const
        {
            ...
            AZStd::string relativePath = "";
            const Instance* rootInstance = PrefabInstanceUtils::ClimbUpToTargetOrRootInstance(relativePath, instance);
            ...
            if (!PrefabInstanceUtils::CompareInstances(instance, *rootInstance))
            {
                ...
                const AZStd::string pathToContainerEntity =
                    AZStd::string::format("%s/%s", relativePath.c_str(), PrefabDomUtils::ContainerEntityName);
                ...
                const PrefabDom& rootTemplateDom = m_prefabSystemComponentInterface->FindTemplateDom(rootInstance->GetTemplateId());
