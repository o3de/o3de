...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        bool InstanceToTemplatePropagator::PatchTemplate(PrefabDomValue& providedPatch, TemplateId templateId, InstanceOptionalReference instanceToExclude, bool immediate)
        {
            ...
            else
            {
                ...
                m_prefabSystemComponentInterface->PropagateTemplateChanges(templateId, instanceToExclude, immediate);
                return true;
            }
        }
