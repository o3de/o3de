...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        public:
            ...
            //! A valid link id would be present in the generated DOM if the given instance is a proper descendant
            //! of the focused or root instance. In addition, container entity is updated depending on the above
            //! relationship with the focused instance.
        ...
        private:
            ...
            //! @param instanceDom The DOM of the instance that will be modified and returned.
            //! @param instance The given instance object.
