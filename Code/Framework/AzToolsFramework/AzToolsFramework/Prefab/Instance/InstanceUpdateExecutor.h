...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        public:
            ...
            void AddTemplateInstancesToQueue(TemplateId instanceTemplateId, bool immediate = false, InstanceOptionalConstReference instanceToExclude = AZStd::nullopt) override;
