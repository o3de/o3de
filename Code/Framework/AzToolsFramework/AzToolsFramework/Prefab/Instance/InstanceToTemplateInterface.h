...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        public:
            ...
            virtual bool PatchTemplate(PrefabDomValue& providedPatch, TemplateId templateId, bool immediate = false, InstanceOptionalConstReference instanceToExclude = AZStd::nullopt) = 0;
