...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        public:
            ...
            bool PatchTemplate(PrefabDomValue& providedPatch, TemplateId templateId, InstanceOptionalReference instanceToExclude = AZStd::nullopt, bool immediate = false) override;
