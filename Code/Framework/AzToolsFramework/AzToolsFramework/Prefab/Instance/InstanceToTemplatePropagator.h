...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        public:
            ...
            bool PatchTemplate(PrefabDomValue& providedPatch, TemplateId templateId, bool immediate = false, InstanceOptionalConstReference instanceToExclude = AZStd::nullopt) override;
