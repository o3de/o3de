...
namespace UnitTest
{
    ...
    using SwitcherId = AzToolsFramework::ViewportUi::SwitcherId;
    using ClusterId = AzToolsFramework::ViewportUi::ClusterId;
    using TextFieldId = AzToolsFramework::ViewportUi::TextFieldId;
    ...
    {
    public:
        MOCK_METHOD1(CreateCluster, const ClusterId(AzToolsFramework::ViewportUi::Alignment align));
        MOCK_METHOD1(CreateSwitcher, const SwitcherId(AzToolsFramework::ViewportUi::Alignment align));
        ...
        MOCK_METHOD3(SetClusterButtonTooltip, void(ClusterId clusterId, ButtonId buttonId, const AZStd::string& tooltip));
        MOCK_METHOD3(SetSwitcherButtonTooltip, void(SwitcherId switcherId, ButtonId buttonId, const AZStd::string& tooltip));
        MOCK_METHOD2(CreateClusterButton, const ButtonId(ClusterId clusterId, const AZStd::string& icon));
        MOCK_METHOD3(CreateSwitcherButton, const ButtonId(SwitcherId switcherId, const AZStd::string& icon, const AZStd::string& name));
        ...
        MOCK_METHOD3(
            ...
            const TextFieldId(
                ...
                const AZStd::string& textFieldDefaultText,
                AzToolsFramework::ViewportUi::TextFieldValidationType validationType));
    ...
    public:
        void SetUp() override final
        {
            ...
            m_viewportUiRequestBusMock = AZStd::make_unique<testing::NiceMock<MockVieportUiRequestBusHandler>>();

            m_viewportUiRequestBusMock.get()->BusConnect(AzToolsFramework::ViewportUi::DefaultViewportId);
        ...
        void TearDown() override final
        {
            ...
            m_viewportUiRequestBusMock.get()->BusDisconnect();
        ...
        AZStd::unique_ptr<testing::NiceMock<MockVieportUiRequestBusHandler>> m_viewportUiRequestBusMock;
