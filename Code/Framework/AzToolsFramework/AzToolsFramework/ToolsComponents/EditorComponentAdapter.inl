...
namespace AzToolsFramework
{
    namespace Components
    {
        ...
        EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::EditorComponentAdapter(
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::Reflect(
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::
            GetProvidedServices(AZ::ComponentDescriptor::DependencyArrayType& services)
        {
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::
            GetRequiredServices(AZ::ComponentDescriptor::DependencyArrayType& services)
        {
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::
            GetDependentServices(AZ::ComponentDescriptor::DependencyArrayType& services)
        {
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::BuildGameEntity(
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::Init()
        {
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::Activate()
        {
        ...
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::ActivateImpl()
        {
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        void EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::Deactivate()
        {
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        bool EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::ReadInConfig(
            const AZ::ComponentConfig* baseConfig)
        {
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        bool EditorComponentAdapter<TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::WriteOutConfig(
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        AZ::u32 EditorComponentAdapter<
            TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::OnConfigurationChanged()
        {
            m_controller.Deactivate();
        ...
        template<typename TController, typename TRuntimeComponent, typename TConfiguration, bool SupportsMultipleComponentPerEntity>
        bool EditorComponentAdapter<
            TController, TRuntimeComponent, TConfiguration, SupportsMultipleComponentPerEntity>::ShouldActivateController() const
        {
            return true;
        }
    } // namespace Components
