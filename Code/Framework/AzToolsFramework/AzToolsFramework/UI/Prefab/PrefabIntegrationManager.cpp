...
namespace AzToolsFramework
{
    namespace Prefab
    {
        ...
        void PrefabIntegrationManager::OnActionUpdaterRegistrationHook()
        {
            ...
            m_actionManagerInterface->RegisterActionUpdater(Editor::LevelLoadedUpdaterIdentifier);
        ...
        void PrefabIntegrationManager::OnToolBarBindingHook()
        {
            ...
            m_toolBarManagerInterface->AddActionToToolBar(Editor::ViewportTopToolBarIdentifier, "o3de.action.prefabs.upOneLevel", 100);
            m_toolBarManagerInterface->AddWidgetToToolBar(Editor::ViewportTopToolBarIdentifier, "o3de.widgetAction.prefab.focusPath", 200);
        }
        ...
        void PrefabIntegrationManager::OnRootPrefabInstanceLoaded()
        {
            if (m_actionManagerInterface)
            {
                m_actionManagerInterface->TriggerActionUpdater(Editor::LevelLoadedUpdaterIdentifier);
            }
        }
