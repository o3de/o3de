...
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZTF_API, LegacyFramework::CoreMessages);
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZTF_API, LegacyFramework::FrameworkApplicationMessages);
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZTF_API, LegacyFramework::LogComponentAPI);
AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZTF_API, LegacyFramework::IPCCommandAPI);
