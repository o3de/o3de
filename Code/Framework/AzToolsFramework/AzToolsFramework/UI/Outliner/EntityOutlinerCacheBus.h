...
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::EntityOutlinerCacheRequests);
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::EntityOutlinerCacheNotifications);
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::EntityOutlinerModelNotifications);
