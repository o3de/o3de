...
namespace AzToolsFramework::ViewportUi::Internal
{
    ...
    public:
        ...
        void AddCluster(AZStd::shared_ptr<ButtonGroup> buttonGroup, const Alignment align);
        ...
        void AddSwitcher(AZStd::shared_ptr<ButtonGroup> buttonGroup, const Alignment align);
