...
namespace AzToolsFramework
{
    namespace AssetBrowser
    {
        ...
        class AssetBrowserExpandedTableModel
        ...
        public:
            AZ_CLASS_ALLOCATOR(AssetBrowserExpandedTableModel, AZ::SystemAllocator, 0);
            explicit AssetBrowserExpandedTableModel(QObject* parent = nullptr);
