...
#include <AzToolsFramework/AssetBrowser/AssetBrowserExpandedTableModel.h>
...
namespace AzToolsFramework
{
    namespace AssetBrowser
    {
        ...
        class AssetBrowserExpandedTableView //! Table view that displays the asset browser entries in a list.
        ...
        private:
            QString m_name;
            QPointer<AssetBrowserExpandedTableModel> m_tableModel;
