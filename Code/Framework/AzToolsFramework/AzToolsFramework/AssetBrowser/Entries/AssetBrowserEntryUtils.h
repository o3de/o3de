...
namespace AzToolsFramework
{
    namespace AssetBrowser
    {
        ...
        namespace Utils
        {
            ...
            //! than one callstack.
            AZTF_API AZStd::string ToString(const AZStd::vector<const AssetBrowserEntry*>& entries);
            ...
            AZTF_API bool FromString(AZStd::string_view inputString, AZStd::vector<const AssetBrowserEntry*>& entries);
            ...
            AZTF_API void ToMimeData(QMimeData* mimeData, const AZStd::vector<const AssetBrowserEntry*>& entries);
            ...
            AZTF_API bool FromMimeData(const QMimeData* mimeData, AZStd::vector<const AssetBrowserEntry*>& entries);
            ...
            AZTF_API AZStd::string WriteEntryToString(const AssetBrowserEntry* entry);
            ...
            AZTF_API const AssetBrowserEntry* FindFromString(AZStd::string_view data);

            //! This function returns the folder in which given asset is located or the entry itself if it's already a folder
            AZTF_API const AssetBrowserEntry* FolderForEntry(const AssetBrowserEntry* entry);
        } 
    }
}
