...
namespace AzToolsFramework
{
    namespace AssetBrowser
    {
        ...
        void AssetBrowserExpandedTableViewProxyModel::SetSourceModelCurrentSelection(const QModelIndex& sourceIndex)
        {
        ...
        QModelIndex AssetBrowserExpandedTableViewProxyModel::index(int row, int column, const QModelIndex& parent) const
        {
            if (!sourceModel())
            {
                return {};
        ...
        QModelIndex AssetBrowserExpandedTableViewProxyModel::parent(const QModelIndex& child) const
        {
        ...
        QModelIndex AssetBrowserExpandedTableViewProxyModel::mapToSource(const QModelIndex& proxyIndex) const
        {
            if (!sourceModel())
            {
                return {};
        ...
        QModelIndex AssetBrowserExpandedTableViewProxyModel::mapFromSource(const QModelIndex& sourceIndex) const
        {
            if (!sourceModel())
            {
                return {};
        ...
        int AssetBrowserExpandedTableViewProxyModel::rowCount(const QModelIndex& parent) const
        {
            Q_UNUSED(parent);
        ...
        int AssetBrowserExpandedTableViewProxyModel::columnCount(const QModelIndex& parent) const
        {
            Q_UNUSED(parent);
        ...
        void AssetBrowserExpandedTableViewProxyModel::RecomputeValidEntries()
        {
