...
AZTF_DECLARE_EBUS_MULTI_ADDRESS_WITH_TRAITS(AzToolsFramework::ViewportInteraction::MouseViewportRequests, AzToolsFramework::ViewportInteraction::ViewportRequestsEBusTraits);
AZTF_DECLARE_EBUS_MULTI_ADDRESS_WITH_TRAITS(AzToolsFramework::ViewportInteraction::ViewportInteractionRequests, AzToolsFramework::ViewportInteraction::ViewportRequestsEBusTraits);
AZTF_DECLARE_EBUS_MULTI_ADDRESS_WITH_TRAITS(AzToolsFramework::ViewportInteraction::ViewportInteractionNotifications, AzToolsFramework::ViewportInteraction::ViewportNotificationsEBusTraits);
AZTF_DECLARE_EBUS_MULTI_ADDRESS_WITH_TRAITS(AzToolsFramework::ViewportInteraction::ViewportSettingNotifications, AzToolsFramework::ViewportInteraction::ViewportNotificationsEBusTraits);
AZTF_DECLARE_EBUS_MULTI_ADDRESS_WITH_TRAITS(AzToolsFramework::ViewportInteraction::MainEditorViewportInteractionRequests, AzToolsFramework::ViewportInteraction::ViewportNotificationsEBusTraits);
AZTF_DECLARE_EBUS_MULTI_ADDRESS_WITH_TRAITS(AzToolsFramework::ViewportInteraction::EditorEntityViewportInteractionRequests, AzToolsFramework::ViewportInteraction::ViewportNotificationsEBusTraits);
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::ViewportInteraction::EditorModifierKeyRequests);
AZTF_DECLARE_EBUS_SINGLE_ADDRESS(AzToolsFramework::ViewportInteraction::EditorViewportInputTimeNowRequests);
AZTF_DECLARE_EBUS_MULTI_ADDRESS_WITH_TRAITS(AzToolsFramework::ViewportInteraction::ViewportMouseCursorRequests, AzToolsFramework::ViewportInteraction::ViewportNotificationsEBusTraits);
