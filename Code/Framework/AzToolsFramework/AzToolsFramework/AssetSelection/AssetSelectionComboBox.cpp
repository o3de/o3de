...
#include "AssetSelectionComboBox.h"
...
namespace Utils
    ...
    void AssetSelectionComboBox::AddPath(const AZStd::string& path)
    {
        ...
        const auto& pathWithAlias = AzToolsFramework::GetPathWithAlias(path);
    ...
    {
            addItem(AzToolsFramework::GetDisplayNameFromPath(pathWithAlias).c_str(), pathItemData);
            QueueSort();
    ...
    {
        AddPath(AzToolsFramework::Utils::GetSourcePathByAssetId(assetId));
    }
    ...
    {
        RemovePath(AzToolsFramework::Utils::GetSourcePathByAssetId(assetId));
    }
    ...
    void AssetSelectionComboBox::RegisterThumbnail(const AZStd::string& path)
    {
        ...
        {
            const auto& pathWithAlias = AzToolsFramework::GetPathWithAlias(path);
            const auto& pathWithoutAlias = AzToolsFramework::GetPathWithoutAlias(path);
...
#include <AzToolsFramework/AssetSelection/moc_AssetSelectionComboBox.cpp>
