...
#include <AzToolsFramework/AssetSelection/AssetSelectionGrid.h>
...
namespace AzToolsFramework
{
    ...
    void AssetSelectionGrid::Populate()
    {
        ...
        for (const auto& path : AzToolsFramework::GetPathsInSourceFoldersMatchingFilter(m_filterFn))
        {
            AddPath(path);
        }
    ...
    void AssetSelectionGrid::AddPath(const AZStd::string& path)
    {
        ...
        const int itemBorder =
            aznumeric_cast<int>(AzToolsFramework::GetSettingsValue<AZ::u64>("/O3DE/ToolsFramework/AssetSelectionGrid/ItemBorder", 4));
        const int itemSpacing = aznumeric_cast<int>(
            AzToolsFramework::GetSettingsValue<AZ::u64>("/O3DE/ToolsFramework/AssetSelectionGrid/ItemSpacing", 10));
        const int headerHeight = aznumeric_cast<int>(
            AzToolsFramework::GetSettingsValue<AZ::u64>("/O3DE/ToolsFramework/AssetSelectionGrid/HeaderHeight", 15));
    ...
    {
        AddPath(AzToolsFramework::GetSourcePathByAssetId(assetId));
    }
    ...
    {
        RemovePath(AzToolsFramework::GetSourcePathByAssetId(assetId));
    }
...
#include <AzToolsFramework/AssetSelection/moc_AssetSelectionGrid.cpp>
