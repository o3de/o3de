...
namespace AZ
{
    AZ_TYPE_INFO_TEMPLATE(AzNetworking::QuantizedValues, "{9C60D8BA-9B88-41BE-B4FE-51F617565A82}", AZ_TYPE_INFO_AUTO, AZ_TYPE_INFO_AUTO, AZ_TYPE_INFO_AUTO_SIGNED, AZ_TYPE_INFO_AUTO_SIGNED);
}
