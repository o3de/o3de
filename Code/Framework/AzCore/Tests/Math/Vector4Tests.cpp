...
namespace UnitTest
{
    ...
    {
        Vector4 v1(0.0f);
        EXPECT_TRUE((v1.GetX() == 0.0f) && (v1.GetY() == 0.0f) && (v1.GetZ() == 0.0f) && (v1.GetW() == 0.0f));
        Vector4 v2(5.0f);
        EXPECT_TRUE((v2.GetX() == 5.0f) && (v2.GetY() == 5.0f) && (v2.GetZ() == 5.0f) && (v2.GetW() == 5.0f));
        Vector4 v3(1.0f, 2.0f, 3.0f, 4.0f);
        EXPECT_TRUE((v3.GetX() == 1.0f) && (v3.GetY() == 2.0f) && (v3.GetZ() == 3.0f) && (v3.GetW() == 4.0f));
