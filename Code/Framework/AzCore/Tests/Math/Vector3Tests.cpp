...
namespace UnitTest
{
    ...
    {
        EXPECT_THAT(AZ::Vector3(3.0f, 0.0f, 4.0f).GetNormalized(), IsCloseTolerance(AZ::Vector3(3.0f / 5.0f, 0.0f, 4.0f / 5.0f), Constants::Tolerance));
        EXPECT_THAT(AZ::Vector3(3.0f, 0.0f, 4.0f).GetNormalizedEstimate(), IsCloseTolerance(AZ::Vector3(3.0f / 5.0f, 0.0f, 4.0f / 5.0f), Constants::Tolerance));
    }

    TEST(MATH_Vector3, TestGetNormalizedSafe)
    {
        EXPECT_THAT(AZ::Vector3(3.0f, 0.0f, 4.0f).GetNormalizedSafe(), IsCloseTolerance(AZ::Vector3(3.0f / 5.0f, 0.0f, 4.0f / 5.0f), Constants::Tolerance));
        EXPECT_THAT(AZ::Vector3(3.0f, 0.0f, 4.0f).GetNormalizedSafeEstimate(), IsCloseTolerance(AZ::Vector3(3.0f / 5.0f, 0.0f, 4.0f / 5.0f), Constants::Tolerance));
    ...
    TEST(MATH_Vector3, TestNormalize)
    {
        ...
        v1.Normalize();
        EXPECT_THAT(v1, IsCloseTolerance(AZ::Vector3(4.0f / 5.0f, 3.0f / 5.0f, 0.0f), Constants::Tolerance));
    ...
    TEST(MATH_Vector3, TestNormalizeSafe)
    {
        ...
        v1.NormalizeSafe();
        EXPECT_THAT(v1, IsCloseTolerance(AZ::Vector3(0.0f, 3.0f / 5.0f, 4.0f / 5.0f), Constants::Tolerance));
        v1.Set(0.0f);
        v1.NormalizeSafe();
    ...
    TEST(MATH_Vector3, TestSetLength)
    {
        ...
        EXPECT_THAT(v1, IsCloseTolerance(AZ::Vector3(6.0f, 8.0f, 0.0f), Constants::ToleranceEstimateFuncs));
    }
