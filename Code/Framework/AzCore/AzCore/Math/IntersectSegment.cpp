...
// All algorithms/code snippets are kindly made available under the MIT License
// https://www.iquilezles.org/www/index.htm - 'all code snippets you'll find are under the MIT license so you can easily reuse them.'
int AZ::Intersect::IntersectRayCone2(
    ...
    float coneBaseRadius, float& t)
{
    ...
    const AZ::Vector3& pb = coneApex + coneHeight * coneDir;
    const AZ::Vector3& ro = rayOrigin;
    const AZ::Vector3& rd = rayDir;
