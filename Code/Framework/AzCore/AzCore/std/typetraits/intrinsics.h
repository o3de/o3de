...
#   define AZSTD_IS_BASE_OF(T, U) (__is_base_of(T, U) && !is_same_v<T, U>)
...
//  #   define AZSTD_HAS_TRIVIAL_COPY(T) (__has_trivial_copy(T) && !is_reference_v<T>)
#   define AZSTD_HAS_TRIVIAL_ASSIGN(T) __has_trivial_assign(T)
#   define AZSTD_HAS_TRIVIAL_DESTRUCTOR(T) __has_trivial_destructor(T)
#   define AZSTD_HAS_NOTHROW_CONSTRUCTOR(T) __has_nothrow_constructor(T)
#   define AZSTD_HAS_NOTHROW_COPY(T) (__has_nothrow_copy(T) && !is_volatile_v<T> && !is_reference_v<T>)
#   define AZSTD_HAS_NOTHROW_ASSIGN(T) (__has_nothrow_assign(T) && !is_volatile_v<T>)
#   define AZSTD_HAS_VIRTUAL_DESTRUCTOR(T) __has_virtual_destructor(T)
