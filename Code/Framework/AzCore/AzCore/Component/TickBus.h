...
//AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZ::TickEvents);
//AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZ::SystemTickEvents);
//AZ_DECLARE_EBUS_EXTERN_SINGLE_ADDRESS(AZ::TickRequests);
