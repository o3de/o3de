...
#define AZ_TYPE_INFO_INTERNAL_SPECIALIZE(_ClassName, _ClassUuid)      \
    ...
    {
    private:
        using BufferType = AZStd::array<char, 64>;
        static constexpr BufferType TypeName = []() constexpr -> BufferType
        {
            BufferType typeName{};
    ...
    {
    private:
        using BufferType = AZStd::array<char, 128>;
        static constexpr BufferType TypeName = []() constexpr -> BufferType
        {
            BufferType typeName{};
            AZ::Internal::AzTypeInfoSafeCat(typeName.data(), typeName.size(), "{");
