...
namespace AZ
{
    namespace IO
    {
        ...
        public:
            ...
            ///       so expect return values like @projectproductassets@/textures/mytexture.dds instead of a full path.  This is so that fileIO works over remote connections.
            ...
            /// SetAlias - Adds an alias to the path resolution system, e.g. @user@, @projectproductassets@, etc.
            ...
            //! NOTE: If the path does not start with an alias then the resolved value of the @projectproductassets@ is used
            //!       which has the effect of making the path relative to the @projectproductassets@/ folder
