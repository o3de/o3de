...
namespace AZ::SystemUtilsApple
{
    ...
    AZCORE_API AppSupportOutcome GetPathToApplicationBundle(AZStd::span<char> buffer);
    ...
    //! On failure an AppSupportErrorResult is returned
    AZCORE_API AppSupportOutcome GetPathToApplicationExecutable(AZStd::span<char> buffer);
    ...
    //! On failure an AppSupportErrorResult is returned
    AZCORE_API AppSupportOutcome GetPathToApplicationFrameworks(AZStd::span<char> buffer);

    //! Get the path to the application's resources.
    //! @param buffer pre-sized buffer to used to fill result of query operation
    //! @return outcome with a string_view of the application resource path on success
    //! On failure an AppSupportErrorResult is returned
    AZCORE_API AppSupportOutcome GetPathToApplicationResources(AZStd::span<char> buffer);
    ...
    //! On failure an AppSupportErrorResult is returned
    AZCORE_API AppSupportOutcome GetPathToUserApplicationSupportDirectory(AZStd::span<char> buffer);
    ...
    //! On failure an AppSupportErrorResult is returned
    AZCORE_API AppSupportOutcome GetPathToUserCachesDirectory(AZStd::span<char> buffer);
    ...
    //! On failure an AppSupportErrorResult is returned
    AZCORE_API AppSupportOutcome GetPathToUserDocumentDirectory(AZStd::span<char> buffer);
    ...
    //! On failure an AppSupportErrorResult is returned
    AZCORE_API AppSupportOutcome GetPathToUserLibraryDirectory(AZStd::span<char> buffer);

    //! Get the user's name.
    //! @param buffer pre-sized buffer to used to fill result of query operation
    //! @return outcome with a string_view of the application bundle path on success
    //! On failure an AppSupportErrorResult is returned
    AZCORE_API AppSupportOutcome GetUserName(AZStd::span<char> buffer);
}
