...
#include <Woodpecker/LUA/TargetContextButton.hxx>
...
namespace LUAEditor
{
        ...
        , m_settingsDialog(nullptr)
    {
        ...
        EBUS_EVENT(LegacyFramework::CustomMenusMessages::Bus, RegisterMenu, LegacyFramework::CustomMenusCommon::LUAEditor::Woodpecker, theMenu);
...
#include <Woodpecker/LUA/moc_LUAEditorMainWindow.cpp>
