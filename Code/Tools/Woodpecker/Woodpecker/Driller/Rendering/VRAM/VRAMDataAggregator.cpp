...
#include <Woodpecker/Driller/Rendering/VRAM/moc_VRAMDataAggregator.cpp>
    ...
    namespace VRAM
    {
        ...
        public:
            ...
            const AZStd::string& FindColumnDescriptor(ExportField exportField) const
            {
                ...
                {
                    AZ_Warning("Woodpecker", false, "Unknown column descriptor in VRAM CSV Export");
        ...
        void VRAMDataAggregator::ExportEventToCSV(AZ::IO::SystemFile& file, const DrillerEvent* drillerEvent, CSVExportSettings* exportSettings)
        {
            ...
            for (ExportField currentField : exportOrdering)
            {
                ...
                default:
                    AZ_Warning("Woodpecker", false, "Unknown Export Field for VRAMDataAggreagtor");
                    break;
                }
