...
#include <Woodpecker/Driller/Replica/moc_ReplicaDataView.cpp>
...
#include "Woodpecker/Driller/Replica/OverallReplicaDetailView.hxx"
...
namespace Driller
{
    ...
    {
        AZ_Error("Woodpecker", selectedIndex > DDT_START && selectedIndex < DDT_END, "selectedIndex for DataType is out of enum range.");
    ...
    {
        AZ_Error("Woodpecker", selectedIndex > ReplicaDisplayTypes::BUDT_START && selectedIndex < ReplicaDisplayTypes::BUDT_END, "Invalid index for BandwidthUsageDisplay");
    ...
    {
        AZ_Error("Woodpecker", selectedIndex > TFT_START && selectedIndex < TFT_END, "Invalid index for TableFilterType");
