...
#include <Woodpecker/Driller/Replica/ui_replicadataview.h>
#include <Woodpecker/Driller/Replica/ui_ReplicaDataViewConfigDialog.h>
        ...
        {            
            ...
            for (FrameNumberType frameId = GetStartFrame(); frameId <= GetEndFrame(); ++frameId)
            {
                ...
                case ReplicaDisplayTypes::BUDT_RECEIVED:
                    ...
                    break;
                default:
                    AZ_Error("Woodpecker", false, "Unknown bandwidth display type.");
                    break;
                }
            }
        }
