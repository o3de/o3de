...
#include <Woodpecker/Driller/Replica/moc_ReplicaDataAggregator.cpp>
            ...
            switch (currentField)
            {
                ...
                case ReplicaExportField::UsageType:
                {
                     switch (replicaChunkEvent->GetEventType())
                     {
                        ...
                        default:
                            AZ_Warning("Woodpecker",false,"Unknown Event Type for Replica Event");
                            break;
                     }
                     break;
                }
                ...
                default:
                    AZ_Warning("Woodpecker",false,"Unknown Export Field for ReplicaDataAggreagtor");
                    break;
            }
