...
#include <Woodpecker/Driller/moc_AreaChart.cpp>
...
namespace AreaChart
{
    ...
    void AreaChart::paintEvent(QPaintEvent* event)
    {
        ...
        if (m_regenGraph)
        {
            AZ_PROFILE_TIMER("Woodpecker", "Generating Graph Data");
            m_regenGraph = false;
        ...
        
        {
            ...
            for (GraphMarker& marker : m_markers)
            {
                ...
                default:
                    AZ_Error("Woodpecker", false, "Unknown axis type given to marker.");
                };
            }
        }
    }
