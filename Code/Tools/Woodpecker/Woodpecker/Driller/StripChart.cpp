...
#include <Woodpecker/Driller/moc_StripChart.cpp>
...
namespace StripChart
{
    ...
    {
        AZ_Error("Woodpecker", !m_InBatchMode, "AddData should not called during a BatchData session.");
    ...
    {
        AZ_Error("Woodpecker", m_InBatchMode, "AddBatchedData should only be called during a BatchData session.");
