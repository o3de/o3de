...
namespace O3DE::ProjectManager::ProjectUtils
{
     ...
     */
    int DisplayDetailedError(const QString& title, const AZ::Outcome<void, AZStd::pair<AZStd::string, AZStd::string>>& outcome, QWidget* parent = nullptr);
     ...
     * @return the QMessageBox result
     */
    int DisplayDetailedError(const QString& title, const AZStd::string& generalError, const AZStd::string& detailedError, QWidget* parent = nullptr, QMessageBox::StandardButtons buttons = QMessageBox::Ok);
