...
static const uint32_t SHADER_INPUT_FLAG_COMPARISON_SAMPLER = (1 << 1);

static uint32_t DecodeShaderInputFlags(uint32_t ui32Token)
{
    return (uint32_t)(ui32Token & 0x00000002);
}
