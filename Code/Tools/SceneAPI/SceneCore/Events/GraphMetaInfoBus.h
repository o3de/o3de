    ...
    namespace SceneAPI
    {
        ...
        namespace Events
        {
            ...
            public:
                ...
                SCENE_CORE_API virtual void GetAppliedPolicyNames([[maybe_unused]] const Containers::Scene& scene, [[maybe_unused]] AZStd::set<AZStd::string>& appliedPolicySet) const {}
            };
