        ...
        namespace Events
        {
                ...
                : public AssetImportRequestReporter
            {
                ...
                void ReportFinish(const AssetImportRequest* instance) override
                {
                    ...
                    {
                        AZ_TraceContext("Old manifest rule count", aznumeric_cast<int>(m_previousManifest.GetEntryCount()));
                        AZ_TraceContext("New manifest rule count", aznumeric_cast<int>(m_scene->GetManifest().GetEntryCount()));
