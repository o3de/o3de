...
namespace AssetProcessor
{
    ...
    public:
        ...
        bool SetJobFingerprintsBySourceID(AZ::s64 sourceID, AZ::u64 hash);
        ...
        */
        ...
        bool UpdateFileHashByFileNameAndScanFolderId(QString fileName, AZ::s64 scanFolderId, AZ::u64 hash);
