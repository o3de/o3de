...
namespace TestImpact
{
    ...
    AZStd::tuple<TargetList<PythonProductionTarget>, TargetList<PythonTestTarget>>
    CompileTargetLists(
        AZStd::vector<TargetDescriptor>&& buildTargetDescriptors, PythonTestTargetMetaMap&& nativeTestTargetMetaMap);
} // namespace TestImpact
