...
//
            const AZStd::vector<AZStd::string> cmds =
            {
                ...
                /*
                example of running tests NOW (this one you can specify thespecific test case):
                python.cmd -m pytest
                E:\o3de_TIF_Feature\AutomatedTesting/Gem/PythonTests/editor/TestSuite_Main.py::TestAutomationNoAutoTestMode::test_BasicEditorWorkflows_LevelEntityComponentCRUD
                --build-directory E:\o3de_TIF_Feature\build\windows_vs2019\bin\profile
