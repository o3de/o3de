...
namespace TestImpact
{
    namespace Console
    {
        ...
        namespace Output
        {
            void TestSuiteSet(const SuiteSet& suiteSet)
            {
        ...
        void TestSequenceCompleteCallback(const SuiteSet& suiteSet, const Client::TestRunSelection& selectedTests)
        {
            Output::TestSuiteSet(suiteSet);
