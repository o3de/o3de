    ...
    namespace Console
    {
        ...
        public:
            static void TestSequenceStartCallback(TestSequenceEventHandler& sequence, Client::TestRunSelection&& selectedTests)
            {
                ...
                {
                    size_t suiteId = 0;
                    for (const auto& suite : *sequence.m_suiteFilter)
                    {
                        std::cout << suite.c_str();
                        if (suiteId + 1 < sequence.m_suiteFilter->size())
                        {
                            std::cout << ", ";
                        }
                        suiteId++;
        ...
        void RegularTestSequenceEventHandler::operator()(Client::TestRunSelection&& selectedTests)
        {
        ...
        void ImpactAnalysisTestSequenceEventHandler::operator()(
        ...
        // Handler for SafeImpactAnalysisTestSequenceStartCallback
        void SafeImpactAnalysisTestSequenceEventHandler::operator()(
            Client::TestRunSelection&& selectedTests,
        ...
        // TestSequenceStartCallback
        void SeededTestSequenceEventHandler::operator()(Client::TestRunSelection&& selectedTests)
        {

        }

        // TestSequenceCompleteCallback
        void SeededTestSequenceEventHandler::operator()(
            Client::SequenceFailure&& failureReport,
            AZStd::chrono::milliseconds duration)
        {
        ...
        //    m_numTests = 0;
        //    m_numTestsComplete = 0;
        //    m_isUpdatingTestImpactData = false;
        //}
    } // namespace Console
} // namespace TestImpact
