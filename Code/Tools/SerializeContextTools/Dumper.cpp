...
namespace AZ::SerializeContextTools
{
    ...
    bool Dumper::CreateType(Application& application)
    {
        ...
        else
        {
            ...
            if (classIds.size() != 1)
            {
                ...
                else
                {
                    ...
                    AZ_Error(
                        ...
                        "Multiple Type with name %s have been registered with the SerializeContext,\n"
            ...
            // Only one class with typename has been registered with the serialize context, so look up it's ClassData
