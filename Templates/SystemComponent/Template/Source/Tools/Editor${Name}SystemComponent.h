...
namespace ${GemName}
{
    ...
    *       Editor${SanitizedCppName}SystemComponent::CreateDescriptor(),
    *
    ...
    */
    ...
    class Editor${SanitizedCppName}SystemComponent
        : public AzToolsFramework::Components::EditorComponentBase
    {
    public:
        AZ_EDITOR_COMPONENT(Editor${SanitizedCppName}SystemComponent, "{${Random_Uuid}}", AzToolsFramework::Components::EditorComponentBase);
