...
namespace ${GemName}
{
     ...
     *
     * IMPORTANT: Because this editor component exists, the runtime ${SanitizedCppName}Component
     ...
     * Use gameEntity->CreateComponent<${SanitizedCppName}Component>(...) and pass your
