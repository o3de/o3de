    ...
    */
    ...
    protected:
        ...
        */
        ...
        /*
        * InGamePostActivate gets called after the UI Canvas has activated.
        * At this point you can successfully send UI events to other Canvas and Element Components.
        */
