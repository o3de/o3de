...
message(STATUS "o3de_default_restricted_folder: ${o3de_default_restricted_folder}")
if(${json_error})
    message(FATAL_ERROR "Unable to read o3de_default_restricted_folder from '${o3de_manifest_json_path}', error: ${json_error}")
endif()
