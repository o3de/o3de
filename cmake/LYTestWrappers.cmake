...
function(ly_add_googletest)
    ...
    if (ly_add_googletest_TEST_SUITE AND NOT ly_add_googletest_TEST_SUITE STREQUAL "main")
        ...
        set(non_ide_params "--gtest_filter=AssetManagerEbusSafety.OnAssetReady_GetAsset_DoesNotDeadlock:*SUITE_${ly_add_googletest_TEST_SUITE}*")
    else()
        ...
        set(non_ide_params "--gtest_filter=AssetManagerEbusSafety.OnAssetReady_GetAsset_DoesNotDeadlock-*SUITE_smoke*:*SUITE_periodic*:*SUITE_benchmark*:*SUITE_sandbox*:*SUITE_awsi*")
    endif()
