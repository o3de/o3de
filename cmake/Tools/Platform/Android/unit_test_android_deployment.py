...
@pytest.mark.parametrize(
    "test_config, test_package_name, test_device_storage_path", [
        pytest.param('profile', 'com.amazon.o3de.foo', '/data/fool_storage'),
        pytest.param('debug', 'com.amazon.o3de.foo', '/data/fool_storage'),
        pytest.param('profile', 'com.amazon.o3de.bar', '/data/fool_storage'),
        pytest.param('debug', 'com.amazon.o3de.bar', '/data/fool_storage'),
        pytest.param('profile', 'com.amazon.o3de.foo', '/data/fool_storage2'),
        pytest.param('debug', 'com.amazon.o3de.foo', '/data/fool_storage2'),
        pytest.param('profile', 'com.amazon.o3de.bar', '/data/fool_storage2'),
        pytest.param('debug', 'com.amazon.o3de.bar', '/data/fool_storage2')
    ]
)
...
@pytest.mark.parametrize(
    "test_game_name, test_config, test_package_name, test_device_storage_path, test_asset_type", [
        pytest.param('game1','profile', 'com.amazon.o3de.foo', '/data/fool_storage', 'android'),
        pytest.param('game1','debug', 'com.amazon.o3de.foo', '/data/fool_storage', 'android'),
        pytest.param('game2','profile', 'com.amazon.o3de.bar', '/data/fool_storage', 'android'),
        pytest.param('game2','debug', 'com.amazon.o3de.bar', '/data/fool_storage', 'android'),
        pytest.param('game3','profile', 'com.amazon.o3de.foo', '/data/fool_storage2', 'pc'),
        pytest.param('game3','debug', 'com.amazon.o3de.foo', '/data/fool_storage2', 'pc'),
        pytest.param('game4','profile', 'com.amazon.o3de.bar', '/data/fool_storage2', 'pc'),
        pytest.param('game4','debug', 'com.amazon.o3de.bar', '/data/fool_storage2', 'pc')
    ]
)
