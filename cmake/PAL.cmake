    ...
    if(NOT cache_exists)
        foreach(external_subdir IN LISTS registered_external_subdirs)
            ...
            if(EXISTS ${candidate_gem_path})
                ...
                if(NOT external_subdir IN_LIST cached_candidate_paths)
                    list(APPEND cached_candidate_paths "${external_subdir}")
                endif()

                set_property(GLOBAL PROPERTY ${cached_candidate_paths_property} "${cached_candidate_paths}")
            endif()
        endforeach()
