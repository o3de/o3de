...
function(ly_get_root_subdirectory_which_is_parent absolute_path output_path)
    ...
    # is found
    cmake_path(SET candidate_path NORMALIZE "${absolute_path}")
    get_property(provider_owner GLOBAL PROPERTY "O3DE_3RDPARTY_DIRECTORY_OWNER_${candidate_path}")
    if(provider_owner)
        set(${output_path} "${provider_owner}" PARENT_SCOPE)
        return()
    endif()
...
function(ly_get_engine_relative_source_dir absolute_target_source_dir output_source_dir)
    cmake_path(NORMAL_PATH absolute_target_source_dir)
