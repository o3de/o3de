...
function(ly_install_target ly_install_target_NAME)
    ...
    install(
        ...
        ARCHIVE DESTINATION ${archive_output_directory}/${PAL_PLATFORM_NAME}/$<CONFIG>
        LIBRARY DESTINATION ${library_output_directory}/${PAL_PLATFORM_NAME}/$<CONFIG>/${target_library_output_subdirectory}
        RUNTIME DESTINATION ${runtime_output_directory}/${PAL_PLATFORM_NAME}/$<CONFIG>/${target_runtime_output_subdirectory}
...
function(ly_generate_target_config_file NAME)
    ...
    if(NOT target_type STREQUAL INTERFACE_LIBRARY)
        ...
        if(target_type IN_LIST runtime_types)
            string(APPEND target_locations "\"\${LY_ROOT_FOLDER}/${runtime_output_directory}/${PAL_PLATFORM_NAME}/$<CONFIG>/${target_runtime_output_subdirectory}/$<TARGET_FILE_NAME:${NAME}>\"")
        elseif(target_type STREQUAL SHARED_LIBRARY)
            string(APPEND target_locations 
                "\"\${LY_ROOT_FOLDER}/${archive_output_directory}/${PAL_PLATFORM_NAME}/$<CONFIG>/$<TARGET_LINKER_FILE_NAME:${NAME}>;\${LY_ROOT_FOLDER}/${runtime_output_directory}/${PAL_PLATFORM_NAME}/$<CONFIG>/${target_runtime_output_subdirectory}/$<TARGET_FILE_NAME:${NAME}>\"")
        else() # STATIC_LIBRARY, OBJECT_LIBRARY, INTERFACE_LIBRARY
            string(APPEND target_locations "\"\${LY_ROOT_FOLDER}/${archive_output_directory}/${PAL_PLATFORM_NAME}/$<CONFIG>/$<TARGET_LINKER_FILE_NAME:${NAME}>\"")
        endif()

        string(APPEND target_file_contents 
"# Generated by O3DE install

set(target_locations ${target_locations})
set_target_properties(${NAME} 
    PROPERTIES
        $<$<CONFIG:profile>:IMPORTED_LOCATION \"\${target_locations}\">
        IMPORTED_LOCATION_$<UPPER_CASE:$<CONFIG>> \"\${target_locations}\"
)
foreach(target \${target_locations})
    if(EXISTS \"\${target}\")
