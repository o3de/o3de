...
# Internationalization (i18n) default settings for Windows
...
if(NOT DEFINED LY_I18N_LANGUAGE)
    set(LY_I18N_LANGUAGE "en_US" CACHE STRING "Target language for single language mode (Windows default: en_US)")
endif()

if(NOT DEFINED LY_I18N_COMPILE_QM)
    set(LY_I18N_COMPILE_QM ON CACHE BOOL "Compile .ts files to .qm binary files (Windows default: ON)")
endif()
