...
foreach(enabled_platform ${LY_PAL_TOOLS_ENABLED})
    ...
    o3de_pal_dir(pal_dir ${CMAKE_CURRENT_SOURCE_DIR}/cmake/Platform/${enabled_platform})
...
function(ly_get_pal_tool_dirs out_list pal_path)
    ...
    foreach(platform ${LY_PAL_TOOLS_ENABLED})
        o3d_pal_dir(path ${pal_path}/${platform} ${O3DE_ENGINE_RESTRICTED_PATH} ${LY_ROOT_FOLDER})
...
function(copy_java_resources_to_build_dir common_relative_path common_target_path file_paths)
  foreach(file_path ${file_paths})
    get_filename_component(target_path "${file_path}" DIRECTORY)
    set(res_file_src ${CMAKE_CURRENT_SOURCE_DIR}/${common_relative_path}/${file_path})
    set(res_file_dest ${CMAKE_BINARY_DIR}/../../../../src/main/${common_target_path}/${target_path})
