...
endforeach()
file(GLOB pal_restricted_tools_files "${O3DE_ENGINE_RESTRICTED_PATH}/*/cmake/PALTools_*.cmake")
...
foreach(enabled_platform ${LY_PAL_TOOLS_ENABLED})
    ...
    o3de_pal_dir(pal_dir "${CMAKE_CURRENT_SOURCE_DIR}/cmake/Platform/${enabled_platform}" "${O3DE_ENGINE_RESTRICTED_PATH}" "${LY_ROOT_FOLDER}")
...
function(ly_get_pal_tool_dirs out_list pal_path)
    ...
    foreach(platform ${LY_PAL_TOOLS_ENABLED})
        o3de_pal_dir(pal_platform_dir "${pal_path}/${platform}" "${O3DE_ENGINE_RESTRICTED_PATH}" "${LY_ROOT_FOLDER}")
        list(APPEND pal_paths ${pal_platform_dir})
    endforeach()
