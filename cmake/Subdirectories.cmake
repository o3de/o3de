...
function(add_engine_gem_json_external_subdirectories gem_path)
    ...
    if(EXISTS ${gem_json_path})
        ...
        if(gem_restricted_path)
            ...
            set(restricted_gem_json_path ${pal_dir}/gem_${PAL_PLATFORM_NAME_LOWERCASE}.json)
...
function(add_engine_json_external_subdirectories)
    ...
    if(EXISTS ${engine_json_path})
        ...
        if(engine_restricted_path)
            o3de_pal_dir(pal_dir ${LY_ROOT_FOLDER}/Platform/${PAL_PLATFORM_NAME} ${engine_restricted_path} ${LY_ROOT_FOLDER})
            set(restricted_engine_json_path ${pal_dir}/engine_${PAL_PLATFORM_NAME_LOWERCASE}.json)
...
function(add_project_json_external_subdirectories project_path project_name)
    ...
    if(EXISTS ${project_json_path})
        ...
        if(project_restricted_path)
            ...
            set(restricted_project_json_path ${pal_dir}/project_${PAL_PLATFORM_NAME_LOWERCASE}.json)
